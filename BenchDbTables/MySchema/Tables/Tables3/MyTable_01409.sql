CREATE TABLE [MySchema].[MyTable_01409] (
    ...
    CONSTRAINT [PK_MyTable_01409] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01409_MyTable01409] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01409] ([ColKey]),
    CONSTRAINT [BK_MyTable_01409_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
