CREATE TABLE [MySchema].[MyTable_01285] (
    ...
    CONSTRAINT [PK_MyTable_01285] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01285_MyTable01285] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01285] ([ColKey]),
    CONSTRAINT [BK_MyTable_01285_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
