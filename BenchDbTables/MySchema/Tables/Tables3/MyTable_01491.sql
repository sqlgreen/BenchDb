CREATE TABLE [MySchema].[MyTable_01491] (
    ...
    CONSTRAINT [PK_MyTable_01491] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01491_MyTable01491] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01491] ([ColKey]),
    CONSTRAINT [BK_MyTable_01491_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
