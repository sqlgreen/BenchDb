CREATE TABLE [MySchema].[MyTable_01469] (
    ...
    CONSTRAINT [PK_MyTable_01469] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01469_MyTable01469] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01469] ([ColKey]),
    CONSTRAINT [BK_MyTable_01469_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
