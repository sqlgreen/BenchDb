CREATE TABLE [MySchema].[MyTable_01083] (
    ...
    CONSTRAINT [PK_MyTable_01083] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01083_MyTable01083] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01083] ([ColKey]),
    CONSTRAINT [BK_MyTable_01083_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
