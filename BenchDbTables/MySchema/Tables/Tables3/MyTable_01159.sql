CREATE TABLE [MySchema].[MyTable_01159] (
    ...
    CONSTRAINT [PK_MyTable_01159] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01159_MyTable01159] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01159] ([ColKey]),
    CONSTRAINT [BK_MyTable_01159_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
