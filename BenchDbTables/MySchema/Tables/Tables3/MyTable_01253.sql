CREATE TABLE [MySchema].[MyTable_01253] (
    ...
    CONSTRAINT [PK_MyTable_01253] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01253_MyTable01253] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01253] ([ColKey]),
    CONSTRAINT [BK_MyTable_01253_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
