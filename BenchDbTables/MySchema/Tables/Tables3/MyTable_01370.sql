CREATE TABLE [MySchema].[MyTable_01370] (
    ...
    CONSTRAINT [PK_MyTable_01370] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01370_MyTable01370] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01370] ([ColKey]),
    CONSTRAINT [BK_MyTable_01370_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
