CREATE TABLE [MySchema].[MyTable_01410] (
    ...
    CONSTRAINT [PK_MyTable_01410] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01410_MyTable01410] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01410] ([ColKey]),
    CONSTRAINT [BK_MyTable_01410_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
