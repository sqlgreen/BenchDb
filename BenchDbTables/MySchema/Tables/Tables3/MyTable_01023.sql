CREATE TABLE [MySchema].[MyTable_01023] (
    ...
    CONSTRAINT [PK_MyTable_01023] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01023_MyTable01023] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01023] ([ColKey]),
    CONSTRAINT [BK_MyTable_01023_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
