CREATE TABLE [MySchema].[MyTable_01427] (
    ...
    CONSTRAINT [PK_MyTable_01427] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01427_MyTable01427] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01427] ([ColKey]),
    CONSTRAINT [BK_MyTable_01427_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
