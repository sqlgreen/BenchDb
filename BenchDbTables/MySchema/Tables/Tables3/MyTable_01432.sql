CREATE TABLE [MySchema].[MyTable_01432] (
    ...
    CONSTRAINT [PK_MyTable_01432] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01432_MyTable01432] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01432] ([ColKey]),
    CONSTRAINT [BK_MyTable_01432_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
