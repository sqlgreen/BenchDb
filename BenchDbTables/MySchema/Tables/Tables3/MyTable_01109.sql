CREATE TABLE [MySchema].[MyTable_01109] (
    ...
    CONSTRAINT [PK_MyTable_01109] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01109_MyTable01109] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01109] ([ColKey]),
    CONSTRAINT [BK_MyTable_01109_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
