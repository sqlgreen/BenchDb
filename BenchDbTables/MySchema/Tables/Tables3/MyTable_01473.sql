CREATE TABLE [MySchema].[MyTable_01473] (
    ...
    CONSTRAINT [PK_MyTable_01473] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01473_MyTable01473] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01473] ([ColKey]),
    CONSTRAINT [BK_MyTable_01473_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
