CREATE TABLE [MySchema].[MyTable_01022] (
    ...
    CONSTRAINT [PK_MyTable_01022] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01022_MyTable01022] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01022] ([ColKey]),
    CONSTRAINT [BK_MyTable_01022_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
