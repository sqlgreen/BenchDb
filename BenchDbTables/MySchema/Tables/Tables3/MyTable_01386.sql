CREATE TABLE [MySchema].[MyTable_01386] (
    ...
    CONSTRAINT [PK_MyTable_01386] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01386_MyTable01386] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01386] ([ColKey]),
    CONSTRAINT [BK_MyTable_01386_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
