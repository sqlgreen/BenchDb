CREATE TABLE [MySchema].[MyTable_01429] (
    ...
    CONSTRAINT [PK_MyTable_01429] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01429_MyTable01429] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01429] ([ColKey]),
    CONSTRAINT [BK_MyTable_01429_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
