CREATE TABLE [MySchema].[MyTable_01422] (
    ...
    CONSTRAINT [PK_MyTable_01422] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01422_MyTable01422] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01422] ([ColKey]),
    CONSTRAINT [BK_MyTable_01422_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
