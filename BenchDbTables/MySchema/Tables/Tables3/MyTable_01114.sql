CREATE TABLE [MySchema].[MyTable_01114] (
    ...
    CONSTRAINT [PK_MyTable_01114] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01114_MyTable01114] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01114] ([ColKey]),
    CONSTRAINT [BK_MyTable_01114_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
