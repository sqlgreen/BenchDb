CREATE TABLE [MySchema].[MyTable_01321] (
    ...
    CONSTRAINT [PK_MyTable_01321] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01321_MyTable01321] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01321] ([ColKey]),
    CONSTRAINT [BK_MyTable_01321_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
