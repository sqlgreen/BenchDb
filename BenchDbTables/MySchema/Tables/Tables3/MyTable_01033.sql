CREATE TABLE [MySchema].[MyTable_01033] (
    ...
    CONSTRAINT [PK_MyTable_01033] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01033_MyTable01033] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01033] ([ColKey]),
    CONSTRAINT [BK_MyTable_01033_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
