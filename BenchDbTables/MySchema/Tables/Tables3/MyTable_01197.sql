CREATE TABLE [MySchema].[MyTable_01197] (
    ...
    CONSTRAINT [PK_MyTable_01197] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01197_MyTable01197] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01197] ([ColKey]),
    CONSTRAINT [BK_MyTable_01197_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
