CREATE TABLE [MySchema].[MyTable_01335] (
    ...
    CONSTRAINT [PK_MyTable_01335] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01335_MyTable01335] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01335] ([ColKey]),
    CONSTRAINT [BK_MyTable_01335_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
