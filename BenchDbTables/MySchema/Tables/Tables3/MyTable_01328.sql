CREATE TABLE [MySchema].[MyTable_01328] (
    ...
    CONSTRAINT [PK_MyTable_01328] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01328_MyTable01328] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01328] ([ColKey]),
    CONSTRAINT [BK_MyTable_01328_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
