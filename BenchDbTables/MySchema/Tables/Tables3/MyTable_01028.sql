CREATE TABLE [MySchema].[MyTable_01028] (
    ...
    CONSTRAINT [PK_MyTable_01028] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01028_MyTable01028] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01028] ([ColKey]),
    CONSTRAINT [BK_MyTable_01028_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
