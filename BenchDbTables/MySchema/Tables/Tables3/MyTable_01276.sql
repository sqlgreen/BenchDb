CREATE TABLE [MySchema].[MyTable_01276] (
    ...
    CONSTRAINT [PK_MyTable_01276] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01276_MyTable01276] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01276] ([ColKey]),
    CONSTRAINT [BK_MyTable_01276_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
