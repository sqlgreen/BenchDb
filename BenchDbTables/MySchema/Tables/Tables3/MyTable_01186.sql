CREATE TABLE [MySchema].[MyTable_01186] (
    ...
    CONSTRAINT [PK_MyTable_01186] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01186_MyTable01186] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01186] ([ColKey]),
    CONSTRAINT [BK_MyTable_01186_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
