CREATE TABLE [MySchema].[MyTable_01194] (
    ...
    CONSTRAINT [PK_MyTable_01194] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01194_MyTable01194] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01194] ([ColKey]),
    CONSTRAINT [BK_MyTable_01194_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
