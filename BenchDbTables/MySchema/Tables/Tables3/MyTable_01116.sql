CREATE TABLE [MySchema].[MyTable_01116] (
    ...
    CONSTRAINT [PK_MyTable_01116] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01116_MyTable01116] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01116] ([ColKey]),
    CONSTRAINT [BK_MyTable_01116_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
