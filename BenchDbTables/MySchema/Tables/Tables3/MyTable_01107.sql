CREATE TABLE [MySchema].[MyTable_01107] (
    ...
    CONSTRAINT [PK_MyTable_01107] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01107_MyTable01107] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01107] ([ColKey]),
    CONSTRAINT [BK_MyTable_01107_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
