CREATE TABLE [MySchema].[MyTable_01061] (
    ...
    CONSTRAINT [PK_MyTable_01061] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01061_MyTable01061] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01061] ([ColKey]),
    CONSTRAINT [BK_MyTable_01061_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
