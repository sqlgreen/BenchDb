CREATE TABLE [MySchema].[MyTable_01402] (
    ...
    CONSTRAINT [PK_MyTable_01402] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01402_MyTable01402] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01402] ([ColKey]),
    CONSTRAINT [BK_MyTable_01402_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
