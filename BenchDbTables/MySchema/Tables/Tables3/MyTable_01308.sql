CREATE TABLE [MySchema].[MyTable_01308] (
    ...
    CONSTRAINT [PK_MyTable_01308] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01308_MyTable01308] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01308] ([ColKey]),
    CONSTRAINT [BK_MyTable_01308_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
