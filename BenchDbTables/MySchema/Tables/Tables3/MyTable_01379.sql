CREATE TABLE [MySchema].[MyTable_01379] (
    ...
    CONSTRAINT [PK_MyTable_01379] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01379_MyTable01379] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01379] ([ColKey]),
    CONSTRAINT [BK_MyTable_01379_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
