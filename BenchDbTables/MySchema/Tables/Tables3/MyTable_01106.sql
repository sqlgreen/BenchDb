CREATE TABLE [MySchema].[MyTable_01106] (
    ...
    CONSTRAINT [PK_MyTable_01106] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01106_MyTable01106] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01106] ([ColKey]),
    CONSTRAINT [BK_MyTable_01106_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
