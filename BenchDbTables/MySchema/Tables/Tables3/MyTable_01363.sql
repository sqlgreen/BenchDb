CREATE TABLE [MySchema].[MyTable_01363] (
    ...
    CONSTRAINT [PK_MyTable_01363] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01363_MyTable01363] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01363] ([ColKey]),
    CONSTRAINT [BK_MyTable_01363_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
