CREATE TABLE [MySchema].[MyTable_01348] (
    ...
    CONSTRAINT [PK_MyTable_01348] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01348_MyTable01348] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01348] ([ColKey]),
    CONSTRAINT [BK_MyTable_01348_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
