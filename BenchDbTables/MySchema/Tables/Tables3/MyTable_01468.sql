CREATE TABLE [MySchema].[MyTable_01468] (
    ...
    CONSTRAINT [PK_MyTable_01468] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01468_MyTable01468] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01468] ([ColKey]),
    CONSTRAINT [BK_MyTable_01468_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
