CREATE TABLE [MySchema].[MyTable_01112] (
    ...
    CONSTRAINT [PK_MyTable_01112] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01112_MyTable01112] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01112] ([ColKey]),
    CONSTRAINT [BK_MyTable_01112_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
