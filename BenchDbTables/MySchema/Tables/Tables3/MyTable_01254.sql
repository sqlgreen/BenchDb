CREATE TABLE [MySchema].[MyTable_01254] (
    ...
    CONSTRAINT [PK_MyTable_01254] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01254_MyTable01254] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01254] ([ColKey]),
    CONSTRAINT [BK_MyTable_01254_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
