CREATE TABLE [MySchema].[MyTable_01493] (
    ...
    CONSTRAINT [PK_MyTable_01493] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01493_MyTable01493] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01493] ([ColKey]),
    CONSTRAINT [BK_MyTable_01493_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
