CREATE TABLE [MySchema].[MyTable_01496] (
    ...
    CONSTRAINT [PK_MyTable_01496] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01496_MyTable01496] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01496] ([ColKey]),
    CONSTRAINT [BK_MyTable_01496_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
