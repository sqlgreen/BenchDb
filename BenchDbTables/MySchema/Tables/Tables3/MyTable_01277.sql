CREATE TABLE [MySchema].[MyTable_01277] (
    ...
    CONSTRAINT [PK_MyTable_01277] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01277_MyTable01277] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01277] ([ColKey]),
    CONSTRAINT [BK_MyTable_01277_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
