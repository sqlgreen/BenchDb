CREATE TABLE [MySchema].[MyTable_01198] (
    ...
    CONSTRAINT [PK_MyTable_01198] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01198_MyTable01198] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01198] ([ColKey]),
    CONSTRAINT [BK_MyTable_01198_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
