CREATE TABLE [MySchema].[MyTable_01166] (
    ...
    CONSTRAINT [PK_MyTable_01166] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01166_MyTable01166] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01166] ([ColKey]),
    CONSTRAINT [BK_MyTable_01166_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
