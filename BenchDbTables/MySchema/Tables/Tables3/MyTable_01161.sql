CREATE TABLE [MySchema].[MyTable_01161] (
    ...
    CONSTRAINT [PK_MyTable_01161] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01161_MyTable01161] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01161] ([ColKey]),
    CONSTRAINT [BK_MyTable_01161_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
