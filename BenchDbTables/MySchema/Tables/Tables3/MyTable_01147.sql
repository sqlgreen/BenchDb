CREATE TABLE [MySchema].[MyTable_01147] (
    ...
    CONSTRAINT [PK_MyTable_01147] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01147_MyTable01147] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01147] ([ColKey]),
    CONSTRAINT [BK_MyTable_01147_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
