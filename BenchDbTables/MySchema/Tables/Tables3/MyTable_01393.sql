CREATE TABLE [MySchema].[MyTable_01393] (
    ...
    CONSTRAINT [PK_MyTable_01393] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01393_MyTable01393] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01393] ([ColKey]),
    CONSTRAINT [BK_MyTable_01393_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
