CREATE TABLE [MySchema].[MyTable_01292] (
    ...
    CONSTRAINT [PK_MyTable_01292] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01292_MyTable01292] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01292] ([ColKey]),
    CONSTRAINT [BK_MyTable_01292_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
