CREATE TABLE [MySchema].[MyTable_01056] (
    ...
    CONSTRAINT [PK_MyTable_01056] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01056_MyTable01056] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01056] ([ColKey]),
    CONSTRAINT [BK_MyTable_01056_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
