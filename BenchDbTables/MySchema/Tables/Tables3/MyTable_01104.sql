CREATE TABLE [MySchema].[MyTable_01104] (
    ...
    CONSTRAINT [PK_MyTable_01104] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01104_MyTable01104] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01104] ([ColKey]),
    CONSTRAINT [BK_MyTable_01104_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
