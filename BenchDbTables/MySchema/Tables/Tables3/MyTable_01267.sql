CREATE TABLE [MySchema].[MyTable_01267] (
    ...
    CONSTRAINT [PK_MyTable_01267] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01267_MyTable01267] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01267] ([ColKey]),
    CONSTRAINT [BK_MyTable_01267_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
