CREATE TABLE [MySchema].[MyTable_01362] (
    ...
    CONSTRAINT [PK_MyTable_01362] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01362_MyTable01362] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01362] ([ColKey]),
    CONSTRAINT [BK_MyTable_01362_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
