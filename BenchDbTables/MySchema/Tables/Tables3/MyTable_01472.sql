CREATE TABLE [MySchema].[MyTable_01472] (
    ...
    CONSTRAINT [PK_MyTable_01472] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01472_MyTable01472] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01472] ([ColKey]),
    CONSTRAINT [BK_MyTable_01472_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
