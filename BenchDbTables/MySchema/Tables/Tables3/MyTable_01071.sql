CREATE TABLE [MySchema].[MyTable_01071] (
    ...
    CONSTRAINT [PK_MyTable_01071] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01071_MyTable01071] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01071] ([ColKey]),
    CONSTRAINT [BK_MyTable_01071_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
