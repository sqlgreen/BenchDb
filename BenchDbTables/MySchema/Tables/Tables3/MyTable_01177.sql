CREATE TABLE [MySchema].[MyTable_01177] (
    ...
    CONSTRAINT [PK_MyTable_01177] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01177_MyTable01177] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01177] ([ColKey]),
    CONSTRAINT [BK_MyTable_01177_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
