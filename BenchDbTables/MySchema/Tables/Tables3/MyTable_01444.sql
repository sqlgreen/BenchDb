CREATE TABLE [MySchema].[MyTable_01444] (
    ...
    CONSTRAINT [PK_MyTable_01444] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01444_MyTable01444] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01444] ([ColKey]),
    CONSTRAINT [BK_MyTable_01444_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
