CREATE TABLE [MySchema].[MyTable_01148] (
    ...
    CONSTRAINT [PK_MyTable_01148] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01148_MyTable01148] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01148] ([ColKey]),
    CONSTRAINT [BK_MyTable_01148_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
