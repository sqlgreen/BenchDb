CREATE TABLE [MySchema].[MyTable_01471] (
    ...
    CONSTRAINT [PK_MyTable_01471] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01471_MyTable01471] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01471] ([ColKey]),
    CONSTRAINT [BK_MyTable_01471_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
