CREATE TABLE [MySchema].[MyTable_01223] (
    ...
    CONSTRAINT [PK_MyTable_01223] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01223_MyTable01223] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01223] ([ColKey]),
    CONSTRAINT [BK_MyTable_01223_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
