CREATE TABLE [MySchema].[MyTable_01270] (
    ...
    CONSTRAINT [PK_MyTable_01270] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01270_MyTable01270] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01270] ([ColKey]),
    CONSTRAINT [BK_MyTable_01270_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
