CREATE TABLE [MySchema].[MyTable_01178] (
    ...
    CONSTRAINT [PK_MyTable_01178] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01178_MyTable01178] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01178] ([ColKey]),
    CONSTRAINT [BK_MyTable_01178_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
