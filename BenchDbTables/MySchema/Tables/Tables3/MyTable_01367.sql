CREATE TABLE [MySchema].[MyTable_01367] (
    ...
    CONSTRAINT [PK_MyTable_01367] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01367_MyTable01367] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01367] ([ColKey]),
    CONSTRAINT [BK_MyTable_01367_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
