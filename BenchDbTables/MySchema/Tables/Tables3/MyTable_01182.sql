CREATE TABLE [MySchema].[MyTable_01182] (
    ...
    CONSTRAINT [PK_MyTable_01182] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01182_MyTable01182] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01182] ([ColKey]),
    CONSTRAINT [BK_MyTable_01182_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
