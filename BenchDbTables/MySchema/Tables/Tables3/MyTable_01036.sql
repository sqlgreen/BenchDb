CREATE TABLE [MySchema].[MyTable_01036] (
    ...
    CONSTRAINT [PK_MyTable_01036] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01036_MyTable01036] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01036] ([ColKey]),
    CONSTRAINT [BK_MyTable_01036_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
