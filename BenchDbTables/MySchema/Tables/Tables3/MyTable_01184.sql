CREATE TABLE [MySchema].[MyTable_01184] (
    ...
    CONSTRAINT [PK_MyTable_01184] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01184_MyTable01184] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01184] ([ColKey]),
    CONSTRAINT [BK_MyTable_01184_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
