CREATE TABLE [MySchema].[MyTable_01066] (
    ...
    CONSTRAINT [PK_MyTable_01066] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01066_MyTable01066] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01066] ([ColKey]),
    CONSTRAINT [BK_MyTable_01066_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
