CREATE TABLE [MySchema].[MyTable_01134] (
    ...
    CONSTRAINT [PK_MyTable_01134] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01134_MyTable01134] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01134] ([ColKey]),
    CONSTRAINT [BK_MyTable_01134_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
