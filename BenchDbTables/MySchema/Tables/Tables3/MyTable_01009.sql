CREATE TABLE [MySchema].[MyTable_01009] (
    ...
    CONSTRAINT [PK_MyTable_01009] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01009_MyTable01009] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01009] ([ColKey]),
    CONSTRAINT [BK_MyTable_01009_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
