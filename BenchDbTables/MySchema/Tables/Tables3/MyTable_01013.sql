CREATE TABLE [MySchema].[MyTable_01013] (
    ...
    CONSTRAINT [PK_MyTable_01013] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01013_MyTable01013] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01013] ([ColKey]),
    CONSTRAINT [BK_MyTable_01013_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
