CREATE TABLE [MySchema].[MyTable_01303] (
    ...
    CONSTRAINT [PK_MyTable_01303] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01303_MyTable01303] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01303] ([ColKey]),
    CONSTRAINT [BK_MyTable_01303_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
