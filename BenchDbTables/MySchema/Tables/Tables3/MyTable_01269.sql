CREATE TABLE [MySchema].[MyTable_01269] (
    ...
    CONSTRAINT [PK_MyTable_01269] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01269_MyTable01269] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01269] ([ColKey]),
    CONSTRAINT [BK_MyTable_01269_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
