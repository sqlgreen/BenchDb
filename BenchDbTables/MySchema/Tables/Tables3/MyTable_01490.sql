CREATE TABLE [MySchema].[MyTable_01490] (
    ...
    CONSTRAINT [PK_MyTable_01490] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01490_MyTable01490] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01490] ([ColKey]),
    CONSTRAINT [BK_MyTable_01490_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
