CREATE TABLE [MySchema].[MyTable_01205] (
    ...
    CONSTRAINT [PK_MyTable_01205] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01205_MyTable01205] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01205] ([ColKey]),
    CONSTRAINT [BK_MyTable_01205_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
