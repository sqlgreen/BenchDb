CREATE TABLE [MySchema].[MyTable_01334] (
    ...
    CONSTRAINT [PK_MyTable_01334] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01334_MyTable01334] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01334] ([ColKey]),
    CONSTRAINT [BK_MyTable_01334_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
