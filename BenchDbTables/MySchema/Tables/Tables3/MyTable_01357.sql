CREATE TABLE [MySchema].[MyTable_01357] (
    ...
    CONSTRAINT [PK_MyTable_01357] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01357_MyTable01357] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01357] ([ColKey]),
    CONSTRAINT [BK_MyTable_01357_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
