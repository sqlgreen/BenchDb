CREATE TABLE [MySchema].[MyTable_01094] (
    ...
    CONSTRAINT [PK_MyTable_01094] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01094_MyTable01094] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01094] ([ColKey]),
    CONSTRAINT [BK_MyTable_01094_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
