CREATE TABLE [MySchema].[MyTable_01431] (
    ...
    CONSTRAINT [PK_MyTable_01431] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01431_MyTable01431] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01431] ([ColKey]),
    CONSTRAINT [BK_MyTable_01431_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
