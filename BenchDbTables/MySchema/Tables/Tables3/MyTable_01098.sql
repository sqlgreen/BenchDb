CREATE TABLE [MySchema].[MyTable_01098] (
    ...
    CONSTRAINT [PK_MyTable_01098] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01098_MyTable01098] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01098] ([ColKey]),
    CONSTRAINT [BK_MyTable_01098_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
