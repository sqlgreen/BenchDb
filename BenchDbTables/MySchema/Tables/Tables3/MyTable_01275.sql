CREATE TABLE [MySchema].[MyTable_01275] (
    ...
    CONSTRAINT [PK_MyTable_01275] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01275_MyTable01275] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01275] ([ColKey]),
    CONSTRAINT [BK_MyTable_01275_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
