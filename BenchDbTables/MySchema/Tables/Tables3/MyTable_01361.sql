CREATE TABLE [MySchema].[MyTable_01361] (
    ...
    CONSTRAINT [PK_MyTable_01361] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01361_MyTable01361] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01361] ([ColKey]),
    CONSTRAINT [BK_MyTable_01361_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
