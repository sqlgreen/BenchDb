CREATE TABLE [MySchema].[MyTable_01236] (
    ...
    CONSTRAINT [PK_MyTable_01236] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01236_MyTable01236] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01236] ([ColKey]),
    CONSTRAINT [BK_MyTable_01236_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
