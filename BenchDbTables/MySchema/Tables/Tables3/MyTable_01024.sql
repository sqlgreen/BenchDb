CREATE TABLE [MySchema].[MyTable_01024] (
    ...
    CONSTRAINT [PK_MyTable_01024] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01024_MyTable01024] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01024] ([ColKey]),
    CONSTRAINT [BK_MyTable_01024_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
