CREATE TABLE [MySchema].[MyTable_01046] (
    ...
    CONSTRAINT [PK_MyTable_01046] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01046_MyTable01046] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01046] ([ColKey]),
    CONSTRAINT [BK_MyTable_01046_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
