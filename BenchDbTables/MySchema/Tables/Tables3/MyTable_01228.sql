CREATE TABLE [MySchema].[MyTable_01228] (
    ...
    CONSTRAINT [PK_MyTable_01228] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01228_MyTable01228] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01228] ([ColKey]),
    CONSTRAINT [BK_MyTable_01228_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
