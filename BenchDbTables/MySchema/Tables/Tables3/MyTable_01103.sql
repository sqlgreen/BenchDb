CREATE TABLE [MySchema].[MyTable_01103] (
    ...
    CONSTRAINT [PK_MyTable_01103] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01103_MyTable01103] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01103] ([ColKey]),
    CONSTRAINT [BK_MyTable_01103_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
