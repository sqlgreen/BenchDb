CREATE TABLE [MySchema].[MyTable_01015] (
    ...
    CONSTRAINT [PK_MyTable_01015] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01015_MyTable01015] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01015] ([ColKey]),
    CONSTRAINT [BK_MyTable_01015_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
