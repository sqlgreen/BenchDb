CREATE TABLE [MySchema].[MyTable_01479] (
    ...
    CONSTRAINT [PK_MyTable_01479] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01479_MyTable01479] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01479] ([ColKey]),
    CONSTRAINT [BK_MyTable_01479_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
