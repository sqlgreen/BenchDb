CREATE TABLE [MySchema].[MyTable_01456] (
    ...
    CONSTRAINT [PK_MyTable_01456] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01456_MyTable01456] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01456] ([ColKey]),
    CONSTRAINT [BK_MyTable_01456_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
