CREATE TABLE [MySchema].[MyTable_01324] (
    ...
    CONSTRAINT [PK_MyTable_01324] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01324_MyTable01324] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01324] ([ColKey]),
    CONSTRAINT [BK_MyTable_01324_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
