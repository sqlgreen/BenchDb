CREATE TABLE [MySchema].[MyTable_01127] (
    ...
    CONSTRAINT [PK_MyTable_01127] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01127_MyTable01127] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01127] ([ColKey]),
    CONSTRAINT [BK_MyTable_01127_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
