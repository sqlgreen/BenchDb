CREATE TABLE [MySchema].[MyTable_01176] (
    ...
    CONSTRAINT [PK_MyTable_01176] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01176_MyTable01176] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01176] ([ColKey]),
    CONSTRAINT [BK_MyTable_01176_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
