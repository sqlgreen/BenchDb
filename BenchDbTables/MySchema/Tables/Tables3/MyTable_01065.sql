CREATE TABLE [MySchema].[MyTable_01065] (
    ...
    CONSTRAINT [PK_MyTable_01065] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01065_MyTable01065] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01065] ([ColKey]),
    CONSTRAINT [BK_MyTable_01065_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
