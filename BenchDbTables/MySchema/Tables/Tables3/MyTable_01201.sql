CREATE TABLE [MySchema].[MyTable_01201] (
    ...
    CONSTRAINT [PK_MyTable_01201] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01201_MyTable01201] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01201] ([ColKey]),
    CONSTRAINT [BK_MyTable_01201_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
