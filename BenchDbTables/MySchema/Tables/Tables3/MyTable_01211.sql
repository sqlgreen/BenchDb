CREATE TABLE [MySchema].[MyTable_01211] (
    ...
    CONSTRAINT [PK_MyTable_01211] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01211_MyTable01211] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01211] ([ColKey]),
    CONSTRAINT [BK_MyTable_01211_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
