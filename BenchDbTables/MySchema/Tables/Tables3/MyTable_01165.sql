CREATE TABLE [MySchema].[MyTable_01165] (
    ...
    CONSTRAINT [PK_MyTable_01165] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01165_MyTable01165] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01165] ([ColKey]),
    CONSTRAINT [BK_MyTable_01165_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
