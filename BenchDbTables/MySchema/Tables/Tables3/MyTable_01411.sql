CREATE TABLE [MySchema].[MyTable_01411] (
    ...
    CONSTRAINT [PK_MyTable_01411] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01411_MyTable01411] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01411] ([ColKey]),
    CONSTRAINT [BK_MyTable_01411_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
