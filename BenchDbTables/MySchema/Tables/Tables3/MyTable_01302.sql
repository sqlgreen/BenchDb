CREATE TABLE [MySchema].[MyTable_01302] (
    ...
    CONSTRAINT [PK_MyTable_01302] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01302_MyTable01302] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01302] ([ColKey]),
    CONSTRAINT [BK_MyTable_01302_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
