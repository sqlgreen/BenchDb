CREATE TABLE [MySchema].[MyTable_01320] (
    ...
    CONSTRAINT [PK_MyTable_01320] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01320_MyTable01320] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01320] ([ColKey]),
    CONSTRAINT [BK_MyTable_01320_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
