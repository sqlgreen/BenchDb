CREATE TABLE [MySchema].[MyTable_00789] (
    ...
    CONSTRAINT [PK_MyTable_00789] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00789_MyTable00789] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00789] ([ColKey]),
    CONSTRAINT [BK_MyTable_00789_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
