CREATE TABLE [MySchema].[MyTable_00825] (
    ...
    CONSTRAINT [PK_MyTable_00825] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00825_MyTable00825] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00825] ([ColKey]),
    CONSTRAINT [BK_MyTable_00825_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
