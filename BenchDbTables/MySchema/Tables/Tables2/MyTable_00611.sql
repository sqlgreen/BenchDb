CREATE TABLE [MySchema].[MyTable_00611] (
    ...
    CONSTRAINT [PK_MyTable_00611] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00611_MyTable00611] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00611] ([ColKey]),
    CONSTRAINT [BK_MyTable_00611_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
