CREATE TABLE [MySchema].[MyTable_00720] (
    ...
    CONSTRAINT [PK_MyTable_00720] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00720_MyTable00720] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00720] ([ColKey]),
    CONSTRAINT [BK_MyTable_00720_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
