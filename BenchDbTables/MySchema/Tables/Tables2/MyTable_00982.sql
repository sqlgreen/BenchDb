CREATE TABLE [MySchema].[MyTable_00982] (
    ...
    CONSTRAINT [PK_MyTable_00982] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00982_MyTable00982] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00982] ([ColKey]),
    CONSTRAINT [BK_MyTable_00982_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
