CREATE TABLE [MySchema].[MyTable_00781] (
    ...
    CONSTRAINT [PK_MyTable_00781] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00781_MyTable00781] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00781] ([ColKey]),
    CONSTRAINT [BK_MyTable_00781_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
