CREATE TABLE [MySchema].[MyTable_00622] (
    ...
    CONSTRAINT [PK_MyTable_00622] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00622_MyTable00622] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00622] ([ColKey]),
    CONSTRAINT [BK_MyTable_00622_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
