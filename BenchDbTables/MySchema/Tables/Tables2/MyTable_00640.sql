CREATE TABLE [MySchema].[MyTable_00640] (
    ...
    CONSTRAINT [PK_MyTable_00640] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00640_MyTable00640] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00640] ([ColKey]),
    CONSTRAINT [BK_MyTable_00640_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
