CREATE TABLE [MySchema].[MyTable_00948] (
    ...
    CONSTRAINT [PK_MyTable_00948] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00948_MyTable00948] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00948] ([ColKey]),
    CONSTRAINT [BK_MyTable_00948_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
