CREATE TABLE [MySchema].[MyTable_00855] (
    ...
    CONSTRAINT [PK_MyTable_00855] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00855_MyTable00855] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00855] ([ColKey]),
    CONSTRAINT [BK_MyTable_00855_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
