CREATE TABLE [MySchema].[MyTable_00708] (
    ...
    CONSTRAINT [PK_MyTable_00708] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00708_MyTable00708] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00708] ([ColKey]),
    CONSTRAINT [BK_MyTable_00708_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
