CREATE TABLE [MySchema].[MyTable_00927] (
    ...
    CONSTRAINT [PK_MyTable_00927] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00927_MyTable00927] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00927] ([ColKey]),
    CONSTRAINT [BK_MyTable_00927_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
