CREATE TABLE [MySchema].[MyTable_00929] (
    ...
    CONSTRAINT [PK_MyTable_00929] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00929_MyTable00929] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00929] ([ColKey]),
    CONSTRAINT [BK_MyTable_00929_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
