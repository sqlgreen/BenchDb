CREATE TABLE [MySchema].[MyTable_00833] (
    ...
    CONSTRAINT [PK_MyTable_00833] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00833_MyTable00833] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00833] ([ColKey]),
    CONSTRAINT [BK_MyTable_00833_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
