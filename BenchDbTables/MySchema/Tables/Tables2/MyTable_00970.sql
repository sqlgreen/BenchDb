CREATE TABLE [MySchema].[MyTable_00970] (
    ...
    CONSTRAINT [PK_MyTable_00970] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00970_MyTable00970] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00970] ([ColKey]),
    CONSTRAINT [BK_MyTable_00970_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
