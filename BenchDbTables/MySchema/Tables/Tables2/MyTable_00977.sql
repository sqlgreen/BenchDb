CREATE TABLE [MySchema].[MyTable_00977] (
    ...
    CONSTRAINT [PK_MyTable_00977] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00977_MyTable00977] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00977] ([ColKey]),
    CONSTRAINT [BK_MyTable_00977_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
