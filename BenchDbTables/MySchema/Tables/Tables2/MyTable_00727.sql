CREATE TABLE [MySchema].[MyTable_00727] (
    ...
    CONSTRAINT [PK_MyTable_00727] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00727_MyTable00727] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00727] ([ColKey]),
    CONSTRAINT [BK_MyTable_00727_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
