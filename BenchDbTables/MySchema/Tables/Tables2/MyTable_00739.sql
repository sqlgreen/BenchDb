CREATE TABLE [MySchema].[MyTable_00739] (
    ...
    CONSTRAINT [PK_MyTable_00739] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00739_MyTable00739] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00739] ([ColKey]),
    CONSTRAINT [BK_MyTable_00739_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
