CREATE TABLE [MySchema].[MyTable_00579] (
    ...
    CONSTRAINT [PK_MyTable_00579] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00579_MyTable00579] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00579] ([ColKey]),
    CONSTRAINT [BK_MyTable_00579_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
