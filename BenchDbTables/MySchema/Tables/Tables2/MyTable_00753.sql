CREATE TABLE [MySchema].[MyTable_00753] (
    ...
    CONSTRAINT [PK_MyTable_00753] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00753_MyTable00753] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00753] ([ColKey]),
    CONSTRAINT [BK_MyTable_00753_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
