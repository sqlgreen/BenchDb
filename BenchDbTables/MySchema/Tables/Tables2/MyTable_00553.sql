CREATE TABLE [MySchema].[MyTable_00553] (
    ...
    CONSTRAINT [PK_MyTable_00553] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00553_MyTable00553] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00553] ([ColKey]),
    CONSTRAINT [BK_MyTable_00553_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
