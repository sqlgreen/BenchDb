CREATE TABLE [MySchema].[MyTable_00918] (
    ...
    CONSTRAINT [PK_MyTable_00918] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00918_MyTable00918] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00918] ([ColKey]),
    CONSTRAINT [BK_MyTable_00918_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
