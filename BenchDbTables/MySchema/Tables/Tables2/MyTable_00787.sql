CREATE TABLE [MySchema].[MyTable_00787] (
    ...
    CONSTRAINT [PK_MyTable_00787] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00787_MyTable00787] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00787] ([ColKey]),
    CONSTRAINT [BK_MyTable_00787_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
