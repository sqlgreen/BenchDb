CREATE TABLE [MySchema].[MyTable_00850] (
    ...
    CONSTRAINT [PK_MyTable_00850] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00850_MyTable00850] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00850] ([ColKey]),
    CONSTRAINT [BK_MyTable_00850_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
