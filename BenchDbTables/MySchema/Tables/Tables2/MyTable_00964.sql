CREATE TABLE [MySchema].[MyTable_00964] (
    ...
    CONSTRAINT [PK_MyTable_00964] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00964_MyTable00964] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00964] ([ColKey]),
    CONSTRAINT [BK_MyTable_00964_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
