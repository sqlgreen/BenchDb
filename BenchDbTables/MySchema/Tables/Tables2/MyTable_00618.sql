CREATE TABLE [MySchema].[MyTable_00618] (
    ...
    CONSTRAINT [PK_MyTable_00618] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00618_MyTable00618] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00618] ([ColKey]),
    CONSTRAINT [BK_MyTable_00618_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
