CREATE TABLE [MySchema].[MyTable_00645] (
    ...
    CONSTRAINT [PK_MyTable_00645] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00645_MyTable00645] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00645] ([ColKey]),
    CONSTRAINT [BK_MyTable_00645_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
