CREATE TABLE [MySchema].[MyTable_00991] (
    ...
    CONSTRAINT [PK_MyTable_00991] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00991_MyTable00991] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00991] ([ColKey]),
    CONSTRAINT [BK_MyTable_00991_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
