CREATE TABLE [MySchema].[MyTable_00754] (
    ...
    CONSTRAINT [PK_MyTable_00754] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00754_MyTable00754] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00754] ([ColKey]),
    CONSTRAINT [BK_MyTable_00754_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
