CREATE TABLE [MySchema].[MyTable_00530] (
    ...
    CONSTRAINT [PK_MyTable_00530] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00530_MyTable00530] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00530] ([ColKey]),
    CONSTRAINT [BK_MyTable_00530_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
