CREATE TABLE [MySchema].[MyTable_00905] (
    ...
    CONSTRAINT [PK_MyTable_00905] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00905_MyTable00905] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00905] ([ColKey]),
    CONSTRAINT [BK_MyTable_00905_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
