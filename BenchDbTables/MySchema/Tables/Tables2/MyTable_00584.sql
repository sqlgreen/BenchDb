CREATE TABLE [MySchema].[MyTable_00584] (
    ...
    CONSTRAINT [PK_MyTable_00584] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00584_MyTable00584] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00584] ([ColKey]),
    CONSTRAINT [BK_MyTable_00584_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
