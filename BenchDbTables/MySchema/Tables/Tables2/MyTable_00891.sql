CREATE TABLE [MySchema].[MyTable_00891] (
    ...
    CONSTRAINT [PK_MyTable_00891] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00891_MyTable00891] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00891] ([ColKey]),
    CONSTRAINT [BK_MyTable_00891_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
