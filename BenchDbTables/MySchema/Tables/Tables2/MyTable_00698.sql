CREATE TABLE [MySchema].[MyTable_00698] (
    ...
    CONSTRAINT [PK_MyTable_00698] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00698_MyTable00698] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00698] ([ColKey]),
    CONSTRAINT [BK_MyTable_00698_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
