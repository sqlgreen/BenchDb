CREATE TABLE [MySchema].[MyTable_00807] (
    ...
    CONSTRAINT [PK_MyTable_00807] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00807_MyTable00807] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00807] ([ColKey]),
    CONSTRAINT [BK_MyTable_00807_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
