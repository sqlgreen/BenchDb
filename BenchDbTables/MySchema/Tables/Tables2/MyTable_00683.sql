CREATE TABLE [MySchema].[MyTable_00683] (
    ...
    CONSTRAINT [PK_MyTable_00683] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00683_MyTable00683] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00683] ([ColKey]),
    CONSTRAINT [BK_MyTable_00683_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
