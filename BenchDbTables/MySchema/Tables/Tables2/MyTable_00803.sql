CREATE TABLE [MySchema].[MyTable_00803] (
    ...
    CONSTRAINT [PK_MyTable_00803] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00803_MyTable00803] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00803] ([ColKey]),
    CONSTRAINT [BK_MyTable_00803_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
