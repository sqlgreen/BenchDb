CREATE TABLE [MySchema].[MyTable_00673] (
    ...
    CONSTRAINT [PK_MyTable_00673] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00673_MyTable00673] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00673] ([ColKey]),
    CONSTRAINT [BK_MyTable_00673_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
