CREATE TABLE [MySchema].[MyTable_00608] (
    ...
    CONSTRAINT [PK_MyTable_00608] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00608_MyTable00608] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00608] ([ColKey]),
    CONSTRAINT [BK_MyTable_00608_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
