CREATE TABLE [MySchema].[MyTable_00788] (
    ...
    CONSTRAINT [PK_MyTable_00788] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00788_MyTable00788] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00788] ([ColKey]),
    CONSTRAINT [BK_MyTable_00788_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
