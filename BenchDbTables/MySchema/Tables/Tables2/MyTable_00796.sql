CREATE TABLE [MySchema].[MyTable_00796] (
    ...
    CONSTRAINT [PK_MyTable_00796] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00796_MyTable00796] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00796] ([ColKey]),
    CONSTRAINT [BK_MyTable_00796_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
