CREATE TABLE [MySchema].[MyTable_00501] (
    ...
    CONSTRAINT [PK_MyTable_00501] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00501_MyTable00501] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00501] ([ColKey]),
    CONSTRAINT [BK_MyTable_00501_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
