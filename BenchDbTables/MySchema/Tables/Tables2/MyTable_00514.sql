CREATE TABLE [MySchema].[MyTable_00514] (
    ...
    CONSTRAINT [PK_MyTable_00514] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00514_MyTable00514] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00514] ([ColKey]),
    CONSTRAINT [BK_MyTable_00514_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
