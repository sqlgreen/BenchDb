CREATE TABLE [MySchema].[MyTable_00907] (
    ...
    CONSTRAINT [PK_MyTable_00907] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00907_MyTable00907] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00907] ([ColKey]),
    CONSTRAINT [BK_MyTable_00907_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
