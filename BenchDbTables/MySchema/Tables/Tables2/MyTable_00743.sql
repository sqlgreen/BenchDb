CREATE TABLE [MySchema].[MyTable_00743] (
    ...
    CONSTRAINT [PK_MyTable_00743] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00743_MyTable00743] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00743] ([ColKey]),
    CONSTRAINT [BK_MyTable_00743_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
