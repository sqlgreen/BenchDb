CREATE TABLE [MySchema].[MyTable_00526] (
    ...
    CONSTRAINT [PK_MyTable_00526] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00526_MyTable00526] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00526] ([ColKey]),
    CONSTRAINT [BK_MyTable_00526_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
