CREATE TABLE [MySchema].[MyTable_00829] (
    ...
    CONSTRAINT [PK_MyTable_00829] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00829_MyTable00829] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00829] ([ColKey]),
    CONSTRAINT [BK_MyTable_00829_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
