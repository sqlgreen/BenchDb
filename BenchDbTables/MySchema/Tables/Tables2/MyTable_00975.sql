CREATE TABLE [MySchema].[MyTable_00975] (
    ...
    CONSTRAINT [PK_MyTable_00975] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00975_MyTable00975] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00975] ([ColKey]),
    CONSTRAINT [BK_MyTable_00975_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
