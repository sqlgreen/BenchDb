CREATE TABLE [MySchema].[MyTable_00621] (
    ...
    CONSTRAINT [PK_MyTable_00621] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00621_MyTable00621] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00621] ([ColKey]),
    CONSTRAINT [BK_MyTable_00621_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
