CREATE TABLE [MySchema].[MyTable_00840] (
    ...
    CONSTRAINT [PK_MyTable_00840] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00840_MyTable00840] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00840] ([ColKey]),
    CONSTRAINT [BK_MyTable_00840_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
