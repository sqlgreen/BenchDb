CREATE TABLE [MySchema].[MyTable_00962] (
    ...
    CONSTRAINT [PK_MyTable_00962] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00962_MyTable00962] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00962] ([ColKey]),
    CONSTRAINT [BK_MyTable_00962_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
