CREATE TABLE [MySchema].[MyTable_00760] (
    ...
    CONSTRAINT [PK_MyTable_00760] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00760_MyTable00760] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00760] ([ColKey]),
    CONSTRAINT [BK_MyTable_00760_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
