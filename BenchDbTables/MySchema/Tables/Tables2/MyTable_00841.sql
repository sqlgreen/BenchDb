CREATE TABLE [MySchema].[MyTable_00841] (
    ...
    CONSTRAINT [PK_MyTable_00841] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00841_MyTable00841] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00841] ([ColKey]),
    CONSTRAINT [BK_MyTable_00841_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
