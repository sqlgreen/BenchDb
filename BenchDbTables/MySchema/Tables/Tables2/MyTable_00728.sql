CREATE TABLE [MySchema].[MyTable_00728] (
    ...
    CONSTRAINT [PK_MyTable_00728] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00728_MyTable00728] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00728] ([ColKey]),
    CONSTRAINT [BK_MyTable_00728_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
