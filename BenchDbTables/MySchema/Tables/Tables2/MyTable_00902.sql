CREATE TABLE [MySchema].[MyTable_00902] (
    ...
    CONSTRAINT [PK_MyTable_00902] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00902_MyTable00902] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00902] ([ColKey]),
    CONSTRAINT [BK_MyTable_00902_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
