CREATE TABLE [MySchema].[MyTable_00709] (
    ...
    CONSTRAINT [PK_MyTable_00709] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00709_MyTable00709] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00709] ([ColKey]),
    CONSTRAINT [BK_MyTable_00709_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
