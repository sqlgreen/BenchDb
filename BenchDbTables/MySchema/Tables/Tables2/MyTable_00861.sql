CREATE TABLE [MySchema].[MyTable_00861] (
    ...
    CONSTRAINT [PK_MyTable_00861] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00861_MyTable00861] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00861] ([ColKey]),
    CONSTRAINT [BK_MyTable_00861_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
