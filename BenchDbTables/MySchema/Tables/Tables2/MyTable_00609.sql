CREATE TABLE [MySchema].[MyTable_00609] (
    ...
    CONSTRAINT [PK_MyTable_00609] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00609_MyTable00609] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00609] ([ColKey]),
    CONSTRAINT [BK_MyTable_00609_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
