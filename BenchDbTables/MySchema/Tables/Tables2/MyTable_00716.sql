CREATE TABLE [MySchema].[MyTable_00716] (
    ...
    CONSTRAINT [PK_MyTable_00716] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00716_MyTable00716] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00716] ([ColKey]),
    CONSTRAINT [BK_MyTable_00716_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
