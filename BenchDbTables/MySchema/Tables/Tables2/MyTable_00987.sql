CREATE TABLE [MySchema].[MyTable_00987] (
    ...
    CONSTRAINT [PK_MyTable_00987] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00987_MyTable00987] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00987] ([ColKey]),
    CONSTRAINT [BK_MyTable_00987_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
