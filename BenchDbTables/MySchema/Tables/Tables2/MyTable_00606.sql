CREATE TABLE [MySchema].[MyTable_00606] (
    ...
    CONSTRAINT [PK_MyTable_00606] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00606_MyTable00606] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00606] ([ColKey]),
    CONSTRAINT [BK_MyTable_00606_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
