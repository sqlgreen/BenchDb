CREATE TABLE [MySchema].[MyTable_00942] (
    ...
    CONSTRAINT [PK_MyTable_00942] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00942_MyTable00942] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00942] ([ColKey]),
    CONSTRAINT [BK_MyTable_00942_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
