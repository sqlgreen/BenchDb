CREATE TABLE [MySchema].[MyTable_00758] (
    ...
    CONSTRAINT [PK_MyTable_00758] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00758_MyTable00758] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00758] ([ColKey]),
    CONSTRAINT [BK_MyTable_00758_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
