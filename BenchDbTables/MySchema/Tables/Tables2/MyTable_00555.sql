CREATE TABLE [MySchema].[MyTable_00555] (
    ...
    CONSTRAINT [PK_MyTable_00555] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00555_MyTable00555] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00555] ([ColKey]),
    CONSTRAINT [BK_MyTable_00555_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
