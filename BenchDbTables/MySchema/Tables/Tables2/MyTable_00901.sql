CREATE TABLE [MySchema].[MyTable_00901] (
    ...
    CONSTRAINT [PK_MyTable_00901] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00901_MyTable00901] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00901] ([ColKey]),
    CONSTRAINT [BK_MyTable_00901_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
