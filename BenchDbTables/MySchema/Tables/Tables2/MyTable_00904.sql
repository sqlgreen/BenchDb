CREATE TABLE [MySchema].[MyTable_00904] (
    ...
    CONSTRAINT [PK_MyTable_00904] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00904_MyTable00904] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00904] ([ColKey]),
    CONSTRAINT [BK_MyTable_00904_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
