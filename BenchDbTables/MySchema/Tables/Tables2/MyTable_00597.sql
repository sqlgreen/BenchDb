CREATE TABLE [MySchema].[MyTable_00597] (
    ...
    CONSTRAINT [PK_MyTable_00597] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00597_MyTable00597] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00597] ([ColKey]),
    CONSTRAINT [BK_MyTable_00597_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
