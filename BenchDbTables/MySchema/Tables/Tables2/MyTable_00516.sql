CREATE TABLE [MySchema].[MyTable_00516] (
    ...
    CONSTRAINT [PK_MyTable_00516] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00516_MyTable00516] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00516] ([ColKey]),
    CONSTRAINT [BK_MyTable_00516_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
