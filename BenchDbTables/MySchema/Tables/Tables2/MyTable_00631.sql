CREATE TABLE [MySchema].[MyTable_00631] (
    ...
    CONSTRAINT [PK_MyTable_00631] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00631_MyTable00631] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00631] ([ColKey]),
    CONSTRAINT [BK_MyTable_00631_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
