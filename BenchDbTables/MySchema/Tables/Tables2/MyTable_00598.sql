CREATE TABLE [MySchema].[MyTable_00598] (
    ...
    CONSTRAINT [PK_MyTable_00598] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00598_MyTable00598] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00598] ([ColKey]),
    CONSTRAINT [BK_MyTable_00598_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
