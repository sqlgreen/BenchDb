CREATE TABLE [MySchema].[MyTable_00816] (
    ...
    CONSTRAINT [PK_MyTable_00816] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00816_MyTable00816] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00816] ([ColKey]),
    CONSTRAINT [BK_MyTable_00816_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
