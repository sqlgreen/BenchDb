CREATE TABLE [MySchema].[MyTable_00934] (
    ...
    CONSTRAINT [PK_MyTable_00934] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00934_MyTable00934] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00934] ([ColKey]),
    CONSTRAINT [BK_MyTable_00934_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
