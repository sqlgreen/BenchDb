CREATE TABLE [MySchema].[MyTable_00534] (
    ...
    CONSTRAINT [PK_MyTable_00534] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00534_MyTable00534] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00534] ([ColKey]),
    CONSTRAINT [BK_MyTable_00534_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
