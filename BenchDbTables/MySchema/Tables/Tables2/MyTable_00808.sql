CREATE TABLE [MySchema].[MyTable_00808] (
    ...
    CONSTRAINT [PK_MyTable_00808] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00808_MyTable00808] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00808] ([ColKey]),
    CONSTRAINT [BK_MyTable_00808_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
