CREATE TABLE [MySchema].[MyTable_00817] (
    ...
    CONSTRAINT [PK_MyTable_00817] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00817_MyTable00817] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00817] ([ColKey]),
    CONSTRAINT [BK_MyTable_00817_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
