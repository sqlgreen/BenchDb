CREATE TABLE [MySchema].[MyTable_00858] (
    ...
    CONSTRAINT [PK_MyTable_00858] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00858_MyTable00858] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00858] ([ColKey]),
    CONSTRAINT [BK_MyTable_00858_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
