CREATE TABLE [MySchema].[MyTable_00719] (
    ...
    CONSTRAINT [PK_MyTable_00719] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00719_MyTable00719] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00719] ([ColKey]),
    CONSTRAINT [BK_MyTable_00719_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
