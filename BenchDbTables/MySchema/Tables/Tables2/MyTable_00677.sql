CREATE TABLE [MySchema].[MyTable_00677] (
    ...
    CONSTRAINT [PK_MyTable_00677] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00677_MyTable00677] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00677] ([ColKey]),
    CONSTRAINT [BK_MyTable_00677_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
