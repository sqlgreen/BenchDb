CREATE TABLE [MySchema].[MyTable_00899] (
    ...
    CONSTRAINT [PK_MyTable_00899] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00899_MyTable00899] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00899] ([ColKey]),
    CONSTRAINT [BK_MyTable_00899_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
