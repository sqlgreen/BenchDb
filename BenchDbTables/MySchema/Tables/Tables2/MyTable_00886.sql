CREATE TABLE [MySchema].[MyTable_00886] (
    ...
    CONSTRAINT [PK_MyTable_00886] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00886_MyTable00886] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00886] ([ColKey]),
    CONSTRAINT [BK_MyTable_00886_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
