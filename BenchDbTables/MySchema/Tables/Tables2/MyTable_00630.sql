CREATE TABLE [MySchema].[MyTable_00630] (
    ...
    CONSTRAINT [PK_MyTable_00630] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00630_MyTable00630] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00630] ([ColKey]),
    CONSTRAINT [BK_MyTable_00630_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
