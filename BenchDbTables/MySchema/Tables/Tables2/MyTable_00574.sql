CREATE TABLE [MySchema].[MyTable_00574] (
    ...
    CONSTRAINT [PK_MyTable_00574] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00574_MyTable00574] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00574] ([ColKey]),
    CONSTRAINT [BK_MyTable_00574_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
