CREATE TABLE [MySchema].[MyTable_00703] (
    ...
    CONSTRAINT [PK_MyTable_00703] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00703_MyTable00703] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00703] ([ColKey]),
    CONSTRAINT [BK_MyTable_00703_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
