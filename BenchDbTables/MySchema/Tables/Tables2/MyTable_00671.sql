CREATE TABLE [MySchema].[MyTable_00671] (
    ...
    CONSTRAINT [PK_MyTable_00671] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00671_MyTable00671] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00671] ([ColKey]),
    CONSTRAINT [BK_MyTable_00671_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
