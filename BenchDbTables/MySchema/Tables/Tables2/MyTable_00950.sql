CREATE TABLE [MySchema].[MyTable_00950] (
    ...
    CONSTRAINT [PK_MyTable_00950] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00950_MyTable00950] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00950] ([ColKey]),
    CONSTRAINT [BK_MyTable_00950_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
