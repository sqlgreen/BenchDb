CREATE TABLE [MySchema].[MyTable_00935] (
    ...
    CONSTRAINT [PK_MyTable_00935] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00935_MyTable00935] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00935] ([ColKey]),
    CONSTRAINT [BK_MyTable_00935_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
