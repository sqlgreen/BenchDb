CREATE TABLE [MySchema].[MyTable_00837] (
    ...
    CONSTRAINT [PK_MyTable_00837] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00837_MyTable00837] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00837] ([ColKey]),
    CONSTRAINT [BK_MyTable_00837_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
