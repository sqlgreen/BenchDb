CREATE TABLE [MySchema].[MyTable_00767] (
    ...
    CONSTRAINT [PK_MyTable_00767] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00767_MyTable00767] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00767] ([ColKey]),
    CONSTRAINT [BK_MyTable_00767_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
