CREATE TABLE [MySchema].[MyTable_00571] (
    ...
    CONSTRAINT [PK_MyTable_00571] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00571_MyTable00571] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00571] ([ColKey]),
    CONSTRAINT [BK_MyTable_00571_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
