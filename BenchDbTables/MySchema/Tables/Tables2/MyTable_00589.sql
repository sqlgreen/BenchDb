CREATE TABLE [MySchema].[MyTable_00589] (
    ...
    CONSTRAINT [PK_MyTable_00589] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00589_MyTable00589] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00589] ([ColKey]),
    CONSTRAINT [BK_MyTable_00589_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
