CREATE TABLE [MySchema].[MyTable_00925] (
    ...
    CONSTRAINT [PK_MyTable_00925] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00925_MyTable00925] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00925] ([ColKey]),
    CONSTRAINT [BK_MyTable_00925_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
