CREATE TABLE [MySchema].[MyTable_00910] (
    ...
    CONSTRAINT [PK_MyTable_00910] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00910_MyTable00910] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00910] ([ColKey]),
    CONSTRAINT [BK_MyTable_00910_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
