CREATE TABLE [MySchema].[MyTable_00543] (
    ...
    CONSTRAINT [PK_MyTable_00543] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00543_MyTable00543] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00543] ([ColKey]),
    CONSTRAINT [BK_MyTable_00543_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
