CREATE TABLE [MySchema].[MyTable_00768] (
    ...
    CONSTRAINT [PK_MyTable_00768] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00768_MyTable00768] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00768] ([ColKey]),
    CONSTRAINT [BK_MyTable_00768_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
