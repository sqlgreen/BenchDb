CREATE TABLE [MySchema].[MyTable_00782] (
    ...
    CONSTRAINT [PK_MyTable_00782] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00782_MyTable00782] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00782] ([ColKey]),
    CONSTRAINT [BK_MyTable_00782_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
