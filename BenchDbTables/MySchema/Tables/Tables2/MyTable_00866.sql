CREATE TABLE [MySchema].[MyTable_00866] (
    ...
    CONSTRAINT [PK_MyTable_00866] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00866_MyTable00866] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00866] ([ColKey]),
    CONSTRAINT [BK_MyTable_00866_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
