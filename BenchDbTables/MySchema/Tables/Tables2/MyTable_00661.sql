CREATE TABLE [MySchema].[MyTable_00661] (
    ...
    CONSTRAINT [PK_MyTable_00661] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00661_MyTable00661] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00661] ([ColKey]),
    CONSTRAINT [BK_MyTable_00661_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
