CREATE TABLE [MySchema].[MyTable_00877] (
    ...
    CONSTRAINT [PK_MyTable_00877] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00877_MyTable00877] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00877] ([ColKey]),
    CONSTRAINT [BK_MyTable_00877_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
