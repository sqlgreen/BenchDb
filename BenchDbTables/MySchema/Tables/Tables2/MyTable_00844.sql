CREATE TABLE [MySchema].[MyTable_00844] (
    ...
    CONSTRAINT [PK_MyTable_00844] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00844_MyTable00844] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00844] ([ColKey]),
    CONSTRAINT [BK_MyTable_00844_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
