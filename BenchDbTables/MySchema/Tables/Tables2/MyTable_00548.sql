CREATE TABLE [MySchema].[MyTable_00548] (
    ...
    CONSTRAINT [PK_MyTable_00548] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00548_MyTable00548] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00548] ([ColKey]),
    CONSTRAINT [BK_MyTable_00548_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
