CREATE TABLE [MySchema].[MyTable_00847] (
    ...
    CONSTRAINT [PK_MyTable_00847] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00847_MyTable00847] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00847] ([ColKey]),
    CONSTRAINT [BK_MyTable_00847_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
