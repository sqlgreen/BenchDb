CREATE TABLE [MySchema].[MyTable_00762] (
    ...
    CONSTRAINT [PK_MyTable_00762] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00762_MyTable00762] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00762] ([ColKey]),
    CONSTRAINT [BK_MyTable_00762_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
