CREATE TABLE [MySchema].[MyTable_00577] (
    ...
    CONSTRAINT [PK_MyTable_00577] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00577_MyTable00577] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00577] ([ColKey]),
    CONSTRAINT [BK_MyTable_00577_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
