CREATE TABLE [MySchema].[MyTable_00737] (
    ...
    CONSTRAINT [PK_MyTable_00737] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00737_MyTable00737] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00737] ([ColKey]),
    CONSTRAINT [BK_MyTable_00737_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
