CREATE TABLE [MySchema].[MyTable_00509] (
    ...
    CONSTRAINT [PK_MyTable_00509] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00509_MyTable00509] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00509] ([ColKey]),
    CONSTRAINT [BK_MyTable_00509_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
