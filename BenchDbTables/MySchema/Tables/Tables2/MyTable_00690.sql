CREATE TABLE [MySchema].[MyTable_00690] (
    ...
    CONSTRAINT [PK_MyTable_00690] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00690_MyTable00690] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00690] ([ColKey]),
    CONSTRAINT [BK_MyTable_00690_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
