CREATE TABLE [MySchema].[MyTable_00937] (
    ...
    CONSTRAINT [PK_MyTable_00937] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00937_MyTable00937] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00937] ([ColKey]),
    CONSTRAINT [BK_MyTable_00937_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
