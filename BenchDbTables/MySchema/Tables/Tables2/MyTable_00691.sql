CREATE TABLE [MySchema].[MyTable_00691] (
    ...
    CONSTRAINT [PK_MyTable_00691] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00691_MyTable00691] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00691] ([ColKey]),
    CONSTRAINT [BK_MyTable_00691_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
