CREATE TABLE [MySchema].[MyTable_00536] (
    ...
    CONSTRAINT [PK_MyTable_00536] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00536_MyTable00536] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00536] ([ColKey]),
    CONSTRAINT [BK_MyTable_00536_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
