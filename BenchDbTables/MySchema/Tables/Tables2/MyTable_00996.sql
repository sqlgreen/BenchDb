CREATE TABLE [MySchema].[MyTable_00996] (
    ...
    CONSTRAINT [PK_MyTable_00996] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00996_MyTable00996] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00996] ([ColKey]),
    CONSTRAINT [BK_MyTable_00996_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
