CREATE TABLE [MySchema].[MyTable_00688] (
    ...
    CONSTRAINT [PK_MyTable_00688] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00688_MyTable00688] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00688] ([ColKey]),
    CONSTRAINT [BK_MyTable_00688_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
