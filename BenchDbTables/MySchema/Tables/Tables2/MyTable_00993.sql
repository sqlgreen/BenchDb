CREATE TABLE [MySchema].[MyTable_00993] (
    ...
    CONSTRAINT [PK_MyTable_00993] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00993_MyTable00993] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00993] ([ColKey]),
    CONSTRAINT [BK_MyTable_00993_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
