CREATE TABLE [MySchema].[MyTable_00581] (
    ...
    CONSTRAINT [PK_MyTable_00581] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00581_MyTable00581] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00581] ([ColKey]),
    CONSTRAINT [BK_MyTable_00581_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
