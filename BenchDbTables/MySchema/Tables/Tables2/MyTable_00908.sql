CREATE TABLE [MySchema].[MyTable_00908] (
    ...
    CONSTRAINT [PK_MyTable_00908] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00908_MyTable00908] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00908] ([ColKey]),
    CONSTRAINT [BK_MyTable_00908_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
