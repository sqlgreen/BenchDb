CREATE TABLE [MySchema].[MyTable_00875] (
    ...
    CONSTRAINT [PK_MyTable_00875] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00875_MyTable00875] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00875] ([ColKey]),
    CONSTRAINT [BK_MyTable_00875_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
