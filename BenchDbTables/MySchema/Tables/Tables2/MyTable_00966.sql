CREATE TABLE [MySchema].[MyTable_00966] (
    ...
    CONSTRAINT [PK_MyTable_00966] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00966_MyTable00966] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00966] ([ColKey]),
    CONSTRAINT [BK_MyTable_00966_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
