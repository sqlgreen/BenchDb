CREATE TABLE [MySchema].[MyTable_00957] (
    ...
    CONSTRAINT [PK_MyTable_00957] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00957_MyTable00957] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00957] ([ColKey]),
    CONSTRAINT [BK_MyTable_00957_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
