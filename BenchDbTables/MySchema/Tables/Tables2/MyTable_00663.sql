CREATE TABLE [MySchema].[MyTable_00663] (
    ...
    CONSTRAINT [PK_MyTable_00663] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00663_MyTable00663] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00663] ([ColKey]),
    CONSTRAINT [BK_MyTable_00663_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
