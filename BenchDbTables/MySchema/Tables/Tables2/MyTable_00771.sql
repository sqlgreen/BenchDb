CREATE TABLE [MySchema].[MyTable_00771] (
    ...
    CONSTRAINT [PK_MyTable_00771] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00771_MyTable00771] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00771] ([ColKey]),
    CONSTRAINT [BK_MyTable_00771_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
