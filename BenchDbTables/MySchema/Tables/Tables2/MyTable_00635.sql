CREATE TABLE [MySchema].[MyTable_00635] (
    ...
    CONSTRAINT [PK_MyTable_00635] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00635_MyTable00635] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00635] ([ColKey]),
    CONSTRAINT [BK_MyTable_00635_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
