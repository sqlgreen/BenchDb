CREATE TABLE [MySchema].[MyTable_00693] (
    ...
    CONSTRAINT [PK_MyTable_00693] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00693_MyTable00693] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00693] ([ColKey]),
    CONSTRAINT [BK_MyTable_00693_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
