CREATE TABLE [MySchema].[MyTable_00864] (
    ...
    CONSTRAINT [PK_MyTable_00864] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00864_MyTable00864] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00864] ([ColKey]),
    CONSTRAINT [BK_MyTable_00864_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
