CREATE TABLE [MySchema].[MyTable_00862] (
    ...
    CONSTRAINT [PK_MyTable_00862] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00862_MyTable00862] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00862] ([ColKey]),
    CONSTRAINT [BK_MyTable_00862_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
