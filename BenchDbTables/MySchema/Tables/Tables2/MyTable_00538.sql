CREATE TABLE [MySchema].[MyTable_00538] (
    ...
    CONSTRAINT [PK_MyTable_00538] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00538_MyTable00538] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00538] ([ColKey]),
    CONSTRAINT [BK_MyTable_00538_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
