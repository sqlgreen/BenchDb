CREATE TABLE [MySchema].[MyTable_00778] (
    ...
    CONSTRAINT [PK_MyTable_00778] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00778_MyTable00778] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00778] ([ColKey]),
    CONSTRAINT [BK_MyTable_00778_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
