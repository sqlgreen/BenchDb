CREATE TABLE [MySchema].[MyTable_00689] (
    ...
    CONSTRAINT [PK_MyTable_00689] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00689_MyTable00689] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00689] ([ColKey]),
    CONSTRAINT [BK_MyTable_00689_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
