CREATE TABLE [MySchema].[MyTable_00542] (
    ...
    CONSTRAINT [PK_MyTable_00542] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00542_MyTable00542] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00542] ([ColKey]),
    CONSTRAINT [BK_MyTable_00542_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
