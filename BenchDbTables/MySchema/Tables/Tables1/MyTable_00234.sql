CREATE TABLE [MySchema].[MyTable_00234] (
    ...
    CONSTRAINT [PK_MyTable_00234] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00234_MyTable00234] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00234] ([ColKey]),
    CONSTRAINT [BK_MyTable_00234_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
