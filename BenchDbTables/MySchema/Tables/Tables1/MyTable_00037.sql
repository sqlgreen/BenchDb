CREATE TABLE [MySchema].[MyTable_00037] (
    ...
    CONSTRAINT [PK_MyTable_00037] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00037_MyTable00037] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00037] ([ColKey]),
    CONSTRAINT [BK_MyTable_00037_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
