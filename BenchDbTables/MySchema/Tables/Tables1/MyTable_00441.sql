CREATE TABLE [MySchema].[MyTable_00441] (
    ...
    CONSTRAINT [PK_MyTable_00441] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00441_MyTable00441] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00441] ([ColKey]),
    CONSTRAINT [BK_MyTable_00441_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
