CREATE TABLE [MySchema].[MyTable_00411] (
    ...
    CONSTRAINT [PK_MyTable_00411] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00411_MyTable00411] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00411] ([ColKey]),
    CONSTRAINT [BK_MyTable_00411_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
