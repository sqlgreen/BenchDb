CREATE TABLE [MySchema].[MyTable_00024] (
    ...
    CONSTRAINT [PK_MyTable_00024] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00024_MyTable00024] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00024] ([ColKey]),
    CONSTRAINT [BK_MyTable_00024_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
