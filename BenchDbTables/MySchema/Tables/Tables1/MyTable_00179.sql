CREATE TABLE [MySchema].[MyTable_00179] (
    ...
    CONSTRAINT [PK_MyTable_00179] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00179_MyTable00179] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00179] ([ColKey]),
    CONSTRAINT [BK_MyTable_00179_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
