CREATE TABLE [MySchema].[MyTable_00417] (
    ...
    CONSTRAINT [PK_MyTable_00417] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00417_MyTable00417] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00417] ([ColKey]),
    CONSTRAINT [BK_MyTable_00417_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
