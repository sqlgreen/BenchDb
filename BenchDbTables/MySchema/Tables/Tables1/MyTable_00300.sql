CREATE TABLE [MySchema].[MyTable_00300] (
    ...
    CONSTRAINT [PK_MyTable_00300] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00300_MyTable00300] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00300] ([ColKey]),
    CONSTRAINT [BK_MyTable_00300_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
