CREATE TABLE [MySchema].[MyTable_00296] (
    ...
    CONSTRAINT [PK_MyTable_00296] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00296_MyTable00296] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00296] ([ColKey]),
    CONSTRAINT [BK_MyTable_00296_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
