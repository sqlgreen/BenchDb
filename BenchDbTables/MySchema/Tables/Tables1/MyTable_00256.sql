CREATE TABLE [MySchema].[MyTable_00256] (
    ...
    CONSTRAINT [PK_MyTable_00256] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00256_MyTable00256] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00256] ([ColKey]),
    CONSTRAINT [BK_MyTable_00256_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
