CREATE TABLE [MySchema].[MyTable_00401] (
    ...
    CONSTRAINT [PK_MyTable_00401] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00401_MyTable00401] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00401] ([ColKey]),
    CONSTRAINT [BK_MyTable_00401_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
