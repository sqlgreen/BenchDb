CREATE TABLE [MySchema].[MyTable_00359] (
    ...
    CONSTRAINT [PK_MyTable_00359] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00359_MyTable00359] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00359] ([ColKey]),
    CONSTRAINT [BK_MyTable_00359_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
