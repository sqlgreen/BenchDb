CREATE TABLE [MySchema].[MyTable_00249] (
    ...
    CONSTRAINT [PK_MyTable_00249] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00249_MyTable00249] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00249] ([ColKey]),
    CONSTRAINT [BK_MyTable_00249_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
