CREATE TABLE [MySchema].[MyTable_00267] (
    ...
    CONSTRAINT [PK_MyTable_00267] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00267_MyTable00267] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00267] ([ColKey]),
    CONSTRAINT [BK_MyTable_00267_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
