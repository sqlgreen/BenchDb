CREATE TABLE [MySchema].[MyTable_00433] (
    ...
    CONSTRAINT [PK_MyTable_00433] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00433_MyTable00433] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00433] ([ColKey]),
    CONSTRAINT [BK_MyTable_00433_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
