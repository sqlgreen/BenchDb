CREATE TABLE [MySchema].[MyTable_00423] (
    ...
    CONSTRAINT [PK_MyTable_00423] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00423_MyTable00423] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00423] ([ColKey]),
    CONSTRAINT [BK_MyTable_00423_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
