CREATE TABLE [MySchema].[MyTable_00448] (
    ...
    CONSTRAINT [PK_MyTable_00448] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00448_MyTable00448] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00448] ([ColKey]),
    CONSTRAINT [BK_MyTable_00448_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
