CREATE TABLE [MySchema].[MyTable_00066] (
    ...
    CONSTRAINT [PK_MyTable_00066] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00066_MyTable00066] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00066] ([ColKey]),
    CONSTRAINT [BK_MyTable_00066_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
