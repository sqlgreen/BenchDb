CREATE TABLE [MySchema].[MyTable_00373] (
    ...
    CONSTRAINT [PK_MyTable_00373] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00373_MyTable00373] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00373] ([ColKey]),
    CONSTRAINT [BK_MyTable_00373_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
