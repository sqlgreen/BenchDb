CREATE TABLE [MySchema].[MyTable_00164] (
    ...
    CONSTRAINT [PK_MyTable_00164] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00164_MyTable00164] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00164] ([ColKey]),
    CONSTRAINT [BK_MyTable_00164_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
