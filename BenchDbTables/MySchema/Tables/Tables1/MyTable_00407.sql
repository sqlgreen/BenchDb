CREATE TABLE [MySchema].[MyTable_00407] (
    ...
    CONSTRAINT [PK_MyTable_00407] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00407_MyTable00407] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00407] ([ColKey]),
    CONSTRAINT [BK_MyTable_00407_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
