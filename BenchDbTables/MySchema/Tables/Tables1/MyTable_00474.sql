CREATE TABLE [MySchema].[MyTable_00474] (
    ...
    CONSTRAINT [PK_MyTable_00474] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00474_MyTable00474] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00474] ([ColKey]),
    CONSTRAINT [BK_MyTable_00474_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
