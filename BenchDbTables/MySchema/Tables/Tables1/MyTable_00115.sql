CREATE TABLE [MySchema].[MyTable_00115] (
    ...
    CONSTRAINT [PK_MyTable_00115] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00115_MyTable00115] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00115] ([ColKey]),
    CONSTRAINT [BK_MyTable_00115_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
