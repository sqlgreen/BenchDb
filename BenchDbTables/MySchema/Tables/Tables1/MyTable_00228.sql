CREATE TABLE [MySchema].[MyTable_00228] (
    ...
    CONSTRAINT [PK_MyTable_00228] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00228_MyTable00228] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00228] ([ColKey]),
    CONSTRAINT [BK_MyTable_00228_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
