CREATE TABLE [MySchema].[MyTable_00285] (
    ...
    CONSTRAINT [PK_MyTable_00285] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00285_MyTable00285] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00285] ([ColKey]),
    CONSTRAINT [BK_MyTable_00285_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
