CREATE TABLE [MySchema].[MyTable_00206] (
    ...
    CONSTRAINT [PK_MyTable_00206] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00206_MyTable00206] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00206] ([ColKey]),
    CONSTRAINT [BK_MyTable_00206_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
