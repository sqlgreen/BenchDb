CREATE TABLE [MySchema].[MyTable_00420] (
    ...
    CONSTRAINT [PK_MyTable_00420] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00420_MyTable00420] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00420] ([ColKey]),
    CONSTRAINT [BK_MyTable_00420_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
