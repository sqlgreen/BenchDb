CREATE TABLE [MySchema].[MyTable_00308] (
    ...
    CONSTRAINT [PK_MyTable_00308] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00308_MyTable00308] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00308] ([ColKey]),
    CONSTRAINT [BK_MyTable_00308_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
