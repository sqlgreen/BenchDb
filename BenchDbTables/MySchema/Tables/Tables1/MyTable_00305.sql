CREATE TABLE [MySchema].[MyTable_00305] (
    ...
    CONSTRAINT [PK_MyTable_00305] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00305_MyTable00305] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00305] ([ColKey]),
    CONSTRAINT [BK_MyTable_00305_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
