CREATE TABLE [MySchema].[MyTable_00158] (
    ...
    CONSTRAINT [PK_MyTable_00158] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00158_MyTable00158] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00158] ([ColKey]),
    CONSTRAINT [BK_MyTable_00158_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
