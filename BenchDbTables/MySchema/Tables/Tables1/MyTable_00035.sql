CREATE TABLE [MySchema].[MyTable_00035] (
    ...
    CONSTRAINT [PK_MyTable_00035] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00035_MyTable00035] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00035] ([ColKey]),
    CONSTRAINT [BK_MyTable_00035_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
