CREATE TABLE [MySchema].[MyTable_00318] (
    ...
    CONSTRAINT [PK_MyTable_00318] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00318_MyTable00318] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00318] ([ColKey]),
    CONSTRAINT [BK_MyTable_00318_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
