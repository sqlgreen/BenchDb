CREATE TABLE [MySchema].[MyTable_00197] (
    ...
    CONSTRAINT [PK_MyTable_00197] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00197_MyTable00197] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00197] ([ColKey]),
    CONSTRAINT [BK_MyTable_00197_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
