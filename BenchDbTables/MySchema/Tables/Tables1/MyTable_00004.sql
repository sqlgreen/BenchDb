CREATE TABLE [MySchema].[MyTable_00004] (
    ...
    CONSTRAINT [PK_MyTable_00004] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00004_MyTable00004] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00004] ([ColKey]),
    CONSTRAINT [BK_MyTable_00004_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
