CREATE TABLE [MySchema].[MyTable_00281] (
    ...
    CONSTRAINT [PK_MyTable_00281] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00281_MyTable00281] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00281] ([ColKey]),
    CONSTRAINT [BK_MyTable_00281_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
