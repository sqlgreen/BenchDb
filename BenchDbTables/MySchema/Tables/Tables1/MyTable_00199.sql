CREATE TABLE [MySchema].[MyTable_00199] (
    ...
    CONSTRAINT [PK_MyTable_00199] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00199_MyTable00199] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00199] ([ColKey]),
    CONSTRAINT [BK_MyTable_00199_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
