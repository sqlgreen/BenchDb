CREATE TABLE [MySchema].[MyTable_00406] (
    ...
    CONSTRAINT [PK_MyTable_00406] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00406_MyTable00406] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00406] ([ColKey]),
    CONSTRAINT [BK_MyTable_00406_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
