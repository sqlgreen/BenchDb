CREATE TABLE [MySchema].[MyTable_00117] (
    ...
    CONSTRAINT [PK_MyTable_00117] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00117_MyTable00117] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00117] ([ColKey]),
    CONSTRAINT [BK_MyTable_00117_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
