CREATE TABLE [MySchema].[MyTable_00357] (
    ...
    CONSTRAINT [PK_MyTable_00357] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00357_MyTable00357] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00357] ([ColKey]),
    CONSTRAINT [BK_MyTable_00357_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
