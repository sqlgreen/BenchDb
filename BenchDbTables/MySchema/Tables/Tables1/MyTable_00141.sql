CREATE TABLE [MySchema].[MyTable_00141] (
    ...
    CONSTRAINT [PK_MyTable_00141] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00141_MyTable00141] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00141] ([ColKey]),
    CONSTRAINT [BK_MyTable_00141_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
