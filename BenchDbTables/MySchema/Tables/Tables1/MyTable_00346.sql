CREATE TABLE [MySchema].[MyTable_00346] (
    ...
    CONSTRAINT [PK_MyTable_00346] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00346_MyTable00346] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00346] ([ColKey]),
    CONSTRAINT [BK_MyTable_00346_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
