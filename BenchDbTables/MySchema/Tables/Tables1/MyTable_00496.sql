CREATE TABLE [MySchema].[MyTable_00496] (
    ...
    CONSTRAINT [PK_MyTable_00496] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00496_MyTable00496] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00496] ([ColKey]),
    CONSTRAINT [BK_MyTable_00496_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
