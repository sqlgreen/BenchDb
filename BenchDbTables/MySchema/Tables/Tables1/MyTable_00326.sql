CREATE TABLE [MySchema].[MyTable_00326] (
    ...
    CONSTRAINT [PK_MyTable_00326] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00326_MyTable00326] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00326] ([ColKey]),
    CONSTRAINT [BK_MyTable_00326_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
