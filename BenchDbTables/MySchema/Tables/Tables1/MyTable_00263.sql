CREATE TABLE [MySchema].[MyTable_00263] (
    ...
    CONSTRAINT [PK_MyTable_00263] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00263_MyTable00263] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00263] ([ColKey]),
    CONSTRAINT [BK_MyTable_00263_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
