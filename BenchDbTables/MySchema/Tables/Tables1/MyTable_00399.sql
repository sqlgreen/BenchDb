CREATE TABLE [MySchema].[MyTable_00399] (
    ...
    CONSTRAINT [PK_MyTable_00399] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00399_MyTable00399] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00399] ([ColKey]),
    CONSTRAINT [BK_MyTable_00399_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
