CREATE TABLE [MySchema].[MyTable_00328] (
    ...
    CONSTRAINT [PK_MyTable_00328] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00328_MyTable00328] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00328] ([ColKey]),
    CONSTRAINT [BK_MyTable_00328_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
