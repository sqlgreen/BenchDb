CREATE TABLE [MySchema].[MyTable_00494] (
    ...
    CONSTRAINT [PK_MyTable_00494] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00494_MyTable00494] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00494] ([ColKey]),
    CONSTRAINT [BK_MyTable_00494_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
