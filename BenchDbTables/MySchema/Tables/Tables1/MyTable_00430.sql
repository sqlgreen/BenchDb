CREATE TABLE [MySchema].[MyTable_00430] (
    ...
    CONSTRAINT [PK_MyTable_00430] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00430_MyTable00430] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00430] ([ColKey]),
    CONSTRAINT [BK_MyTable_00430_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
