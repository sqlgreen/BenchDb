CREATE TABLE [MySchema].[MyTable_00435] (
    ...
    CONSTRAINT [PK_MyTable_00435] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00435_MyTable00435] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00435] ([ColKey]),
    CONSTRAINT [BK_MyTable_00435_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
