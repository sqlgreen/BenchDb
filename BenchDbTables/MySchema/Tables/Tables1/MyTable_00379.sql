CREATE TABLE [MySchema].[MyTable_00379] (
    ...
    CONSTRAINT [PK_MyTable_00379] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00379_MyTable00379] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00379] ([ColKey]),
    CONSTRAINT [BK_MyTable_00379_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
