CREATE TABLE [MySchema].[MyTable_00365] (
    ...
    CONSTRAINT [PK_MyTable_00365] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00365_MyTable00365] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00365] ([ColKey]),
    CONSTRAINT [BK_MyTable_00365_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
