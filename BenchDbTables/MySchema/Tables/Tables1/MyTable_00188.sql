CREATE TABLE [MySchema].[MyTable_00188] (
    ...
    CONSTRAINT [PK_MyTable_00188] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00188_MyTable00188] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00188] ([ColKey]),
    CONSTRAINT [BK_MyTable_00188_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
