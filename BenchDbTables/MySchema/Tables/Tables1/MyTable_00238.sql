CREATE TABLE [MySchema].[MyTable_00238] (
    ...
    CONSTRAINT [PK_MyTable_00238] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00238_MyTable00238] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00238] ([ColKey]),
    CONSTRAINT [BK_MyTable_00238_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
