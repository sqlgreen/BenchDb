CREATE TABLE [MySchema].[MyTable_00428] (
    ...
    CONSTRAINT [PK_MyTable_00428] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00428_MyTable00428] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00428] ([ColKey]),
    CONSTRAINT [BK_MyTable_00428_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
