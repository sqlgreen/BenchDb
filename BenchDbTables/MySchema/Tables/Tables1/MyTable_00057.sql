CREATE TABLE [MySchema].[MyTable_00057] (
    ...
    CONSTRAINT [PK_MyTable_00057] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00057_MyTable00057] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00057] ([ColKey]),
    CONSTRAINT [BK_MyTable_00057_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
