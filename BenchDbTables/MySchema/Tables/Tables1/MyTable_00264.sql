CREATE TABLE [MySchema].[MyTable_00264] (
    ...
    CONSTRAINT [PK_MyTable_00264] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00264_MyTable00264] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00264] ([ColKey]),
    CONSTRAINT [BK_MyTable_00264_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
