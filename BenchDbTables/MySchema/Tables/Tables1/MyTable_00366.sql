CREATE TABLE [MySchema].[MyTable_00366] (
    ...
    CONSTRAINT [PK_MyTable_00366] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00366_MyTable00366] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00366] ([ColKey]),
    CONSTRAINT [BK_MyTable_00366_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
