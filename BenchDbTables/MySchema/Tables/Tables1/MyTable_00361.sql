CREATE TABLE [MySchema].[MyTable_00361] (
    ...
    CONSTRAINT [PK_MyTable_00361] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00361_MyTable00361] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00361] ([ColKey]),
    CONSTRAINT [BK_MyTable_00361_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
