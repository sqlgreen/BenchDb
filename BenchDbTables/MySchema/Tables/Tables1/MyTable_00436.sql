CREATE TABLE [MySchema].[MyTable_00436] (
    ...
    CONSTRAINT [PK_MyTable_00436] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00436_MyTable00436] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00436] ([ColKey]),
    CONSTRAINT [BK_MyTable_00436_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
