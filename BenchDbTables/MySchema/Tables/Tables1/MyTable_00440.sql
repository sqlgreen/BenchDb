CREATE TABLE [MySchema].[MyTable_00440] (
    ...
    CONSTRAINT [PK_MyTable_00440] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00440_MyTable00440] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00440] ([ColKey]),
    CONSTRAINT [BK_MyTable_00440_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
