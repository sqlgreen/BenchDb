CREATE TABLE [MySchema].[MyTable_00487] (
    ...
    CONSTRAINT [PK_MyTable_00487] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00487_MyTable00487] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00487] ([ColKey]),
    CONSTRAINT [BK_MyTable_00487_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
