CREATE TABLE [MySchema].[MyTable_00299] (
    ...
    CONSTRAINT [PK_MyTable_00299] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00299_MyTable00299] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00299] ([ColKey]),
    CONSTRAINT [BK_MyTable_00299_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
