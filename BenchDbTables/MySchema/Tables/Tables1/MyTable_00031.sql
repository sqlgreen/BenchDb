CREATE TABLE [MySchema].[MyTable_00031] (
    ...
    CONSTRAINT [PK_MyTable_00031] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00031_MyTable00031] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00031] ([ColKey]),
    CONSTRAINT [BK_MyTable_00031_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
