CREATE TABLE [MySchema].[MyTable_00027] (
    ...
    CONSTRAINT [PK_MyTable_00027] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00027_MyTable00027] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00027] ([ColKey]),
    CONSTRAINT [BK_MyTable_00027_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
