CREATE TABLE [MySchema].[MyTable_00331] (
    ...
    CONSTRAINT [PK_MyTable_00331] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00331_MyTable00331] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00331] ([ColKey]),
    CONSTRAINT [BK_MyTable_00331_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
