CREATE TABLE [MySchema].[MyTable_00443] (
    ...
    CONSTRAINT [PK_MyTable_00443] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00443_MyTable00443] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00443] ([ColKey]),
    CONSTRAINT [BK_MyTable_00443_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
