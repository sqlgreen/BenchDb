CREATE TABLE [MySchema].[MyTable_00260] (
    ...
    CONSTRAINT [PK_MyTable_00260] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00260_MyTable00260] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00260] ([ColKey]),
    CONSTRAINT [BK_MyTable_00260_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
