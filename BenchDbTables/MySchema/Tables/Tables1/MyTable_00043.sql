CREATE TABLE [MySchema].[MyTable_00043] (
    ...
    CONSTRAINT [PK_MyTable_00043] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00043_MyTable00043] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00043] ([ColKey]),
    CONSTRAINT [BK_MyTable_00043_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
