CREATE TABLE [MySchema].[MyTable_00368] (
    ...
    CONSTRAINT [PK_MyTable_00368] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00368_MyTable00368] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00368] ([ColKey]),
    CONSTRAINT [BK_MyTable_00368_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
