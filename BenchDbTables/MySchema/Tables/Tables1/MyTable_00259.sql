CREATE TABLE [MySchema].[MyTable_00259] (
    ...
    CONSTRAINT [PK_MyTable_00259] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00259_MyTable00259] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00259] ([ColKey]),
    CONSTRAINT [BK_MyTable_00259_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
