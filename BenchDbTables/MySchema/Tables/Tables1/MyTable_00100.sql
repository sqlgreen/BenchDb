CREATE TABLE [MySchema].[MyTable_00100] (
    ...
    CONSTRAINT [PK_MyTable_00100] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00100_MyTable00100] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00100] ([ColKey]),
    CONSTRAINT [BK_MyTable_00100_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
