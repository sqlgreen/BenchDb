CREATE TABLE [MySchema].[MyTable_00113] (
    ...
    CONSTRAINT [PK_MyTable_00113] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00113_MyTable00113] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00113] ([ColKey]),
    CONSTRAINT [BK_MyTable_00113_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
