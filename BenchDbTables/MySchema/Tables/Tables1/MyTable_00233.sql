CREATE TABLE [MySchema].[MyTable_00233] (
    ...
    CONSTRAINT [PK_MyTable_00233] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00233_MyTable00233] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00233] ([ColKey]),
    CONSTRAINT [BK_MyTable_00233_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
