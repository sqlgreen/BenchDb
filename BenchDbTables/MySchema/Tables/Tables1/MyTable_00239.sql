CREATE TABLE [MySchema].[MyTable_00239] (
    ...
    CONSTRAINT [PK_MyTable_00239] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00239_MyTable00239] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00239] ([ColKey]),
    CONSTRAINT [BK_MyTable_00239_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
