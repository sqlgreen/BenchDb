CREATE TABLE [MySchema].[MyTable_00009] (
    ...
    CONSTRAINT [PK_MyTable_00009] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00009_MyTable00009] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00009] ([ColKey]),
    CONSTRAINT [BK_MyTable_00009_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
