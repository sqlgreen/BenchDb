CREATE TABLE [MySchema].[MyTable_00104] (
    ...
    CONSTRAINT [PK_MyTable_00104] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00104_MyTable00104] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00104] ([ColKey]),
    CONSTRAINT [BK_MyTable_00104_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
