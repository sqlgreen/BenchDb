CREATE TABLE [MySchema].[MyTable_00452] (
    ...
    CONSTRAINT [PK_MyTable_00452] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00452_MyTable00452] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00452] ([ColKey]),
    CONSTRAINT [BK_MyTable_00452_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
