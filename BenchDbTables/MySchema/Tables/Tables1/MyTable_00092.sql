CREATE TABLE [MySchema].[MyTable_00092] (
    ...
    CONSTRAINT [PK_MyTable_00092] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00092_MyTable00092] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00092] ([ColKey]),
    CONSTRAINT [BK_MyTable_00092_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
