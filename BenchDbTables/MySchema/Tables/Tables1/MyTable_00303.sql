CREATE TABLE [MySchema].[MyTable_00303] (
    ...
    CONSTRAINT [PK_MyTable_00303] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00303_MyTable00303] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00303] ([ColKey]),
    CONSTRAINT [BK_MyTable_00303_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
