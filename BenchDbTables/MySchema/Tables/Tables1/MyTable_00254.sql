CREATE TABLE [MySchema].[MyTable_00254] (
    ...
    CONSTRAINT [PK_MyTable_00254] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00254_MyTable00254] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00254] ([ColKey]),
    CONSTRAINT [BK_MyTable_00254_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
