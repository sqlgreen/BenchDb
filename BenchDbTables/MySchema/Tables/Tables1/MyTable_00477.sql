CREATE TABLE [MySchema].[MyTable_00477] (
    ...
    CONSTRAINT [PK_MyTable_00477] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00477_MyTable00477] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00477] ([ColKey]),
    CONSTRAINT [BK_MyTable_00477_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
