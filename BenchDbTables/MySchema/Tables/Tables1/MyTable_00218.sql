CREATE TABLE [MySchema].[MyTable_00218] (
    ...
    CONSTRAINT [PK_MyTable_00218] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00218_MyTable00218] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00218] ([ColKey]),
    CONSTRAINT [BK_MyTable_00218_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
