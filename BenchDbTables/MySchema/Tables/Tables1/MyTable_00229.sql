CREATE TABLE [MySchema].[MyTable_00229] (
    ...
    CONSTRAINT [PK_MyTable_00229] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00229_MyTable00229] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00229] ([ColKey]),
    CONSTRAINT [BK_MyTable_00229_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
