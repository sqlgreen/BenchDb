CREATE TABLE [MySchema].[MyTable_00475] (
    ...
    CONSTRAINT [PK_MyTable_00475] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00475_MyTable00475] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00475] ([ColKey]),
    CONSTRAINT [BK_MyTable_00475_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
