CREATE TABLE [MySchema].[MyTable_00060] (
    ...
    CONSTRAINT [PK_MyTable_00060] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00060_MyTable00060] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00060] ([ColKey]),
    CONSTRAINT [BK_MyTable_00060_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
