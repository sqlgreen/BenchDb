CREATE TABLE [MySchema].[MyTable_00273] (
    ...
    CONSTRAINT [PK_MyTable_00273] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00273_MyTable00273] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00273] ([ColKey]),
    CONSTRAINT [BK_MyTable_00273_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
