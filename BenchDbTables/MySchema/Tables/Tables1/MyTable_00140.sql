CREATE TABLE [MySchema].[MyTable_00140] (
    ...
    CONSTRAINT [PK_MyTable_00140] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00140_MyTable00140] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00140] ([ColKey]),
    CONSTRAINT [BK_MyTable_00140_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
