CREATE TABLE [MySchema].[MyTable_00020] (
    ...
    CONSTRAINT [PK_MyTable_00020] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00020_MyTable00020] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00020] ([ColKey]),
    CONSTRAINT [BK_MyTable_00020_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
