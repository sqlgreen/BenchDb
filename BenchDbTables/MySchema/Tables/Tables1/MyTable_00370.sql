CREATE TABLE [MySchema].[MyTable_00370] (
    ...
    CONSTRAINT [PK_MyTable_00370] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00370_MyTable00370] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00370] ([ColKey]),
    CONSTRAINT [BK_MyTable_00370_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
