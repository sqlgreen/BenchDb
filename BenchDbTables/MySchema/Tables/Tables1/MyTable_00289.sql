CREATE TABLE [MySchema].[MyTable_00289] (
    ...
    CONSTRAINT [PK_MyTable_00289] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00289_MyTable00289] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00289] ([ColKey]),
    CONSTRAINT [BK_MyTable_00289_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
