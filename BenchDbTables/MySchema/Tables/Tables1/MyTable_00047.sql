CREATE TABLE [MySchema].[MyTable_00047] (
    ...
    CONSTRAINT [PK_MyTable_00047] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00047_MyTable00047] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00047] ([ColKey]),
    CONSTRAINT [BK_MyTable_00047_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
