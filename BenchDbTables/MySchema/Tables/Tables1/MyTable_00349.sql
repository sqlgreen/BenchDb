CREATE TABLE [MySchema].[MyTable_00349] (
    ...
    CONSTRAINT [PK_MyTable_00349] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00349_MyTable00349] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00349] ([ColKey]),
    CONSTRAINT [BK_MyTable_00349_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
