CREATE TABLE [MySchema].[MyTable_00120] (
    ...
    CONSTRAINT [PK_MyTable_00120] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00120_MyTable00120] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00120] ([ColKey]),
    CONSTRAINT [BK_MyTable_00120_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
