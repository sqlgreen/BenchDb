CREATE TABLE [MySchema].[MyTable_00246] (
    ...
    CONSTRAINT [PK_MyTable_00246] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00246_MyTable00246] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00246] ([ColKey]),
    CONSTRAINT [BK_MyTable_00246_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
