CREATE TABLE [MySchema].[MyTable_00356] (
    ...
    CONSTRAINT [PK_MyTable_00356] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00356_MyTable00356] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00356] ([ColKey]),
    CONSTRAINT [BK_MyTable_00356_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
