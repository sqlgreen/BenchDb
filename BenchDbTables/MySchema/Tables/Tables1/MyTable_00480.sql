CREATE TABLE [MySchema].[MyTable_00480] (
    ...
    CONSTRAINT [PK_MyTable_00480] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00480_MyTable00480] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00480] ([ColKey]),
    CONSTRAINT [BK_MyTable_00480_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
