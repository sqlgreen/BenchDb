CREATE TABLE [MySchema].[MyTable_00119] (
    ...
    CONSTRAINT [PK_MyTable_00119] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00119_MyTable00119] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00119] ([ColKey]),
    CONSTRAINT [BK_MyTable_00119_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
