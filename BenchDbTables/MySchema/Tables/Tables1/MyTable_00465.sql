CREATE TABLE [MySchema].[MyTable_00465] (
    ...
    CONSTRAINT [PK_MyTable_00465] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00465_MyTable00465] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00465] ([ColKey]),
    CONSTRAINT [BK_MyTable_00465_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
