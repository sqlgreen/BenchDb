CREATE TABLE [MySchema].[MyTable_00055] (
    ...
    CONSTRAINT [PK_MyTable_00055] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00055_MyTable00055] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00055] ([ColKey]),
    CONSTRAINT [BK_MyTable_00055_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
