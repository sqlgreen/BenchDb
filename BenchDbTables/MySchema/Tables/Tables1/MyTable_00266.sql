CREATE TABLE [MySchema].[MyTable_00266] (
    ...
    CONSTRAINT [PK_MyTable_00266] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00266_MyTable00266] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00266] ([ColKey]),
    CONSTRAINT [BK_MyTable_00266_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
