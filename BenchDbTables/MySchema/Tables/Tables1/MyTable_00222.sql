CREATE TABLE [MySchema].[MyTable_00222] (
    ...
    CONSTRAINT [PK_MyTable_00222] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00222_MyTable00222] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00222] ([ColKey]),
    CONSTRAINT [BK_MyTable_00222_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
