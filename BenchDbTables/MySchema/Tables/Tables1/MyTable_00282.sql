CREATE TABLE [MySchema].[MyTable_00282] (
    ...
    CONSTRAINT [PK_MyTable_00282] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00282_MyTable00282] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00282] ([ColKey]),
    CONSTRAINT [BK_MyTable_00282_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
