CREATE TABLE [MySchema].[MyTable_00169] (
    ...
    CONSTRAINT [PK_MyTable_00169] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00169_MyTable00169] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00169] ([ColKey]),
    CONSTRAINT [BK_MyTable_00169_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
