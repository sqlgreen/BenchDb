CREATE TABLE [MySchema].[MyTable_00191] (
    ...
    CONSTRAINT [PK_MyTable_00191] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00191_MyTable00191] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00191] ([ColKey]),
    CONSTRAINT [BK_MyTable_00191_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
