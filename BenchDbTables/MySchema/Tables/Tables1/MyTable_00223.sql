CREATE TABLE [MySchema].[MyTable_00223] (
    ...
    CONSTRAINT [PK_MyTable_00223] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00223_MyTable00223] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00223] ([ColKey]),
    CONSTRAINT [BK_MyTable_00223_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
