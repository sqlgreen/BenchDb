CREATE TABLE [MySchema].[MyTable_00231] (
    ...
    CONSTRAINT [PK_MyTable_00231] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00231_MyTable00231] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00231] ([ColKey]),
    CONSTRAINT [BK_MyTable_00231_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
