CREATE TABLE [MySchema].[MyTable_00168] (
    ...
    CONSTRAINT [PK_MyTable_00168] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00168_MyTable00168] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00168] ([ColKey]),
    CONSTRAINT [BK_MyTable_00168_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
