CREATE TABLE [MySchema].[MyTable_00471] (
    ...
    CONSTRAINT [PK_MyTable_00471] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00471_MyTable00471] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00471] ([ColKey]),
    CONSTRAINT [BK_MyTable_00471_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
