CREATE TABLE [MySchema].[MyTable_00018] (
    ...
    CONSTRAINT [PK_MyTable_00018] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00018_MyTable00018] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00018] ([ColKey]),
    CONSTRAINT [BK_MyTable_00018_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
