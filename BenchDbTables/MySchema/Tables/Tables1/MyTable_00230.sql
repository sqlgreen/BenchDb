CREATE TABLE [MySchema].[MyTable_00230] (
    ...
    CONSTRAINT [PK_MyTable_00230] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00230_MyTable00230] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00230] ([ColKey]),
    CONSTRAINT [BK_MyTable_00230_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
