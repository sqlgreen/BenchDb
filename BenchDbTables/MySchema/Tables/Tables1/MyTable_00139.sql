CREATE TABLE [MySchema].[MyTable_00139] (
    ...
    CONSTRAINT [PK_MyTable_00139] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00139_MyTable00139] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00139] ([ColKey]),
    CONSTRAINT [BK_MyTable_00139_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
