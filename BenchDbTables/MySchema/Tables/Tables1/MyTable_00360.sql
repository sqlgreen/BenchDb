CREATE TABLE [MySchema].[MyTable_00360] (
    ...
    CONSTRAINT [PK_MyTable_00360] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00360_MyTable00360] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00360] ([ColKey]),
    CONSTRAINT [BK_MyTable_00360_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
