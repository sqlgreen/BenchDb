CREATE TABLE [MySchema].[MyTable_00261] (
    ...
    CONSTRAINT [PK_MyTable_00261] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00261_MyTable00261] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00261] ([ColKey]),
    CONSTRAINT [BK_MyTable_00261_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
