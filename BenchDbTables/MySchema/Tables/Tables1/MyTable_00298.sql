CREATE TABLE [MySchema].[MyTable_00298] (
    ...
    CONSTRAINT [PK_MyTable_00298] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00298_MyTable00298] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00298] ([ColKey]),
    CONSTRAINT [BK_MyTable_00298_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
