CREATE TABLE [MySchema].[MyTable_00493] (
    ...
    CONSTRAINT [PK_MyTable_00493] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00493_MyTable00493] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00493] ([ColKey]),
    CONSTRAINT [BK_MyTable_00493_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
