CREATE TABLE [MySchema].[MyTable_00095] (
    ...
    CONSTRAINT [PK_MyTable_00095] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00095_MyTable00095] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00095] ([ColKey]),
    CONSTRAINT [BK_MyTable_00095_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
