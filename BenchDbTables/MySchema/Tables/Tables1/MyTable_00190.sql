CREATE TABLE [MySchema].[MyTable_00190] (
    ...
    CONSTRAINT [PK_MyTable_00190] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00190_MyTable00190] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00190] ([ColKey]),
    CONSTRAINT [BK_MyTable_00190_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
