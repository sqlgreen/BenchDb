CREATE TABLE [MySchema].[MyTable_01939] (
    ...
    CONSTRAINT [PK_MyTable_01939] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01939_MyTable01939] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01939] ([ColKey]),
    CONSTRAINT [BK_MyTable_01939_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
