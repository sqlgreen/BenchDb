CREATE TABLE [MySchema].[MyTable_01988] (
    ...
    CONSTRAINT [PK_MyTable_01988] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01988_MyTable01988] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01988] ([ColKey]),
    CONSTRAINT [BK_MyTable_01988_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
