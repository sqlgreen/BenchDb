CREATE TABLE [MySchema].[MyTable_01799] (
    ...
    CONSTRAINT [PK_MyTable_01799] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01799_MyTable01799] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01799] ([ColKey]),
    CONSTRAINT [BK_MyTable_01799_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
