CREATE TABLE [MySchema].[MyTable_01770] (
    ...
    CONSTRAINT [PK_MyTable_01770] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01770_MyTable01770] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01770] ([ColKey]),
    CONSTRAINT [BK_MyTable_01770_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
