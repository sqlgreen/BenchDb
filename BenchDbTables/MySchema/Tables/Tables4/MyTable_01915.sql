CREATE TABLE [MySchema].[MyTable_01915] (
    ...
    CONSTRAINT [PK_MyTable_01915] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01915_MyTable01915] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01915] ([ColKey]),
    CONSTRAINT [BK_MyTable_01915_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
