CREATE TABLE [MySchema].[MyTable_01779] (
    ...
    CONSTRAINT [PK_MyTable_01779] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01779_MyTable01779] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01779] ([ColKey]),
    CONSTRAINT [BK_MyTable_01779_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
