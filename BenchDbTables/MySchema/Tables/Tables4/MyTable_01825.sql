CREATE TABLE [MySchema].[MyTable_01825] (
    ...
    CONSTRAINT [PK_MyTable_01825] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01825_MyTable01825] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01825] ([ColKey]),
    CONSTRAINT [BK_MyTable_01825_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
