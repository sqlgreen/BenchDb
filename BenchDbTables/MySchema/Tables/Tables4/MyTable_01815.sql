CREATE TABLE [MySchema].[MyTable_01815] (
    ...
    CONSTRAINT [PK_MyTable_01815] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01815_MyTable01815] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01815] ([ColKey]),
    CONSTRAINT [BK_MyTable_01815_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
