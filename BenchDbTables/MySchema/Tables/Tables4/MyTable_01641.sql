CREATE TABLE [MySchema].[MyTable_01641] (
    ...
    CONSTRAINT [PK_MyTable_01641] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01641_MyTable01641] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01641] ([ColKey]),
    CONSTRAINT [BK_MyTable_01641_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
