CREATE TABLE [MySchema].[MyTable_01729] (
    ...
    CONSTRAINT [PK_MyTable_01729] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01729_MyTable01729] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01729] ([ColKey]),
    CONSTRAINT [BK_MyTable_01729_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
