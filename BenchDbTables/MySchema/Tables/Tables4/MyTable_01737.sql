CREATE TABLE [MySchema].[MyTable_01737] (
    ...
    CONSTRAINT [PK_MyTable_01737] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01737_MyTable01737] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01737] ([ColKey]),
    CONSTRAINT [BK_MyTable_01737_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
