CREATE TABLE [MySchema].[MyTable_01511] (
    ...
    CONSTRAINT [PK_MyTable_01511] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01511_MyTable01511] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01511] ([ColKey]),
    CONSTRAINT [BK_MyTable_01511_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
