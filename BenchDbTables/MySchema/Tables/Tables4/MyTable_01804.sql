CREATE TABLE [MySchema].[MyTable_01804] (
    ...
    CONSTRAINT [PK_MyTable_01804] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01804_MyTable01804] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01804] ([ColKey]),
    CONSTRAINT [BK_MyTable_01804_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
