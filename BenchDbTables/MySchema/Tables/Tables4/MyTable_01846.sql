CREATE TABLE [MySchema].[MyTable_01846] (
    ...
    CONSTRAINT [PK_MyTable_01846] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01846_MyTable01846] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01846] ([ColKey]),
    CONSTRAINT [BK_MyTable_01846_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
