CREATE TABLE [MySchema].[MyTable_01514] (
    ...
    CONSTRAINT [PK_MyTable_01514] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01514_MyTable01514] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01514] ([ColKey]),
    CONSTRAINT [BK_MyTable_01514_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
