CREATE TABLE [MySchema].[MyTable_01609] (
    ...
    CONSTRAINT [PK_MyTable_01609] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01609_MyTable01609] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01609] ([ColKey]),
    CONSTRAINT [BK_MyTable_01609_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
