CREATE TABLE [MySchema].[MyTable_01946] (
    ...
    CONSTRAINT [PK_MyTable_01946] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01946_MyTable01946] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01946] ([ColKey]),
    CONSTRAINT [BK_MyTable_01946_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
