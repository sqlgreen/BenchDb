CREATE TABLE [MySchema].[MyTable_01938] (
    ...
    CONSTRAINT [PK_MyTable_01938] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01938_MyTable01938] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01938] ([ColKey]),
    CONSTRAINT [BK_MyTable_01938_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
