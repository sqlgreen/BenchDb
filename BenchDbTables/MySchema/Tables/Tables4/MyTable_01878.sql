CREATE TABLE [MySchema].[MyTable_01878] (
    ...
    CONSTRAINT [PK_MyTable_01878] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01878_MyTable01878] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01878] ([ColKey]),
    CONSTRAINT [BK_MyTable_01878_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
