CREATE TABLE [MySchema].[MyTable_01592] (
    ...
    CONSTRAINT [PK_MyTable_01592] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01592_MyTable01592] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01592] ([ColKey]),
    CONSTRAINT [BK_MyTable_01592_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
