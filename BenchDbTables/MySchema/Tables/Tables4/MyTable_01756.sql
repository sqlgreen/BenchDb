CREATE TABLE [MySchema].[MyTable_01756] (
    ...
    CONSTRAINT [PK_MyTable_01756] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01756_MyTable01756] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01756] ([ColKey]),
    CONSTRAINT [BK_MyTable_01756_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
