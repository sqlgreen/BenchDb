CREATE TABLE [MySchema].[MyTable_01758] (
    ...
    CONSTRAINT [PK_MyTable_01758] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01758_MyTable01758] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01758] ([ColKey]),
    CONSTRAINT [BK_MyTable_01758_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
