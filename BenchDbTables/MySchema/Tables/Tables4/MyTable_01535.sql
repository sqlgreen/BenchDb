CREATE TABLE [MySchema].[MyTable_01535] (
    ...
    CONSTRAINT [PK_MyTable_01535] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01535_MyTable01535] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01535] ([ColKey]),
    CONSTRAINT [BK_MyTable_01535_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
