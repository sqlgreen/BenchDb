CREATE TABLE [MySchema].[MyTable_01670] (
    ...
    CONSTRAINT [PK_MyTable_01670] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01670_MyTable01670] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01670] ([ColKey]),
    CONSTRAINT [BK_MyTable_01670_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
