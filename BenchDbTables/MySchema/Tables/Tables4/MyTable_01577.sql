CREATE TABLE [MySchema].[MyTable_01577] (
    ...
    CONSTRAINT [PK_MyTable_01577] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01577_MyTable01577] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01577] ([ColKey]),
    CONSTRAINT [BK_MyTable_01577_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
