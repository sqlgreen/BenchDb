CREATE TABLE [MySchema].[MyTable_01949] (
    ...
    CONSTRAINT [PK_MyTable_01949] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01949_MyTable01949] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01949] ([ColKey]),
    CONSTRAINT [BK_MyTable_01949_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
