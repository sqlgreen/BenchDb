CREATE TABLE [MySchema].[MyTable_01543] (
    ...
    CONSTRAINT [PK_MyTable_01543] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01543_MyTable01543] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01543] ([ColKey]),
    CONSTRAINT [BK_MyTable_01543_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
