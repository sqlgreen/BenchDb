CREATE TABLE [MySchema].[MyTable_01619] (
    ...
    CONSTRAINT [PK_MyTable_01619] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01619_MyTable01619] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01619] ([ColKey]),
    CONSTRAINT [BK_MyTable_01619_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
