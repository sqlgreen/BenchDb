CREATE TABLE [MySchema].[MyTable_01786] (
    ...
    CONSTRAINT [PK_MyTable_01786] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01786_MyTable01786] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01786] ([ColKey]),
    CONSTRAINT [BK_MyTable_01786_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
