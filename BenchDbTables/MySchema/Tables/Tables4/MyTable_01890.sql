CREATE TABLE [MySchema].[MyTable_01890] (
    ...
    CONSTRAINT [PK_MyTable_01890] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01890_MyTable01890] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01890] ([ColKey]),
    CONSTRAINT [BK_MyTable_01890_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
