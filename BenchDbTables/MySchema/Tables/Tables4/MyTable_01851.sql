CREATE TABLE [MySchema].[MyTable_01851] (
    ...
    CONSTRAINT [PK_MyTable_01851] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01851_MyTable01851] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01851] ([ColKey]),
    CONSTRAINT [BK_MyTable_01851_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
