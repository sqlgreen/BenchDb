CREATE TABLE [MySchema].[MyTable_01536] (
    ...
    CONSTRAINT [PK_MyTable_01536] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01536_MyTable01536] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01536] ([ColKey]),
    CONSTRAINT [BK_MyTable_01536_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
