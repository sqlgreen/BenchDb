CREATE TABLE [MySchema].[MyTable_01548] (
    ...
    CONSTRAINT [PK_MyTable_01548] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01548_MyTable01548] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01548] ([ColKey]),
    CONSTRAINT [BK_MyTable_01548_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
