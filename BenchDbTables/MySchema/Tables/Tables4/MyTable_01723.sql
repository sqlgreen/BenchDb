CREATE TABLE [MySchema].[MyTable_01723] (
    ...
    CONSTRAINT [PK_MyTable_01723] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01723_MyTable01723] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01723] ([ColKey]),
    CONSTRAINT [BK_MyTable_01723_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
