CREATE TABLE [MySchema].[MyTable_01774] (
    ...
    CONSTRAINT [PK_MyTable_01774] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01774_MyTable01774] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01774] ([ColKey]),
    CONSTRAINT [BK_MyTable_01774_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
