CREATE TABLE [MySchema].[MyTable_01525] (
    ...
    CONSTRAINT [PK_MyTable_01525] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01525_MyTable01525] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01525] ([ColKey]),
    CONSTRAINT [BK_MyTable_01525_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
