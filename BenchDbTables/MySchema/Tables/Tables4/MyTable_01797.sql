CREATE TABLE [MySchema].[MyTable_01797] (
    ...
    CONSTRAINT [PK_MyTable_01797] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01797_MyTable01797] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01797] ([ColKey]),
    CONSTRAINT [BK_MyTable_01797_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
