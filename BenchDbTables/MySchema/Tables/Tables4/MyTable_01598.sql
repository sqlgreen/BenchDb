CREATE TABLE [MySchema].[MyTable_01598] (
    ...
    CONSTRAINT [PK_MyTable_01598] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01598_MyTable01598] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01598] ([ColKey]),
    CONSTRAINT [BK_MyTable_01598_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
