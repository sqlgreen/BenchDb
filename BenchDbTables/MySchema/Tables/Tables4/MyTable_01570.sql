CREATE TABLE [MySchema].[MyTable_01570] (
    ...
    CONSTRAINT [PK_MyTable_01570] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01570_MyTable01570] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01570] ([ColKey]),
    CONSTRAINT [BK_MyTable_01570_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
