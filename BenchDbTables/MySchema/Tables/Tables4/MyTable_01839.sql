CREATE TABLE [MySchema].[MyTable_01839] (
    ...
    CONSTRAINT [PK_MyTable_01839] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01839_MyTable01839] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01839] ([ColKey]),
    CONSTRAINT [BK_MyTable_01839_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
