CREATE TABLE [MySchema].[MyTable_01861] (
    ...
    CONSTRAINT [PK_MyTable_01861] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01861_MyTable01861] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01861] ([ColKey]),
    CONSTRAINT [BK_MyTable_01861_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
