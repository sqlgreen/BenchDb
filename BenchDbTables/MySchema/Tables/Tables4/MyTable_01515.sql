CREATE TABLE [MySchema].[MyTable_01515] (
    ...
    CONSTRAINT [PK_MyTable_01515] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01515_MyTable01515] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01515] ([ColKey]),
    CONSTRAINT [BK_MyTable_01515_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
