CREATE TABLE [MySchema].[MyTable_01932] (
    ...
    CONSTRAINT [PK_MyTable_01932] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01932_MyTable01932] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01932] ([ColKey]),
    CONSTRAINT [BK_MyTable_01932_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
