CREATE TABLE [MySchema].[MyTable_01806] (
    ...
    CONSTRAINT [PK_MyTable_01806] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01806_MyTable01806] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01806] ([ColKey]),
    CONSTRAINT [BK_MyTable_01806_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
