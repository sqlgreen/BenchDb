CREATE TABLE [MySchema].[MyTable_01627] (
    ...
    CONSTRAINT [PK_MyTable_01627] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01627_MyTable01627] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01627] ([ColKey]),
    CONSTRAINT [BK_MyTable_01627_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
