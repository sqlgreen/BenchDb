CREATE TABLE [MySchema].[MyTable_01865] (
    ...
    CONSTRAINT [PK_MyTable_01865] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01865_MyTable01865] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01865] ([ColKey]),
    CONSTRAINT [BK_MyTable_01865_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
