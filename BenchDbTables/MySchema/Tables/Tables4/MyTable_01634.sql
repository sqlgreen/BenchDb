CREATE TABLE [MySchema].[MyTable_01634] (
    ...
    CONSTRAINT [PK_MyTable_01634] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01634_MyTable01634] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01634] ([ColKey]),
    CONSTRAINT [BK_MyTable_01634_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
