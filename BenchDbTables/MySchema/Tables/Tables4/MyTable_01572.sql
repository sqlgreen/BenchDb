CREATE TABLE [MySchema].[MyTable_01572] (
    ...
    CONSTRAINT [PK_MyTable_01572] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01572_MyTable01572] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01572] ([ColKey]),
    CONSTRAINT [BK_MyTable_01572_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
