CREATE TABLE [MySchema].[MyTable_01855] (
    ...
    CONSTRAINT [PK_MyTable_01855] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01855_MyTable01855] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01855] ([ColKey]),
    CONSTRAINT [BK_MyTable_01855_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
