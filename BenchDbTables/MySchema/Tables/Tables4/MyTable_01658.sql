CREATE TABLE [MySchema].[MyTable_01658] (
    ...
    CONSTRAINT [PK_MyTable_01658] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01658_MyTable01658] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01658] ([ColKey]),
    CONSTRAINT [BK_MyTable_01658_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
