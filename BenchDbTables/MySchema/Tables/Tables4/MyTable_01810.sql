CREATE TABLE [MySchema].[MyTable_01810] (
    ...
    CONSTRAINT [PK_MyTable_01810] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01810_MyTable01810] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01810] ([ColKey]),
    CONSTRAINT [BK_MyTable_01810_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
