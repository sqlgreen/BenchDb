CREATE TABLE [MySchema].[MyTable_01964] (
    ...
    CONSTRAINT [PK_MyTable_01964] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01964_MyTable01964] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01964] ([ColKey]),
    CONSTRAINT [BK_MyTable_01964_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
