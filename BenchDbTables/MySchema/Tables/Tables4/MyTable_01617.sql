CREATE TABLE [MySchema].[MyTable_01617] (
    ...
    CONSTRAINT [PK_MyTable_01617] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01617_MyTable01617] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01617] ([ColKey]),
    CONSTRAINT [BK_MyTable_01617_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
