CREATE TABLE [MySchema].[MyTable_01644] (
    ...
    CONSTRAINT [PK_MyTable_01644] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01644_MyTable01644] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01644] ([ColKey]),
    CONSTRAINT [BK_MyTable_01644_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
