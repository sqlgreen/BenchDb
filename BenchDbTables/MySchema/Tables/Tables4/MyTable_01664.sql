CREATE TABLE [MySchema].[MyTable_01664] (
    ...
    CONSTRAINT [PK_MyTable_01664] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01664_MyTable01664] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01664] ([ColKey]),
    CONSTRAINT [BK_MyTable_01664_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
