CREATE TABLE [MySchema].[MyTable_01519] (
    ...
    CONSTRAINT [PK_MyTable_01519] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01519_MyTable01519] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01519] ([ColKey]),
    CONSTRAINT [BK_MyTable_01519_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
