CREATE TABLE [MySchema].[MyTable_01868] (
    ...
    CONSTRAINT [PK_MyTable_01868] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01868_MyTable01868] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01868] ([ColKey]),
    CONSTRAINT [BK_MyTable_01868_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
