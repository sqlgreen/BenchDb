CREATE TABLE [MySchema].[MyTable_01541] (
    ...
    CONSTRAINT [PK_MyTable_01541] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01541_MyTable01541] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01541] ([ColKey]),
    CONSTRAINT [BK_MyTable_01541_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
