CREATE TABLE [MySchema].[MyTable_01942] (
    ...
    CONSTRAINT [PK_MyTable_01942] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01942_MyTable01942] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01942] ([ColKey]),
    CONSTRAINT [BK_MyTable_01942_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
