CREATE TABLE [MySchema].[MyTable_01610] (
    ...
    CONSTRAINT [PK_MyTable_01610] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01610_MyTable01610] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01610] ([ColKey]),
    CONSTRAINT [BK_MyTable_01610_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
