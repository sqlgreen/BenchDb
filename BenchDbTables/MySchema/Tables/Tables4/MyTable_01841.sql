CREATE TABLE [MySchema].[MyTable_01841] (
    ...
    CONSTRAINT [PK_MyTable_01841] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01841_MyTable01841] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01841] ([ColKey]),
    CONSTRAINT [BK_MyTable_01841_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
