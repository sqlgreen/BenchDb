CREATE TABLE [MySchema].[MyTable_01554] (
    ...
    CONSTRAINT [PK_MyTable_01554] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01554_MyTable01554] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01554] ([ColKey]),
    CONSTRAINT [BK_MyTable_01554_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
