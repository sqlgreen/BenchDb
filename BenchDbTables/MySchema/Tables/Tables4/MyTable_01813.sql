CREATE TABLE [MySchema].[MyTable_01813] (
    ...
    CONSTRAINT [PK_MyTable_01813] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01813_MyTable01813] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01813] ([ColKey]),
    CONSTRAINT [BK_MyTable_01813_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
