CREATE TABLE [MySchema].[MyTable_01731] (
    ...
    CONSTRAINT [PK_MyTable_01731] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01731_MyTable01731] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01731] ([ColKey]),
    CONSTRAINT [BK_MyTable_01731_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
