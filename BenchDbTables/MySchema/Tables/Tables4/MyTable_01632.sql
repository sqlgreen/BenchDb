CREATE TABLE [MySchema].[MyTable_01632] (
    ...
    CONSTRAINT [PK_MyTable_01632] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01632_MyTable01632] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01632] ([ColKey]),
    CONSTRAINT [BK_MyTable_01632_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
