CREATE TABLE [MySchema].[MyTable_01663] (
    ...
    CONSTRAINT [PK_MyTable_01663] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01663_MyTable01663] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01663] ([ColKey]),
    CONSTRAINT [BK_MyTable_01663_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
