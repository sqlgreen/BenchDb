CREATE TABLE [MySchema].[MyTable_01521] (
    ...
    CONSTRAINT [PK_MyTable_01521] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01521_MyTable01521] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01521] ([ColKey]),
    CONSTRAINT [BK_MyTable_01521_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
