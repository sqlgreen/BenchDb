CREATE TABLE [MySchema].[MyTable_01636] (
    ...
    CONSTRAINT [PK_MyTable_01636] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01636_MyTable01636] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01636] ([ColKey]),
    CONSTRAINT [BK_MyTable_01636_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
