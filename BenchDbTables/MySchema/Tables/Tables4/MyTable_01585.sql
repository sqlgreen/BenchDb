CREATE TABLE [MySchema].[MyTable_01585] (
    ...
    CONSTRAINT [PK_MyTable_01585] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01585_MyTable01585] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01585] ([ColKey]),
    CONSTRAINT [BK_MyTable_01585_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
