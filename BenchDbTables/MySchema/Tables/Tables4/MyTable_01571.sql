CREATE TABLE [MySchema].[MyTable_01571] (
    ...
    CONSTRAINT [PK_MyTable_01571] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01571_MyTable01571] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01571] ([ColKey]),
    CONSTRAINT [BK_MyTable_01571_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
