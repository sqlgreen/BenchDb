CREATE TABLE [MySchema].[MyTable_01767] (
    ...
    CONSTRAINT [PK_MyTable_01767] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01767_MyTable01767] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01767] ([ColKey]),
    CONSTRAINT [BK_MyTable_01767_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
