CREATE TABLE [MySchema].[MyTable_01532] (
    ...
    CONSTRAINT [PK_MyTable_01532] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01532_MyTable01532] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01532] ([ColKey]),
    CONSTRAINT [BK_MyTable_01532_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
