CREATE TABLE [MySchema].[MyTable_01563] (
    ...
    CONSTRAINT [PK_MyTable_01563] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01563_MyTable01563] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01563] ([ColKey]),
    CONSTRAINT [BK_MyTable_01563_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
