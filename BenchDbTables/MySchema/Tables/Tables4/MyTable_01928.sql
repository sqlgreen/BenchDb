CREATE TABLE [MySchema].[MyTable_01928] (
    ...
    CONSTRAINT [PK_MyTable_01928] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01928_MyTable01928] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01928] ([ColKey]),
    CONSTRAINT [BK_MyTable_01928_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
