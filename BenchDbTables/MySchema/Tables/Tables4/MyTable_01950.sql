CREATE TABLE [MySchema].[MyTable_01950] (
    ...
    CONSTRAINT [PK_MyTable_01950] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01950_MyTable01950] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01950] ([ColKey]),
    CONSTRAINT [BK_MyTable_01950_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
