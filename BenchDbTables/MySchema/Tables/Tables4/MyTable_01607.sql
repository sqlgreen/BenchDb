CREATE TABLE [MySchema].[MyTable_01607] (
    ...
    CONSTRAINT [PK_MyTable_01607] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01607_MyTable01607] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01607] ([ColKey]),
    CONSTRAINT [BK_MyTable_01607_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
