CREATE TABLE [MySchema].[MyTable_01885] (
    ...
    CONSTRAINT [PK_MyTable_01885] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01885_MyTable01885] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01885] ([ColKey]),
    CONSTRAINT [BK_MyTable_01885_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
