CREATE TABLE [MySchema].[MyTable_01856] (
    ...
    CONSTRAINT [PK_MyTable_01856] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01856_MyTable01856] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01856] ([ColKey]),
    CONSTRAINT [BK_MyTable_01856_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
