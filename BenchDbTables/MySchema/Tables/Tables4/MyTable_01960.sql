CREATE TABLE [MySchema].[MyTable_01960] (
    ...
    CONSTRAINT [PK_MyTable_01960] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01960_MyTable01960] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01960] ([ColKey]),
    CONSTRAINT [BK_MyTable_01960_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
