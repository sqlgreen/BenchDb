CREATE TABLE [MySchema].[MyTable_01741] (
    ...
    CONSTRAINT [PK_MyTable_01741] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01741_MyTable01741] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01741] ([ColKey]),
    CONSTRAINT [BK_MyTable_01741_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
