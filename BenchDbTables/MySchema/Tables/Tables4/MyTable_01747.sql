CREATE TABLE [MySchema].[MyTable_01747] (
    ...
    CONSTRAINT [PK_MyTable_01747] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01747_MyTable01747] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01747] ([ColKey]),
    CONSTRAINT [BK_MyTable_01747_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
