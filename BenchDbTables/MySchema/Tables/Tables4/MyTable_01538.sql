CREATE TABLE [MySchema].[MyTable_01538] (
    ...
    CONSTRAINT [PK_MyTable_01538] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01538_MyTable01538] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01538] ([ColKey]),
    CONSTRAINT [BK_MyTable_01538_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
