CREATE TABLE [MySchema].[MyTable_01929] (
    ...
    CONSTRAINT [PK_MyTable_01929] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01929_MyTable01929] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01929] ([ColKey]),
    CONSTRAINT [BK_MyTable_01929_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
