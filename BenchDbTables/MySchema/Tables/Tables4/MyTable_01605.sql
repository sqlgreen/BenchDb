CREATE TABLE [MySchema].[MyTable_01605] (
    ...
    CONSTRAINT [PK_MyTable_01605] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01605_MyTable01605] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01605] ([ColKey]),
    CONSTRAINT [BK_MyTable_01605_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
