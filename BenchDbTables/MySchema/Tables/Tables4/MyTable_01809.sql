CREATE TABLE [MySchema].[MyTable_01809] (
    ...
    CONSTRAINT [PK_MyTable_01809] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01809_MyTable01809] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01809] ([ColKey]),
    CONSTRAINT [BK_MyTable_01809_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
