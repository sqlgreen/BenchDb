CREATE TABLE [MySchema].[MyTable_01685] (
    ...
    CONSTRAINT [PK_MyTable_01685] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01685_MyTable01685] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01685] ([ColKey]),
    CONSTRAINT [BK_MyTable_01685_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
