CREATE TABLE [MySchema].[MyTable_01830] (
    ...
    CONSTRAINT [PK_MyTable_01830] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01830_MyTable01830] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01830] ([ColKey]),
    CONSTRAINT [BK_MyTable_01830_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
