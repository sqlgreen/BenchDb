CREATE TABLE [MySchema].[MyTable_01772] (
    ...
    CONSTRAINT [PK_MyTable_01772] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01772_MyTable01772] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01772] ([ColKey]),
    CONSTRAINT [BK_MyTable_01772_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
