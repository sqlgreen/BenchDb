CREATE TABLE [MySchema].[MyTable_01586] (
    ...
    CONSTRAINT [PK_MyTable_01586] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01586_MyTable01586] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01586] ([ColKey]),
    CONSTRAINT [BK_MyTable_01586_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
