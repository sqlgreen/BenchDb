CREATE TABLE [MySchema].[MyTable_01908] (
    ...
    CONSTRAINT [PK_MyTable_01908] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01908_MyTable01908] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01908] ([ColKey]),
    CONSTRAINT [BK_MyTable_01908_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
