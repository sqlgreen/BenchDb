CREATE TABLE [MySchema].[MyTable_01684] (
    ...
    CONSTRAINT [PK_MyTable_01684] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01684_MyTable01684] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01684] ([ColKey]),
    CONSTRAINT [BK_MyTable_01684_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
