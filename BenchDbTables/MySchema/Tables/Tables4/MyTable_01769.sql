CREATE TABLE [MySchema].[MyTable_01769] (
    ...
    CONSTRAINT [PK_MyTable_01769] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01769_MyTable01769] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01769] ([ColKey]),
    CONSTRAINT [BK_MyTable_01769_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
