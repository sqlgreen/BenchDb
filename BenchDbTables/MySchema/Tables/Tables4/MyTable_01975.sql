CREATE TABLE [MySchema].[MyTable_01975] (
    ...
    CONSTRAINT [PK_MyTable_01975] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01975_MyTable01975] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01975] ([ColKey]),
    CONSTRAINT [BK_MyTable_01975_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
