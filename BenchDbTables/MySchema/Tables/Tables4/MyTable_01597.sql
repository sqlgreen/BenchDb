CREATE TABLE [MySchema].[MyTable_01597] (
    ...
    CONSTRAINT [PK_MyTable_01597] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01597_MyTable01597] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01597] ([ColKey]),
    CONSTRAINT [BK_MyTable_01597_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
