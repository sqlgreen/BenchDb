CREATE TABLE [MySchema].[MyTable_01979] (
    ...
    CONSTRAINT [PK_MyTable_01979] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01979_MyTable01979] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01979] ([ColKey]),
    CONSTRAINT [BK_MyTable_01979_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
