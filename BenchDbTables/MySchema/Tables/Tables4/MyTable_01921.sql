CREATE TABLE [MySchema].[MyTable_01921] (
    ...
    CONSTRAINT [PK_MyTable_01921] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01921_MyTable01921] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01921] ([ColKey]),
    CONSTRAINT [BK_MyTable_01921_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
