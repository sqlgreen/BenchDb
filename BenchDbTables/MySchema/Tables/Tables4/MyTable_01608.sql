CREATE TABLE [MySchema].[MyTable_01608] (
    ...
    CONSTRAINT [PK_MyTable_01608] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01608_MyTable01608] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01608] ([ColKey]),
    CONSTRAINT [BK_MyTable_01608_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
