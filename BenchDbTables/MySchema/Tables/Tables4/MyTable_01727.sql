CREATE TABLE [MySchema].[MyTable_01727] (
    ...
    CONSTRAINT [PK_MyTable_01727] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01727_MyTable01727] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01727] ([ColKey]),
    CONSTRAINT [BK_MyTable_01727_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
