CREATE TABLE [MySchema].[MyTable_01584] (
    ...
    CONSTRAINT [PK_MyTable_01584] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01584_MyTable01584] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01584] ([ColKey]),
    CONSTRAINT [BK_MyTable_01584_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
