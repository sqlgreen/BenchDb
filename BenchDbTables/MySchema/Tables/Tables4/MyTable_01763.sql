CREATE TABLE [MySchema].[MyTable_01763] (
    ...
    CONSTRAINT [PK_MyTable_01763] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01763_MyTable01763] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01763] ([ColKey]),
    CONSTRAINT [BK_MyTable_01763_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
