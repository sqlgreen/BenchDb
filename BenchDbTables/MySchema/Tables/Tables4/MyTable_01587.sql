CREATE TABLE [MySchema].[MyTable_01587] (
    ...
    CONSTRAINT [PK_MyTable_01587] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01587_MyTable01587] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01587] ([ColKey]),
    CONSTRAINT [BK_MyTable_01587_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
