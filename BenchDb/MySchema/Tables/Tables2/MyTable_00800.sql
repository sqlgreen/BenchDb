CREATE TABLE [MySchema].[MyTable_00800] (
    ...
    CONSTRAINT [PK_MyTable_00800] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00800_MyTable00800] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00800] ([ColKey]),
    CONSTRAINT [BK_MyTable_00800_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
