CREATE TABLE [MySchema].[MyTable_00955] (
    ...
    CONSTRAINT [PK_MyTable_00955] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00955_MyTable00955] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00955] ([ColKey]),
    CONSTRAINT [BK_MyTable_00955_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
