CREATE TABLE [MySchema].[MyTable_00990] (
    ...
    CONSTRAINT [PK_MyTable_00990] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00990_MyTable00990] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00990] ([ColKey]),
    CONSTRAINT [BK_MyTable_00990_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
