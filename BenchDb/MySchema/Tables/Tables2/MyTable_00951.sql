CREATE TABLE [MySchema].[MyTable_00951] (
    ...
    CONSTRAINT [PK_MyTable_00951] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00951_MyTable00951] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00951] ([ColKey]),
    CONSTRAINT [BK_MyTable_00951_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
