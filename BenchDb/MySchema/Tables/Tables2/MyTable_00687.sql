CREATE TABLE [MySchema].[MyTable_00687] (
    ...
    CONSTRAINT [PK_MyTable_00687] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00687_MyTable00687] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00687] ([ColKey]),
    CONSTRAINT [BK_MyTable_00687_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
