CREATE TABLE [MySchema].[MyTable_00613] (
    ...
    CONSTRAINT [PK_MyTable_00613] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00613_MyTable00613] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00613] ([ColKey]),
    CONSTRAINT [BK_MyTable_00613_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
