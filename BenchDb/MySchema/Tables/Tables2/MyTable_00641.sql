CREATE TABLE [MySchema].[MyTable_00641] (
    ...
    CONSTRAINT [PK_MyTable_00641] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00641_MyTable00641] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00641] ([ColKey]),
    CONSTRAINT [BK_MyTable_00641_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
