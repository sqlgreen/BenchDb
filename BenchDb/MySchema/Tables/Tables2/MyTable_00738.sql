CREATE TABLE [MySchema].[MyTable_00738] (
    ...
    CONSTRAINT [PK_MyTable_00738] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00738_MyTable00738] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00738] ([ColKey]),
    CONSTRAINT [BK_MyTable_00738_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
