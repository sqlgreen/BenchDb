CREATE TABLE [MySchema].[MyTable_00981] (
    ...
    CONSTRAINT [PK_MyTable_00981] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00981_MyTable00981] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00981] ([ColKey]),
    CONSTRAINT [BK_MyTable_00981_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
