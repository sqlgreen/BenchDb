CREATE TABLE [MySchema].[MyTable_00873] (
    ...
    CONSTRAINT [PK_MyTable_00873] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00873_MyTable00873] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00873] ([ColKey]),
    CONSTRAINT [BK_MyTable_00873_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
