CREATE TABLE [MySchema].[MyTable_00874] (
    ...
    CONSTRAINT [PK_MyTable_00874] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00874_MyTable00874] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00874] ([ColKey]),
    CONSTRAINT [BK_MyTable_00874_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
