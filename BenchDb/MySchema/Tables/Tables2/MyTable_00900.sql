CREATE TABLE [MySchema].[MyTable_00900] (
    ...
    CONSTRAINT [PK_MyTable_00900] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00900_MyTable00900] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00900] ([ColKey]),
    CONSTRAINT [BK_MyTable_00900_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
