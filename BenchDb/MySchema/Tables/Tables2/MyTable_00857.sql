CREATE TABLE [MySchema].[MyTable_00857] (
    ...
    CONSTRAINT [PK_MyTable_00857] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00857_MyTable00857] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00857] ([ColKey]),
    CONSTRAINT [BK_MyTable_00857_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
