CREATE TABLE [MySchema].[MyTable_00558] (
    ...
    CONSTRAINT [PK_MyTable_00558] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00558_MyTable00558] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00558] ([ColKey]),
    CONSTRAINT [BK_MyTable_00558_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
