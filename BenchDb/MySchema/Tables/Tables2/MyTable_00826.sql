CREATE TABLE [MySchema].[MyTable_00826] (
    ...
    CONSTRAINT [PK_MyTable_00826] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00826_MyTable00826] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00826] ([ColKey]),
    CONSTRAINT [BK_MyTable_00826_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
