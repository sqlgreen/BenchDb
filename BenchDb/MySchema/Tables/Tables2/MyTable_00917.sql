CREATE TABLE [MySchema].[MyTable_00917] (
    ...
    CONSTRAINT [PK_MyTable_00917] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00917_MyTable00917] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00917] ([ColKey]),
    CONSTRAINT [BK_MyTable_00917_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
