CREATE TABLE [MySchema].[MyTable_00869] (
    ...
    CONSTRAINT [PK_MyTable_00869] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00869_MyTable00869] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00869] ([ColKey]),
    CONSTRAINT [BK_MyTable_00869_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
