CREATE TABLE [MySchema].[MyTable_00903] (
    ...
    CONSTRAINT [PK_MyTable_00903] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00903_MyTable00903] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00903] ([ColKey]),
    CONSTRAINT [BK_MyTable_00903_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
