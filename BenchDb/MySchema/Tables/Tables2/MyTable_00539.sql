CREATE TABLE [MySchema].[MyTable_00539] (
    ...
    CONSTRAINT [PK_MyTable_00539] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00539_MyTable00539] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00539] ([ColKey]),
    CONSTRAINT [BK_MyTable_00539_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
