CREATE TABLE [MySchema].[MyTable_00749] (
    ...
    CONSTRAINT [PK_MyTable_00749] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00749_MyTable00749] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00749] ([ColKey]),
    CONSTRAINT [BK_MyTable_00749_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
