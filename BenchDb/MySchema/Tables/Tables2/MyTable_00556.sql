CREATE TABLE [MySchema].[MyTable_00556] (
    ...
    CONSTRAINT [PK_MyTable_00556] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00556_MyTable00556] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00556] ([ColKey]),
    CONSTRAINT [BK_MyTable_00556_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
