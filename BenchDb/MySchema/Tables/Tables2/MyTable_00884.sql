CREATE TABLE [MySchema].[MyTable_00884] (
    ...
    CONSTRAINT [PK_MyTable_00884] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00884_MyTable00884] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00884] ([ColKey]),
    CONSTRAINT [BK_MyTable_00884_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
