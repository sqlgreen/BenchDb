CREATE TABLE [MySchema].[MyTable_00560] (
    ...
    CONSTRAINT [PK_MyTable_00560] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00560_MyTable00560] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00560] ([ColKey]),
    CONSTRAINT [BK_MyTable_00560_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
