CREATE TABLE [MySchema].[MyTable_00836] (
    ...
    CONSTRAINT [PK_MyTable_00836] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00836_MyTable00836] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00836] ([ColKey]),
    CONSTRAINT [BK_MyTable_00836_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
