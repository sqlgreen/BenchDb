CREATE TABLE [MySchema].[MyTable_00599] (
    ...
    CONSTRAINT [PK_MyTable_00599] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00599_MyTable00599] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00599] ([ColKey]),
    CONSTRAINT [BK_MyTable_00599_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
