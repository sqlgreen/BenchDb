CREATE TABLE [MySchema].[MyTable_00699] (
    ...
    CONSTRAINT [PK_MyTable_00699] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00699_MyTable00699] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00699] ([ColKey]),
    CONSTRAINT [BK_MyTable_00699_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
