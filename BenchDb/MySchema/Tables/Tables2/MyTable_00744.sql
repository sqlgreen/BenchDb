CREATE TABLE [MySchema].[MyTable_00744] (
    ...
    CONSTRAINT [PK_MyTable_00744] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00744_MyTable00744] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00744] ([ColKey]),
    CONSTRAINT [BK_MyTable_00744_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
