CREATE TABLE [MySchema].[MyTable_00974] (
    ...
    CONSTRAINT [PK_MyTable_00974] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00974_MyTable00974] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00974] ([ColKey]),
    CONSTRAINT [BK_MyTable_00974_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
