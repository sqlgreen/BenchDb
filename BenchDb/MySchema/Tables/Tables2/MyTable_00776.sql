CREATE TABLE [MySchema].[MyTable_00776] (
    ...
    CONSTRAINT [PK_MyTable_00776] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00776_MyTable00776] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00776] ([ColKey]),
    CONSTRAINT [BK_MyTable_00776_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
