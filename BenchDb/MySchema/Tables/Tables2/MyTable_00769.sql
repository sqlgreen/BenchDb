CREATE TABLE [MySchema].[MyTable_00769] (
    ...
    CONSTRAINT [PK_MyTable_00769] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00769_MyTable00769] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00769] ([ColKey]),
    CONSTRAINT [BK_MyTable_00769_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
