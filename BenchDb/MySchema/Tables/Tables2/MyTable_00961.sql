CREATE TABLE [MySchema].[MyTable_00961] (
    ...
    CONSTRAINT [PK_MyTable_00961] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00961_MyTable00961] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00961] ([ColKey]),
    CONSTRAINT [BK_MyTable_00961_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
