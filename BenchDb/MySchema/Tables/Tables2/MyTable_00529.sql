CREATE TABLE [MySchema].[MyTable_00529] (
    ...
    CONSTRAINT [PK_MyTable_00529] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00529_MyTable00529] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00529] ([ColKey]),
    CONSTRAINT [BK_MyTable_00529_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
