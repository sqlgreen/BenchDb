CREATE TABLE [MySchema].[MyTable_00667] (
    ...
    CONSTRAINT [PK_MyTable_00667] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00667_MyTable00667] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00667] ([ColKey]),
    CONSTRAINT [BK_MyTable_00667_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
