CREATE TABLE [MySchema].[MyTable_00773] (
    ...
    CONSTRAINT [PK_MyTable_00773] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00773_MyTable00773] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00773] ([ColKey]),
    CONSTRAINT [BK_MyTable_00773_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
