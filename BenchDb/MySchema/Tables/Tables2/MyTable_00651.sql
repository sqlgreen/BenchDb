CREATE TABLE [MySchema].[MyTable_00651] (
    ...
    CONSTRAINT [PK_MyTable_00651] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00651_MyTable00651] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00651] ([ColKey]),
    CONSTRAINT [BK_MyTable_00651_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
