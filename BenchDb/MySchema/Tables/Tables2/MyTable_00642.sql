CREATE TABLE [MySchema].[MyTable_00642] (
    ...
    CONSTRAINT [PK_MyTable_00642] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00642_MyTable00642] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00642] ([ColKey]),
    CONSTRAINT [BK_MyTable_00642_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
