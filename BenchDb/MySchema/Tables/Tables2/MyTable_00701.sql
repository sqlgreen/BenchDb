CREATE TABLE [MySchema].[MyTable_00701] (
    ...
    CONSTRAINT [PK_MyTable_00701] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00701_MyTable00701] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00701] ([ColKey]),
    CONSTRAINT [BK_MyTable_00701_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
