CREATE TABLE [MySchema].[MyTable_00632] (
    ...
    CONSTRAINT [PK_MyTable_00632] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00632_MyTable00632] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00632] ([ColKey]),
    CONSTRAINT [BK_MyTable_00632_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
