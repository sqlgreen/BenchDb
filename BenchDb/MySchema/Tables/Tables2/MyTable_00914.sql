CREATE TABLE [MySchema].[MyTable_00914] (
    ...
    CONSTRAINT [PK_MyTable_00914] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00914_MyTable00914] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00914] ([ColKey]),
    CONSTRAINT [BK_MyTable_00914_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
