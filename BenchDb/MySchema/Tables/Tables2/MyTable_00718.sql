CREATE TABLE [MySchema].[MyTable_00718] (
    ...
    CONSTRAINT [PK_MyTable_00718] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00718_MyTable00718] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00718] ([ColKey]),
    CONSTRAINT [BK_MyTable_00718_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
