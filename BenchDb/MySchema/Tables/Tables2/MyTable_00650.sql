CREATE TABLE [MySchema].[MyTable_00650] (
    ...
    CONSTRAINT [PK_MyTable_00650] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00650_MyTable00650] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00650] ([ColKey]),
    CONSTRAINT [BK_MyTable_00650_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
