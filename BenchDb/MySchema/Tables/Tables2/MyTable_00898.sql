CREATE TABLE [MySchema].[MyTable_00898] (
    ...
    CONSTRAINT [PK_MyTable_00898] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00898_MyTable00898] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00898] ([ColKey]),
    CONSTRAINT [BK_MyTable_00898_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
