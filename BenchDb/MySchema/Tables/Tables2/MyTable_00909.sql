CREATE TABLE [MySchema].[MyTable_00909] (
    ...
    CONSTRAINT [PK_MyTable_00909] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00909_MyTable00909] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00909] ([ColKey]),
    CONSTRAINT [BK_MyTable_00909_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
