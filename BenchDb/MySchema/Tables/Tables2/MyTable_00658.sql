CREATE TABLE [MySchema].[MyTable_00658] (
    ...
    CONSTRAINT [PK_MyTable_00658] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00658_MyTable00658] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00658] ([ColKey]),
    CONSTRAINT [BK_MyTable_00658_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
