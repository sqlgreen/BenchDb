CREATE TABLE [MySchema].[MyTable_00610] (
    ...
    CONSTRAINT [PK_MyTable_00610] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00610_MyTable00610] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00610] ([ColKey]),
    CONSTRAINT [BK_MyTable_00610_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
