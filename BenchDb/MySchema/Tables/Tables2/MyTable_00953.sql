CREATE TABLE [MySchema].[MyTable_00953] (
    ...
    CONSTRAINT [PK_MyTable_00953] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00953_MyTable00953] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00953] ([ColKey]),
    CONSTRAINT [BK_MyTable_00953_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
