CREATE TABLE [MySchema].[MyTable_00717] (
    ...
    CONSTRAINT [PK_MyTable_00717] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00717_MyTable00717] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00717] ([ColKey]),
    CONSTRAINT [BK_MyTable_00717_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
