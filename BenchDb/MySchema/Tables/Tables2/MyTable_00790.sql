CREATE TABLE [MySchema].[MyTable_00790] (
    ...
    CONSTRAINT [PK_MyTable_00790] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00790_MyTable00790] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00790] ([ColKey]),
    CONSTRAINT [BK_MyTable_00790_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
