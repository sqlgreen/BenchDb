CREATE TABLE [MySchema].[MyTable_00967] (
    ...
    CONSTRAINT [PK_MyTable_00967] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00967_MyTable00967] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00967] ([ColKey]),
    CONSTRAINT [BK_MyTable_00967_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
