CREATE TABLE [MySchema].[MyTable_00851] (
    ...
    CONSTRAINT [PK_MyTable_00851] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00851_MyTable00851] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00851] ([ColKey]),
    CONSTRAINT [BK_MyTable_00851_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
