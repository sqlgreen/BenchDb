CREATE TABLE [MySchema].[MyTable_00821] (
    ...
    CONSTRAINT [PK_MyTable_00821] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00821_MyTable00821] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00821] ([ColKey]),
    CONSTRAINT [BK_MyTable_00821_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
