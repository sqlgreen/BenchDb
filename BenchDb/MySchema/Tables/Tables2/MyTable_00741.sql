CREATE TABLE [MySchema].[MyTable_00741] (
    ...
    CONSTRAINT [PK_MyTable_00741] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00741_MyTable00741] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00741] ([ColKey]),
    CONSTRAINT [BK_MyTable_00741_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
