CREATE TABLE [MySchema].[MyTable_00550] (
    ...
    CONSTRAINT [PK_MyTable_00550] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00550_MyTable00550] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00550] ([ColKey]),
    CONSTRAINT [BK_MyTable_00550_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
