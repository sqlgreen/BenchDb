CREATE TABLE [MySchema].[MyTable_00828] (
    ...
    CONSTRAINT [PK_MyTable_00828] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00828_MyTable00828] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00828] ([ColKey]),
    CONSTRAINT [BK_MyTable_00828_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
