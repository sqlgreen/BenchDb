CREATE TABLE [MySchema].[MyTable_00732] (
    ...
    CONSTRAINT [PK_MyTable_00732] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00732_MyTable00732] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00732] ([ColKey]),
    CONSTRAINT [BK_MyTable_00732_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
