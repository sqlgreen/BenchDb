CREATE TABLE [MySchema].[MyTable_00976] (
    ...
    CONSTRAINT [PK_MyTable_00976] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00976_MyTable00976] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00976] ([ColKey]),
    CONSTRAINT [BK_MyTable_00976_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
