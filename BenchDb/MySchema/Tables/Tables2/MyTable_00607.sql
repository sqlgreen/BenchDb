CREATE TABLE [MySchema].[MyTable_00607] (
    ...
    CONSTRAINT [PK_MyTable_00607] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00607_MyTable00607] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00607] ([ColKey]),
    CONSTRAINT [BK_MyTable_00607_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
