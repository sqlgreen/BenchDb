CREATE TABLE [MySchema].[MyTable_00710] (
    ...
    CONSTRAINT [PK_MyTable_00710] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00710_MyTable00710] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00710] ([ColKey]),
    CONSTRAINT [BK_MyTable_00710_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
