CREATE TABLE [MySchema].[MyTable_00600] (
    ...
    CONSTRAINT [PK_MyTable_00600] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00600_MyTable00600] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00600] ([ColKey]),
    CONSTRAINT [BK_MyTable_00600_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
