CREATE TABLE [MySchema].[MyTable_00647] (
    ...
    CONSTRAINT [PK_MyTable_00647] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00647_MyTable00647] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00647] ([ColKey]),
    CONSTRAINT [BK_MyTable_00647_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
