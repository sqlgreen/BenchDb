CREATE TABLE [MySchema].[MyTable_00752] (
    ...
    CONSTRAINT [PK_MyTable_00752] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00752_MyTable00752] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00752] ([ColKey]),
    CONSTRAINT [BK_MyTable_00752_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
