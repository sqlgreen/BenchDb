CREATE TABLE [MySchema].[MyTable_00617] (
    ...
    CONSTRAINT [PK_MyTable_00617] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00617_MyTable00617] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00617] ([ColKey]),
    CONSTRAINT [BK_MyTable_00617_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
