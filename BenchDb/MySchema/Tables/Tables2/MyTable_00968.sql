CREATE TABLE [MySchema].[MyTable_00968] (
    ...
    CONSTRAINT [PK_MyTable_00968] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00968_MyTable00968] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00968] ([ColKey]),
    CONSTRAINT [BK_MyTable_00968_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
