CREATE TABLE [MySchema].[MyTable_00777] (
    ...
    CONSTRAINT [PK_MyTable_00777] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00777_MyTable00777] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00777] ([ColKey]),
    CONSTRAINT [BK_MyTable_00777_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
