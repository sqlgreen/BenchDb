CREATE TABLE [MySchema].[MyTable_00572] (
    ...
    CONSTRAINT [PK_MyTable_00572] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00572_MyTable00572] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00572] ([ColKey]),
    CONSTRAINT [BK_MyTable_00572_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
