CREATE TABLE [MySchema].[MyTable_00883] (
    ...
    CONSTRAINT [PK_MyTable_00883] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00883_MyTable00883] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00883] ([ColKey]),
    CONSTRAINT [BK_MyTable_00883_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
