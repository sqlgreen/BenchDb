CREATE TABLE [MySchema].[MyTable_00569] (
    ...
    CONSTRAINT [PK_MyTable_00569] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00569_MyTable00569] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00569] ([ColKey]),
    CONSTRAINT [BK_MyTable_00569_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
