CREATE TABLE [MySchema].[MyTable_00580] (
    ...
    CONSTRAINT [PK_MyTable_00580] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00580_MyTable00580] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00580] ([ColKey]),
    CONSTRAINT [BK_MyTable_00580_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
