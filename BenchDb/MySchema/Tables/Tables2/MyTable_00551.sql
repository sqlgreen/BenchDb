CREATE TABLE [MySchema].[MyTable_00551] (
    ...
    CONSTRAINT [PK_MyTable_00551] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00551_MyTable00551] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00551] ([ColKey]),
    CONSTRAINT [BK_MyTable_00551_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
