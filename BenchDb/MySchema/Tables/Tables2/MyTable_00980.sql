CREATE TABLE [MySchema].[MyTable_00980] (
    ...
    CONSTRAINT [PK_MyTable_00980] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00980_MyTable00980] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00980] ([ColKey]),
    CONSTRAINT [BK_MyTable_00980_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
