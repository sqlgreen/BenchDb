CREATE TABLE [MySchema].[MyTable_00637] (
    ...
    CONSTRAINT [PK_MyTable_00637] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00637_MyTable00637] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00637] ([ColKey]),
    CONSTRAINT [BK_MyTable_00637_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
