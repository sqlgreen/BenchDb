CREATE TABLE [MySchema].[MyTable_00725] (
    ...
    CONSTRAINT [PK_MyTable_00725] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00725_MyTable00725] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00725] ([ColKey]),
    CONSTRAINT [BK_MyTable_00725_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
