CREATE TABLE [MySchema].[MyTable_00628] (
    ...
    CONSTRAINT [PK_MyTable_00628] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00628_MyTable00628] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00628] ([ColKey]),
    CONSTRAINT [BK_MyTable_00628_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
