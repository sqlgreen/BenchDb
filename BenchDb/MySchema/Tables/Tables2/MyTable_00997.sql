CREATE TABLE [MySchema].[MyTable_00997] (
    ...
    CONSTRAINT [PK_MyTable_00997] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00997_MyTable00997] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00997] ([ColKey]),
    CONSTRAINT [BK_MyTable_00997_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
