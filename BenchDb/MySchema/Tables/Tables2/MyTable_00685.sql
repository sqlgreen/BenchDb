CREATE TABLE [MySchema].[MyTable_00685] (
    ...
    CONSTRAINT [PK_MyTable_00685] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00685_MyTable00685] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00685] ([ColKey]),
    CONSTRAINT [BK_MyTable_00685_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
