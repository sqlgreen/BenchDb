CREATE TABLE [MySchema].[MyTable_00835] (
    ...
    CONSTRAINT [PK_MyTable_00835] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00835_MyTable00835] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00835] ([ColKey]),
    CONSTRAINT [BK_MyTable_00835_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
