CREATE TABLE [MySchema].[MyTable_00583] (
    ...
    CONSTRAINT [PK_MyTable_00583] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00583_MyTable00583] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00583] ([ColKey]),
    CONSTRAINT [BK_MyTable_00583_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
