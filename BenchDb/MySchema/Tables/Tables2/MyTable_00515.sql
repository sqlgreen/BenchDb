CREATE TABLE [MySchema].[MyTable_00515] (
    ...
    CONSTRAINT [PK_MyTable_00515] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00515_MyTable00515] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00515] ([ColKey]),
    CONSTRAINT [BK_MyTable_00515_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
