CREATE TABLE [MySchema].[MyTable_00895] (
    ...
    CONSTRAINT [PK_MyTable_00895] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00895_MyTable00895] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00895] ([ColKey]),
    CONSTRAINT [BK_MyTable_00895_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
