CREATE TABLE [MySchema].[MyTable_00814] (
    ...
    CONSTRAINT [PK_MyTable_00814] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00814_MyTable00814] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00814] ([ColKey]),
    CONSTRAINT [BK_MyTable_00814_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
