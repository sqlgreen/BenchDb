CREATE TABLE [MySchema].[MyTable_00528] (
    ...
    CONSTRAINT [PK_MyTable_00528] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00528_MyTable00528] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00528] ([ColKey]),
    CONSTRAINT [BK_MyTable_00528_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
