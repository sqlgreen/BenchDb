CREATE TABLE [MySchema].[MyTable_00681] (
    ...
    CONSTRAINT [PK_MyTable_00681] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00681_MyTable00681] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00681] ([ColKey]),
    CONSTRAINT [BK_MyTable_00681_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
