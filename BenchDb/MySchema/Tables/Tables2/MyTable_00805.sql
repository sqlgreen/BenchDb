CREATE TABLE [MySchema].[MyTable_00805] (
    ...
    CONSTRAINT [PK_MyTable_00805] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00805_MyTable00805] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00805] ([ColKey]),
    CONSTRAINT [BK_MyTable_00805_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
