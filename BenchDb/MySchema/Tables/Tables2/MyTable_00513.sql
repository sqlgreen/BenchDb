CREATE TABLE [MySchema].[MyTable_00513] (
    ...
    CONSTRAINT [PK_MyTable_00513] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00513_MyTable00513] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00513] ([ColKey]),
    CONSTRAINT [BK_MyTable_00513_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
