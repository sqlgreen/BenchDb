CREATE TABLE [MySchema].[MyTable_00604] (
    ...
    CONSTRAINT [PK_MyTable_00604] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00604_MyTable00604] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00604] ([ColKey]),
    CONSTRAINT [BK_MyTable_00604_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
