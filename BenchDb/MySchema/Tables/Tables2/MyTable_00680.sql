CREATE TABLE [MySchema].[MyTable_00680] (
    ...
    CONSTRAINT [PK_MyTable_00680] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00680_MyTable00680] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00680] ([ColKey]),
    CONSTRAINT [BK_MyTable_00680_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
