CREATE TABLE [MySchema].[MyTable_00958] (
    ...
    CONSTRAINT [PK_MyTable_00958] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00958_MyTable00958] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00958] ([ColKey]),
    CONSTRAINT [BK_MyTable_00958_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
