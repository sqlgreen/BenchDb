CREATE TABLE [MySchema].[MyTable_00713] (
    ...
    CONSTRAINT [PK_MyTable_00713] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00713_MyTable00713] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00713] ([ColKey]),
    CONSTRAINT [BK_MyTable_00713_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
