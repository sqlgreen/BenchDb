CREATE TABLE [MySchema].[MyTable_00806] (
    ...
    CONSTRAINT [PK_MyTable_00806] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00806_MyTable00806] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00806] ([ColKey]),
    CONSTRAINT [BK_MyTable_00806_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
