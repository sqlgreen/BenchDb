CREATE TABLE [MySchema].[MyTable_00906] (
    ...
    CONSTRAINT [PK_MyTable_00906] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00906_MyTable00906] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00906] ([ColKey]),
    CONSTRAINT [BK_MyTable_00906_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
