CREATE TABLE [MySchema].[MyTable_00923] (
    ...
    CONSTRAINT [PK_MyTable_00923] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00923_MyTable00923] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00923] ([ColKey]),
    CONSTRAINT [BK_MyTable_00923_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
