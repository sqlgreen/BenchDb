CREATE TABLE [MySchema].[MyTable_00928] (
    ...
    CONSTRAINT [PK_MyTable_00928] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00928_MyTable00928] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00928] ([ColKey]),
    CONSTRAINT [BK_MyTable_00928_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
