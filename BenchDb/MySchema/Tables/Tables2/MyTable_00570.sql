CREATE TABLE [MySchema].[MyTable_00570] (
    ...
    CONSTRAINT [PK_MyTable_00570] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00570_MyTable00570] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00570] ([ColKey]),
    CONSTRAINT [BK_MyTable_00570_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
