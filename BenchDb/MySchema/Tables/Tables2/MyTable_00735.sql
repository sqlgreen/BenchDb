CREATE TABLE [MySchema].[MyTable_00735] (
    ...
    CONSTRAINT [PK_MyTable_00735] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00735_MyTable00735] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00735] ([ColKey]),
    CONSTRAINT [BK_MyTable_00735_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
