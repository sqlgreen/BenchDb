CREATE TABLE [MySchema].[MyTable_00723] (
    ...
    CONSTRAINT [PK_MyTable_00723] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00723_MyTable00723] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00723] ([ColKey]),
    CONSTRAINT [BK_MyTable_00723_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
