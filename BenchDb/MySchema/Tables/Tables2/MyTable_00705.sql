CREATE TABLE [MySchema].[MyTable_00705] (
    ...
    CONSTRAINT [PK_MyTable_00705] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00705_MyTable00705] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00705] ([ColKey]),
    CONSTRAINT [BK_MyTable_00705_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
