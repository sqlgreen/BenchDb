CREATE TABLE [MySchema].[MyTable_00715] (
    ...
    CONSTRAINT [PK_MyTable_00715] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00715_MyTable00715] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00715] ([ColKey]),
    CONSTRAINT [BK_MyTable_00715_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
