CREATE TABLE [MySchema].[MyTable_00563] (
    ...
    CONSTRAINT [PK_MyTable_00563] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00563_MyTable00563] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00563] ([ColKey]),
    CONSTRAINT [BK_MyTable_00563_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
