CREATE TABLE [MySchema].[MyTable_00540] (
    ...
    CONSTRAINT [PK_MyTable_00540] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00540_MyTable00540] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00540] ([ColKey]),
    CONSTRAINT [BK_MyTable_00540_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
