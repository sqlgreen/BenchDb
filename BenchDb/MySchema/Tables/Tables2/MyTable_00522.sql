CREATE TABLE [MySchema].[MyTable_00522] (
    ...
    CONSTRAINT [PK_MyTable_00522] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00522_MyTable00522] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00522] ([ColKey]),
    CONSTRAINT [BK_MyTable_00522_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
