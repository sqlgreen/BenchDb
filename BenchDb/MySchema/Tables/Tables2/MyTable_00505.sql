CREATE TABLE [MySchema].[MyTable_00505] (
    ...
    CONSTRAINT [PK_MyTable_00505] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00505_MyTable00505] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00505] ([ColKey]),
    CONSTRAINT [BK_MyTable_00505_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
