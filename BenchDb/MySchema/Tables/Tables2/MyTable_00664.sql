CREATE TABLE [MySchema].[MyTable_00664] (
    ...
    CONSTRAINT [PK_MyTable_00664] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00664_MyTable00664] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00664] ([ColKey]),
    CONSTRAINT [BK_MyTable_00664_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
