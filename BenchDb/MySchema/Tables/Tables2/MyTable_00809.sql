CREATE TABLE [MySchema].[MyTable_00809] (
    ...
    CONSTRAINT [PK_MyTable_00809] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00809_MyTable00809] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00809] ([ColKey]),
    CONSTRAINT [BK_MyTable_00809_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
