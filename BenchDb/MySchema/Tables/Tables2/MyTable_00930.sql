CREATE TABLE [MySchema].[MyTable_00930] (
    ...
    CONSTRAINT [PK_MyTable_00930] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00930_MyTable00930] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00930] ([ColKey]),
    CONSTRAINT [BK_MyTable_00930_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
