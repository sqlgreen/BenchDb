CREATE TABLE [MySchema].[MyTable_00920] (
    ...
    CONSTRAINT [PK_MyTable_00920] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00920_MyTable00920] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00920] ([ColKey]),
    CONSTRAINT [BK_MyTable_00920_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
