CREATE TABLE [MySchema].[MyTable_00695] (
    ...
    CONSTRAINT [PK_MyTable_00695] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00695_MyTable00695] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00695] ([ColKey]),
    CONSTRAINT [BK_MyTable_00695_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
