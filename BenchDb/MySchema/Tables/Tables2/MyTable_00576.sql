CREATE TABLE [MySchema].[MyTable_00576] (
    ...
    CONSTRAINT [PK_MyTable_00576] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00576_MyTable00576] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00576] ([ColKey]),
    CONSTRAINT [BK_MyTable_00576_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
