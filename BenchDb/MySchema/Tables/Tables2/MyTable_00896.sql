CREATE TABLE [MySchema].[MyTable_00896] (
    ...
    CONSTRAINT [PK_MyTable_00896] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00896_MyTable00896] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00896] ([ColKey]),
    CONSTRAINT [BK_MyTable_00896_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
