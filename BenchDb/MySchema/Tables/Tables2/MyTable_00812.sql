CREATE TABLE [MySchema].[MyTable_00812] (
    ...
    CONSTRAINT [PK_MyTable_00812] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00812_MyTable00812] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00812] ([ColKey]),
    CONSTRAINT [BK_MyTable_00812_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
