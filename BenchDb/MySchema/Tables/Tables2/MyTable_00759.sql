CREATE TABLE [MySchema].[MyTable_00759] (
    ...
    CONSTRAINT [PK_MyTable_00759] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00759_MyTable00759] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00759] ([ColKey]),
    CONSTRAINT [BK_MyTable_00759_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
