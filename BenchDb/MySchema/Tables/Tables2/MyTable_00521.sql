CREATE TABLE [MySchema].[MyTable_00521] (
    ...
    CONSTRAINT [PK_MyTable_00521] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00521_MyTable00521] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00521] ([ColKey]),
    CONSTRAINT [BK_MyTable_00521_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
