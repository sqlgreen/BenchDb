CREATE TABLE [MySchema].[MyTable_00652] (
    ...
    CONSTRAINT [PK_MyTable_00652] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00652_MyTable00652] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00652] ([ColKey]),
    CONSTRAINT [BK_MyTable_00652_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
