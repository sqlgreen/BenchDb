CREATE TABLE [MySchema].[MyTable_00747] (
    ...
    CONSTRAINT [PK_MyTable_00747] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00747_MyTable00747] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00747] ([ColKey]),
    CONSTRAINT [BK_MyTable_00747_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
