CREATE TABLE [MySchema].[MyTable_00919] (
    ...
    CONSTRAINT [PK_MyTable_00919] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00919_MyTable00919] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00919] ([ColKey]),
    CONSTRAINT [BK_MyTable_00919_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
