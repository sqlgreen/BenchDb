CREATE TABLE [MySchema].[MyTable_00586] (
    ...
    CONSTRAINT [PK_MyTable_00586] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00586_MyTable00586] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00586] ([ColKey]),
    CONSTRAINT [BK_MyTable_00586_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
