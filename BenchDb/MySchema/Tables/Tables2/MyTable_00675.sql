CREATE TABLE [MySchema].[MyTable_00675] (
    ...
    CONSTRAINT [PK_MyTable_00675] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00675_MyTable00675] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00675] ([ColKey]),
    CONSTRAINT [BK_MyTable_00675_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
