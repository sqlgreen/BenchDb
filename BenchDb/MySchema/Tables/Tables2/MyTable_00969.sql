CREATE TABLE [MySchema].[MyTable_00969] (
    ...
    CONSTRAINT [PK_MyTable_00969] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00969_MyTable00969] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00969] ([ColKey]),
    CONSTRAINT [BK_MyTable_00969_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
