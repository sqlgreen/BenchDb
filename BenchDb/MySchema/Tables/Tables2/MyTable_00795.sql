CREATE TABLE [MySchema].[MyTable_00795] (
    ...
    CONSTRAINT [PK_MyTable_00795] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00795_MyTable00795] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00795] ([ColKey]),
    CONSTRAINT [BK_MyTable_00795_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
