CREATE TABLE [MySchema].[MyTable_00839] (
    ...
    CONSTRAINT [PK_MyTable_00839] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00839_MyTable00839] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00839] ([ColKey]),
    CONSTRAINT [BK_MyTable_00839_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
