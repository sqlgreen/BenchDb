CREATE TABLE [MySchema].[MyTable_00591] (
    ...
    CONSTRAINT [PK_MyTable_00591] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00591_MyTable00591] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00591] ([ColKey]),
    CONSTRAINT [BK_MyTable_00591_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
