CREATE TABLE [MySchema].[MyTable_00712] (
    ...
    CONSTRAINT [PK_MyTable_00712] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00712_MyTable00712] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00712] ([ColKey]),
    CONSTRAINT [BK_MyTable_00712_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
