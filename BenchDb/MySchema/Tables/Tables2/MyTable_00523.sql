CREATE TABLE [MySchema].[MyTable_00523] (
    ...
    CONSTRAINT [PK_MyTable_00523] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00523_MyTable00523] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00523] ([ColKey]),
    CONSTRAINT [BK_MyTable_00523_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
