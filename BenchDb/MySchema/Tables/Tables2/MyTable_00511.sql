CREATE TABLE [MySchema].[MyTable_00511] (
    ...
    CONSTRAINT [PK_MyTable_00511] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00511_MyTable00511] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00511] ([ColKey]),
    CONSTRAINT [BK_MyTable_00511_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
