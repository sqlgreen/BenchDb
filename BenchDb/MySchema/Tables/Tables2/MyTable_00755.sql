CREATE TABLE [MySchema].[MyTable_00755] (
    ...
    CONSTRAINT [PK_MyTable_00755] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00755_MyTable00755] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00755] ([ColKey]),
    CONSTRAINT [BK_MyTable_00755_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
