CREATE TABLE [MySchema].[MyTable_00770] (
    ...
    CONSTRAINT [PK_MyTable_00770] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00770_MyTable00770] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00770] ([ColKey]),
    CONSTRAINT [BK_MyTable_00770_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
