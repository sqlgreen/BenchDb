CREATE TABLE [MySchema].[MyTable_00757] (
    ...
    CONSTRAINT [PK_MyTable_00757] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00757_MyTable00757] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00757] ([ColKey]),
    CONSTRAINT [BK_MyTable_00757_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
