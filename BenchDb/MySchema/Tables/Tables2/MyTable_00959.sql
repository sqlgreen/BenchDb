CREATE TABLE [MySchema].[MyTable_00959] (
    ...
    CONSTRAINT [PK_MyTable_00959] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00959_MyTable00959] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00959] ([ColKey]),
    CONSTRAINT [BK_MyTable_00959_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
