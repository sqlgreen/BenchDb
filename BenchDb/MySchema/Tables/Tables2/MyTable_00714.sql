CREATE TABLE [MySchema].[MyTable_00714] (
    ...
    CONSTRAINT [PK_MyTable_00714] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00714_MyTable00714] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00714] ([ColKey]),
    CONSTRAINT [BK_MyTable_00714_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
