CREATE TABLE [MySchema].[MyTable_00848] (
    ...
    CONSTRAINT [PK_MyTable_00848] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00848_MyTable00848] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00848] ([ColKey]),
    CONSTRAINT [BK_MyTable_00848_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
