CREATE TABLE [MySchema].[MyTable_00541] (
    ...
    CONSTRAINT [PK_MyTable_00541] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00541_MyTable00541] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00541] ([ColKey]),
    CONSTRAINT [BK_MyTable_00541_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
