CREATE TABLE [MySchema].[MyTable_00615] (
    ...
    CONSTRAINT [PK_MyTable_00615] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00615_MyTable00615] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00615] ([ColKey]),
    CONSTRAINT [BK_MyTable_00615_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
