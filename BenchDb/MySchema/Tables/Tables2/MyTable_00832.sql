CREATE TABLE [MySchema].[MyTable_00832] (
    ...
    CONSTRAINT [PK_MyTable_00832] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00832_MyTable00832] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00832] ([ColKey]),
    CONSTRAINT [BK_MyTable_00832_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
