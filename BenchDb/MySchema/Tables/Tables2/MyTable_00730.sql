CREATE TABLE [MySchema].[MyTable_00730] (
    ...
    CONSTRAINT [PK_MyTable_00730] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00730_MyTable00730] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00730] ([ColKey]),
    CONSTRAINT [BK_MyTable_00730_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
