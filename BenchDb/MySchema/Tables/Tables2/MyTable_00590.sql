CREATE TABLE [MySchema].[MyTable_00590] (
    ...
    CONSTRAINT [PK_MyTable_00590] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00590_MyTable00590] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00590] ([ColKey]),
    CONSTRAINT [BK_MyTable_00590_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
