CREATE TABLE [MySchema].[MyTable_00670] (
    ...
    CONSTRAINT [PK_MyTable_00670] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00670_MyTable00670] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00670] ([ColKey]),
    CONSTRAINT [BK_MyTable_00670_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
