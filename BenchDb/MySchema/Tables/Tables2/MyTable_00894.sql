CREATE TABLE [MySchema].[MyTable_00894] (
    ...
    CONSTRAINT [PK_MyTable_00894] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00894_MyTable00894] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00894] ([ColKey]),
    CONSTRAINT [BK_MyTable_00894_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
