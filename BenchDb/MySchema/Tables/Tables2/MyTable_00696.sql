CREATE TABLE [MySchema].[MyTable_00696] (
    ...
    CONSTRAINT [PK_MyTable_00696] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00696_MyTable00696] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00696] ([ColKey]),
    CONSTRAINT [BK_MyTable_00696_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
