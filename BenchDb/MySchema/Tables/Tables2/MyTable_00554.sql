CREATE TABLE [MySchema].[MyTable_00554] (
    ...
    CONSTRAINT [PK_MyTable_00554] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00554_MyTable00554] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00554] ([ColKey]),
    CONSTRAINT [BK_MyTable_00554_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
