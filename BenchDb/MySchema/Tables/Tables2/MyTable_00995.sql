CREATE TABLE [MySchema].[MyTable_00995] (
    ...
    CONSTRAINT [PK_MyTable_00995] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00995_MyTable00995] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00995] ([ColKey]),
    CONSTRAINT [BK_MyTable_00995_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
