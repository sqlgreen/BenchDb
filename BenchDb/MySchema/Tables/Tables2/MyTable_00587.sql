CREATE TABLE [MySchema].[MyTable_00587] (
    ...
    CONSTRAINT [PK_MyTable_00587] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00587_MyTable00587] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00587] ([ColKey]),
    CONSTRAINT [BK_MyTable_00587_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
