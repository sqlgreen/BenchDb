CREATE TABLE [MySchema].[MyTable_00700] (
    ...
    CONSTRAINT [PK_MyTable_00700] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00700_MyTable00700] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00700] ([ColKey]),
    CONSTRAINT [BK_MyTable_00700_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
