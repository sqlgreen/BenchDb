CREATE TABLE [MySchema].[MyTable_00669] (
    ...
    CONSTRAINT [PK_MyTable_00669] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00669_MyTable00669] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00669] ([ColKey]),
    CONSTRAINT [BK_MyTable_00669_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
