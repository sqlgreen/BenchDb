CREATE TABLE [MySchema].[MyTable_00603] (
    ...
    CONSTRAINT [PK_MyTable_00603] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00603_MyTable00603] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00603] ([ColKey]),
    CONSTRAINT [BK_MyTable_00603_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
