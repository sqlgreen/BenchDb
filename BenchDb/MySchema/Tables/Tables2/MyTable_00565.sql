CREATE TABLE [MySchema].[MyTable_00565] (
    ...
    CONSTRAINT [PK_MyTable_00565] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00565_MyTable00565] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00565] ([ColKey]),
    CONSTRAINT [BK_MyTable_00565_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
