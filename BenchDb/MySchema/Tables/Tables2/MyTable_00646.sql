CREATE TABLE [MySchema].[MyTable_00646] (
    ...
    CONSTRAINT [PK_MyTable_00646] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00646_MyTable00646] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00646] ([ColKey]),
    CONSTRAINT [BK_MyTable_00646_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
