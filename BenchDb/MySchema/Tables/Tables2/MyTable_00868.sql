CREATE TABLE [MySchema].[MyTable_00868] (
    ...
    CONSTRAINT [PK_MyTable_00868] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00868_MyTable00868] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00868] ([ColKey]),
    CONSTRAINT [BK_MyTable_00868_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
