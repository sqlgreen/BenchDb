CREATE TABLE [MySchema].[MyTable_00592] (
    ...
    CONSTRAINT [PK_MyTable_00592] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00592_MyTable00592] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00592] ([ColKey]),
    CONSTRAINT [BK_MyTable_00592_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
