CREATE TABLE [MySchema].[MyTable_00623] (
    ...
    CONSTRAINT [PK_MyTable_00623] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00623_MyTable00623] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00623] ([ColKey]),
    CONSTRAINT [BK_MyTable_00623_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
