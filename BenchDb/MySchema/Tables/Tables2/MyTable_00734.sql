CREATE TABLE [MySchema].[MyTable_00734] (
    ...
    CONSTRAINT [PK_MyTable_00734] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00734_MyTable00734] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00734] ([ColKey]),
    CONSTRAINT [BK_MyTable_00734_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
