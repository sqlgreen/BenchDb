CREATE TABLE [MySchema].[MyTable_00643] (
    ...
    CONSTRAINT [PK_MyTable_00643] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00643_MyTable00643] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00643] ([ColKey]),
    CONSTRAINT [BK_MyTable_00643_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
