CREATE TABLE [MySchema].[MyTable_00745] (
    ...
    CONSTRAINT [PK_MyTable_00745] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00745_MyTable00745] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00745] ([ColKey]),
    CONSTRAINT [BK_MyTable_00745_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
