CREATE TABLE [MySchema].[MyTable_00546] (
    ...
    CONSTRAINT [PK_MyTable_00546] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00546_MyTable00546] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00546] ([ColKey]),
    CONSTRAINT [BK_MyTable_00546_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
