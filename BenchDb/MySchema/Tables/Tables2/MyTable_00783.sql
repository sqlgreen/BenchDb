CREATE TABLE [MySchema].[MyTable_00783] (
    ...
    CONSTRAINT [PK_MyTable_00783] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00783_MyTable00783] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00783] ([ColKey]),
    CONSTRAINT [BK_MyTable_00783_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
