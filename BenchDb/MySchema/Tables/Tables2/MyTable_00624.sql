CREATE TABLE [MySchema].[MyTable_00624] (
    ...
    CONSTRAINT [PK_MyTable_00624] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00624_MyTable00624] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00624] ([ColKey]),
    CONSTRAINT [BK_MyTable_00624_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
