CREATE TABLE [MySchema].[MyTable_00984] (
    ...
    CONSTRAINT [PK_MyTable_00984] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00984_MyTable00984] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00984] ([ColKey]),
    CONSTRAINT [BK_MyTable_00984_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
