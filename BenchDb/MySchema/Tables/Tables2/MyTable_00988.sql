CREATE TABLE [MySchema].[MyTable_00988] (
    ...
    CONSTRAINT [PK_MyTable_00988] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00988_MyTable00988] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00988] ([ColKey]),
    CONSTRAINT [BK_MyTable_00988_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
