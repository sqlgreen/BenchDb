CREATE TABLE [MySchema].[MyTable_00500] (
    ...
    CONSTRAINT [PK_MyTable_00500] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00500_MyTable00500] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00500] ([ColKey]),
    CONSTRAINT [BK_MyTable_00500_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
