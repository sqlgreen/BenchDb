CREATE TABLE [MySchema].[MyTable_00838] (
    ...
    CONSTRAINT [PK_MyTable_00838] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00838_MyTable00838] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00838] ([ColKey]),
    CONSTRAINT [BK_MyTable_00838_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
