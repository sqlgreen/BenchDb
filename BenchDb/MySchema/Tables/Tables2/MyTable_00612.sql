CREATE TABLE [MySchema].[MyTable_00612] (
    ...
    CONSTRAINT [PK_MyTable_00612] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00612_MyTable00612] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00612] ([ColKey]),
    CONSTRAINT [BK_MyTable_00612_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
