CREATE TABLE [MySchema].[MyTable_00721] (
    ...
    CONSTRAINT [PK_MyTable_00721] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00721_MyTable00721] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00721] ([ColKey]),
    CONSTRAINT [BK_MyTable_00721_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
