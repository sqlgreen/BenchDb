CREATE TABLE [MySchema].[MyTable_00971] (
    ...
    CONSTRAINT [PK_MyTable_00971] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00971_MyTable00971] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00971] ([ColKey]),
    CONSTRAINT [BK_MyTable_00971_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
