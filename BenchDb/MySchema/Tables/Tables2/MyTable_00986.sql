CREATE TABLE [MySchema].[MyTable_00986] (
    ...
    CONSTRAINT [PK_MyTable_00986] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00986_MyTable00986] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00986] ([ColKey]),
    CONSTRAINT [BK_MyTable_00986_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
