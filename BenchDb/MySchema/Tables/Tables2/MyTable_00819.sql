CREATE TABLE [MySchema].[MyTable_00819] (
    ...
    CONSTRAINT [PK_MyTable_00819] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00819_MyTable00819] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00819] ([ColKey]),
    CONSTRAINT [BK_MyTable_00819_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
