CREATE TABLE [MySchema].[MyTable_00616] (
    ...
    CONSTRAINT [PK_MyTable_00616] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00616_MyTable00616] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00616] ([ColKey]),
    CONSTRAINT [BK_MyTable_00616_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
