CREATE TABLE [MySchema].[MyTable_00949] (
    ...
    CONSTRAINT [PK_MyTable_00949] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00949_MyTable00949] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00949] ([ColKey]),
    CONSTRAINT [BK_MyTable_00949_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
