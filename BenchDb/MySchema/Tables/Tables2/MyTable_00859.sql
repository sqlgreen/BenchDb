CREATE TABLE [MySchema].[MyTable_00859] (
    ...
    CONSTRAINT [PK_MyTable_00859] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00859_MyTable00859] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00859] ([ColKey]),
    CONSTRAINT [BK_MyTable_00859_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
