CREATE TABLE [MySchema].[MyTable_00527] (
    ...
    CONSTRAINT [PK_MyTable_00527] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00527_MyTable00527] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00527] ([ColKey]),
    CONSTRAINT [BK_MyTable_00527_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
