CREATE TABLE [MySchema].[MyTable_00748] (
    ...
    CONSTRAINT [PK_MyTable_00748] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00748_MyTable00748] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00748] ([ColKey]),
    CONSTRAINT [BK_MyTable_00748_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
