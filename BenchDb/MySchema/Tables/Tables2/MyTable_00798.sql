CREATE TABLE [MySchema].[MyTable_00798] (
    ...
    CONSTRAINT [PK_MyTable_00798] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00798_MyTable00798] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00798] ([ColKey]),
    CONSTRAINT [BK_MyTable_00798_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
