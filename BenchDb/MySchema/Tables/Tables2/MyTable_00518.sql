CREATE TABLE [MySchema].[MyTable_00518] (
    ...
    CONSTRAINT [PK_MyTable_00518] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00518_MyTable00518] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00518] ([ColKey]),
    CONSTRAINT [BK_MyTable_00518_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
