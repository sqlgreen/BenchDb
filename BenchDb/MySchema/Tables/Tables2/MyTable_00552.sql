CREATE TABLE [MySchema].[MyTable_00552] (
    ...
    CONSTRAINT [PK_MyTable_00552] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00552_MyTable00552] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00552] ([ColKey]),
    CONSTRAINT [BK_MyTable_00552_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
