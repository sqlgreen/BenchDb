CREATE TABLE [MySchema].[MyTable_00834] (
    ...
    CONSTRAINT [PK_MyTable_00834] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00834_MyTable00834] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00834] ([ColKey]),
    CONSTRAINT [BK_MyTable_00834_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
