CREATE TABLE [MySchema].[MyTable_00973] (
    ...
    CONSTRAINT [PK_MyTable_00973] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00973_MyTable00973] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00973] ([ColKey]),
    CONSTRAINT [BK_MyTable_00973_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
