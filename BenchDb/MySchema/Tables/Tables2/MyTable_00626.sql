CREATE TABLE [MySchema].[MyTable_00626] (
    ...
    CONSTRAINT [PK_MyTable_00626] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00626_MyTable00626] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00626] ([ColKey]),
    CONSTRAINT [BK_MyTable_00626_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
