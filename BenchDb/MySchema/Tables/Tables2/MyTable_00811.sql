CREATE TABLE [MySchema].[MyTable_00811] (
    ...
    CONSTRAINT [PK_MyTable_00811] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00811_MyTable00811] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00811] ([ColKey]),
    CONSTRAINT [BK_MyTable_00811_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
