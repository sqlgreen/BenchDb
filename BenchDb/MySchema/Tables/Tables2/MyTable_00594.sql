CREATE TABLE [MySchema].[MyTable_00594] (
    ...
    CONSTRAINT [PK_MyTable_00594] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00594_MyTable00594] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00594] ([ColKey]),
    CONSTRAINT [BK_MyTable_00594_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
