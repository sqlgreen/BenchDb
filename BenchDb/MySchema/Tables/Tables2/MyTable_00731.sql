CREATE TABLE [MySchema].[MyTable_00731] (
    ...
    CONSTRAINT [PK_MyTable_00731] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00731_MyTable00731] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00731] ([ColKey]),
    CONSTRAINT [BK_MyTable_00731_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
