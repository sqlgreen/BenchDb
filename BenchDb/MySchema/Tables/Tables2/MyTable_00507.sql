CREATE TABLE [MySchema].[MyTable_00507] (
    ...
    CONSTRAINT [PK_MyTable_00507] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00507_MyTable00507] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00507] ([ColKey]),
    CONSTRAINT [BK_MyTable_00507_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
