CREATE TABLE [MySchema].[MyTable_00676] (
    ...
    CONSTRAINT [PK_MyTable_00676] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00676_MyTable00676] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00676] ([ColKey]),
    CONSTRAINT [BK_MyTable_00676_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
