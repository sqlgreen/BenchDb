CREATE TABLE [MySchema].[MyTable_00740] (
    ...
    CONSTRAINT [PK_MyTable_00740] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00740_MyTable00740] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00740] ([ColKey]),
    CONSTRAINT [BK_MyTable_00740_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
