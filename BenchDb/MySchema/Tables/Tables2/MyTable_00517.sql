CREATE TABLE [MySchema].[MyTable_00517] (
    ...
    CONSTRAINT [PK_MyTable_00517] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00517_MyTable00517] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00517] ([ColKey]),
    CONSTRAINT [BK_MyTable_00517_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
