CREATE TABLE [MySchema].[MyTable_00557] (
    ...
    CONSTRAINT [PK_MyTable_00557] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00557_MyTable00557] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00557] ([ColKey]),
    CONSTRAINT [BK_MyTable_00557_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
