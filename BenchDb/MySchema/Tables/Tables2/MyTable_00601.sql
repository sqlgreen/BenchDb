CREATE TABLE [MySchema].[MyTable_00601] (
    ...
    CONSTRAINT [PK_MyTable_00601] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00601_MyTable00601] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00601] ([ColKey]),
    CONSTRAINT [BK_MyTable_00601_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
