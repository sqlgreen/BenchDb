CREATE TABLE [MySchema].[MyTable_00779] (
    ...
    CONSTRAINT [PK_MyTable_00779] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00779_MyTable00779] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00779] ([ColKey]),
    CONSTRAINT [BK_MyTable_00779_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
