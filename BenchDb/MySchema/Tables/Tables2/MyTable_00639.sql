CREATE TABLE [MySchema].[MyTable_00639] (
    ...
    CONSTRAINT [PK_MyTable_00639] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00639_MyTable00639] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00639] ([ColKey]),
    CONSTRAINT [BK_MyTable_00639_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
