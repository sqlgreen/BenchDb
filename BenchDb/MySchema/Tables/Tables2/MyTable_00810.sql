CREATE TABLE [MySchema].[MyTable_00810] (
    ...
    CONSTRAINT [PK_MyTable_00810] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00810_MyTable00810] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00810] ([ColKey]),
    CONSTRAINT [BK_MyTable_00810_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
