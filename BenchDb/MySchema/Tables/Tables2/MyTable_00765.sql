CREATE TABLE [MySchema].[MyTable_00765] (
    ...
    CONSTRAINT [PK_MyTable_00765] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00765_MyTable00765] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00765] ([ColKey]),
    CONSTRAINT [BK_MyTable_00765_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
