CREATE TABLE [MySchema].[MyTable_00892] (
    ...
    CONSTRAINT [PK_MyTable_00892] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00892_MyTable00892] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00892] ([ColKey]),
    CONSTRAINT [BK_MyTable_00892_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
