CREATE TABLE [MySchema].[MyTable_00947] (
    ...
    CONSTRAINT [PK_MyTable_00947] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00947_MyTable00947] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00947] ([ColKey]),
    CONSTRAINT [BK_MyTable_00947_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
