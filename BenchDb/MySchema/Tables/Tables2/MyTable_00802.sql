CREATE TABLE [MySchema].[MyTable_00802] (
    ...
    CONSTRAINT [PK_MyTable_00802] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00802_MyTable00802] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00802] ([ColKey]),
    CONSTRAINT [BK_MyTable_00802_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
