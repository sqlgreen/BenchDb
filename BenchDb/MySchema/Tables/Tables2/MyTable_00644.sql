CREATE TABLE [MySchema].[MyTable_00644] (
    ...
    CONSTRAINT [PK_MyTable_00644] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00644_MyTable00644] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00644] ([ColKey]),
    CONSTRAINT [BK_MyTable_00644_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
