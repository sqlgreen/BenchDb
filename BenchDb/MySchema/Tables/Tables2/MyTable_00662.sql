CREATE TABLE [MySchema].[MyTable_00662] (
    ...
    CONSTRAINT [PK_MyTable_00662] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00662_MyTable00662] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00662] ([ColKey]),
    CONSTRAINT [BK_MyTable_00662_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
