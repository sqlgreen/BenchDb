CREATE TABLE [MySchema].[MyTable_00983] (
    ...
    CONSTRAINT [PK_MyTable_00983] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00983_MyTable00983] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00983] ([ColKey]),
    CONSTRAINT [BK_MyTable_00983_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
