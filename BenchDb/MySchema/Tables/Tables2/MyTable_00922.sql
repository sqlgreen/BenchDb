CREATE TABLE [MySchema].[MyTable_00922] (
    ...
    CONSTRAINT [PK_MyTable_00922] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00922_MyTable00922] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00922] ([ColKey]),
    CONSTRAINT [BK_MyTable_00922_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
