CREATE TABLE [MySchema].[MyTable_00926] (
    ...
    CONSTRAINT [PK_MyTable_00926] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00926_MyTable00926] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00926] ([ColKey]),
    CONSTRAINT [BK_MyTable_00926_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
