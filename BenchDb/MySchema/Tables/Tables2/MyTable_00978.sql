CREATE TABLE [MySchema].[MyTable_00978] (
    ...
    CONSTRAINT [PK_MyTable_00978] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00978_MyTable00978] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00978] ([ColKey]),
    CONSTRAINT [BK_MyTable_00978_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
