CREATE TABLE [MySchema].[MyTable_00692] (
    ...
    CONSTRAINT [PK_MyTable_00692] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00692_MyTable00692] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00692] ([ColKey]),
    CONSTRAINT [BK_MyTable_00692_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
