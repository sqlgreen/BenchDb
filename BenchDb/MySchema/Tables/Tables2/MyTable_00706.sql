CREATE TABLE [MySchema].[MyTable_00706] (
    ...
    CONSTRAINT [PK_MyTable_00706] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00706_MyTable00706] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00706] ([ColKey]),
    CONSTRAINT [BK_MyTable_00706_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
