CREATE TABLE [MySchema].[MyTable_00510] (
    ...
    CONSTRAINT [PK_MyTable_00510] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00510_MyTable00510] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00510] ([ColKey]),
    CONSTRAINT [BK_MyTable_00510_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
