CREATE TABLE [MySchema].[MyTable_00746] (
    ...
    CONSTRAINT [PK_MyTable_00746] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00746_MyTable00746] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00746] ([ColKey]),
    CONSTRAINT [BK_MyTable_00746_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
