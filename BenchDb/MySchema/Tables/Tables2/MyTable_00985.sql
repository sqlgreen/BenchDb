CREATE TABLE [MySchema].[MyTable_00985] (
    ...
    CONSTRAINT [PK_MyTable_00985] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00985_MyTable00985] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00985] ([ColKey]),
    CONSTRAINT [BK_MyTable_00985_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
