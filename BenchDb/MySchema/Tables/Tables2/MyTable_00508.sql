CREATE TABLE [MySchema].[MyTable_00508] (
    ...
    CONSTRAINT [PK_MyTable_00508] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00508_MyTable00508] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00508] ([ColKey]),
    CONSTRAINT [BK_MyTable_00508_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
