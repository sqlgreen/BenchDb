CREATE TABLE [MySchema].[MyTable_00780] (
    ...
    CONSTRAINT [PK_MyTable_00780] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00780_MyTable00780] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00780] ([ColKey]),
    CONSTRAINT [BK_MyTable_00780_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
