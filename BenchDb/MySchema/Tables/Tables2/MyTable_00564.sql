CREATE TABLE [MySchema].[MyTable_00564] (
    ...
    CONSTRAINT [PK_MyTable_00564] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00564_MyTable00564] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00564] ([ColKey]),
    CONSTRAINT [BK_MyTable_00564_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
