CREATE TABLE [MySchema].[MyTable_00849] (
    ...
    CONSTRAINT [PK_MyTable_00849] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00849_MyTable00849] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00849] ([ColKey]),
    CONSTRAINT [BK_MyTable_00849_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
