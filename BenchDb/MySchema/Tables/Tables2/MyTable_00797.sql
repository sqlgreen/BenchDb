CREATE TABLE [MySchema].[MyTable_00797] (
    ...
    CONSTRAINT [PK_MyTable_00797] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00797_MyTable00797] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00797] ([ColKey]),
    CONSTRAINT [BK_MyTable_00797_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
