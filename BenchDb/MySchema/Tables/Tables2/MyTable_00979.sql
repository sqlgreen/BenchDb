CREATE TABLE [MySchema].[MyTable_00979] (
    ...
    CONSTRAINT [PK_MyTable_00979] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00979_MyTable00979] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00979] ([ColKey]),
    CONSTRAINT [BK_MyTable_00979_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
