CREATE TABLE [MySchema].[MyTable_00525] (
    ...
    CONSTRAINT [PK_MyTable_00525] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00525_MyTable00525] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00525] ([ColKey]),
    CONSTRAINT [BK_MyTable_00525_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
