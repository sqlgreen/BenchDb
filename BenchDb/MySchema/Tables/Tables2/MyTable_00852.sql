CREATE TABLE [MySchema].[MyTable_00852] (
    ...
    CONSTRAINT [PK_MyTable_00852] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00852_MyTable00852] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00852] ([ColKey]),
    CONSTRAINT [BK_MyTable_00852_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
