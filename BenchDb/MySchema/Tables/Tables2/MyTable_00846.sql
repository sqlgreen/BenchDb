CREATE TABLE [MySchema].[MyTable_00846] (
    ...
    CONSTRAINT [PK_MyTable_00846] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00846_MyTable00846] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00846] ([ColKey]),
    CONSTRAINT [BK_MyTable_00846_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
