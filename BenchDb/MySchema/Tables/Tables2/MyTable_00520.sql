CREATE TABLE [MySchema].[MyTable_00520] (
    ...
    CONSTRAINT [PK_MyTable_00520] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00520_MyTable00520] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00520] ([ColKey]),
    CONSTRAINT [BK_MyTable_00520_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
