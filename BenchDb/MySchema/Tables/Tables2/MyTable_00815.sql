CREATE TABLE [MySchema].[MyTable_00815] (
    ...
    CONSTRAINT [PK_MyTable_00815] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00815_MyTable00815] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00815] ([ColKey]),
    CONSTRAINT [BK_MyTable_00815_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
