CREATE TABLE [MySchema].[MyTable_00722] (
    ...
    CONSTRAINT [PK_MyTable_00722] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00722_MyTable00722] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00722] ([ColKey]),
    CONSTRAINT [BK_MyTable_00722_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
