CREATE TABLE [MySchema].[MyTable_00660] (
    ...
    CONSTRAINT [PK_MyTable_00660] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00660_MyTable00660] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00660] ([ColKey]),
    CONSTRAINT [BK_MyTable_00660_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
