CREATE TABLE [MySchema].[MyTable_00659] (
    ...
    CONSTRAINT [PK_MyTable_00659] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00659_MyTable00659] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00659] ([ColKey]),
    CONSTRAINT [BK_MyTable_00659_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
