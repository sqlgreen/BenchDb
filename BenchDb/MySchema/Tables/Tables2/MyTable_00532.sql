CREATE TABLE [MySchema].[MyTable_00532] (
    ...
    CONSTRAINT [PK_MyTable_00532] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00532_MyTable00532] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00532] ([ColKey]),
    CONSTRAINT [BK_MyTable_00532_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
