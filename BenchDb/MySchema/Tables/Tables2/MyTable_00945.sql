CREATE TABLE [MySchema].[MyTable_00945] (
    ...
    CONSTRAINT [PK_MyTable_00945] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00945_MyTable00945] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00945] ([ColKey]),
    CONSTRAINT [BK_MyTable_00945_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
