CREATE TABLE [MySchema].[MyTable_00697] (
    ...
    CONSTRAINT [PK_MyTable_00697] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00697_MyTable00697] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00697] ([ColKey]),
    CONSTRAINT [BK_MyTable_00697_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
