CREATE TABLE [MySchema].[MyTable_00559] (
    ...
    CONSTRAINT [PK_MyTable_00559] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00559_MyTable00559] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00559] ([ColKey]),
    CONSTRAINT [BK_MyTable_00559_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
