CREATE TABLE [MySchema].[MyTable_00939] (
    ...
    CONSTRAINT [PK_MyTable_00939] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00939_MyTable00939] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00939] ([ColKey]),
    CONSTRAINT [BK_MyTable_00939_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
