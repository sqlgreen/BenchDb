CREATE TABLE [MySchema].[MyTable_00823] (
    ...
    CONSTRAINT [PK_MyTable_00823] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00823_MyTable00823] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00823] ([ColKey]),
    CONSTRAINT [BK_MyTable_00823_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
