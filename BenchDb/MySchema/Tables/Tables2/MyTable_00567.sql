CREATE TABLE [MySchema].[MyTable_00567] (
    ...
    CONSTRAINT [PK_MyTable_00567] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00567_MyTable00567] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00567] ([ColKey]),
    CONSTRAINT [BK_MyTable_00567_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
