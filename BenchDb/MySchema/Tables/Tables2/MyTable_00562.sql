CREATE TABLE [MySchema].[MyTable_00562] (
    ...
    CONSTRAINT [PK_MyTable_00562] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00562_MyTable00562] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00562] ([ColKey]),
    CONSTRAINT [BK_MyTable_00562_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
