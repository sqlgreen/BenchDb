CREATE TABLE [MySchema].[MyTable_00845] (
    ...
    CONSTRAINT [PK_MyTable_00845] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00845_MyTable00845] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00845] ([ColKey]),
    CONSTRAINT [BK_MyTable_00845_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
