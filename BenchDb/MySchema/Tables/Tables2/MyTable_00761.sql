CREATE TABLE [MySchema].[MyTable_00761] (
    ...
    CONSTRAINT [PK_MyTable_00761] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00761_MyTable00761] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00761] ([ColKey]),
    CONSTRAINT [BK_MyTable_00761_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
