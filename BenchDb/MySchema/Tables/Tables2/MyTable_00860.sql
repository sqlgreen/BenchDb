CREATE TABLE [MySchema].[MyTable_00860] (
    ...
    CONSTRAINT [PK_MyTable_00860] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00860_MyTable00860] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00860] ([ColKey]),
    CONSTRAINT [BK_MyTable_00860_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
