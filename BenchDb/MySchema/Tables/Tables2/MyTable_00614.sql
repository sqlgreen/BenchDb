CREATE TABLE [MySchema].[MyTable_00614] (
    ...
    CONSTRAINT [PK_MyTable_00614] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00614_MyTable00614] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00614] ([ColKey]),
    CONSTRAINT [BK_MyTable_00614_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
