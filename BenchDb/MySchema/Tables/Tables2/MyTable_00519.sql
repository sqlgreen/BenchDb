CREATE TABLE [MySchema].[MyTable_00519] (
    ...
    CONSTRAINT [PK_MyTable_00519] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00519_MyTable00519] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00519] ([ColKey]),
    CONSTRAINT [BK_MyTable_00519_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
