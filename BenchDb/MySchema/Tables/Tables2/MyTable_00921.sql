CREATE TABLE [MySchema].[MyTable_00921] (
    ...
    CONSTRAINT [PK_MyTable_00921] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00921_MyTable00921] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00921] ([ColKey]),
    CONSTRAINT [BK_MyTable_00921_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
