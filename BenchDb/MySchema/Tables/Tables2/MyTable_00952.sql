CREATE TABLE [MySchema].[MyTable_00952] (
    ...
    CONSTRAINT [PK_MyTable_00952] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00952_MyTable00952] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00952] ([ColKey]),
    CONSTRAINT [BK_MyTable_00952_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
