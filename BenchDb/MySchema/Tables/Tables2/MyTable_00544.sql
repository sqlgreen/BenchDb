CREATE TABLE [MySchema].[MyTable_00544] (
    ...
    CONSTRAINT [PK_MyTable_00544] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00544_MyTable00544] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00544] ([ColKey]),
    CONSTRAINT [BK_MyTable_00544_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
