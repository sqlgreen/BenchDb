CREATE TABLE [MySchema].[MyTable_00657] (
    ...
    CONSTRAINT [PK_MyTable_00657] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00657_MyTable00657] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00657] ([ColKey]),
    CONSTRAINT [BK_MyTable_00657_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
