CREATE TABLE [MySchema].[MyTable_00989] (
    ...
    CONSTRAINT [PK_MyTable_00989] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00989_MyTable00989] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00989] ([ColKey]),
    CONSTRAINT [BK_MyTable_00989_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
