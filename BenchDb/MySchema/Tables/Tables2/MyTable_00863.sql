CREATE TABLE [MySchema].[MyTable_00863] (
    ...
    CONSTRAINT [PK_MyTable_00863] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00863_MyTable00863] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00863] ([ColKey]),
    CONSTRAINT [BK_MyTable_00863_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
