CREATE TABLE [MySchema].[MyTable_00878] (
    ...
    CONSTRAINT [PK_MyTable_00878] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00878_MyTable00878] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00878] ([ColKey]),
    CONSTRAINT [BK_MyTable_00878_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
