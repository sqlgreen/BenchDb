CREATE TABLE [MySchema].[MyTable_00537] (
    ...
    CONSTRAINT [PK_MyTable_00537] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00537_MyTable00537] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00537] ([ColKey]),
    CONSTRAINT [BK_MyTable_00537_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
