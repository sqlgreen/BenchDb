CREATE TABLE [MySchema].[MyTable_00856] (
    ...
    CONSTRAINT [PK_MyTable_00856] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00856_MyTable00856] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00856] ([ColKey]),
    CONSTRAINT [BK_MyTable_00856_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
