CREATE TABLE [MySchema].[MyTable_00954] (
    ...
    CONSTRAINT [PK_MyTable_00954] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00954_MyTable00954] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00954] ([ColKey]),
    CONSTRAINT [BK_MyTable_00954_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
