CREATE TABLE [MySchema].[MyTable_00870] (
    ...
    CONSTRAINT [PK_MyTable_00870] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00870_MyTable00870] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00870] ([ColKey]),
    CONSTRAINT [BK_MyTable_00870_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
