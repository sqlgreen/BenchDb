CREATE TABLE [MySchema].[MyTable_00535] (
    ...
    CONSTRAINT [PK_MyTable_00535] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00535_MyTable00535] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00535] ([ColKey]),
    CONSTRAINT [BK_MyTable_00535_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
