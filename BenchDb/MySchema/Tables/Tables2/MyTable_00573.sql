CREATE TABLE [MySchema].[MyTable_00573] (
    ...
    CONSTRAINT [PK_MyTable_00573] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00573_MyTable00573] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00573] ([ColKey]),
    CONSTRAINT [BK_MyTable_00573_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
