CREATE TABLE [MySchema].[MyTable_00733] (
    ...
    CONSTRAINT [PK_MyTable_00733] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00733_MyTable00733] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00733] ([ColKey]),
    CONSTRAINT [BK_MyTable_00733_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
