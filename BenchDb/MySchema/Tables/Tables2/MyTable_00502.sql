CREATE TABLE [MySchema].[MyTable_00502] (
    ...
    CONSTRAINT [PK_MyTable_00502] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00502_MyTable00502] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00502] ([ColKey]),
    CONSTRAINT [BK_MyTable_00502_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
