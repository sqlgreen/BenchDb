CREATE TABLE [MySchema].[MyTable_00619] (
    ...
    CONSTRAINT [PK_MyTable_00619] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00619_MyTable00619] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00619] ([ColKey]),
    CONSTRAINT [BK_MyTable_00619_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
