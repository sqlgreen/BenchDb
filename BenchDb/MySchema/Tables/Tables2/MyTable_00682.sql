CREATE TABLE [MySchema].[MyTable_00682] (
    ...
    CONSTRAINT [PK_MyTable_00682] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00682_MyTable00682] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00682] ([ColKey]),
    CONSTRAINT [BK_MyTable_00682_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
