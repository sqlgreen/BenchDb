CREATE TABLE [MySchema].[MyTable_00674] (
    ...
    CONSTRAINT [PK_MyTable_00674] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00674_MyTable00674] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00674] ([ColKey]),
    CONSTRAINT [BK_MyTable_00674_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
