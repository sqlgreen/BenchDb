CREATE TABLE [MySchema].[MyTable_01800] (
    ...
    CONSTRAINT [PK_MyTable_01800] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01800_MyTable01800] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01800] ([ColKey]),
    CONSTRAINT [BK_MyTable_01800_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
