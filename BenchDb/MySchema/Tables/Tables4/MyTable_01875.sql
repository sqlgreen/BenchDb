CREATE TABLE [MySchema].[MyTable_01875] (
    ...
    CONSTRAINT [PK_MyTable_01875] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01875_MyTable01875] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01875] ([ColKey]),
    CONSTRAINT [BK_MyTable_01875_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
