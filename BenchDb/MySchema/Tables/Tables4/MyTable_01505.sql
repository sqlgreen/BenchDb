CREATE TABLE [MySchema].[MyTable_01505] (
    ...
    CONSTRAINT [PK_MyTable_01505] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01505_MyTable01505] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01505] ([ColKey]),
    CONSTRAINT [BK_MyTable_01505_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
