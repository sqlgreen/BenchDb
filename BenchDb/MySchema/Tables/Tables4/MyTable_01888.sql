CREATE TABLE [MySchema].[MyTable_01888] (
    ...
    CONSTRAINT [PK_MyTable_01888] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01888_MyTable01888] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01888] ([ColKey]),
    CONSTRAINT [BK_MyTable_01888_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
