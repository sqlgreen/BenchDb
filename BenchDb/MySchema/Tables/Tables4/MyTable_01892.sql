CREATE TABLE [MySchema].[MyTable_01892] (
    ...
    CONSTRAINT [PK_MyTable_01892] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01892_MyTable01892] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01892] ([ColKey]),
    CONSTRAINT [BK_MyTable_01892_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
