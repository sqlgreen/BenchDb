CREATE TABLE [MySchema].[MyTable_01662] (
    ...
    CONSTRAINT [PK_MyTable_01662] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01662_MyTable01662] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01662] ([ColKey]),
    CONSTRAINT [BK_MyTable_01662_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
