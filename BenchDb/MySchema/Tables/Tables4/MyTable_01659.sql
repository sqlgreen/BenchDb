CREATE TABLE [MySchema].[MyTable_01659] (
    ...
    CONSTRAINT [PK_MyTable_01659] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01659_MyTable01659] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01659] ([ColKey]),
    CONSTRAINT [BK_MyTable_01659_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
