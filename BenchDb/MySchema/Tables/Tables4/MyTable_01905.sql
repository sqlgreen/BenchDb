CREATE TABLE [MySchema].[MyTable_01905] (
    ...
    CONSTRAINT [PK_MyTable_01905] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01905_MyTable01905] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01905] ([ColKey]),
    CONSTRAINT [BK_MyTable_01905_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
