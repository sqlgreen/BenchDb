CREATE TABLE [MySchema].[MyTable_01965] (
    ...
    CONSTRAINT [PK_MyTable_01965] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01965_MyTable01965] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01965] ([ColKey]),
    CONSTRAINT [BK_MyTable_01965_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
