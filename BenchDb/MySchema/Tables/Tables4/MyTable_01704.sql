CREATE TABLE [MySchema].[MyTable_01704] (
    ...
    CONSTRAINT [PK_MyTable_01704] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01704_MyTable01704] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01704] ([ColKey]),
    CONSTRAINT [BK_MyTable_01704_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
