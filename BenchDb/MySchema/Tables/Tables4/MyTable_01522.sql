CREATE TABLE [MySchema].[MyTable_01522] (
    ...
    CONSTRAINT [PK_MyTable_01522] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01522_MyTable01522] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01522] ([ColKey]),
    CONSTRAINT [BK_MyTable_01522_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
