CREATE TABLE [MySchema].[MyTable_01998] (
    ...
    CONSTRAINT [PK_MyTable_01998] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01998_MyTable01998] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01998] ([ColKey]),
    CONSTRAINT [BK_MyTable_01998_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
