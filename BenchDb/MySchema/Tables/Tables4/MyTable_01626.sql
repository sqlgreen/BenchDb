CREATE TABLE [MySchema].[MyTable_01626] (
    ...
    CONSTRAINT [PK_MyTable_01626] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01626_MyTable01626] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01626] ([ColKey]),
    CONSTRAINT [BK_MyTable_01626_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
