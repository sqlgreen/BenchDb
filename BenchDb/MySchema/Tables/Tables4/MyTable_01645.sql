CREATE TABLE [MySchema].[MyTable_01645] (
    ...
    CONSTRAINT [PK_MyTable_01645] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01645_MyTable01645] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01645] ([ColKey]),
    CONSTRAINT [BK_MyTable_01645_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
