CREATE TABLE [MySchema].[MyTable_01562] (
    ...
    CONSTRAINT [PK_MyTable_01562] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01562_MyTable01562] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01562] ([ColKey]),
    CONSTRAINT [BK_MyTable_01562_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
