CREATE TABLE [MySchema].[MyTable_01948] (
    ...
    CONSTRAINT [PK_MyTable_01948] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01948_MyTable01948] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01948] ([ColKey]),
    CONSTRAINT [BK_MyTable_01948_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
