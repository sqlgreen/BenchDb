CREATE TABLE [MySchema].[MyTable_01854] (
    ...
    CONSTRAINT [PK_MyTable_01854] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01854_MyTable01854] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01854] ([ColKey]),
    CONSTRAINT [BK_MyTable_01854_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
