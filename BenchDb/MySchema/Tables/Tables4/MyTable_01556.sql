CREATE TABLE [MySchema].[MyTable_01556] (
    ...
    CONSTRAINT [PK_MyTable_01556] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01556_MyTable01556] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01556] ([ColKey]),
    CONSTRAINT [BK_MyTable_01556_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
