CREATE TABLE [MySchema].[MyTable_01812] (
    ...
    CONSTRAINT [PK_MyTable_01812] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01812_MyTable01812] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01812] ([ColKey]),
    CONSTRAINT [BK_MyTable_01812_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
