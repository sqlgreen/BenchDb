CREATE TABLE [MySchema].[MyTable_01792] (
    ...
    CONSTRAINT [PK_MyTable_01792] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01792_MyTable01792] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01792] ([ColKey]),
    CONSTRAINT [BK_MyTable_01792_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
