CREATE TABLE [MySchema].[MyTable_01573] (
    ...
    CONSTRAINT [PK_MyTable_01573] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01573_MyTable01573] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01573] ([ColKey]),
    CONSTRAINT [BK_MyTable_01573_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
