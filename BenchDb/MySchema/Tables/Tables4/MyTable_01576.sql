CREATE TABLE [MySchema].[MyTable_01576] (
    ...
    CONSTRAINT [PK_MyTable_01576] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01576_MyTable01576] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01576] ([ColKey]),
    CONSTRAINT [BK_MyTable_01576_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
