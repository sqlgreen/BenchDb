CREATE TABLE [MySchema].[MyTable_01891] (
    ...
    CONSTRAINT [PK_MyTable_01891] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01891_MyTable01891] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01891] ([ColKey]),
    CONSTRAINT [BK_MyTable_01891_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
