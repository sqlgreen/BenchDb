CREATE TABLE [MySchema].[MyTable_01937] (
    ...
    CONSTRAINT [PK_MyTable_01937] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01937_MyTable01937] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01937] ([ColKey]),
    CONSTRAINT [BK_MyTable_01937_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
