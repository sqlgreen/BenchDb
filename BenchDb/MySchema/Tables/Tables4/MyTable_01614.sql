CREATE TABLE [MySchema].[MyTable_01614] (
    ...
    CONSTRAINT [PK_MyTable_01614] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01614_MyTable01614] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01614] ([ColKey]),
    CONSTRAINT [BK_MyTable_01614_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
