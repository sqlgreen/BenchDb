CREATE TABLE [MySchema].[MyTable_01603] (
    ...
    CONSTRAINT [PK_MyTable_01603] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01603_MyTable01603] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01603] ([ColKey]),
    CONSTRAINT [BK_MyTable_01603_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
