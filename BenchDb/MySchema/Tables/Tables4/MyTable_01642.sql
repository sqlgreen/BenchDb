CREATE TABLE [MySchema].[MyTable_01642] (
    ...
    CONSTRAINT [PK_MyTable_01642] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01642_MyTable01642] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01642] ([ColKey]),
    CONSTRAINT [BK_MyTable_01642_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
