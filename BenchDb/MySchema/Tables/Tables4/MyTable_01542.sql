CREATE TABLE [MySchema].[MyTable_01542] (
    ...
    CONSTRAINT [PK_MyTable_01542] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01542_MyTable01542] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01542] ([ColKey]),
    CONSTRAINT [BK_MyTable_01542_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
