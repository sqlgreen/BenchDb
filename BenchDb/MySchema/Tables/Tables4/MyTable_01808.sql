CREATE TABLE [MySchema].[MyTable_01808] (
    ...
    CONSTRAINT [PK_MyTable_01808] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01808_MyTable01808] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01808] ([ColKey]),
    CONSTRAINT [BK_MyTable_01808_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
