CREATE TABLE [MySchema].[MyTable_01902] (
    ...
    CONSTRAINT [PK_MyTable_01902] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01902_MyTable01902] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01902] ([ColKey]),
    CONSTRAINT [BK_MyTable_01902_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
