CREATE TABLE [MySchema].[MyTable_01994] (
    ...
    CONSTRAINT [PK_MyTable_01994] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01994_MyTable01994] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01994] ([ColKey]),
    CONSTRAINT [BK_MyTable_01994_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
