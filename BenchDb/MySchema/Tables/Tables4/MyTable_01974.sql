CREATE TABLE [MySchema].[MyTable_01974] (
    ...
    CONSTRAINT [PK_MyTable_01974] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01974_MyTable01974] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01974] ([ColKey]),
    CONSTRAINT [BK_MyTable_01974_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
