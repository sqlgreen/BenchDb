CREATE TABLE [MySchema].[MyTable_01639] (
    ...
    CONSTRAINT [PK_MyTable_01639] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01639_MyTable01639] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01639] ([ColKey]),
    CONSTRAINT [BK_MyTable_01639_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
