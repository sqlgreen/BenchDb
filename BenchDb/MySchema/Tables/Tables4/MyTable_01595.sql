CREATE TABLE [MySchema].[MyTable_01595] (
    ...
    CONSTRAINT [PK_MyTable_01595] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01595_MyTable01595] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01595] ([ColKey]),
    CONSTRAINT [BK_MyTable_01595_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
