CREATE TABLE [MySchema].[MyTable_01923] (
    ...
    CONSTRAINT [PK_MyTable_01923] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01923_MyTable01923] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01923] ([ColKey]),
    CONSTRAINT [BK_MyTable_01923_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
