CREATE TABLE [MySchema].[MyTable_01726] (
    ...
    CONSTRAINT [PK_MyTable_01726] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01726_MyTable01726] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01726] ([ColKey]),
    CONSTRAINT [BK_MyTable_01726_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
