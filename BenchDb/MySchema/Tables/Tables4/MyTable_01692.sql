CREATE TABLE [MySchema].[MyTable_01692] (
    ...
    CONSTRAINT [PK_MyTable_01692] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01692_MyTable01692] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01692] ([ColKey]),
    CONSTRAINT [BK_MyTable_01692_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
