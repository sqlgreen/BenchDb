CREATE TABLE [MySchema].[MyTable_01725] (
    ...
    CONSTRAINT [PK_MyTable_01725] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01725_MyTable01725] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01725] ([ColKey]),
    CONSTRAINT [BK_MyTable_01725_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
