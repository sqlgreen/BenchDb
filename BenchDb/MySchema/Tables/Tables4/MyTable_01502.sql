CREATE TABLE [MySchema].[MyTable_01502] (
    ...
    CONSTRAINT [PK_MyTable_01502] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01502_MyTable01502] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01502] ([ColKey]),
    CONSTRAINT [BK_MyTable_01502_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
