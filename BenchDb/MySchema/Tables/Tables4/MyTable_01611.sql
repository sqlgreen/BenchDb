CREATE TABLE [MySchema].[MyTable_01611] (
    ...
    CONSTRAINT [PK_MyTable_01611] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01611_MyTable01611] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01611] ([ColKey]),
    CONSTRAINT [BK_MyTable_01611_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
