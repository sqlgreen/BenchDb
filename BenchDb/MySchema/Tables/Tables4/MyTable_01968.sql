CREATE TABLE [MySchema].[MyTable_01968] (
    ...
    CONSTRAINT [PK_MyTable_01968] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01968_MyTable01968] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01968] ([ColKey]),
    CONSTRAINT [BK_MyTable_01968_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
