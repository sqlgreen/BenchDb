CREATE TABLE [MySchema].[MyTable_01687] (
    ...
    CONSTRAINT [PK_MyTable_01687] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01687_MyTable01687] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01687] ([ColKey]),
    CONSTRAINT [BK_MyTable_01687_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
