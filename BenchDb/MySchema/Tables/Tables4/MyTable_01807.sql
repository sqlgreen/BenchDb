CREATE TABLE [MySchema].[MyTable_01807] (
    ...
    CONSTRAINT [PK_MyTable_01807] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01807_MyTable01807] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01807] ([ColKey]),
    CONSTRAINT [BK_MyTable_01807_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
