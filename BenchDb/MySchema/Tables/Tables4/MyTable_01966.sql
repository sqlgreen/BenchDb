CREATE TABLE [MySchema].[MyTable_01966] (
    ...
    CONSTRAINT [PK_MyTable_01966] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01966_MyTable01966] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01966] ([ColKey]),
    CONSTRAINT [BK_MyTable_01966_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
