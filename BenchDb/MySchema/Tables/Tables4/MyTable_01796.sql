CREATE TABLE [MySchema].[MyTable_01796] (
    ...
    CONSTRAINT [PK_MyTable_01796] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01796_MyTable01796] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01796] ([ColKey]),
    CONSTRAINT [BK_MyTable_01796_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
