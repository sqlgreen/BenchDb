CREATE TABLE [MySchema].[MyTable_01540] (
    ...
    CONSTRAINT [PK_MyTable_01540] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01540_MyTable01540] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01540] ([ColKey]),
    CONSTRAINT [BK_MyTable_01540_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
