CREATE TABLE [MySchema].[MyTable_01831] (
    ...
    CONSTRAINT [PK_MyTable_01831] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01831_MyTable01831] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01831] ([ColKey]),
    CONSTRAINT [BK_MyTable_01831_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
