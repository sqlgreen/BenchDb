CREATE TABLE [MySchema].[MyTable_01631] (
    ...
    CONSTRAINT [PK_MyTable_01631] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01631_MyTable01631] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01631] ([ColKey]),
    CONSTRAINT [BK_MyTable_01631_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
