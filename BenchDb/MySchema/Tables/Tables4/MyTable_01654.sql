CREATE TABLE [MySchema].[MyTable_01654] (
    ...
    CONSTRAINT [PK_MyTable_01654] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01654_MyTable01654] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01654] ([ColKey]),
    CONSTRAINT [BK_MyTable_01654_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
