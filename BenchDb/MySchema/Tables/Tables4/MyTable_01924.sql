CREATE TABLE [MySchema].[MyTable_01924] (
    ...
    CONSTRAINT [PK_MyTable_01924] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01924_MyTable01924] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01924] ([ColKey]),
    CONSTRAINT [BK_MyTable_01924_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
