CREATE TABLE [MySchema].[MyTable_01694] (
    ...
    CONSTRAINT [PK_MyTable_01694] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01694_MyTable01694] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01694] ([ColKey]),
    CONSTRAINT [BK_MyTable_01694_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
