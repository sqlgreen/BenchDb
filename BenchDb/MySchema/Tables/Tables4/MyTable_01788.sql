CREATE TABLE [MySchema].[MyTable_01788] (
    ...
    CONSTRAINT [PK_MyTable_01788] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01788_MyTable01788] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01788] ([ColKey]),
    CONSTRAINT [BK_MyTable_01788_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
