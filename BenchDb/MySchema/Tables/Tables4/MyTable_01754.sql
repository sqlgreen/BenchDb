CREATE TABLE [MySchema].[MyTable_01754] (
    ...
    CONSTRAINT [PK_MyTable_01754] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01754_MyTable01754] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01754] ([ColKey]),
    CONSTRAINT [BK_MyTable_01754_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
