CREATE TABLE [MySchema].[MyTable_01760] (
    ...
    CONSTRAINT [PK_MyTable_01760] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01760_MyTable01760] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01760] ([ColKey]),
    CONSTRAINT [BK_MyTable_01760_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
