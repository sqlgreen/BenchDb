CREATE TABLE [MySchema].[MyTable_01695] (
    ...
    CONSTRAINT [PK_MyTable_01695] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01695_MyTable01695] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01695] ([ColKey]),
    CONSTRAINT [BK_MyTable_01695_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
