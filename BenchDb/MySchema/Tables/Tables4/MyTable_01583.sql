CREATE TABLE [MySchema].[MyTable_01583] (
    ...
    CONSTRAINT [PK_MyTable_01583] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01583_MyTable01583] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01583] ([ColKey]),
    CONSTRAINT [BK_MyTable_01583_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
