CREATE TABLE [MySchema].[MyTable_01793] (
    ...
    CONSTRAINT [PK_MyTable_01793] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01793_MyTable01793] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01793] ([ColKey]),
    CONSTRAINT [BK_MyTable_01793_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
