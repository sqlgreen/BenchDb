CREATE TABLE [MySchema].[MyTable_01711] (
    ...
    CONSTRAINT [PK_MyTable_01711] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01711_MyTable01711] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01711] ([ColKey]),
    CONSTRAINT [BK_MyTable_01711_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
