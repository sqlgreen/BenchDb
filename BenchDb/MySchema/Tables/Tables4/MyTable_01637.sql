CREATE TABLE [MySchema].[MyTable_01637] (
    ...
    CONSTRAINT [PK_MyTable_01637] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01637_MyTable01637] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01637] ([ColKey]),
    CONSTRAINT [BK_MyTable_01637_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
