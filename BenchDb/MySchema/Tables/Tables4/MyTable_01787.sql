CREATE TABLE [MySchema].[MyTable_01787] (
    ...
    CONSTRAINT [PK_MyTable_01787] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01787_MyTable01787] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01787] ([ColKey]),
    CONSTRAINT [BK_MyTable_01787_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
