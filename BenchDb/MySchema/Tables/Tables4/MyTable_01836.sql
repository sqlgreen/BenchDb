CREATE TABLE [MySchema].[MyTable_01836] (
    ...
    CONSTRAINT [PK_MyTable_01836] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01836_MyTable01836] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01836] ([ColKey]),
    CONSTRAINT [BK_MyTable_01836_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
