CREATE TABLE [MySchema].[MyTable_01871] (
    ...
    CONSTRAINT [PK_MyTable_01871] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01871_MyTable01871] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01871] ([ColKey]),
    CONSTRAINT [BK_MyTable_01871_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
