CREATE TABLE [MySchema].[MyTable_01957] (
    ...
    CONSTRAINT [PK_MyTable_01957] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01957_MyTable01957] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01957] ([ColKey]),
    CONSTRAINT [BK_MyTable_01957_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
