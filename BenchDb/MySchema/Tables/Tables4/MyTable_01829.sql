CREATE TABLE [MySchema].[MyTable_01829] (
    ...
    CONSTRAINT [PK_MyTable_01829] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01829_MyTable01829] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01829] ([ColKey]),
    CONSTRAINT [BK_MyTable_01829_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
