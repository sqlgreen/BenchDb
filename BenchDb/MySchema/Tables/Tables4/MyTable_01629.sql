CREATE TABLE [MySchema].[MyTable_01629] (
    ...
    CONSTRAINT [PK_MyTable_01629] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01629_MyTable01629] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01629] ([ColKey]),
    CONSTRAINT [BK_MyTable_01629_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
