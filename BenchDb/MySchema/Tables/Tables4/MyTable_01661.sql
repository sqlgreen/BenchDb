CREATE TABLE [MySchema].[MyTable_01661] (
    ...
    CONSTRAINT [PK_MyTable_01661] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01661_MyTable01661] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01661] ([ColKey]),
    CONSTRAINT [BK_MyTable_01661_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
