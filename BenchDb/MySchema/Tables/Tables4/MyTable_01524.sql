CREATE TABLE [MySchema].[MyTable_01524] (
    ...
    CONSTRAINT [PK_MyTable_01524] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01524_MyTable01524] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01524] ([ColKey]),
    CONSTRAINT [BK_MyTable_01524_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
