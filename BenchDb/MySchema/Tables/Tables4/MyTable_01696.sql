CREATE TABLE [MySchema].[MyTable_01696] (
    ...
    CONSTRAINT [PK_MyTable_01696] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01696_MyTable01696] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01696] ([ColKey]),
    CONSTRAINT [BK_MyTable_01696_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
