CREATE TABLE [MySchema].[MyTable_01877] (
    ...
    CONSTRAINT [PK_MyTable_01877] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01877_MyTable01877] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01877] ([ColKey]),
    CONSTRAINT [BK_MyTable_01877_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
