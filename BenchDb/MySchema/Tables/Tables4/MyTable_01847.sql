CREATE TABLE [MySchema].[MyTable_01847] (
    ...
    CONSTRAINT [PK_MyTable_01847] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01847_MyTable01847] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01847] ([ColKey]),
    CONSTRAINT [BK_MyTable_01847_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
