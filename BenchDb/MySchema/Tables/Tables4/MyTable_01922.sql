CREATE TABLE [MySchema].[MyTable_01922] (
    ...
    CONSTRAINT [PK_MyTable_01922] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01922_MyTable01922] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01922] ([ColKey]),
    CONSTRAINT [BK_MyTable_01922_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
