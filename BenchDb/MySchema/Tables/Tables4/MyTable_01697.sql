CREATE TABLE [MySchema].[MyTable_01697] (
    ...
    CONSTRAINT [PK_MyTable_01697] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01697_MyTable01697] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01697] ([ColKey]),
    CONSTRAINT [BK_MyTable_01697_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
