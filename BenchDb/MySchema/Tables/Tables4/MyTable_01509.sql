CREATE TABLE [MySchema].[MyTable_01509] (
    ...
    CONSTRAINT [PK_MyTable_01509] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01509_MyTable01509] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01509] ([ColKey]),
    CONSTRAINT [BK_MyTable_01509_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
