CREATE TABLE [MySchema].[MyTable_01969] (
    ...
    CONSTRAINT [PK_MyTable_01969] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01969_MyTable01969] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01969] ([ColKey]),
    CONSTRAINT [BK_MyTable_01969_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
