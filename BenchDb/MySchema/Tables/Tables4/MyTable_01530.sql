CREATE TABLE [MySchema].[MyTable_01530] (
    ...
    CONSTRAINT [PK_MyTable_01530] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01530_MyTable01530] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01530] ([ColKey]),
    CONSTRAINT [BK_MyTable_01530_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
