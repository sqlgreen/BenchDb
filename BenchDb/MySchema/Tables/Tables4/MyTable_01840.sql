CREATE TABLE [MySchema].[MyTable_01840] (
    ...
    CONSTRAINT [PK_MyTable_01840] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01840_MyTable01840] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01840] ([ColKey]),
    CONSTRAINT [BK_MyTable_01840_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
