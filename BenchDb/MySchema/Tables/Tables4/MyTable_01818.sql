CREATE TABLE [MySchema].[MyTable_01818] (
    ...
    CONSTRAINT [PK_MyTable_01818] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01818_MyTable01818] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01818] ([ColKey]),
    CONSTRAINT [BK_MyTable_01818_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
