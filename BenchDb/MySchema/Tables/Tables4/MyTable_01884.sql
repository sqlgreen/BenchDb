CREATE TABLE [MySchema].[MyTable_01884] (
    ...
    CONSTRAINT [PK_MyTable_01884] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01884_MyTable01884] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01884] ([ColKey]),
    CONSTRAINT [BK_MyTable_01884_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
