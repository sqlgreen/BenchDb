CREATE TABLE [MySchema].[MyTable_01757] (
    ...
    CONSTRAINT [PK_MyTable_01757] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01757_MyTable01757] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01757] ([ColKey]),
    CONSTRAINT [BK_MyTable_01757_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
