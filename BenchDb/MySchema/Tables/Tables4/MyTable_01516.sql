CREATE TABLE [MySchema].[MyTable_01516] (
    ...
    CONSTRAINT [PK_MyTable_01516] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01516_MyTable01516] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01516] ([ColKey]),
    CONSTRAINT [BK_MyTable_01516_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
