CREATE TABLE [MySchema].[MyTable_01955] (
    ...
    CONSTRAINT [PK_MyTable_01955] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01955_MyTable01955] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01955] ([ColKey]),
    CONSTRAINT [BK_MyTable_01955_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
