CREATE TABLE [MySchema].[MyTable_01539] (
    ...
    CONSTRAINT [PK_MyTable_01539] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01539_MyTable01539] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01539] ([ColKey]),
    CONSTRAINT [BK_MyTable_01539_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
