CREATE TABLE [MySchema].[MyTable_01710] (
    ...
    CONSTRAINT [PK_MyTable_01710] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01710_MyTable01710] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01710] ([ColKey]),
    CONSTRAINT [BK_MyTable_01710_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
