CREATE TABLE [MySchema].[MyTable_01551] (
    ...
    CONSTRAINT [PK_MyTable_01551] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01551_MyTable01551] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01551] ([ColKey]),
    CONSTRAINT [BK_MyTable_01551_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
