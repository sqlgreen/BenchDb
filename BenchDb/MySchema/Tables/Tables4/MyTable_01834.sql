CREATE TABLE [MySchema].[MyTable_01834] (
    ...
    CONSTRAINT [PK_MyTable_01834] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01834_MyTable01834] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01834] ([ColKey]),
    CONSTRAINT [BK_MyTable_01834_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
