CREATE TABLE [MySchema].[MyTable_01709] (
    ...
    CONSTRAINT [PK_MyTable_01709] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01709_MyTable01709] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01709] ([ColKey]),
    CONSTRAINT [BK_MyTable_01709_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
