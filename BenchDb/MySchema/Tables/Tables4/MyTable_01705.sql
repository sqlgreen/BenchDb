CREATE TABLE [MySchema].[MyTable_01705] (
    ...
    CONSTRAINT [PK_MyTable_01705] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01705_MyTable01705] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01705] ([ColKey]),
    CONSTRAINT [BK_MyTable_01705_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
