CREATE TABLE [MySchema].[MyTable_01699] (
    ...
    CONSTRAINT [PK_MyTable_01699] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01699_MyTable01699] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01699] ([ColKey]),
    CONSTRAINT [BK_MyTable_01699_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
