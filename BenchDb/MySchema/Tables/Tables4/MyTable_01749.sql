CREATE TABLE [MySchema].[MyTable_01749] (
    ...
    CONSTRAINT [PK_MyTable_01749] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01749_MyTable01749] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01749] ([ColKey]),
    CONSTRAINT [BK_MyTable_01749_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
