CREATE TABLE [MySchema].[MyTable_01721] (
    ...
    CONSTRAINT [PK_MyTable_01721] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01721_MyTable01721] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01721] ([ColKey]),
    CONSTRAINT [BK_MyTable_01721_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
