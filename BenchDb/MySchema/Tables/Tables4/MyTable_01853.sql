CREATE TABLE [MySchema].[MyTable_01853] (
    ...
    CONSTRAINT [PK_MyTable_01853] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01853_MyTable01853] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01853] ([ColKey]),
    CONSTRAINT [BK_MyTable_01853_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
