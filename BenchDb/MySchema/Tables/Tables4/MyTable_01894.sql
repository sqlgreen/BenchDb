CREATE TABLE [MySchema].[MyTable_01894] (
    ...
    CONSTRAINT [PK_MyTable_01894] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01894_MyTable01894] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01894] ([ColKey]),
    CONSTRAINT [BK_MyTable_01894_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
