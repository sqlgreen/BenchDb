CREATE TABLE [MySchema].[MyTable_01671] (
    ...
    CONSTRAINT [PK_MyTable_01671] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01671_MyTable01671] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01671] ([ColKey]),
    CONSTRAINT [BK_MyTable_01671_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
