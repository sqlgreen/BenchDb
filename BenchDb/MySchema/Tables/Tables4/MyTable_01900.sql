CREATE TABLE [MySchema].[MyTable_01900] (
    ...
    CONSTRAINT [PK_MyTable_01900] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01900_MyTable01900] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01900] ([ColKey]),
    CONSTRAINT [BK_MyTable_01900_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
