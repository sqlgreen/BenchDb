CREATE TABLE [MySchema].[MyTable_01640] (
    ...
    CONSTRAINT [PK_MyTable_01640] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01640_MyTable01640] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01640] ([ColKey]),
    CONSTRAINT [BK_MyTable_01640_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
