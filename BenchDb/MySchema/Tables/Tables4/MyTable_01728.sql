CREATE TABLE [MySchema].[MyTable_01728] (
    ...
    CONSTRAINT [PK_MyTable_01728] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01728_MyTable01728] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01728] ([ColKey]),
    CONSTRAINT [BK_MyTable_01728_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
