CREATE TABLE [MySchema].[MyTable_01904] (
    ...
    CONSTRAINT [PK_MyTable_01904] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01904_MyTable01904] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01904] ([ColKey]),
    CONSTRAINT [BK_MyTable_01904_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
