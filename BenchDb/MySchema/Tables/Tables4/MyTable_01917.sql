CREATE TABLE [MySchema].[MyTable_01917] (
    ...
    CONSTRAINT [PK_MyTable_01917] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01917_MyTable01917] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01917] ([ColKey]),
    CONSTRAINT [BK_MyTable_01917_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
