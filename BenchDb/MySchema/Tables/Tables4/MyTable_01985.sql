CREATE TABLE [MySchema].[MyTable_01985] (
    ...
    CONSTRAINT [PK_MyTable_01985] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01985_MyTable01985] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01985] ([ColKey]),
    CONSTRAINT [BK_MyTable_01985_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
