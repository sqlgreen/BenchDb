CREATE TABLE [MySchema].[MyTable_01785] (
    ...
    CONSTRAINT [PK_MyTable_01785] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01785_MyTable01785] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01785] ([ColKey]),
    CONSTRAINT [BK_MyTable_01785_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
