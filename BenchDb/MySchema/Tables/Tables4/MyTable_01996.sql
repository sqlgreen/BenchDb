CREATE TABLE [MySchema].[MyTable_01996] (
    ...
    CONSTRAINT [PK_MyTable_01996] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01996_MyTable01996] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01996] ([ColKey]),
    CONSTRAINT [BK_MyTable_01996_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
