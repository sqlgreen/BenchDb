CREATE TABLE [MySchema].[MyTable_01526] (
    ...
    CONSTRAINT [PK_MyTable_01526] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01526_MyTable01526] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01526] ([ColKey]),
    CONSTRAINT [BK_MyTable_01526_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
