CREATE TABLE [MySchema].[MyTable_01837] (
    ...
    CONSTRAINT [PK_MyTable_01837] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01837_MyTable01837] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01837] ([ColKey]),
    CONSTRAINT [BK_MyTable_01837_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
