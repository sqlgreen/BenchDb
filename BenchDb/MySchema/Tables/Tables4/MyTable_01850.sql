CREATE TABLE [MySchema].[MyTable_01850] (
    ...
    CONSTRAINT [PK_MyTable_01850] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01850_MyTable01850] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01850] ([ColKey]),
    CONSTRAINT [BK_MyTable_01850_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
