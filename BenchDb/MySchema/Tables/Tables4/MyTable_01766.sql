CREATE TABLE [MySchema].[MyTable_01766] (
    ...
    CONSTRAINT [PK_MyTable_01766] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01766_MyTable01766] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01766] ([ColKey]),
    CONSTRAINT [BK_MyTable_01766_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
