CREATE TABLE [MySchema].[MyTable_01981] (
    ...
    CONSTRAINT [PK_MyTable_01981] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01981_MyTable01981] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01981] ([ColKey]),
    CONSTRAINT [BK_MyTable_01981_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
