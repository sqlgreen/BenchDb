CREATE TABLE [MySchema].[MyTable_01952] (
    ...
    CONSTRAINT [PK_MyTable_01952] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01952_MyTable01952] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01952] ([ColKey]),
    CONSTRAINT [BK_MyTable_01952_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
