CREATE TABLE [MySchema].[MyTable_01944] (
    ...
    CONSTRAINT [PK_MyTable_01944] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01944_MyTable01944] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01944] ([ColKey]),
    CONSTRAINT [BK_MyTable_01944_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
