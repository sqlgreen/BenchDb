CREATE TABLE [MySchema].[MyTable_01679] (
    ...
    CONSTRAINT [PK_MyTable_01679] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01679_MyTable01679] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01679] ([ColKey]),
    CONSTRAINT [BK_MyTable_01679_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
