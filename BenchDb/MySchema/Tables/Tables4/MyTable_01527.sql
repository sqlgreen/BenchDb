CREATE TABLE [MySchema].[MyTable_01527] (
    ...
    CONSTRAINT [PK_MyTable_01527] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01527_MyTable01527] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01527] ([ColKey]),
    CONSTRAINT [BK_MyTable_01527_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
