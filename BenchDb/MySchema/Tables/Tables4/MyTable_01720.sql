CREATE TABLE [MySchema].[MyTable_01720] (
    ...
    CONSTRAINT [PK_MyTable_01720] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01720_MyTable01720] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01720] ([ColKey]),
    CONSTRAINT [BK_MyTable_01720_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
