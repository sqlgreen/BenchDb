CREATE TABLE [MySchema].[MyTable_01863] (
    ...
    CONSTRAINT [PK_MyTable_01863] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01863_MyTable01863] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01863] ([ColKey]),
    CONSTRAINT [BK_MyTable_01863_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
