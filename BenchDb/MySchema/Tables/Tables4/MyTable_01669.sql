CREATE TABLE [MySchema].[MyTable_01669] (
    ...
    CONSTRAINT [PK_MyTable_01669] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01669_MyTable01669] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01669] ([ColKey]),
    CONSTRAINT [BK_MyTable_01669_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
