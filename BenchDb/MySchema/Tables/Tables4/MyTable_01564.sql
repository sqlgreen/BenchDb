CREATE TABLE [MySchema].[MyTable_01564] (
    ...
    CONSTRAINT [PK_MyTable_01564] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01564_MyTable01564] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01564] ([ColKey]),
    CONSTRAINT [BK_MyTable_01564_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
