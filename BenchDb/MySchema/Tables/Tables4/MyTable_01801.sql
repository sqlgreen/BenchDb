CREATE TABLE [MySchema].[MyTable_01801] (
    ...
    CONSTRAINT [PK_MyTable_01801] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01801_MyTable01801] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01801] ([ColKey]),
    CONSTRAINT [BK_MyTable_01801_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
