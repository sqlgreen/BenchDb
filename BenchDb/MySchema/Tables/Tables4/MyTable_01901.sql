CREATE TABLE [MySchema].[MyTable_01901] (
    ...
    CONSTRAINT [PK_MyTable_01901] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01901_MyTable01901] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01901] ([ColKey]),
    CONSTRAINT [BK_MyTable_01901_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
