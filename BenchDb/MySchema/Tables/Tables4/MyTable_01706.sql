CREATE TABLE [MySchema].[MyTable_01706] (
    ...
    CONSTRAINT [PK_MyTable_01706] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01706_MyTable01706] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01706] ([ColKey]),
    CONSTRAINT [BK_MyTable_01706_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
