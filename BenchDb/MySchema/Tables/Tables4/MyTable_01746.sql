CREATE TABLE [MySchema].[MyTable_01746] (
    ...
    CONSTRAINT [PK_MyTable_01746] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01746_MyTable01746] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01746] ([ColKey]),
    CONSTRAINT [BK_MyTable_01746_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
