CREATE TABLE [MySchema].[MyTable_01613] (
    ...
    CONSTRAINT [PK_MyTable_01613] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01613_MyTable01613] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01613] ([ColKey]),
    CONSTRAINT [BK_MyTable_01613_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
