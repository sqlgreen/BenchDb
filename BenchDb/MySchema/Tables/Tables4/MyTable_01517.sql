CREATE TABLE [MySchema].[MyTable_01517] (
    ...
    CONSTRAINT [PK_MyTable_01517] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01517_MyTable01517] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01517] ([ColKey]),
    CONSTRAINT [BK_MyTable_01517_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
