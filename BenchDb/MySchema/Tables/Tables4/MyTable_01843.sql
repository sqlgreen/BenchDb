CREATE TABLE [MySchema].[MyTable_01843] (
    ...
    CONSTRAINT [PK_MyTable_01843] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01843_MyTable01843] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01843] ([ColKey]),
    CONSTRAINT [BK_MyTable_01843_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
