CREATE TABLE [MySchema].[MyTable_01832] (
    ...
    CONSTRAINT [PK_MyTable_01832] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01832_MyTable01832] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01832] ([ColKey]),
    CONSTRAINT [BK_MyTable_01832_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
