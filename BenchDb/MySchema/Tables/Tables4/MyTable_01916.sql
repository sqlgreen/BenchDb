CREATE TABLE [MySchema].[MyTable_01916] (
    ...
    CONSTRAINT [PK_MyTable_01916] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01916_MyTable01916] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01916] ([ColKey]),
    CONSTRAINT [BK_MyTable_01916_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
