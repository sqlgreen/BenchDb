CREATE TABLE [MySchema].[MyTable_01870] (
    ...
    CONSTRAINT [PK_MyTable_01870] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01870_MyTable01870] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01870] ([ColKey]),
    CONSTRAINT [BK_MyTable_01870_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
