CREATE TABLE [MySchema].[MyTable_01838] (
    ...
    CONSTRAINT [PK_MyTable_01838] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01838_MyTable01838] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01838] ([ColKey]),
    CONSTRAINT [BK_MyTable_01838_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
