CREATE TABLE [MySchema].[MyTable_01999] (
    ...
    CONSTRAINT [PK_MyTable_01999] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01999_MyTable01999] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01999] ([ColKey]),
    CONSTRAINT [BK_MyTable_01999_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
