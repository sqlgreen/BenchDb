CREATE TABLE [MySchema].[MyTable_01862] (
    ...
    CONSTRAINT [PK_MyTable_01862] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01862_MyTable01862] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01862] ([ColKey]),
    CONSTRAINT [BK_MyTable_01862_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
