CREATE TABLE [MySchema].[MyTable_01591] (
    ...
    CONSTRAINT [PK_MyTable_01591] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01591_MyTable01591] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01591] ([ColKey]),
    CONSTRAINT [BK_MyTable_01591_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
