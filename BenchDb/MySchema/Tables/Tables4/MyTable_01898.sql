CREATE TABLE [MySchema].[MyTable_01898] (
    ...
    CONSTRAINT [PK_MyTable_01898] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01898_MyTable01898] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01898] ([ColKey]),
    CONSTRAINT [BK_MyTable_01898_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
