CREATE TABLE [MySchema].[MyTable_01601] (
    ...
    CONSTRAINT [PK_MyTable_01601] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01601_MyTable01601] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01601] ([ColKey]),
    CONSTRAINT [BK_MyTable_01601_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
