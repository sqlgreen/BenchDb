CREATE TABLE [MySchema].[MyTable_01828] (
    ...
    CONSTRAINT [PK_MyTable_01828] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01828_MyTable01828] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01828] ([ColKey]),
    CONSTRAINT [BK_MyTable_01828_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
