CREATE TABLE [MySchema].[MyTable_01931] (
    ...
    CONSTRAINT [PK_MyTable_01931] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01931_MyTable01931] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01931] ([ColKey]),
    CONSTRAINT [BK_MyTable_01931_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
