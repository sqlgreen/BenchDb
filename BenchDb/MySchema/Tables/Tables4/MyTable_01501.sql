CREATE TABLE [MySchema].[MyTable_01501] (
    ...
    CONSTRAINT [PK_MyTable_01501] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01501_MyTable01501] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01501] ([ColKey]),
    CONSTRAINT [BK_MyTable_01501_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
