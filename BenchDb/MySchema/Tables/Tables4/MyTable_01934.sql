CREATE TABLE [MySchema].[MyTable_01934] (
    ...
    CONSTRAINT [PK_MyTable_01934] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01934_MyTable01934] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01934] ([ColKey]),
    CONSTRAINT [BK_MyTable_01934_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
