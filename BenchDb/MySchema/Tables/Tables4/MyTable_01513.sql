CREATE TABLE [MySchema].[MyTable_01513] (
    ...
    CONSTRAINT [PK_MyTable_01513] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01513_MyTable01513] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01513] ([ColKey]),
    CONSTRAINT [BK_MyTable_01513_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
