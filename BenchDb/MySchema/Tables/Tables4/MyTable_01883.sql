CREATE TABLE [MySchema].[MyTable_01883] (
    ...
    CONSTRAINT [PK_MyTable_01883] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01883_MyTable01883] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01883] ([ColKey]),
    CONSTRAINT [BK_MyTable_01883_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
