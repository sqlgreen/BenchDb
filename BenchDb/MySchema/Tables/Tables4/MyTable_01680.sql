CREATE TABLE [MySchema].[MyTable_01680] (
    ...
    CONSTRAINT [PK_MyTable_01680] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01680_MyTable01680] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01680] ([ColKey]),
    CONSTRAINT [BK_MyTable_01680_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
