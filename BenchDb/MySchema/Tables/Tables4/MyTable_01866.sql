CREATE TABLE [MySchema].[MyTable_01866] (
    ...
    CONSTRAINT [PK_MyTable_01866] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01866_MyTable01866] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01866] ([ColKey]),
    CONSTRAINT [BK_MyTable_01866_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
