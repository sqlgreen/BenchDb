CREATE TABLE [MySchema].[MyTable_01625] (
    ...
    CONSTRAINT [PK_MyTable_01625] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01625_MyTable01625] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01625] ([ColKey]),
    CONSTRAINT [BK_MyTable_01625_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
