CREATE TABLE [MySchema].[MyTable_01745] (
    ...
    CONSTRAINT [PK_MyTable_01745] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01745_MyTable01745] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01745] ([ColKey]),
    CONSTRAINT [BK_MyTable_01745_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
