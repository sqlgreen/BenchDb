CREATE TABLE [MySchema].[MyTable_01953] (
    ...
    CONSTRAINT [PK_MyTable_01953] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01953_MyTable01953] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01953] ([ColKey]),
    CONSTRAINT [BK_MyTable_01953_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
