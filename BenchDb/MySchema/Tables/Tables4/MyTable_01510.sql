CREATE TABLE [MySchema].[MyTable_01510] (
    ...
    CONSTRAINT [PK_MyTable_01510] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01510_MyTable01510] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01510] ([ColKey]),
    CONSTRAINT [BK_MyTable_01510_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
