CREATE TABLE [MySchema].[MyTable_01956] (
    ...
    CONSTRAINT [PK_MyTable_01956] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01956_MyTable01956] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01956] ([ColKey]),
    CONSTRAINT [BK_MyTable_01956_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
