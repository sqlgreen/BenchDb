CREATE TABLE [MySchema].[MyTable_01638] (
    ...
    CONSTRAINT [PK_MyTable_01638] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01638_MyTable01638] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01638] ([ColKey]),
    CONSTRAINT [BK_MyTable_01638_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
