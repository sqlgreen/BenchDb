CREATE TABLE [MySchema].[MyTable_01569] (
    ...
    CONSTRAINT [PK_MyTable_01569] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01569_MyTable01569] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01569] ([ColKey]),
    CONSTRAINT [BK_MyTable_01569_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
