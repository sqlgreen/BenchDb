CREATE TABLE [MySchema].[MyTable_01733] (
    ...
    CONSTRAINT [PK_MyTable_01733] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01733_MyTable01733] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01733] ([ColKey]),
    CONSTRAINT [BK_MyTable_01733_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
