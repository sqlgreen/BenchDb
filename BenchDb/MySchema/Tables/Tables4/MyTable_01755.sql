CREATE TABLE [MySchema].[MyTable_01755] (
    ...
    CONSTRAINT [PK_MyTable_01755] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01755_MyTable01755] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01755] ([ColKey]),
    CONSTRAINT [BK_MyTable_01755_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
