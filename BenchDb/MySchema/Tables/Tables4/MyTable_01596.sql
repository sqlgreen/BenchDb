CREATE TABLE [MySchema].[MyTable_01596] (
    ...
    CONSTRAINT [PK_MyTable_01596] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01596_MyTable01596] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01596] ([ColKey]),
    CONSTRAINT [BK_MyTable_01596_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
