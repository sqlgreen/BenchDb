CREATE TABLE [MySchema].[MyTable_01740] (
    ...
    CONSTRAINT [PK_MyTable_01740] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01740_MyTable01740] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01740] ([ColKey]),
    CONSTRAINT [BK_MyTable_01740_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
