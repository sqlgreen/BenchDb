CREATE TABLE [MySchema].[MyTable_01716] (
    ...
    CONSTRAINT [PK_MyTable_01716] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01716_MyTable01716] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01716] ([ColKey]),
    CONSTRAINT [BK_MyTable_01716_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
