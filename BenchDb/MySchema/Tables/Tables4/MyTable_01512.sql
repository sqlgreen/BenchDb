CREATE TABLE [MySchema].[MyTable_01512] (
    ...
    CONSTRAINT [PK_MyTable_01512] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01512_MyTable01512] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01512] ([ColKey]),
    CONSTRAINT [BK_MyTable_01512_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
