CREATE TABLE [MySchema].[MyTable_01537] (
    ...
    CONSTRAINT [PK_MyTable_01537] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01537_MyTable01537] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01537] ([ColKey]),
    CONSTRAINT [BK_MyTable_01537_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
