CREATE TABLE [MySchema].[MyTable_01628] (
    ...
    CONSTRAINT [PK_MyTable_01628] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01628_MyTable01628] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01628] ([ColKey]),
    CONSTRAINT [BK_MyTable_01628_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
