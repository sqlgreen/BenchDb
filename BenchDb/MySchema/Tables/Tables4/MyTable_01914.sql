CREATE TABLE [MySchema].[MyTable_01914] (
    ...
    CONSTRAINT [PK_MyTable_01914] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01914_MyTable01914] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01914] ([ColKey]),
    CONSTRAINT [BK_MyTable_01914_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
