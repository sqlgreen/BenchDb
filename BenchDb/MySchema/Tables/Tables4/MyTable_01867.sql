CREATE TABLE [MySchema].[MyTable_01867] (
    ...
    CONSTRAINT [PK_MyTable_01867] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01867_MyTable01867] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01867] ([ColKey]),
    CONSTRAINT [BK_MyTable_01867_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
