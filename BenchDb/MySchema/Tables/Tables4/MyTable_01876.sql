CREATE TABLE [MySchema].[MyTable_01876] (
    ...
    CONSTRAINT [PK_MyTable_01876] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01876_MyTable01876] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01876] ([ColKey]),
    CONSTRAINT [BK_MyTable_01876_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
