CREATE TABLE [MySchema].[MyTable_01534] (
    ...
    CONSTRAINT [PK_MyTable_01534] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01534_MyTable01534] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01534] ([ColKey]),
    CONSTRAINT [BK_MyTable_01534_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
