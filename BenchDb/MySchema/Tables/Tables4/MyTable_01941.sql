CREATE TABLE [MySchema].[MyTable_01941] (
    ...
    CONSTRAINT [PK_MyTable_01941] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01941_MyTable01941] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01941] ([ColKey]),
    CONSTRAINT [BK_MyTable_01941_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
