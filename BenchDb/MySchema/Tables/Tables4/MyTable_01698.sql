CREATE TABLE [MySchema].[MyTable_01698] (
    ...
    CONSTRAINT [PK_MyTable_01698] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01698_MyTable01698] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01698] ([ColKey]),
    CONSTRAINT [BK_MyTable_01698_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
