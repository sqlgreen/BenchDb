CREATE TABLE [MySchema].[MyTable_01802] (
    ...
    CONSTRAINT [PK_MyTable_01802] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01802_MyTable01802] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01802] ([ColKey]),
    CONSTRAINT [BK_MyTable_01802_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
