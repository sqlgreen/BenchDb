CREATE TABLE [MySchema].[MyTable_01826] (
    ...
    CONSTRAINT [PK_MyTable_01826] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01826_MyTable01826] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01826] ([ColKey]),
    CONSTRAINT [BK_MyTable_01826_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
