CREATE TABLE [MySchema].[MyTable_01986] (
    ...
    CONSTRAINT [PK_MyTable_01986] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01986_MyTable01986] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01986] ([ColKey]),
    CONSTRAINT [BK_MyTable_01986_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
