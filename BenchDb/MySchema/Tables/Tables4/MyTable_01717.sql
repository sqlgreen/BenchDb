CREATE TABLE [MySchema].[MyTable_01717] (
    ...
    CONSTRAINT [PK_MyTable_01717] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01717_MyTable01717] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01717] ([ColKey]),
    CONSTRAINT [BK_MyTable_01717_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
