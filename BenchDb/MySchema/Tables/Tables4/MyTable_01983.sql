CREATE TABLE [MySchema].[MyTable_01983] (
    ...
    CONSTRAINT [PK_MyTable_01983] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01983_MyTable01983] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01983] ([ColKey]),
    CONSTRAINT [BK_MyTable_01983_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
