CREATE TABLE [MySchema].[MyTable_01798] (
    ...
    CONSTRAINT [PK_MyTable_01798] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01798_MyTable01798] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01798] ([ColKey]),
    CONSTRAINT [BK_MyTable_01798_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
