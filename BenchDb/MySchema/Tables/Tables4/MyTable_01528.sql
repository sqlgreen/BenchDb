CREATE TABLE [MySchema].[MyTable_01528] (
    ...
    CONSTRAINT [PK_MyTable_01528] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01528_MyTable01528] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01528] ([ColKey]),
    CONSTRAINT [BK_MyTable_01528_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
