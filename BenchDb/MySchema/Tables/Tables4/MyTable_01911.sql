CREATE TABLE [MySchema].[MyTable_01911] (
    ...
    CONSTRAINT [PK_MyTable_01911] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01911_MyTable01911] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01911] ([ColKey]),
    CONSTRAINT [BK_MyTable_01911_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
