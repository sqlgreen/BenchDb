CREATE TABLE [MySchema].[MyTable_01893] (
    ...
    CONSTRAINT [PK_MyTable_01893] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01893_MyTable01893] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01893] ([ColKey]),
    CONSTRAINT [BK_MyTable_01893_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
