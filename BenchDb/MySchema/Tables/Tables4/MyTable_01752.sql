CREATE TABLE [MySchema].[MyTable_01752] (
    ...
    CONSTRAINT [PK_MyTable_01752] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01752_MyTable01752] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01752] ([ColKey]),
    CONSTRAINT [BK_MyTable_01752_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
