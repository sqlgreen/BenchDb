CREATE TABLE [MySchema].[MyTable_01533] (
    ...
    CONSTRAINT [PK_MyTable_01533] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01533_MyTable01533] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01533] ([ColKey]),
    CONSTRAINT [BK_MyTable_01533_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
