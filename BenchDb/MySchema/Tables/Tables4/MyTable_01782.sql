CREATE TABLE [MySchema].[MyTable_01782] (
    ...
    CONSTRAINT [PK_MyTable_01782] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01782_MyTable01782] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01782] ([ColKey]),
    CONSTRAINT [BK_MyTable_01782_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
