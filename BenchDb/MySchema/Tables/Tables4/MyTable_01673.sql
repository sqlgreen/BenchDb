CREATE TABLE [MySchema].[MyTable_01673] (
    ...
    CONSTRAINT [PK_MyTable_01673] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01673_MyTable01673] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01673] ([ColKey]),
    CONSTRAINT [BK_MyTable_01673_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
