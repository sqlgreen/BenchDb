CREATE TABLE [MySchema].[MyTable_01776] (
    ...
    CONSTRAINT [PK_MyTable_01776] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01776_MyTable01776] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01776] ([ColKey]),
    CONSTRAINT [BK_MyTable_01776_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
