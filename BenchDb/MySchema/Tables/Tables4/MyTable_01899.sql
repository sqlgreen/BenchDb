CREATE TABLE [MySchema].[MyTable_01899] (
    ...
    CONSTRAINT [PK_MyTable_01899] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01899_MyTable01899] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01899] ([ColKey]),
    CONSTRAINT [BK_MyTable_01899_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
