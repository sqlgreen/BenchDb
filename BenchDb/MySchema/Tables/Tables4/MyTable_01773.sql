CREATE TABLE [MySchema].[MyTable_01773] (
    ...
    CONSTRAINT [PK_MyTable_01773] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01773_MyTable01773] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01773] ([ColKey]),
    CONSTRAINT [BK_MyTable_01773_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
