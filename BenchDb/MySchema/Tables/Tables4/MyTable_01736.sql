CREATE TABLE [MySchema].[MyTable_01736] (
    ...
    CONSTRAINT [PK_MyTable_01736] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01736_MyTable01736] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01736] ([ColKey]),
    CONSTRAINT [BK_MyTable_01736_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
