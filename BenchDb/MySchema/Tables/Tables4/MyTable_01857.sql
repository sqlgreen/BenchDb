CREATE TABLE [MySchema].[MyTable_01857] (
    ...
    CONSTRAINT [PK_MyTable_01857] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01857_MyTable01857] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01857] ([ColKey]),
    CONSTRAINT [BK_MyTable_01857_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
