CREATE TABLE [MySchema].[MyTable_01909] (
    ...
    CONSTRAINT [PK_MyTable_01909] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01909_MyTable01909] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01909] ([ColKey]),
    CONSTRAINT [BK_MyTable_01909_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
