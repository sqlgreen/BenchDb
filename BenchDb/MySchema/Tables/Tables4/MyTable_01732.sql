CREATE TABLE [MySchema].[MyTable_01732] (
    ...
    CONSTRAINT [PK_MyTable_01732] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01732_MyTable01732] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01732] ([ColKey]),
    CONSTRAINT [BK_MyTable_01732_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
