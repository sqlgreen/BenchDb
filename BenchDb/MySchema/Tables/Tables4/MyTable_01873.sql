CREATE TABLE [MySchema].[MyTable_01873] (
    ...
    CONSTRAINT [PK_MyTable_01873] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01873_MyTable01873] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01873] ([ColKey]),
    CONSTRAINT [BK_MyTable_01873_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
