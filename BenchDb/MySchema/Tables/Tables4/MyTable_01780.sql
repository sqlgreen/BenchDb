CREATE TABLE [MySchema].[MyTable_01780] (
    ...
    CONSTRAINT [PK_MyTable_01780] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01780_MyTable01780] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01780] ([ColKey]),
    CONSTRAINT [BK_MyTable_01780_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
