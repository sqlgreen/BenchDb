CREATE TABLE [MySchema].[MyTable_01864] (
    ...
    CONSTRAINT [PK_MyTable_01864] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01864_MyTable01864] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01864] ([ColKey]),
    CONSTRAINT [BK_MyTable_01864_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
