CREATE TABLE [MySchema].[MyTable_01886] (
    ...
    CONSTRAINT [PK_MyTable_01886] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01886_MyTable01886] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01886] ([ColKey]),
    CONSTRAINT [BK_MyTable_01886_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
