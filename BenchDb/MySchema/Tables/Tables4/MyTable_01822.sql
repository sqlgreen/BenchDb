CREATE TABLE [MySchema].[MyTable_01822] (
    ...
    CONSTRAINT [PK_MyTable_01822] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01822_MyTable01822] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01822] ([ColKey]),
    CONSTRAINT [BK_MyTable_01822_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
