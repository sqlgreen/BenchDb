CREATE TABLE [MySchema].[MyTable_01761] (
    ...
    CONSTRAINT [PK_MyTable_01761] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01761_MyTable01761] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01761] ([ColKey]),
    CONSTRAINT [BK_MyTable_01761_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
