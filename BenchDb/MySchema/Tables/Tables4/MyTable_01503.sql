CREATE TABLE [MySchema].[MyTable_01503] (
    ...
    CONSTRAINT [PK_MyTable_01503] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01503_MyTable01503] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01503] ([ColKey]),
    CONSTRAINT [BK_MyTable_01503_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
