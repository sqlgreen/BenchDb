CREATE TABLE [MySchema].[MyTable_01859] (
    ...
    CONSTRAINT [PK_MyTable_01859] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01859_MyTable01859] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01859] ([ColKey]),
    CONSTRAINT [BK_MyTable_01859_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
