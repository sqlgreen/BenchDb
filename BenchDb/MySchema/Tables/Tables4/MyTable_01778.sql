CREATE TABLE [MySchema].[MyTable_01778] (
    ...
    CONSTRAINT [PK_MyTable_01778] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01778_MyTable01778] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01778] ([ColKey]),
    CONSTRAINT [BK_MyTable_01778_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
