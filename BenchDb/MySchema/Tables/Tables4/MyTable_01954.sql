CREATE TABLE [MySchema].[MyTable_01954] (
    ...
    CONSTRAINT [PK_MyTable_01954] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01954_MyTable01954] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01954] ([ColKey]),
    CONSTRAINT [BK_MyTable_01954_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
