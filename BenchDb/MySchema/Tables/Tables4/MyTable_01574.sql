CREATE TABLE [MySchema].[MyTable_01574] (
    ...
    CONSTRAINT [PK_MyTable_01574] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01574_MyTable01574] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01574] ([ColKey]),
    CONSTRAINT [BK_MyTable_01574_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
