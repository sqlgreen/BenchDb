CREATE TABLE [MySchema].[MyTable_01930] (
    ...
    CONSTRAINT [PK_MyTable_01930] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01930_MyTable01930] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01930] ([ColKey]),
    CONSTRAINT [BK_MyTable_01930_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
