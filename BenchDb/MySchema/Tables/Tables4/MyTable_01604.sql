CREATE TABLE [MySchema].[MyTable_01604] (
    ...
    CONSTRAINT [PK_MyTable_01604] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01604_MyTable01604] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01604] ([ColKey]),
    CONSTRAINT [BK_MyTable_01604_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
