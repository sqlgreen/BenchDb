CREATE TABLE [MySchema].[MyTable_01655] (
    ...
    CONSTRAINT [PK_MyTable_01655] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01655_MyTable01655] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01655] ([ColKey]),
    CONSTRAINT [BK_MyTable_01655_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
