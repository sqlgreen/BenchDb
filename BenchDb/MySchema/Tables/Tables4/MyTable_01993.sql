CREATE TABLE [MySchema].[MyTable_01993] (
    ...
    CONSTRAINT [PK_MyTable_01993] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01993_MyTable01993] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01993] ([ColKey]),
    CONSTRAINT [BK_MyTable_01993_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
