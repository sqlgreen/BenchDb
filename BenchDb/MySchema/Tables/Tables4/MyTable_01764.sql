CREATE TABLE [MySchema].[MyTable_01764] (
    ...
    CONSTRAINT [PK_MyTable_01764] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01764_MyTable01764] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01764] ([ColKey]),
    CONSTRAINT [BK_MyTable_01764_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
