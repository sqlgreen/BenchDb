CREATE TABLE [MySchema].[MyTable_01715] (
    ...
    CONSTRAINT [PK_MyTable_01715] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01715_MyTable01715] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01715] ([ColKey]),
    CONSTRAINT [BK_MyTable_01715_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
