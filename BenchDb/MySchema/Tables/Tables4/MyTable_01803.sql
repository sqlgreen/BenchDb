CREATE TABLE [MySchema].[MyTable_01803] (
    ...
    CONSTRAINT [PK_MyTable_01803] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01803_MyTable01803] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01803] ([ColKey]),
    CONSTRAINT [BK_MyTable_01803_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
