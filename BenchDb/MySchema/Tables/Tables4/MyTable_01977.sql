CREATE TABLE [MySchema].[MyTable_01977] (
    ...
    CONSTRAINT [PK_MyTable_01977] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01977_MyTable01977] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01977] ([ColKey]),
    CONSTRAINT [BK_MyTable_01977_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
