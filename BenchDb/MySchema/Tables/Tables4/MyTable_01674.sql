CREATE TABLE [MySchema].[MyTable_01674] (
    ...
    CONSTRAINT [PK_MyTable_01674] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01674_MyTable01674] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01674] ([ColKey]),
    CONSTRAINT [BK_MyTable_01674_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
