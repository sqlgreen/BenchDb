CREATE TABLE [MySchema].[MyTable_01599] (
    ...
    CONSTRAINT [PK_MyTable_01599] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01599_MyTable01599] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01599] ([ColKey]),
    CONSTRAINT [BK_MyTable_01599_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
