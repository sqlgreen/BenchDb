CREATE TABLE [MySchema].[MyTable_01945] (
    ...
    CONSTRAINT [PK_MyTable_01945] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01945_MyTable01945] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01945] ([ColKey]),
    CONSTRAINT [BK_MyTable_01945_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
