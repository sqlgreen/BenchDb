CREATE TABLE [MySchema].[MyTable_01683] (
    ...
    CONSTRAINT [PK_MyTable_01683] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01683_MyTable01683] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01683] ([ColKey]),
    CONSTRAINT [BK_MyTable_01683_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
