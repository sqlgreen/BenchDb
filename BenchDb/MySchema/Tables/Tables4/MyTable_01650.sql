CREATE TABLE [MySchema].[MyTable_01650] (
    ...
    CONSTRAINT [PK_MyTable_01650] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01650_MyTable01650] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01650] ([ColKey]),
    CONSTRAINT [BK_MyTable_01650_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
