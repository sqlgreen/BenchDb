CREATE TABLE [MySchema].[MyTable_01852] (
    ...
    CONSTRAINT [PK_MyTable_01852] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01852_MyTable01852] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01852] ([ColKey]),
    CONSTRAINT [BK_MyTable_01852_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
