CREATE TABLE [MySchema].[MyTable_01821] (
    ...
    CONSTRAINT [PK_MyTable_01821] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01821_MyTable01821] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01821] ([ColKey]),
    CONSTRAINT [BK_MyTable_01821_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
