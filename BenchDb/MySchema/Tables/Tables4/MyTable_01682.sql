CREATE TABLE [MySchema].[MyTable_01682] (
    ...
    CONSTRAINT [PK_MyTable_01682] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01682_MyTable01682] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01682] ([ColKey]),
    CONSTRAINT [BK_MyTable_01682_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
