CREATE TABLE [MySchema].[MyTable_01943] (
    ...
    CONSTRAINT [PK_MyTable_01943] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01943_MyTable01943] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01943] ([ColKey]),
    CONSTRAINT [BK_MyTable_01943_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
