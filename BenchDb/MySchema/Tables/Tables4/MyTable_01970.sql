CREATE TABLE [MySchema].[MyTable_01970] (
    ...
    CONSTRAINT [PK_MyTable_01970] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01970_MyTable01970] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01970] ([ColKey]),
    CONSTRAINT [BK_MyTable_01970_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
