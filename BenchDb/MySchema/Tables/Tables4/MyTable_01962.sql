CREATE TABLE [MySchema].[MyTable_01962] (
    ...
    CONSTRAINT [PK_MyTable_01962] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01962_MyTable01962] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01962] ([ColKey]),
    CONSTRAINT [BK_MyTable_01962_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
