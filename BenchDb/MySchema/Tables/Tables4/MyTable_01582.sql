CREATE TABLE [MySchema].[MyTable_01582] (
    ...
    CONSTRAINT [PK_MyTable_01582] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01582_MyTable01582] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01582] ([ColKey]),
    CONSTRAINT [BK_MyTable_01582_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
