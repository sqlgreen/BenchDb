CREATE TABLE [MySchema].[MyTable_01649] (
    ...
    CONSTRAINT [PK_MyTable_01649] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01649_MyTable01649] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01649] ([ColKey]),
    CONSTRAINT [BK_MyTable_01649_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
