CREATE TABLE [MySchema].[MyTable_01881] (
    ...
    CONSTRAINT [PK_MyTable_01881] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01881_MyTable01881] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01881] ([ColKey]),
    CONSTRAINT [BK_MyTable_01881_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
