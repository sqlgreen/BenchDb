CREATE TABLE [MySchema].[MyTable_01686] (
    ...
    CONSTRAINT [PK_MyTable_01686] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01686_MyTable01686] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01686] ([ColKey]),
    CONSTRAINT [BK_MyTable_01686_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
