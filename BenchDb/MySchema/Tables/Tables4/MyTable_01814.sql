CREATE TABLE [MySchema].[MyTable_01814] (
    ...
    CONSTRAINT [PK_MyTable_01814] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01814_MyTable01814] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01814] ([ColKey]),
    CONSTRAINT [BK_MyTable_01814_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
