CREATE TABLE [MySchema].[MyTable_01568] (
    ...
    CONSTRAINT [PK_MyTable_01568] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01568_MyTable01568] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01568] ([ColKey]),
    CONSTRAINT [BK_MyTable_01568_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
