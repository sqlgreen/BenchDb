CREATE TABLE [MySchema].[MyTable_01588] (
    ...
    CONSTRAINT [PK_MyTable_01588] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01588_MyTable01588] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01588] ([ColKey]),
    CONSTRAINT [BK_MyTable_01588_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
