CREATE TABLE [MySchema].[MyTable_01987] (
    ...
    CONSTRAINT [PK_MyTable_01987] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01987_MyTable01987] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01987] ([ColKey]),
    CONSTRAINT [BK_MyTable_01987_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
