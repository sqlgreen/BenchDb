CREATE TABLE [MySchema].[MyTable_01845] (
    ...
    CONSTRAINT [PK_MyTable_01845] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01845_MyTable01845] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01845] ([ColKey]),
    CONSTRAINT [BK_MyTable_01845_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
