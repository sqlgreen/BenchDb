CREATE TABLE [MySchema].[MyTable_01579] (
    ...
    CONSTRAINT [PK_MyTable_01579] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01579_MyTable01579] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01579] ([ColKey]),
    CONSTRAINT [BK_MyTable_01579_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
