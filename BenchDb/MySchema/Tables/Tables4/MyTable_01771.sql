CREATE TABLE [MySchema].[MyTable_01771] (
    ...
    CONSTRAINT [PK_MyTable_01771] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01771_MyTable01771] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01771] ([ColKey]),
    CONSTRAINT [BK_MyTable_01771_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
