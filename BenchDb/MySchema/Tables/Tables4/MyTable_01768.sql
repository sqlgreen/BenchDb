CREATE TABLE [MySchema].[MyTable_01768] (
    ...
    CONSTRAINT [PK_MyTable_01768] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01768_MyTable01768] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01768] ([ColKey]),
    CONSTRAINT [BK_MyTable_01768_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
