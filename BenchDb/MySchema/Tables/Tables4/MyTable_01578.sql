CREATE TABLE [MySchema].[MyTable_01578] (
    ...
    CONSTRAINT [PK_MyTable_01578] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01578_MyTable01578] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01578] ([ColKey]),
    CONSTRAINT [BK_MyTable_01578_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
