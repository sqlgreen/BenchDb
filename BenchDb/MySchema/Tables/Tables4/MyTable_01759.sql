CREATE TABLE [MySchema].[MyTable_01759] (
    ...
    CONSTRAINT [PK_MyTable_01759] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01759_MyTable01759] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01759] ([ColKey]),
    CONSTRAINT [BK_MyTable_01759_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
