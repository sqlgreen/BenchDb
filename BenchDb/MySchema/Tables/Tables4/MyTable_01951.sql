CREATE TABLE [MySchema].[MyTable_01951] (
    ...
    CONSTRAINT [PK_MyTable_01951] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01951_MyTable01951] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01951] ([ColKey]),
    CONSTRAINT [BK_MyTable_01951_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
