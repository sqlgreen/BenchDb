CREATE TABLE [MySchema].[MyTable_01688] (
    ...
    CONSTRAINT [PK_MyTable_01688] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01688_MyTable01688] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01688] ([ColKey]),
    CONSTRAINT [BK_MyTable_01688_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
