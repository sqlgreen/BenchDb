CREATE TABLE [MySchema].[MyTable_01635] (
    ...
    CONSTRAINT [PK_MyTable_01635] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01635_MyTable01635] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01635] ([ColKey]),
    CONSTRAINT [BK_MyTable_01635_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
