CREATE TABLE [MySchema].[MyTable_01722] (
    ...
    CONSTRAINT [PK_MyTable_01722] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01722_MyTable01722] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01722] ([ColKey]),
    CONSTRAINT [BK_MyTable_01722_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
