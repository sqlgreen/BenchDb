CREATE TABLE [MySchema].[MyTable_01940] (
    ...
    CONSTRAINT [PK_MyTable_01940] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01940_MyTable01940] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01940] ([ColKey]),
    CONSTRAINT [BK_MyTable_01940_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
