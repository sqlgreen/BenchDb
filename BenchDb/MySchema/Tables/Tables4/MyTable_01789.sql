CREATE TABLE [MySchema].[MyTable_01789] (
    ...
    CONSTRAINT [PK_MyTable_01789] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01789_MyTable01789] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01789] ([ColKey]),
    CONSTRAINT [BK_MyTable_01789_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
