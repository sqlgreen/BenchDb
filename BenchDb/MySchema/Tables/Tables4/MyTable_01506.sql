CREATE TABLE [MySchema].[MyTable_01506] (
    ...
    CONSTRAINT [PK_MyTable_01506] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01506_MyTable01506] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01506] ([ColKey]),
    CONSTRAINT [BK_MyTable_01506_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
