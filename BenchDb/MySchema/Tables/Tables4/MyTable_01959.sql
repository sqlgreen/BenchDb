CREATE TABLE [MySchema].[MyTable_01959] (
    ...
    CONSTRAINT [PK_MyTable_01959] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01959_MyTable01959] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01959] ([ColKey]),
    CONSTRAINT [BK_MyTable_01959_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
