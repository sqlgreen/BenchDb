CREATE TABLE [MySchema].[MyTable_01882] (
    ...
    CONSTRAINT [PK_MyTable_01882] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01882_MyTable01882] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01882] ([ColKey]),
    CONSTRAINT [BK_MyTable_01882_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
