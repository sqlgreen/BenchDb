CREATE TABLE [MySchema].[MyTable_01546] (
    ...
    CONSTRAINT [PK_MyTable_01546] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01546_MyTable01546] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01546] ([ColKey]),
    CONSTRAINT [BK_MyTable_01546_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
