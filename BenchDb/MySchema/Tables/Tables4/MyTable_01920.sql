CREATE TABLE [MySchema].[MyTable_01920] (
    ...
    CONSTRAINT [PK_MyTable_01920] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01920_MyTable01920] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01920] ([ColKey]),
    CONSTRAINT [BK_MyTable_01920_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
