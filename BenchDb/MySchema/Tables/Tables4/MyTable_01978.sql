CREATE TABLE [MySchema].[MyTable_01978] (
    ...
    CONSTRAINT [PK_MyTable_01978] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01978_MyTable01978] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01978] ([ColKey]),
    CONSTRAINT [BK_MyTable_01978_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
