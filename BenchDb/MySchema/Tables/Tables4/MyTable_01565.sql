CREATE TABLE [MySchema].[MyTable_01565] (
    ...
    CONSTRAINT [PK_MyTable_01565] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01565_MyTable01565] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01565] ([ColKey]),
    CONSTRAINT [BK_MyTable_01565_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
