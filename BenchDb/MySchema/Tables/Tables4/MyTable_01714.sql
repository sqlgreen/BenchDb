CREATE TABLE [MySchema].[MyTable_01714] (
    ...
    CONSTRAINT [PK_MyTable_01714] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01714_MyTable01714] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01714] ([ColKey]),
    CONSTRAINT [BK_MyTable_01714_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
