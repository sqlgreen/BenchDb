CREATE TABLE [MySchema].[MyTable_01660] (
    ...
    CONSTRAINT [PK_MyTable_01660] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01660_MyTable01660] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01660] ([ColKey]),
    CONSTRAINT [BK_MyTable_01660_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
