CREATE TABLE [MySchema].[MyTable_01895] (
    ...
    CONSTRAINT [PK_MyTable_01895] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01895_MyTable01895] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01895] ([ColKey]),
    CONSTRAINT [BK_MyTable_01895_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
