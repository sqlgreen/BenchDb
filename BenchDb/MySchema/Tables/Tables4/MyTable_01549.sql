CREATE TABLE [MySchema].[MyTable_01549] (
    ...
    CONSTRAINT [PK_MyTable_01549] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01549_MyTable01549] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01549] ([ColKey]),
    CONSTRAINT [BK_MyTable_01549_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
