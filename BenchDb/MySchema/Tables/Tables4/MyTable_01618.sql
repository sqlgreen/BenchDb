CREATE TABLE [MySchema].[MyTable_01618] (
    ...
    CONSTRAINT [PK_MyTable_01618] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01618_MyTable01618] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01618] ([ColKey]),
    CONSTRAINT [BK_MyTable_01618_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
