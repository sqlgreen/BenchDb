CREATE TABLE [MySchema].[MyTable_01580] (
    ...
    CONSTRAINT [PK_MyTable_01580] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01580_MyTable01580] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01580] ([ColKey]),
    CONSTRAINT [BK_MyTable_01580_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
