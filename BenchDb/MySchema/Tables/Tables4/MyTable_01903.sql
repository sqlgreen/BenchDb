CREATE TABLE [MySchema].[MyTable_01903] (
    ...
    CONSTRAINT [PK_MyTable_01903] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01903_MyTable01903] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01903] ([ColKey]),
    CONSTRAINT [BK_MyTable_01903_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
