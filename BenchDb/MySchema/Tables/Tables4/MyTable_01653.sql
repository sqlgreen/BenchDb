CREATE TABLE [MySchema].[MyTable_01653] (
    ...
    CONSTRAINT [PK_MyTable_01653] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01653_MyTable01653] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01653] ([ColKey]),
    CONSTRAINT [BK_MyTable_01653_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
