CREATE TABLE [MySchema].[MyTable_01907] (
    ...
    CONSTRAINT [PK_MyTable_01907] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01907_MyTable01907] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01907] ([ColKey]),
    CONSTRAINT [BK_MyTable_01907_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
