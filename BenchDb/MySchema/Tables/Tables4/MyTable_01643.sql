CREATE TABLE [MySchema].[MyTable_01643] (
    ...
    CONSTRAINT [PK_MyTable_01643] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01643_MyTable01643] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01643] ([ColKey]),
    CONSTRAINT [BK_MyTable_01643_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
