CREATE TABLE [MySchema].[MyTable_01844] (
    ...
    CONSTRAINT [PK_MyTable_01844] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01844_MyTable01844] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01844] ([ColKey]),
    CONSTRAINT [BK_MyTable_01844_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
