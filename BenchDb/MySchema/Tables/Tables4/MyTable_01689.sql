CREATE TABLE [MySchema].[MyTable_01689] (
    ...
    CONSTRAINT [PK_MyTable_01689] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01689_MyTable01689] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01689] ([ColKey]),
    CONSTRAINT [BK_MyTable_01689_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
