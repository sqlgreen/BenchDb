CREATE TABLE [MySchema].[MyTable_01544] (
    ...
    CONSTRAINT [PK_MyTable_01544] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01544_MyTable01544] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01544] ([ColKey]),
    CONSTRAINT [BK_MyTable_01544_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
