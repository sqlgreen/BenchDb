CREATE TABLE [MySchema].[MyTable_01860] (
    ...
    CONSTRAINT [PK_MyTable_01860] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01860_MyTable01860] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01860] ([ColKey]),
    CONSTRAINT [BK_MyTable_01860_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
