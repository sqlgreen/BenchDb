CREATE TABLE [MySchema].[MyTable_01926] (
    ...
    CONSTRAINT [PK_MyTable_01926] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01926_MyTable01926] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01926] ([ColKey]),
    CONSTRAINT [BK_MyTable_01926_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
