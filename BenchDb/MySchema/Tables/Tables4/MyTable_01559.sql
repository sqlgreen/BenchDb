CREATE TABLE [MySchema].[MyTable_01559] (
    ...
    CONSTRAINT [PK_MyTable_01559] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01559_MyTable01559] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01559] ([ColKey]),
    CONSTRAINT [BK_MyTable_01559_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
