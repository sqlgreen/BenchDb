CREATE TABLE [MySchema].[MyTable_01842] (
    ...
    CONSTRAINT [PK_MyTable_01842] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01842_MyTable01842] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01842] ([ColKey]),
    CONSTRAINT [BK_MyTable_01842_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
