CREATE TABLE [MySchema].[MyTable_01817] (
    ...
    CONSTRAINT [PK_MyTable_01817] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01817_MyTable01817] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01817] ([ColKey]),
    CONSTRAINT [BK_MyTable_01817_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
