CREATE TABLE [MySchema].[MyTable_01790] (
    ...
    CONSTRAINT [PK_MyTable_01790] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01790_MyTable01790] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01790] ([ColKey]),
    CONSTRAINT [BK_MyTable_01790_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
