CREATE TABLE [MySchema].[MyTable_01567] (
    ...
    CONSTRAINT [PK_MyTable_01567] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01567_MyTable01567] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01567] ([ColKey]),
    CONSTRAINT [BK_MyTable_01567_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
