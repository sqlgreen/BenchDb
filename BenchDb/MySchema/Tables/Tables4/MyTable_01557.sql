CREATE TABLE [MySchema].[MyTable_01557] (
    ...
    CONSTRAINT [PK_MyTable_01557] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01557_MyTable01557] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01557] ([ColKey]),
    CONSTRAINT [BK_MyTable_01557_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
