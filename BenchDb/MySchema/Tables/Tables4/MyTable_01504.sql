CREATE TABLE [MySchema].[MyTable_01504] (
    ...
    CONSTRAINT [PK_MyTable_01504] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01504_MyTable01504] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01504] ([ColKey]),
    CONSTRAINT [BK_MyTable_01504_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
