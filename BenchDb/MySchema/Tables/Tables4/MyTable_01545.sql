CREATE TABLE [MySchema].[MyTable_01545] (
    ...
    CONSTRAINT [PK_MyTable_01545] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01545_MyTable01545] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01545] ([ColKey]),
    CONSTRAINT [BK_MyTable_01545_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
