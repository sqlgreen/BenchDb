CREATE TABLE [MySchema].[MyTable_01593] (
    ...
    CONSTRAINT [PK_MyTable_01593] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01593_MyTable01593] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01593] ([ColKey]),
    CONSTRAINT [BK_MyTable_01593_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
