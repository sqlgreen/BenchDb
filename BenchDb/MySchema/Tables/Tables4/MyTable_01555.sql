CREATE TABLE [MySchema].[MyTable_01555] (
    ...
    CONSTRAINT [PK_MyTable_01555] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01555_MyTable01555] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01555] ([ColKey]),
    CONSTRAINT [BK_MyTable_01555_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
