CREATE TABLE [MySchema].[MyTable_01912] (
    ...
    CONSTRAINT [PK_MyTable_01912] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01912_MyTable01912] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01912] ([ColKey]),
    CONSTRAINT [BK_MyTable_01912_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
