CREATE TABLE [MySchema].[MyTable_01675] (
    ...
    CONSTRAINT [PK_MyTable_01675] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01675_MyTable01675] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01675] ([ColKey]),
    CONSTRAINT [BK_MyTable_01675_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
