CREATE TABLE [MySchema].[MyTable_01652] (
    ...
    CONSTRAINT [PK_MyTable_01652] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01652_MyTable01652] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01652] ([ColKey]),
    CONSTRAINT [BK_MyTable_01652_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
