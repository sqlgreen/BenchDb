CREATE TABLE [MySchema].[MyTable_01646] (
    ...
    CONSTRAINT [PK_MyTable_01646] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01646_MyTable01646] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01646] ([ColKey]),
    CONSTRAINT [BK_MyTable_01646_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
