CREATE TABLE [MySchema].[MyTable_01753] (
    ...
    CONSTRAINT [PK_MyTable_01753] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01753_MyTable01753] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01753] ([ColKey]),
    CONSTRAINT [BK_MyTable_01753_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
