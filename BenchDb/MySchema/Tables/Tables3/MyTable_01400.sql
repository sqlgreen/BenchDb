CREATE TABLE [MySchema].[MyTable_01400] (
    ...
    CONSTRAINT [PK_MyTable_01400] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01400_MyTable01400] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01400] ([ColKey]),
    CONSTRAINT [BK_MyTable_01400_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
