CREATE TABLE [MySchema].[MyTable_01398] (
    ...
    CONSTRAINT [PK_MyTable_01398] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01398_MyTable01398] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01398] ([ColKey]),
    CONSTRAINT [BK_MyTable_01398_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
