CREATE TABLE [MySchema].[MyTable_01215] (
    ...
    CONSTRAINT [PK_MyTable_01215] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01215_MyTable01215] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01215] ([ColKey]),
    CONSTRAINT [BK_MyTable_01215_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
