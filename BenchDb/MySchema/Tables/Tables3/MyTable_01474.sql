CREATE TABLE [MySchema].[MyTable_01474] (
    ...
    CONSTRAINT [PK_MyTable_01474] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01474_MyTable01474] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01474] ([ColKey]),
    CONSTRAINT [BK_MyTable_01474_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
