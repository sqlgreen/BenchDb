CREATE TABLE [MySchema].[MyTable_01323] (
    ...
    CONSTRAINT [PK_MyTable_01323] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01323_MyTable01323] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01323] ([ColKey]),
    CONSTRAINT [BK_MyTable_01323_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
