CREATE TABLE [MySchema].[MyTable_01301] (
    ...
    CONSTRAINT [PK_MyTable_01301] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01301_MyTable01301] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01301] ([ColKey]),
    CONSTRAINT [BK_MyTable_01301_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
