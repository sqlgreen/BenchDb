CREATE TABLE [MySchema].[MyTable_01331] (
    ...
    CONSTRAINT [PK_MyTable_01331] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01331_MyTable01331] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01331] ([ColKey]),
    CONSTRAINT [BK_MyTable_01331_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
