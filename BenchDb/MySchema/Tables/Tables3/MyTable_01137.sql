CREATE TABLE [MySchema].[MyTable_01137] (
    ...
    CONSTRAINT [PK_MyTable_01137] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01137_MyTable01137] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01137] ([ColKey]),
    CONSTRAINT [BK_MyTable_01137_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
