CREATE TABLE [MySchema].[MyTable_01484] (
    ...
    CONSTRAINT [PK_MyTable_01484] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01484_MyTable01484] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01484] ([ColKey]),
    CONSTRAINT [BK_MyTable_01484_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
