CREATE TABLE [MySchema].[MyTable_01413] (
    ...
    CONSTRAINT [PK_MyTable_01413] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01413_MyTable01413] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01413] ([ColKey]),
    CONSTRAINT [BK_MyTable_01413_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
