CREATE TABLE [MySchema].[MyTable_01069] (
    ...
    CONSTRAINT [PK_MyTable_01069] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01069_MyTable01069] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01069] ([ColKey]),
    CONSTRAINT [BK_MyTable_01069_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
