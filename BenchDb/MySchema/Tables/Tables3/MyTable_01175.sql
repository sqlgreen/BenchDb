CREATE TABLE [MySchema].[MyTable_01175] (
    ...
    CONSTRAINT [PK_MyTable_01175] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01175_MyTable01175] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01175] ([ColKey]),
    CONSTRAINT [BK_MyTable_01175_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
