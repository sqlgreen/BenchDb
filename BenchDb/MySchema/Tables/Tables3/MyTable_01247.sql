CREATE TABLE [MySchema].[MyTable_01247] (
    ...
    CONSTRAINT [PK_MyTable_01247] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01247_MyTable01247] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01247] ([ColKey]),
    CONSTRAINT [BK_MyTable_01247_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
