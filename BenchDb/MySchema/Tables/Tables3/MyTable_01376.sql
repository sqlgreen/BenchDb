CREATE TABLE [MySchema].[MyTable_01376] (
    ...
    CONSTRAINT [PK_MyTable_01376] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01376_MyTable01376] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01376] ([ColKey]),
    CONSTRAINT [BK_MyTable_01376_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
