CREATE TABLE [MySchema].[MyTable_01183] (
    ...
    CONSTRAINT [PK_MyTable_01183] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01183_MyTable01183] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01183] ([ColKey]),
    CONSTRAINT [BK_MyTable_01183_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
