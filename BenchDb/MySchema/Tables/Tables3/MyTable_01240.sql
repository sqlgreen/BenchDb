CREATE TABLE [MySchema].[MyTable_01240] (
    ...
    CONSTRAINT [PK_MyTable_01240] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01240_MyTable01240] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01240] ([ColKey]),
    CONSTRAINT [BK_MyTable_01240_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
