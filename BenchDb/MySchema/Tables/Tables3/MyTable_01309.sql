CREATE TABLE [MySchema].[MyTable_01309] (
    ...
    CONSTRAINT [PK_MyTable_01309] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01309_MyTable01309] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01309] ([ColKey]),
    CONSTRAINT [BK_MyTable_01309_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
