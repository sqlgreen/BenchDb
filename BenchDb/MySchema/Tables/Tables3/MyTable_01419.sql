CREATE TABLE [MySchema].[MyTable_01419] (
    ...
    CONSTRAINT [PK_MyTable_01419] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01419_MyTable01419] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01419] ([ColKey]),
    CONSTRAINT [BK_MyTable_01419_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
