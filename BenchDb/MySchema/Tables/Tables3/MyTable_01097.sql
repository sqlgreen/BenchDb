CREATE TABLE [MySchema].[MyTable_01097] (
    ...
    CONSTRAINT [PK_MyTable_01097] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01097_MyTable01097] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01097] ([ColKey]),
    CONSTRAINT [BK_MyTable_01097_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
