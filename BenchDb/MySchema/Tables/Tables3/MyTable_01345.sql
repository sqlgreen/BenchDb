CREATE TABLE [MySchema].[MyTable_01345] (
    ...
    CONSTRAINT [PK_MyTable_01345] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01345_MyTable01345] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01345] ([ColKey]),
    CONSTRAINT [BK_MyTable_01345_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
