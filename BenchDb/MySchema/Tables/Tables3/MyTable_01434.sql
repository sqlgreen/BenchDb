CREATE TABLE [MySchema].[MyTable_01434] (
    ...
    CONSTRAINT [PK_MyTable_01434] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01434_MyTable01434] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01434] ([ColKey]),
    CONSTRAINT [BK_MyTable_01434_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
