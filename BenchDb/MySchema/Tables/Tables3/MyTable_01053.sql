CREATE TABLE [MySchema].[MyTable_01053] (
    ...
    CONSTRAINT [PK_MyTable_01053] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01053_MyTable01053] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01053] ([ColKey]),
    CONSTRAINT [BK_MyTable_01053_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
