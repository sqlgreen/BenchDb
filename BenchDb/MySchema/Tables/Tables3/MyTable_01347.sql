CREATE TABLE [MySchema].[MyTable_01347] (
    ...
    CONSTRAINT [PK_MyTable_01347] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01347_MyTable01347] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01347] ([ColKey]),
    CONSTRAINT [BK_MyTable_01347_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
