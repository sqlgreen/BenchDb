CREATE TABLE [MySchema].[MyTable_01162] (
    ...
    CONSTRAINT [PK_MyTable_01162] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01162_MyTable01162] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01162] ([ColKey]),
    CONSTRAINT [BK_MyTable_01162_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
