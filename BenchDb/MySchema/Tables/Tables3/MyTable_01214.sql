CREATE TABLE [MySchema].[MyTable_01214] (
    ...
    CONSTRAINT [PK_MyTable_01214] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01214_MyTable01214] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01214] ([ColKey]),
    CONSTRAINT [BK_MyTable_01214_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
