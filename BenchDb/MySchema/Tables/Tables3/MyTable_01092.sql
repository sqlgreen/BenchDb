CREATE TABLE [MySchema].[MyTable_01092] (
    ...
    CONSTRAINT [PK_MyTable_01092] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01092_MyTable01092] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01092] ([ColKey]),
    CONSTRAINT [BK_MyTable_01092_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
