CREATE TABLE [MySchema].[MyTable_01280] (
    ...
    CONSTRAINT [PK_MyTable_01280] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01280_MyTable01280] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01280] ([ColKey]),
    CONSTRAINT [BK_MyTable_01280_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
