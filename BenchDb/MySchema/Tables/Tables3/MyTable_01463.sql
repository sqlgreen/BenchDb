CREATE TABLE [MySchema].[MyTable_01463] (
    ...
    CONSTRAINT [PK_MyTable_01463] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01463_MyTable01463] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01463] ([ColKey]),
    CONSTRAINT [BK_MyTable_01463_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
