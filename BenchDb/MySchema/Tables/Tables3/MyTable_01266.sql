CREATE TABLE [MySchema].[MyTable_01266] (
    ...
    CONSTRAINT [PK_MyTable_01266] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01266_MyTable01266] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01266] ([ColKey]),
    CONSTRAINT [BK_MyTable_01266_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
