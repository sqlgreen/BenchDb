CREATE TABLE [MySchema].[MyTable_01482] (
    ...
    CONSTRAINT [PK_MyTable_01482] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01482_MyTable01482] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01482] ([ColKey]),
    CONSTRAINT [BK_MyTable_01482_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
