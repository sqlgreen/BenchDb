CREATE TABLE [MySchema].[MyTable_01050] (
    ...
    CONSTRAINT [PK_MyTable_01050] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01050_MyTable01050] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01050] ([ColKey]),
    CONSTRAINT [BK_MyTable_01050_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
