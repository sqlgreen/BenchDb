CREATE TABLE [MySchema].[MyTable_01086] (
    ...
    CONSTRAINT [PK_MyTable_01086] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01086_MyTable01086] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01086] ([ColKey]),
    CONSTRAINT [BK_MyTable_01086_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
