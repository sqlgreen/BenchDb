CREATE TABLE [MySchema].[MyTable_01068] (
    ...
    CONSTRAINT [PK_MyTable_01068] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01068_MyTable01068] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01068] ([ColKey]),
    CONSTRAINT [BK_MyTable_01068_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
