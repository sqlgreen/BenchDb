CREATE TABLE [MySchema].[MyTable_01273] (
    ...
    CONSTRAINT [PK_MyTable_01273] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01273_MyTable01273] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01273] ([ColKey]),
    CONSTRAINT [BK_MyTable_01273_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
