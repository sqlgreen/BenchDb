CREATE TABLE [MySchema].[MyTable_01395] (
    ...
    CONSTRAINT [PK_MyTable_01395] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01395_MyTable01395] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01395] ([ColKey]),
    CONSTRAINT [BK_MyTable_01395_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
