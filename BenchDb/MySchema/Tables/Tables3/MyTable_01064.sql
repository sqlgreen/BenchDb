CREATE TABLE [MySchema].[MyTable_01064] (
    ...
    CONSTRAINT [PK_MyTable_01064] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01064_MyTable01064] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01064] ([ColKey]),
    CONSTRAINT [BK_MyTable_01064_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
