CREATE TABLE [MySchema].[MyTable_01394] (
    ...
    CONSTRAINT [PK_MyTable_01394] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01394_MyTable01394] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01394] ([ColKey]),
    CONSTRAINT [BK_MyTable_01394_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
