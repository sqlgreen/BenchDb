CREATE TABLE [MySchema].[MyTable_01282] (
    ...
    CONSTRAINT [PK_MyTable_01282] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01282_MyTable01282] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01282] ([ColKey]),
    CONSTRAINT [BK_MyTable_01282_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
