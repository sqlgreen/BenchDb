CREATE TABLE [MySchema].[MyTable_01136] (
    ...
    CONSTRAINT [PK_MyTable_01136] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01136_MyTable01136] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01136] ([ColKey]),
    CONSTRAINT [BK_MyTable_01136_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
