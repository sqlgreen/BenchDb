CREATE TABLE [MySchema].[MyTable_01369] (
    ...
    CONSTRAINT [PK_MyTable_01369] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01369_MyTable01369] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01369] ([ColKey]),
    CONSTRAINT [BK_MyTable_01369_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
