CREATE TABLE [MySchema].[MyTable_01311] (
    ...
    CONSTRAINT [PK_MyTable_01311] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01311_MyTable01311] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01311] ([ColKey]),
    CONSTRAINT [BK_MyTable_01311_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
