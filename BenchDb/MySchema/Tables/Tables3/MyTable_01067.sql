CREATE TABLE [MySchema].[MyTable_01067] (
    ...
    CONSTRAINT [PK_MyTable_01067] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01067_MyTable01067] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01067] ([ColKey]),
    CONSTRAINT [BK_MyTable_01067_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
