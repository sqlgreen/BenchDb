CREATE TABLE [MySchema].[MyTable_01342] (
    ...
    CONSTRAINT [PK_MyTable_01342] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01342_MyTable01342] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01342] ([ColKey]),
    CONSTRAINT [BK_MyTable_01342_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
