CREATE TABLE [MySchema].[MyTable_01191] (
    ...
    CONSTRAINT [PK_MyTable_01191] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01191_MyTable01191] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01191] ([ColKey]),
    CONSTRAINT [BK_MyTable_01191_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
