CREATE TABLE [MySchema].[MyTable_01164] (
    ...
    CONSTRAINT [PK_MyTable_01164] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01164_MyTable01164] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01164] ([ColKey]),
    CONSTRAINT [BK_MyTable_01164_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
