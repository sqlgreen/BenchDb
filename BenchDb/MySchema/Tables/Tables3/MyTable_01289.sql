CREATE TABLE [MySchema].[MyTable_01289] (
    ...
    CONSTRAINT [PK_MyTable_01289] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01289_MyTable01289] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01289] ([ColKey]),
    CONSTRAINT [BK_MyTable_01289_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
