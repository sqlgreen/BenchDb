CREATE TABLE [MySchema].[MyTable_01283] (
    ...
    CONSTRAINT [PK_MyTable_01283] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01283_MyTable01283] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01283] ([ColKey]),
    CONSTRAINT [BK_MyTable_01283_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
