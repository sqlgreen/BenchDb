CREATE TABLE [MySchema].[MyTable_01152] (
    ...
    CONSTRAINT [PK_MyTable_01152] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01152_MyTable01152] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01152] ([ColKey]),
    CONSTRAINT [BK_MyTable_01152_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
