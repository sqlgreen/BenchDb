CREATE TABLE [MySchema].[MyTable_01492] (
    ...
    CONSTRAINT [PK_MyTable_01492] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01492_MyTable01492] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01492] ([ColKey]),
    CONSTRAINT [BK_MyTable_01492_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
