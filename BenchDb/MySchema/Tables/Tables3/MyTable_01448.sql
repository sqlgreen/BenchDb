CREATE TABLE [MySchema].[MyTable_01448] (
    ...
    CONSTRAINT [PK_MyTable_01448] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01448_MyTable01448] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01448] ([ColKey]),
    CONSTRAINT [BK_MyTable_01448_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
