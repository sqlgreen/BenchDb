CREATE TABLE [MySchema].[MyTable_01020] (
    ...
    CONSTRAINT [PK_MyTable_01020] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01020_MyTable01020] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01020] ([ColKey]),
    CONSTRAINT [BK_MyTable_01020_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
