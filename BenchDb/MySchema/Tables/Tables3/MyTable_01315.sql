CREATE TABLE [MySchema].[MyTable_01315] (
    ...
    CONSTRAINT [PK_MyTable_01315] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01315_MyTable01315] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01315] ([ColKey]),
    CONSTRAINT [BK_MyTable_01315_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
