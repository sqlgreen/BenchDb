CREATE TABLE [MySchema].[MyTable_01072] (
    ...
    CONSTRAINT [PK_MyTable_01072] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01072_MyTable01072] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01072] ([ColKey]),
    CONSTRAINT [BK_MyTable_01072_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
