CREATE TABLE [MySchema].[MyTable_01344] (
    ...
    CONSTRAINT [PK_MyTable_01344] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01344_MyTable01344] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01344] ([ColKey]),
    CONSTRAINT [BK_MyTable_01344_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
