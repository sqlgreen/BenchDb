CREATE TABLE [MySchema].[MyTable_01126] (
    ...
    CONSTRAINT [PK_MyTable_01126] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01126_MyTable01126] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01126] ([ColKey]),
    CONSTRAINT [BK_MyTable_01126_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
