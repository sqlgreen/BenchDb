CREATE TABLE [MySchema].[MyTable_01412] (
    ...
    CONSTRAINT [PK_MyTable_01412] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01412_MyTable01412] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01412] ([ColKey]),
    CONSTRAINT [BK_MyTable_01412_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
