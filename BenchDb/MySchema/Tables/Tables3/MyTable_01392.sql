CREATE TABLE [MySchema].[MyTable_01392] (
    ...
    CONSTRAINT [PK_MyTable_01392] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01392_MyTable01392] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01392] ([ColKey]),
    CONSTRAINT [BK_MyTable_01392_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
