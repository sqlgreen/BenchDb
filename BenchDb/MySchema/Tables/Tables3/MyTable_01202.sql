CREATE TABLE [MySchema].[MyTable_01202] (
    ...
    CONSTRAINT [PK_MyTable_01202] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01202_MyTable01202] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01202] ([ColKey]),
    CONSTRAINT [BK_MyTable_01202_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
