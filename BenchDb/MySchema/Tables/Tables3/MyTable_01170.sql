CREATE TABLE [MySchema].[MyTable_01170] (
    ...
    CONSTRAINT [PK_MyTable_01170] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01170_MyTable01170] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01170] ([ColKey]),
    CONSTRAINT [BK_MyTable_01170_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
