CREATE TABLE [MySchema].[MyTable_01088] (
    ...
    CONSTRAINT [PK_MyTable_01088] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01088_MyTable01088] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01088] ([ColKey]),
    CONSTRAINT [BK_MyTable_01088_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
