CREATE TABLE [MySchema].[MyTable_01090] (
    ...
    CONSTRAINT [PK_MyTable_01090] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01090_MyTable01090] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01090] ([ColKey]),
    CONSTRAINT [BK_MyTable_01090_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
