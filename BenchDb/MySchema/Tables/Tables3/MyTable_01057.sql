CREATE TABLE [MySchema].[MyTable_01057] (
    ...
    CONSTRAINT [PK_MyTable_01057] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01057_MyTable01057] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01057] ([ColKey]),
    CONSTRAINT [BK_MyTable_01057_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
