CREATE TABLE [MySchema].[MyTable_01261] (
    ...
    CONSTRAINT [PK_MyTable_01261] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01261_MyTable01261] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01261] ([ColKey]),
    CONSTRAINT [BK_MyTable_01261_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
