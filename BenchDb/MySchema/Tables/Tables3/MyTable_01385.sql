CREATE TABLE [MySchema].[MyTable_01385] (
    ...
    CONSTRAINT [PK_MyTable_01385] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01385_MyTable01385] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01385] ([ColKey]),
    CONSTRAINT [BK_MyTable_01385_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
