CREATE TABLE [MySchema].[MyTable_01249] (
    ...
    CONSTRAINT [PK_MyTable_01249] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01249_MyTable01249] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01249] ([ColKey]),
    CONSTRAINT [BK_MyTable_01249_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
