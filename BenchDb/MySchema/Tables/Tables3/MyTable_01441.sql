CREATE TABLE [MySchema].[MyTable_01441] (
    ...
    CONSTRAINT [PK_MyTable_01441] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01441_MyTable01441] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01441] ([ColKey]),
    CONSTRAINT [BK_MyTable_01441_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
