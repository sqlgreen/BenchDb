CREATE TABLE [MySchema].[MyTable_01187] (
    ...
    CONSTRAINT [PK_MyTable_01187] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01187_MyTable01187] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01187] ([ColKey]),
    CONSTRAINT [BK_MyTable_01187_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
