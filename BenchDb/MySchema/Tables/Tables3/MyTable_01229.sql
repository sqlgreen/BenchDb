CREATE TABLE [MySchema].[MyTable_01229] (
    ...
    CONSTRAINT [PK_MyTable_01229] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01229_MyTable01229] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01229] ([ColKey]),
    CONSTRAINT [BK_MyTable_01229_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
