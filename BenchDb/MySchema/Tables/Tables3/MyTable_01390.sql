CREATE TABLE [MySchema].[MyTable_01390] (
    ...
    CONSTRAINT [PK_MyTable_01390] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01390_MyTable01390] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01390] ([ColKey]),
    CONSTRAINT [BK_MyTable_01390_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
