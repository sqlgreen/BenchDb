CREATE TABLE [MySchema].[MyTable_01070] (
    ...
    CONSTRAINT [PK_MyTable_01070] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01070_MyTable01070] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01070] ([ColKey]),
    CONSTRAINT [BK_MyTable_01070_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
