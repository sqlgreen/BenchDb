CREATE TABLE [MySchema].[MyTable_01212] (
    ...
    CONSTRAINT [PK_MyTable_01212] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01212_MyTable01212] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01212] ([ColKey]),
    CONSTRAINT [BK_MyTable_01212_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
