CREATE TABLE [MySchema].[MyTable_01110] (
    ...
    CONSTRAINT [PK_MyTable_01110] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01110_MyTable01110] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01110] ([ColKey]),
    CONSTRAINT [BK_MyTable_01110_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
