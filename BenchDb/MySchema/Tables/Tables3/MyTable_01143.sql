CREATE TABLE [MySchema].[MyTable_01143] (
    ...
    CONSTRAINT [PK_MyTable_01143] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01143_MyTable01143] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01143] ([ColKey]),
    CONSTRAINT [BK_MyTable_01143_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
