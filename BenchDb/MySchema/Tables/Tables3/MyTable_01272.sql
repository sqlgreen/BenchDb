CREATE TABLE [MySchema].[MyTable_01272] (
    ...
    CONSTRAINT [PK_MyTable_01272] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01272_MyTable01272] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01272] ([ColKey]),
    CONSTRAINT [BK_MyTable_01272_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
