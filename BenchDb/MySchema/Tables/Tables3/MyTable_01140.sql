CREATE TABLE [MySchema].[MyTable_01140] (
    ...
    CONSTRAINT [PK_MyTable_01140] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01140_MyTable01140] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01140] ([ColKey]),
    CONSTRAINT [BK_MyTable_01140_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
