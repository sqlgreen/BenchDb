CREATE TABLE [MySchema].[MyTable_01029] (
    ...
    CONSTRAINT [PK_MyTable_01029] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01029_MyTable01029] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01029] ([ColKey]),
    CONSTRAINT [BK_MyTable_01029_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
