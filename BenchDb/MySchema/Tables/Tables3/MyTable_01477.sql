CREATE TABLE [MySchema].[MyTable_01477] (
    ...
    CONSTRAINT [PK_MyTable_01477] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01477_MyTable01477] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01477] ([ColKey]),
    CONSTRAINT [BK_MyTable_01477_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
