CREATE TABLE [MySchema].[MyTable_01312] (
    ...
    CONSTRAINT [PK_MyTable_01312] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01312_MyTable01312] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01312] ([ColKey]),
    CONSTRAINT [BK_MyTable_01312_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
