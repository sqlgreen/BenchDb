CREATE TABLE [MySchema].[MyTable_01470] (
    ...
    CONSTRAINT [PK_MyTable_01470] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01470_MyTable01470] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01470] ([ColKey]),
    CONSTRAINT [BK_MyTable_01470_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
