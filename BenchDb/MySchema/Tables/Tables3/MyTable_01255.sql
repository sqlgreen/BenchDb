CREATE TABLE [MySchema].[MyTable_01255] (
    ...
    CONSTRAINT [PK_MyTable_01255] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01255_MyTable01255] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01255] ([ColKey]),
    CONSTRAINT [BK_MyTable_01255_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
