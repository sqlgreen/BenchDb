CREATE TABLE [MySchema].[MyTable_01352] (
    ...
    CONSTRAINT [PK_MyTable_01352] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01352_MyTable01352] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01352] ([ColKey]),
    CONSTRAINT [BK_MyTable_01352_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
