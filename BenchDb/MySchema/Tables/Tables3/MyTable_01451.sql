CREATE TABLE [MySchema].[MyTable_01451] (
    ...
    CONSTRAINT [PK_MyTable_01451] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01451_MyTable01451] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01451] ([ColKey]),
    CONSTRAINT [BK_MyTable_01451_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
