CREATE TABLE [MySchema].[MyTable_01245] (
    ...
    CONSTRAINT [PK_MyTable_01245] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01245_MyTable01245] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01245] ([ColKey]),
    CONSTRAINT [BK_MyTable_01245_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
