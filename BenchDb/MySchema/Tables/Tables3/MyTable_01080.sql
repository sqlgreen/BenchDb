CREATE TABLE [MySchema].[MyTable_01080] (
    ...
    CONSTRAINT [PK_MyTable_01080] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01080_MyTable01080] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01080] ([ColKey]),
    CONSTRAINT [BK_MyTable_01080_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
