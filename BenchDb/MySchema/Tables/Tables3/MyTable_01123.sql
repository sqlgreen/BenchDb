CREATE TABLE [MySchema].[MyTable_01123] (
    ...
    CONSTRAINT [PK_MyTable_01123] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01123_MyTable01123] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01123] ([ColKey]),
    CONSTRAINT [BK_MyTable_01123_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
