CREATE TABLE [MySchema].[MyTable_01373] (
    ...
    CONSTRAINT [PK_MyTable_01373] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01373_MyTable01373] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01373] ([ColKey]),
    CONSTRAINT [BK_MyTable_01373_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
