CREATE TABLE [MySchema].[MyTable_01019] (
    ...
    CONSTRAINT [PK_MyTable_01019] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01019_MyTable01019] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01019] ([ColKey]),
    CONSTRAINT [BK_MyTable_01019_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
