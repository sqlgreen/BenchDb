CREATE TABLE [MySchema].[MyTable_01333] (
    ...
    CONSTRAINT [PK_MyTable_01333] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01333_MyTable01333] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01333] ([ColKey]),
    CONSTRAINT [BK_MyTable_01333_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
