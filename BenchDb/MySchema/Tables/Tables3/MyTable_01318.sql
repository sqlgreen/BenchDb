CREATE TABLE [MySchema].[MyTable_01318] (
    ...
    CONSTRAINT [PK_MyTable_01318] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01318_MyTable01318] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01318] ([ColKey]),
    CONSTRAINT [BK_MyTable_01318_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
