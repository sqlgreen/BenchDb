CREATE TABLE [MySchema].[MyTable_01368] (
    ...
    CONSTRAINT [PK_MyTable_01368] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01368_MyTable01368] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01368] ([ColKey]),
    CONSTRAINT [BK_MyTable_01368_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
