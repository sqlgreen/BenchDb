CREATE TABLE [MySchema].[MyTable_01372] (
    ...
    CONSTRAINT [PK_MyTable_01372] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01372_MyTable01372] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01372] ([ColKey]),
    CONSTRAINT [BK_MyTable_01372_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
