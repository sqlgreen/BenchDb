CREATE TABLE [MySchema].[MyTable_01426] (
    ...
    CONSTRAINT [PK_MyTable_01426] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01426_MyTable01426] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01426] ([ColKey]),
    CONSTRAINT [BK_MyTable_01426_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
