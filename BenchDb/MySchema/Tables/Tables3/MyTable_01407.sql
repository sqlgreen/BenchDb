CREATE TABLE [MySchema].[MyTable_01407] (
    ...
    CONSTRAINT [PK_MyTable_01407] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01407_MyTable01407] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01407] ([ColKey]),
    CONSTRAINT [BK_MyTable_01407_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
