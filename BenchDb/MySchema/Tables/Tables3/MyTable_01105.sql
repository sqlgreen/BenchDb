CREATE TABLE [MySchema].[MyTable_01105] (
    ...
    CONSTRAINT [PK_MyTable_01105] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01105_MyTable01105] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01105] ([ColKey]),
    CONSTRAINT [BK_MyTable_01105_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
