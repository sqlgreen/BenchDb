CREATE TABLE [MySchema].[MyTable_01079] (
    ...
    CONSTRAINT [PK_MyTable_01079] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01079_MyTable01079] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01079] ([ColKey]),
    CONSTRAINT [BK_MyTable_01079_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
