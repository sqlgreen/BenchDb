CREATE TABLE [MySchema].[MyTable_01128] (
    ...
    CONSTRAINT [PK_MyTable_01128] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01128_MyTable01128] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01128] ([ColKey]),
    CONSTRAINT [BK_MyTable_01128_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
