CREATE TABLE [MySchema].[MyTable_01195] (
    ...
    CONSTRAINT [PK_MyTable_01195] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01195_MyTable01195] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01195] ([ColKey]),
    CONSTRAINT [BK_MyTable_01195_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
