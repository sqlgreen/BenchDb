CREATE TABLE [MySchema].[MyTable_01139] (
    ...
    CONSTRAINT [PK_MyTable_01139] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01139_MyTable01139] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01139] ([ColKey]),
    CONSTRAINT [BK_MyTable_01139_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
