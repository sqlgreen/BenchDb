CREATE TABLE [MySchema].[MyTable_01218] (
    ...
    CONSTRAINT [PK_MyTable_01218] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01218_MyTable01218] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01218] ([ColKey]),
    CONSTRAINT [BK_MyTable_01218_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
