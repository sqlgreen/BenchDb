CREATE TABLE [MySchema].[MyTable_01327] (
    ...
    CONSTRAINT [PK_MyTable_01327] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01327_MyTable01327] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01327] ([ColKey]),
    CONSTRAINT [BK_MyTable_01327_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
