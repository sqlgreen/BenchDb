CREATE TABLE [MySchema].[MyTable_01155] (
    ...
    CONSTRAINT [PK_MyTable_01155] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01155_MyTable01155] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01155] ([ColKey]),
    CONSTRAINT [BK_MyTable_01155_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
