CREATE TABLE [MySchema].[MyTable_01233] (
    ...
    CONSTRAINT [PK_MyTable_01233] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01233_MyTable01233] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01233] ([ColKey]),
    CONSTRAINT [BK_MyTable_01233_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
