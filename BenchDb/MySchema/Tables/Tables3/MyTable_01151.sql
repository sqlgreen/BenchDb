CREATE TABLE [MySchema].[MyTable_01151] (
    ...
    CONSTRAINT [PK_MyTable_01151] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01151_MyTable01151] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01151] ([ColKey]),
    CONSTRAINT [BK_MyTable_01151_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
