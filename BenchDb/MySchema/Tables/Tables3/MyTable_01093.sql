CREATE TABLE [MySchema].[MyTable_01093] (
    ...
    CONSTRAINT [PK_MyTable_01093] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01093_MyTable01093] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01093] ([ColKey]),
    CONSTRAINT [BK_MyTable_01093_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
