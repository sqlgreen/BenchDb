CREATE TABLE [MySchema].[MyTable_01008] (
    ...
    CONSTRAINT [PK_MyTable_01008] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01008_MyTable01008] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01008] ([ColKey]),
    CONSTRAINT [BK_MyTable_01008_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
