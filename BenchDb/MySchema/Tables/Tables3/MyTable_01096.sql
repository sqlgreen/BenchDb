CREATE TABLE [MySchema].[MyTable_01096] (
    ...
    CONSTRAINT [PK_MyTable_01096] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01096_MyTable01096] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01096] ([ColKey]),
    CONSTRAINT [BK_MyTable_01096_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
