CREATE TABLE [MySchema].[MyTable_01436] (
    ...
    CONSTRAINT [PK_MyTable_01436] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01436_MyTable01436] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01436] ([ColKey]),
    CONSTRAINT [BK_MyTable_01436_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
