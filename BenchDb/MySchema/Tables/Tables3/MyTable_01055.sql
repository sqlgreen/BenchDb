CREATE TABLE [MySchema].[MyTable_01055] (
    ...
    CONSTRAINT [PK_MyTable_01055] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01055_MyTable01055] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01055] ([ColKey]),
    CONSTRAINT [BK_MyTable_01055_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
