CREATE TABLE [MySchema].[MyTable_01005] (
    ...
    CONSTRAINT [PK_MyTable_01005] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01005_MyTable01005] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01005] ([ColKey]),
    CONSTRAINT [BK_MyTable_01005_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
