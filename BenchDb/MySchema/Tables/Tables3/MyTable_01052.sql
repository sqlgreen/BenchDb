CREATE TABLE [MySchema].[MyTable_01052] (
    ...
    CONSTRAINT [PK_MyTable_01052] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01052_MyTable01052] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01052] ([ColKey]),
    CONSTRAINT [BK_MyTable_01052_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
