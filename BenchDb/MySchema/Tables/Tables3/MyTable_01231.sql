CREATE TABLE [MySchema].[MyTable_01231] (
    ...
    CONSTRAINT [PK_MyTable_01231] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01231_MyTable01231] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01231] ([ColKey]),
    CONSTRAINT [BK_MyTable_01231_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
