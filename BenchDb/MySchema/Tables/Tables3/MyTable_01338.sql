CREATE TABLE [MySchema].[MyTable_01338] (
    ...
    CONSTRAINT [PK_MyTable_01338] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01338_MyTable01338] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01338] ([ColKey]),
    CONSTRAINT [BK_MyTable_01338_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
