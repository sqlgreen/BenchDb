CREATE TABLE [MySchema].[MyTable_01154] (
    ...
    CONSTRAINT [PK_MyTable_01154] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01154_MyTable01154] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01154] ([ColKey]),
    CONSTRAINT [BK_MyTable_01154_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
