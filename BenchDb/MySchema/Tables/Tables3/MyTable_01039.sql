CREATE TABLE [MySchema].[MyTable_01039] (
    ...
    CONSTRAINT [PK_MyTable_01039] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01039_MyTable01039] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01039] ([ColKey]),
    CONSTRAINT [BK_MyTable_01039_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
