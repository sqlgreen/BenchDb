CREATE TABLE [MySchema].[MyTable_01035] (
    ...
    CONSTRAINT [PK_MyTable_01035] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01035_MyTable01035] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01035] ([ColKey]),
    CONSTRAINT [BK_MyTable_01035_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
