CREATE TABLE [MySchema].[MyTable_01365] (
    ...
    CONSTRAINT [PK_MyTable_01365] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01365_MyTable01365] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01365] ([ColKey]),
    CONSTRAINT [BK_MyTable_01365_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
