CREATE TABLE [MySchema].[MyTable_01278] (
    ...
    CONSTRAINT [PK_MyTable_01278] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01278_MyTable01278] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01278] ([ColKey]),
    CONSTRAINT [BK_MyTable_01278_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
