CREATE TABLE [MySchema].[MyTable_01179] (
    ...
    CONSTRAINT [PK_MyTable_01179] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01179_MyTable01179] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01179] ([ColKey]),
    CONSTRAINT [BK_MyTable_01179_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
