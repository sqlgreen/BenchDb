CREATE TABLE [MySchema].[MyTable_01264] (
    ...
    CONSTRAINT [PK_MyTable_01264] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01264_MyTable01264] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01264] ([ColKey]),
    CONSTRAINT [BK_MyTable_01264_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
