CREATE TABLE [MySchema].[MyTable_01387] (
    ...
    CONSTRAINT [PK_MyTable_01387] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01387_MyTable01387] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01387] ([ColKey]),
    CONSTRAINT [BK_MyTable_01387_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
