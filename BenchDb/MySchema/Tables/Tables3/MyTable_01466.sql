CREATE TABLE [MySchema].[MyTable_01466] (
    ...
    CONSTRAINT [PK_MyTable_01466] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01466_MyTable01466] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01466] ([ColKey]),
    CONSTRAINT [BK_MyTable_01466_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
