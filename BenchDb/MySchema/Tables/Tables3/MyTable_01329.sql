CREATE TABLE [MySchema].[MyTable_01329] (
    ...
    CONSTRAINT [PK_MyTable_01329] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01329_MyTable01329] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01329] ([ColKey]),
    CONSTRAINT [BK_MyTable_01329_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
