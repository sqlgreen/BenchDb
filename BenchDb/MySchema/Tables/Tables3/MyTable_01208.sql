CREATE TABLE [MySchema].[MyTable_01208] (
    ...
    CONSTRAINT [PK_MyTable_01208] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01208_MyTable01208] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01208] ([ColKey]),
    CONSTRAINT [BK_MyTable_01208_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
