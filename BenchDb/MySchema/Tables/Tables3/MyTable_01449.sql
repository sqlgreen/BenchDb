CREATE TABLE [MySchema].[MyTable_01449] (
    ...
    CONSTRAINT [PK_MyTable_01449] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01449_MyTable01449] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01449] ([ColKey]),
    CONSTRAINT [BK_MyTable_01449_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
