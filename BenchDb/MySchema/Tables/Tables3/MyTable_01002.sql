CREATE TABLE [MySchema].[MyTable_01002] (
    ...
    CONSTRAINT [PK_MyTable_01002] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01002_MyTable01002] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01002] ([ColKey]),
    CONSTRAINT [BK_MyTable_01002_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
