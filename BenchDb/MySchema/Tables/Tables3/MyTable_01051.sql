CREATE TABLE [MySchema].[MyTable_01051] (
    ...
    CONSTRAINT [PK_MyTable_01051] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01051_MyTable01051] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01051] ([ColKey]),
    CONSTRAINT [BK_MyTable_01051_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
