CREATE TABLE [MySchema].[MyTable_01026] (
    ...
    CONSTRAINT [PK_MyTable_01026] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01026_MyTable01026] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01026] ([ColKey]),
    CONSTRAINT [BK_MyTable_01026_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
