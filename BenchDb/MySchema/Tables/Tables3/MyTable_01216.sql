CREATE TABLE [MySchema].[MyTable_01216] (
    ...
    CONSTRAINT [PK_MyTable_01216] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01216_MyTable01216] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01216] ([ColKey]),
    CONSTRAINT [BK_MyTable_01216_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
