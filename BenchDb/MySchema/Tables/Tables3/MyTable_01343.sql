CREATE TABLE [MySchema].[MyTable_01343] (
    ...
    CONSTRAINT [PK_MyTable_01343] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01343_MyTable01343] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01343] ([ColKey]),
    CONSTRAINT [BK_MyTable_01343_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
