CREATE TABLE [MySchema].[MyTable_01058] (
    ...
    CONSTRAINT [PK_MyTable_01058] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01058_MyTable01058] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01058] ([ColKey]),
    CONSTRAINT [BK_MyTable_01058_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
