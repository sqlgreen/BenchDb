CREATE TABLE [MySchema].[MyTable_01011] (
    ...
    CONSTRAINT [PK_MyTable_01011] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01011_MyTable01011] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01011] ([ColKey]),
    CONSTRAINT [BK_MyTable_01011_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
