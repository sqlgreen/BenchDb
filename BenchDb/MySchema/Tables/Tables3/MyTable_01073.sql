CREATE TABLE [MySchema].[MyTable_01073] (
    ...
    CONSTRAINT [PK_MyTable_01073] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01073_MyTable01073] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01073] ([ColKey]),
    CONSTRAINT [BK_MyTable_01073_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
