CREATE TABLE [MySchema].[MyTable_01217] (
    ...
    CONSTRAINT [PK_MyTable_01217] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01217_MyTable01217] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01217] ([ColKey]),
    CONSTRAINT [BK_MyTable_01217_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
