CREATE TABLE [MySchema].[MyTable_01007] (
    ...
    CONSTRAINT [PK_MyTable_01007] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01007_MyTable01007] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01007] ([ColKey]),
    CONSTRAINT [BK_MyTable_01007_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
