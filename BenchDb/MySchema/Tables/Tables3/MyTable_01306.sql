CREATE TABLE [MySchema].[MyTable_01306] (
    ...
    CONSTRAINT [PK_MyTable_01306] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01306_MyTable01306] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01306] ([ColKey]),
    CONSTRAINT [BK_MyTable_01306_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
