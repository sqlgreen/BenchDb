CREATE TABLE [MySchema].[MyTable_01095] (
    ...
    CONSTRAINT [PK_MyTable_01095] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01095_MyTable01095] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01095] ([ColKey]),
    CONSTRAINT [BK_MyTable_01095_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
