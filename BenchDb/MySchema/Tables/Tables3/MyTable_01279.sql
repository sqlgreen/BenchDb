CREATE TABLE [MySchema].[MyTable_01279] (
    ...
    CONSTRAINT [PK_MyTable_01279] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01279_MyTable01279] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01279] ([ColKey]),
    CONSTRAINT [BK_MyTable_01279_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
