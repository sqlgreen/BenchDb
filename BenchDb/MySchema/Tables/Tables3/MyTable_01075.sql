CREATE TABLE [MySchema].[MyTable_01075] (
    ...
    CONSTRAINT [PK_MyTable_01075] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01075_MyTable01075] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01075] ([ColKey]),
    CONSTRAINT [BK_MyTable_01075_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
