CREATE TABLE [MySchema].[MyTable_01242] (
    ...
    CONSTRAINT [PK_MyTable_01242] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01242_MyTable01242] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01242] ([ColKey]),
    CONSTRAINT [BK_MyTable_01242_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
