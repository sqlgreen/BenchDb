CREATE TABLE [MySchema].[MyTable_01259] (
    ...
    CONSTRAINT [PK_MyTable_01259] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01259_MyTable01259] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01259] ([ColKey]),
    CONSTRAINT [BK_MyTable_01259_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
