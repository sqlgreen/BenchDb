CREATE TABLE [MySchema].[MyTable_01271] (
    ...
    CONSTRAINT [PK_MyTable_01271] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01271_MyTable01271] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01271] ([ColKey]),
    CONSTRAINT [BK_MyTable_01271_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
