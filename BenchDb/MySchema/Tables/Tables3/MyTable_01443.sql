CREATE TABLE [MySchema].[MyTable_01443] (
    ...
    CONSTRAINT [PK_MyTable_01443] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01443_MyTable01443] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01443] ([ColKey]),
    CONSTRAINT [BK_MyTable_01443_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
