CREATE TABLE [MySchema].[MyTable_01189] (
    ...
    CONSTRAINT [PK_MyTable_01189] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01189_MyTable01189] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01189] ([ColKey]),
    CONSTRAINT [BK_MyTable_01189_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
