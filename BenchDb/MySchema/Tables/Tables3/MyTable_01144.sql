CREATE TABLE [MySchema].[MyTable_01144] (
    ...
    CONSTRAINT [PK_MyTable_01144] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01144_MyTable01144] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01144] ([ColKey]),
    CONSTRAINT [BK_MyTable_01144_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
