CREATE TABLE [MySchema].[MyTable_01131] (
    ...
    CONSTRAINT [PK_MyTable_01131] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01131_MyTable01131] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01131] ([ColKey]),
    CONSTRAINT [BK_MyTable_01131_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
