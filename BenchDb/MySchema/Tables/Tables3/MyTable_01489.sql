CREATE TABLE [MySchema].[MyTable_01489] (
    ...
    CONSTRAINT [PK_MyTable_01489] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01489_MyTable01489] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01489] ([ColKey]),
    CONSTRAINT [BK_MyTable_01489_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
