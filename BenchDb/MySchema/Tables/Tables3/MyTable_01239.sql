CREATE TABLE [MySchema].[MyTable_01239] (
    ...
    CONSTRAINT [PK_MyTable_01239] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01239_MyTable01239] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01239] ([ColKey]),
    CONSTRAINT [BK_MyTable_01239_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
