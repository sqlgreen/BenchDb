CREATE TABLE [MySchema].[MyTable_01040] (
    ...
    CONSTRAINT [PK_MyTable_01040] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01040_MyTable01040] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01040] ([ColKey]),
    CONSTRAINT [BK_MyTable_01040_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
