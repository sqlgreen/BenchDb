CREATE TABLE [MySchema].[MyTable_01156] (
    ...
    CONSTRAINT [PK_MyTable_01156] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01156_MyTable01156] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01156] ([ColKey]),
    CONSTRAINT [BK_MyTable_01156_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
