CREATE TABLE [MySchema].[MyTable_01359] (
    ...
    CONSTRAINT [PK_MyTable_01359] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01359_MyTable01359] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01359] ([ColKey]),
    CONSTRAINT [BK_MyTable_01359_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
