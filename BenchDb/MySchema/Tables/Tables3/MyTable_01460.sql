CREATE TABLE [MySchema].[MyTable_01460] (
    ...
    CONSTRAINT [PK_MyTable_01460] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01460_MyTable01460] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01460] ([ColKey]),
    CONSTRAINT [BK_MyTable_01460_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
