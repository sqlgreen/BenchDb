CREATE TABLE [MySchema].[MyTable_01160] (
    ...
    CONSTRAINT [PK_MyTable_01160] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01160_MyTable01160] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01160] ([ColKey]),
    CONSTRAINT [BK_MyTable_01160_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
