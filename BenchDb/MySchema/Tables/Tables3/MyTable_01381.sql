CREATE TABLE [MySchema].[MyTable_01381] (
    ...
    CONSTRAINT [PK_MyTable_01381] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01381_MyTable01381] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01381] ([ColKey]),
    CONSTRAINT [BK_MyTable_01381_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
