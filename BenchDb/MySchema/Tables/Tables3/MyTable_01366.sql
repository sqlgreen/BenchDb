CREATE TABLE [MySchema].[MyTable_01366] (
    ...
    CONSTRAINT [PK_MyTable_01366] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01366_MyTable01366] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01366] ([ColKey]),
    CONSTRAINT [BK_MyTable_01366_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
