CREATE TABLE [MySchema].[MyTable_01452] (
    ...
    CONSTRAINT [PK_MyTable_01452] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01452_MyTable01452] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01452] ([ColKey]),
    CONSTRAINT [BK_MyTable_01452_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
