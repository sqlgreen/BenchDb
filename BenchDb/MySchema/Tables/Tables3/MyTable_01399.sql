CREATE TABLE [MySchema].[MyTable_01399] (
    ...
    CONSTRAINT [PK_MyTable_01399] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01399_MyTable01399] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01399] ([ColKey]),
    CONSTRAINT [BK_MyTable_01399_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
