CREATE TABLE [MySchema].[MyTable_01487] (
    ...
    CONSTRAINT [PK_MyTable_01487] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01487_MyTable01487] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01487] ([ColKey]),
    CONSTRAINT [BK_MyTable_01487_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
