CREATE TABLE [MySchema].[MyTable_01062] (
    ...
    CONSTRAINT [PK_MyTable_01062] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01062_MyTable01062] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01062] ([ColKey]),
    CONSTRAINT [BK_MyTable_01062_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
