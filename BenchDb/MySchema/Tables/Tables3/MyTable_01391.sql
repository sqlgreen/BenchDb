CREATE TABLE [MySchema].[MyTable_01391] (
    ...
    CONSTRAINT [PK_MyTable_01391] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01391_MyTable01391] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01391] ([ColKey]),
    CONSTRAINT [BK_MyTable_01391_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
