CREATE TABLE [MySchema].[MyTable_01142] (
    ...
    CONSTRAINT [PK_MyTable_01142] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01142_MyTable01142] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01142] ([ColKey]),
    CONSTRAINT [BK_MyTable_01142_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
