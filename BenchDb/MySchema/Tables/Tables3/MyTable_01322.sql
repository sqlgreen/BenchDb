CREATE TABLE [MySchema].[MyTable_01322] (
    ...
    CONSTRAINT [PK_MyTable_01322] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01322_MyTable01322] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01322] ([ColKey]),
    CONSTRAINT [BK_MyTable_01322_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
