CREATE TABLE [MySchema].[MyTable_01219] (
    ...
    CONSTRAINT [PK_MyTable_01219] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01219_MyTable01219] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01219] ([ColKey]),
    CONSTRAINT [BK_MyTable_01219_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
