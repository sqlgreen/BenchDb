CREATE TABLE [MySchema].[MyTable_01041] (
    ...
    CONSTRAINT [PK_MyTable_01041] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01041_MyTable01041] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01041] ([ColKey]),
    CONSTRAINT [BK_MyTable_01041_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
