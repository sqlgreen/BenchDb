CREATE TABLE [MySchema].[MyTable_01265] (
    ...
    CONSTRAINT [PK_MyTable_01265] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01265_MyTable01265] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01265] ([ColKey]),
    CONSTRAINT [BK_MyTable_01265_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
