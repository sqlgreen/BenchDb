CREATE TABLE [MySchema].[MyTable_01018] (
    ...
    CONSTRAINT [PK_MyTable_01018] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01018_MyTable01018] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01018] ([ColKey]),
    CONSTRAINT [BK_MyTable_01018_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
