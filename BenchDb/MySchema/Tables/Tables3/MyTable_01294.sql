CREATE TABLE [MySchema].[MyTable_01294] (
    ...
    CONSTRAINT [PK_MyTable_01294] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01294_MyTable01294] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01294] ([ColKey]),
    CONSTRAINT [BK_MyTable_01294_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
