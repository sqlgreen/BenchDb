CREATE TABLE [MySchema].[MyTable_01447] (
    ...
    CONSTRAINT [PK_MyTable_01447] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01447_MyTable01447] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01447] ([ColKey]),
    CONSTRAINT [BK_MyTable_01447_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
