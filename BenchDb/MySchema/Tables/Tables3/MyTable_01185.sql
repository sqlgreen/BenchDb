CREATE TABLE [MySchema].[MyTable_01185] (
    ...
    CONSTRAINT [PK_MyTable_01185] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01185_MyTable01185] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01185] ([ColKey]),
    CONSTRAINT [BK_MyTable_01185_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
