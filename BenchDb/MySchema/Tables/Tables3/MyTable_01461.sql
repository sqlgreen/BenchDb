CREATE TABLE [MySchema].[MyTable_01461] (
    ...
    CONSTRAINT [PK_MyTable_01461] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01461_MyTable01461] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01461] ([ColKey]),
    CONSTRAINT [BK_MyTable_01461_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
