CREATE TABLE [MySchema].[MyTable_01433] (
    ...
    CONSTRAINT [PK_MyTable_01433] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01433_MyTable01433] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01433] ([ColKey]),
    CONSTRAINT [BK_MyTable_01433_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
