CREATE TABLE [MySchema].[MyTable_01117] (
    ...
    CONSTRAINT [PK_MyTable_01117] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01117_MyTable01117] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01117] ([ColKey]),
    CONSTRAINT [BK_MyTable_01117_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
