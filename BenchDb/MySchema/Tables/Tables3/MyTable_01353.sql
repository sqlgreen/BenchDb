CREATE TABLE [MySchema].[MyTable_01353] (
    ...
    CONSTRAINT [PK_MyTable_01353] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01353_MyTable01353] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01353] ([ColKey]),
    CONSTRAINT [BK_MyTable_01353_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
