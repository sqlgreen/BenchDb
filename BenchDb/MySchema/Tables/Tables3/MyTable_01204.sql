CREATE TABLE [MySchema].[MyTable_01204] (
    ...
    CONSTRAINT [PK_MyTable_01204] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01204_MyTable01204] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01204] ([ColKey]),
    CONSTRAINT [BK_MyTable_01204_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
