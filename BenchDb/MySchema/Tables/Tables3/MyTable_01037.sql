CREATE TABLE [MySchema].[MyTable_01037] (
    ...
    CONSTRAINT [PK_MyTable_01037] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01037_MyTable01037] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01037] ([ColKey]),
    CONSTRAINT [BK_MyTable_01037_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
