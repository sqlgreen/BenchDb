CREATE TABLE [MySchema].[MyTable_01380] (
    ...
    CONSTRAINT [PK_MyTable_01380] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01380_MyTable01380] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01380] ([ColKey]),
    CONSTRAINT [BK_MyTable_01380_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
