CREATE TABLE [MySchema].[MyTable_01418] (
    ...
    CONSTRAINT [PK_MyTable_01418] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01418_MyTable01418] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01418] ([ColKey]),
    CONSTRAINT [BK_MyTable_01418_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
