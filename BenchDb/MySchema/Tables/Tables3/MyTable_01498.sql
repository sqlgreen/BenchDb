CREATE TABLE [MySchema].[MyTable_01498] (
    ...
    CONSTRAINT [PK_MyTable_01498] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01498_MyTable01498] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01498] ([ColKey]),
    CONSTRAINT [BK_MyTable_01498_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
