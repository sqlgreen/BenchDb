CREATE TABLE [MySchema].[MyTable_01237] (
    ...
    CONSTRAINT [PK_MyTable_01237] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01237_MyTable01237] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01237] ([ColKey]),
    CONSTRAINT [BK_MyTable_01237_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
