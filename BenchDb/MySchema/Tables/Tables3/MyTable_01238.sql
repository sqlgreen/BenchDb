CREATE TABLE [MySchema].[MyTable_01238] (
    ...
    CONSTRAINT [PK_MyTable_01238] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01238_MyTable01238] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01238] ([ColKey]),
    CONSTRAINT [BK_MyTable_01238_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
