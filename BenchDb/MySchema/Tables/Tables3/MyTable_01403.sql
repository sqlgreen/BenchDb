CREATE TABLE [MySchema].[MyTable_01403] (
    ...
    CONSTRAINT [PK_MyTable_01403] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01403_MyTable01403] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01403] ([ColKey]),
    CONSTRAINT [BK_MyTable_01403_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
