CREATE TABLE [MySchema].[MyTable_01416] (
    ...
    CONSTRAINT [PK_MyTable_01416] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01416_MyTable01416] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01416] ([ColKey]),
    CONSTRAINT [BK_MyTable_01416_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
