CREATE TABLE [MySchema].[MyTable_01087] (
    ...
    CONSTRAINT [PK_MyTable_01087] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01087_MyTable01087] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01087] ([ColKey]),
    CONSTRAINT [BK_MyTable_01087_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
