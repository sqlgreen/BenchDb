CREATE TABLE [MySchema].[MyTable_01234] (
    ...
    CONSTRAINT [PK_MyTable_01234] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01234_MyTable01234] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01234] ([ColKey]),
    CONSTRAINT [BK_MyTable_01234_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
