CREATE TABLE [MySchema].[MyTable_01113] (
    ...
    CONSTRAINT [PK_MyTable_01113] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01113_MyTable01113] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01113] ([ColKey]),
    CONSTRAINT [BK_MyTable_01113_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
