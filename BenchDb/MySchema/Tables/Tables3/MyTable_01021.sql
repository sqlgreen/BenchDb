CREATE TABLE [MySchema].[MyTable_01021] (
    ...
    CONSTRAINT [PK_MyTable_01021] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01021_MyTable01021] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01021] ([ColKey]),
    CONSTRAINT [BK_MyTable_01021_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
