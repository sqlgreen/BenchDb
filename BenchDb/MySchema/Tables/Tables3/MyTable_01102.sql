CREATE TABLE [MySchema].[MyTable_01102] (
    ...
    CONSTRAINT [PK_MyTable_01102] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01102_MyTable01102] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01102] ([ColKey]),
    CONSTRAINT [BK_MyTable_01102_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
