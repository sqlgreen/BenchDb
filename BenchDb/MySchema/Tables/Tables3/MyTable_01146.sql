CREATE TABLE [MySchema].[MyTable_01146] (
    ...
    CONSTRAINT [PK_MyTable_01146] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01146_MyTable01146] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01146] ([ColKey]),
    CONSTRAINT [BK_MyTable_01146_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
