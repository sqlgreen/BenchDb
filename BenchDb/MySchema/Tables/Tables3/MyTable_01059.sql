CREATE TABLE [MySchema].[MyTable_01059] (
    ...
    CONSTRAINT [PK_MyTable_01059] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01059_MyTable01059] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01059] ([ColKey]),
    CONSTRAINT [BK_MyTable_01059_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
