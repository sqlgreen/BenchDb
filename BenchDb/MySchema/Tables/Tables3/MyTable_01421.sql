CREATE TABLE [MySchema].[MyTable_01421] (
    ...
    CONSTRAINT [PK_MyTable_01421] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01421_MyTable01421] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01421] ([ColKey]),
    CONSTRAINT [BK_MyTable_01421_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
