CREATE TABLE [MySchema].[MyTable_01437] (
    ...
    CONSTRAINT [PK_MyTable_01437] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01437_MyTable01437] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01437] ([ColKey]),
    CONSTRAINT [BK_MyTable_01437_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
