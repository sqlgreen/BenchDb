CREATE TABLE [MySchema].[MyTable_01475] (
    ...
    CONSTRAINT [PK_MyTable_01475] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01475_MyTable01475] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01475] ([ColKey]),
    CONSTRAINT [BK_MyTable_01475_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
