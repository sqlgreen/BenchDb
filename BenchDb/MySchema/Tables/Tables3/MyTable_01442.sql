CREATE TABLE [MySchema].[MyTable_01442] (
    ...
    CONSTRAINT [PK_MyTable_01442] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01442_MyTable01442] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01442] ([ColKey]),
    CONSTRAINT [BK_MyTable_01442_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
