CREATE TABLE [MySchema].[MyTable_01010] (
    ...
    CONSTRAINT [PK_MyTable_01010] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01010_MyTable01010] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01010] ([ColKey]),
    CONSTRAINT [BK_MyTable_01010_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
