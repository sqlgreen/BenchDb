CREATE TABLE [MySchema].[MyTable_01256] (
    ...
    CONSTRAINT [PK_MyTable_01256] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01256_MyTable01256] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01256] ([ColKey]),
    CONSTRAINT [BK_MyTable_01256_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
