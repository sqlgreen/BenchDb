CREATE TABLE [MySchema].[MyTable_01485] (
    ...
    CONSTRAINT [PK_MyTable_01485] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01485_MyTable01485] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01485] ([ColKey]),
    CONSTRAINT [BK_MyTable_01485_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
