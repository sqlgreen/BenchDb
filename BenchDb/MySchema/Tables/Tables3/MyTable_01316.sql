CREATE TABLE [MySchema].[MyTable_01316] (
    ...
    CONSTRAINT [PK_MyTable_01316] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01316_MyTable01316] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01316] ([ColKey]),
    CONSTRAINT [BK_MyTable_01316_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
