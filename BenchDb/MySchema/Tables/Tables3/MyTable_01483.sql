CREATE TABLE [MySchema].[MyTable_01483] (
    ...
    CONSTRAINT [PK_MyTable_01483] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01483_MyTable01483] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01483] ([ColKey]),
    CONSTRAINT [BK_MyTable_01483_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
