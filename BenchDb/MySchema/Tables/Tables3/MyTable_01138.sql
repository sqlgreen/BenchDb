CREATE TABLE [MySchema].[MyTable_01138] (
    ...
    CONSTRAINT [PK_MyTable_01138] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01138_MyTable01138] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01138] ([ColKey]),
    CONSTRAINT [BK_MyTable_01138_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
