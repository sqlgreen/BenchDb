CREATE TABLE [MySchema].[MyTable_01263] (
    ...
    CONSTRAINT [PK_MyTable_01263] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01263_MyTable01263] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01263] ([ColKey]),
    CONSTRAINT [BK_MyTable_01263_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
