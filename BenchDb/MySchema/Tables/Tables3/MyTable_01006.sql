CREATE TABLE [MySchema].[MyTable_01006] (
    ...
    CONSTRAINT [PK_MyTable_01006] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01006_MyTable01006] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01006] ([ColKey]),
    CONSTRAINT [BK_MyTable_01006_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
