CREATE TABLE [MySchema].[MyTable_01494] (
    ...
    CONSTRAINT [PK_MyTable_01494] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01494_MyTable01494] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01494] ([ColKey]),
    CONSTRAINT [BK_MyTable_01494_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
