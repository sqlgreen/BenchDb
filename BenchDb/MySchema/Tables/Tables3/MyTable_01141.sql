CREATE TABLE [MySchema].[MyTable_01141] (
    ...
    CONSTRAINT [PK_MyTable_01141] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01141_MyTable01141] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01141] ([ColKey]),
    CONSTRAINT [BK_MyTable_01141_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
