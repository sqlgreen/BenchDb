CREATE TABLE [MySchema].[MyTable_01044] (
    ...
    CONSTRAINT [PK_MyTable_01044] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01044_MyTable01044] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01044] ([ColKey]),
    CONSTRAINT [BK_MyTable_01044_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
