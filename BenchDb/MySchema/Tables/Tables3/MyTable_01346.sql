CREATE TABLE [MySchema].[MyTable_01346] (
    ...
    CONSTRAINT [PK_MyTable_01346] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01346_MyTable01346] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01346] ([ColKey]),
    CONSTRAINT [BK_MyTable_01346_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
