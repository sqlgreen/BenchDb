CREATE TABLE [MySchema].[MyTable_01268] (
    ...
    CONSTRAINT [PK_MyTable_01268] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01268_MyTable01268] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01268] ([ColKey]),
    CONSTRAINT [BK_MyTable_01268_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
