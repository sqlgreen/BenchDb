CREATE TABLE [MySchema].[MyTable_01339] (
    ...
    CONSTRAINT [PK_MyTable_01339] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01339_MyTable01339] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01339] ([ColKey]),
    CONSTRAINT [BK_MyTable_01339_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
