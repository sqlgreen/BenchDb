CREATE TABLE [MySchema].[MyTable_01089] (
    ...
    CONSTRAINT [PK_MyTable_01089] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01089_MyTable01089] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01089] ([ColKey]),
    CONSTRAINT [BK_MyTable_01089_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
