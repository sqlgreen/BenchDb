CREATE TABLE [MySchema].[MyTable_01145] (
    ...
    CONSTRAINT [PK_MyTable_01145] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01145_MyTable01145] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01145] ([ColKey]),
    CONSTRAINT [BK_MyTable_01145_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
