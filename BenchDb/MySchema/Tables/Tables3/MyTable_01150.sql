CREATE TABLE [MySchema].[MyTable_01150] (
    ...
    CONSTRAINT [PK_MyTable_01150] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01150_MyTable01150] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01150] ([ColKey]),
    CONSTRAINT [BK_MyTable_01150_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
