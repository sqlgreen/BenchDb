CREATE TABLE [MySchema].[MyTable_01291] (
    ...
    CONSTRAINT [PK_MyTable_01291] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01291_MyTable01291] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01291] ([ColKey]),
    CONSTRAINT [BK_MyTable_01291_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
