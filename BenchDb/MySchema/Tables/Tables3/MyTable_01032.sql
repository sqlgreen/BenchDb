CREATE TABLE [MySchema].[MyTable_01032] (
    ...
    CONSTRAINT [PK_MyTable_01032] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01032_MyTable01032] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01032] ([ColKey]),
    CONSTRAINT [BK_MyTable_01032_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
