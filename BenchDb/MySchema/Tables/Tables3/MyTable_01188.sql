CREATE TABLE [MySchema].[MyTable_01188] (
    ...
    CONSTRAINT [PK_MyTable_01188] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01188_MyTable01188] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01188] ([ColKey]),
    CONSTRAINT [BK_MyTable_01188_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
