CREATE TABLE [MySchema].[MyTable_01125] (
    ...
    CONSTRAINT [PK_MyTable_01125] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01125_MyTable01125] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01125] ([ColKey]),
    CONSTRAINT [BK_MyTable_01125_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
