CREATE TABLE [MySchema].[MyTable_01014] (
    ...
    CONSTRAINT [PK_MyTable_01014] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01014_MyTable01014] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01014] ([ColKey]),
    CONSTRAINT [BK_MyTable_01014_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
