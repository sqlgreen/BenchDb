CREATE TABLE [MySchema].[MyTable_01286] (
    ...
    CONSTRAINT [PK_MyTable_01286] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01286_MyTable01286] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01286] ([ColKey]),
    CONSTRAINT [BK_MyTable_01286_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
