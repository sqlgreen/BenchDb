CREATE TABLE [MySchema].[MyTable_01244] (
    ...
    CONSTRAINT [PK_MyTable_01244] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01244_MyTable01244] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01244] ([ColKey]),
    CONSTRAINT [BK_MyTable_01244_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
