CREATE TABLE [MySchema].[MyTable_01063] (
    ...
    CONSTRAINT [PK_MyTable_01063] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01063_MyTable01063] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01063] ([ColKey]),
    CONSTRAINT [BK_MyTable_01063_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
