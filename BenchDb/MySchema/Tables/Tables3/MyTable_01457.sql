CREATE TABLE [MySchema].[MyTable_01457] (
    ...
    CONSTRAINT [PK_MyTable_01457] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01457_MyTable01457] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01457] ([ColKey]),
    CONSTRAINT [BK_MyTable_01457_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
