CREATE TABLE [MySchema].[MyTable_01232] (
    ...
    CONSTRAINT [PK_MyTable_01232] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01232_MyTable01232] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01232] ([ColKey]),
    CONSTRAINT [BK_MyTable_01232_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
