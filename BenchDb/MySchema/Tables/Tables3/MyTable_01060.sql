CREATE TABLE [MySchema].[MyTable_01060] (
    ...
    CONSTRAINT [PK_MyTable_01060] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01060_MyTable01060] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01060] ([ColKey]),
    CONSTRAINT [BK_MyTable_01060_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
