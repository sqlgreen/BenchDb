CREATE TABLE [MySchema].[MyTable_01076] (
    ...
    CONSTRAINT [PK_MyTable_01076] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01076_MyTable01076] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01076] ([ColKey]),
    CONSTRAINT [BK_MyTable_01076_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
