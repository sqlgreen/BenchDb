CREATE TABLE [MySchema].[MyTable_01374] (
    ...
    CONSTRAINT [PK_MyTable_01374] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01374_MyTable01374] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01374] ([ColKey]),
    CONSTRAINT [BK_MyTable_01374_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
