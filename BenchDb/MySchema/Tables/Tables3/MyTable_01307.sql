CREATE TABLE [MySchema].[MyTable_01307] (
    ...
    CONSTRAINT [PK_MyTable_01307] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01307_MyTable01307] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01307] ([ColKey]),
    CONSTRAINT [BK_MyTable_01307_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
