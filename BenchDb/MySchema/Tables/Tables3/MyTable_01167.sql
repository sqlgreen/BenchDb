CREATE TABLE [MySchema].[MyTable_01167] (
    ...
    CONSTRAINT [PK_MyTable_01167] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01167_MyTable01167] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01167] ([ColKey]),
    CONSTRAINT [BK_MyTable_01167_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
