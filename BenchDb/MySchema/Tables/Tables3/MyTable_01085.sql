CREATE TABLE [MySchema].[MyTable_01085] (
    ...
    CONSTRAINT [PK_MyTable_01085] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01085_MyTable01085] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01085] ([ColKey]),
    CONSTRAINT [BK_MyTable_01085_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
