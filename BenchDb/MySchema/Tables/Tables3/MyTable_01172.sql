CREATE TABLE [MySchema].[MyTable_01172] (
    ...
    CONSTRAINT [PK_MyTable_01172] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01172_MyTable01172] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01172] ([ColKey]),
    CONSTRAINT [BK_MyTable_01172_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
