CREATE TABLE [MySchema].[MyTable_01252] (
    ...
    CONSTRAINT [PK_MyTable_01252] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01252_MyTable01252] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01252] ([ColKey]),
    CONSTRAINT [BK_MyTable_01252_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
