CREATE TABLE [MySchema].[MyTable_01235] (
    ...
    CONSTRAINT [PK_MyTable_01235] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01235_MyTable01235] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01235] ([ColKey]),
    CONSTRAINT [BK_MyTable_01235_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
