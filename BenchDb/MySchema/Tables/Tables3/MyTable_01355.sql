CREATE TABLE [MySchema].[MyTable_01355] (
    ...
    CONSTRAINT [PK_MyTable_01355] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01355_MyTable01355] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01355] ([ColKey]),
    CONSTRAINT [BK_MyTable_01355_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
