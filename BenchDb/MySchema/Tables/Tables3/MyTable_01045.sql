CREATE TABLE [MySchema].[MyTable_01045] (
    ...
    CONSTRAINT [PK_MyTable_01045] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01045_MyTable01045] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01045] ([ColKey]),
    CONSTRAINT [BK_MyTable_01045_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
