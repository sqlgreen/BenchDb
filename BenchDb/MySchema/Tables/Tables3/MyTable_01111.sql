CREATE TABLE [MySchema].[MyTable_01111] (
    ...
    CONSTRAINT [PK_MyTable_01111] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01111_MyTable01111] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01111] ([ColKey]),
    CONSTRAINT [BK_MyTable_01111_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
