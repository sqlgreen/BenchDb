CREATE TABLE [MySchema].[MyTable_01119] (
    ...
    CONSTRAINT [PK_MyTable_01119] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01119_MyTable01119] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01119] ([ColKey]),
    CONSTRAINT [BK_MyTable_01119_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
