CREATE TABLE [MySchema].[MyTable_01440] (
    ...
    CONSTRAINT [PK_MyTable_01440] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01440_MyTable01440] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01440] ([ColKey]),
    CONSTRAINT [BK_MyTable_01440_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
