CREATE TABLE [MySchema].[MyTable_01122] (
    ...
    CONSTRAINT [PK_MyTable_01122] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01122_MyTable01122] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01122] ([ColKey]),
    CONSTRAINT [BK_MyTable_01122_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
