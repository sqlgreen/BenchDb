CREATE TABLE [MySchema].[MyTable_01351] (
    ...
    CONSTRAINT [PK_MyTable_01351] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01351_MyTable01351] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01351] ([ColKey]),
    CONSTRAINT [BK_MyTable_01351_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
