CREATE TABLE [MySchema].[MyTable_01099] (
    ...
    CONSTRAINT [PK_MyTable_01099] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01099_MyTable01099] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01099] ([ColKey]),
    CONSTRAINT [BK_MyTable_01099_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
