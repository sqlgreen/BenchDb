CREATE TABLE [MySchema].[MyTable_01262] (
    ...
    CONSTRAINT [PK_MyTable_01262] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01262_MyTable01262] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01262] ([ColKey]),
    CONSTRAINT [BK_MyTable_01262_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
