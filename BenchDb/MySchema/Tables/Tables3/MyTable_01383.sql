CREATE TABLE [MySchema].[MyTable_01383] (
    ...
    CONSTRAINT [PK_MyTable_01383] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01383_MyTable01383] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01383] ([ColKey]),
    CONSTRAINT [BK_MyTable_01383_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
