CREATE TABLE [MySchema].[MyTable_01258] (
    ...
    CONSTRAINT [PK_MyTable_01258] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01258_MyTable01258] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01258] ([ColKey]),
    CONSTRAINT [BK_MyTable_01258_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
