CREATE TABLE [MySchema].[MyTable_01084] (
    ...
    CONSTRAINT [PK_MyTable_01084] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01084_MyTable01084] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01084] ([ColKey]),
    CONSTRAINT [BK_MyTable_01084_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
