CREATE TABLE [MySchema].[MyTable_01304] (
    ...
    CONSTRAINT [PK_MyTable_01304] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01304_MyTable01304] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01304] ([ColKey]),
    CONSTRAINT [BK_MyTable_01304_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
