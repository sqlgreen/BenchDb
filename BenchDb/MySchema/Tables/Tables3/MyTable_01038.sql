CREATE TABLE [MySchema].[MyTable_01038] (
    ...
    CONSTRAINT [PK_MyTable_01038] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01038_MyTable01038] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01038] ([ColKey]),
    CONSTRAINT [BK_MyTable_01038_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
