CREATE TABLE [MySchema].[MyTable_01074] (
    ...
    CONSTRAINT [PK_MyTable_01074] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01074_MyTable01074] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01074] ([ColKey]),
    CONSTRAINT [BK_MyTable_01074_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
