CREATE TABLE [MySchema].[MyTable_01115] (
    ...
    CONSTRAINT [PK_MyTable_01115] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01115_MyTable01115] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01115] ([ColKey]),
    CONSTRAINT [BK_MyTable_01115_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
