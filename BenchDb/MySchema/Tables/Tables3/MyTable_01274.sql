CREATE TABLE [MySchema].[MyTable_01274] (
    ...
    CONSTRAINT [PK_MyTable_01274] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01274_MyTable01274] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01274] ([ColKey]),
    CONSTRAINT [BK_MyTable_01274_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
