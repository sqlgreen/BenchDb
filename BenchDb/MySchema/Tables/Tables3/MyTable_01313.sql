CREATE TABLE [MySchema].[MyTable_01313] (
    ...
    CONSTRAINT [PK_MyTable_01313] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01313_MyTable01313] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01313] ([ColKey]),
    CONSTRAINT [BK_MyTable_01313_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
