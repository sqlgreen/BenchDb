CREATE TABLE [MySchema].[MyTable_01003] (
    ...
    CONSTRAINT [PK_MyTable_01003] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01003_MyTable01003] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01003] ([ColKey]),
    CONSTRAINT [BK_MyTable_01003_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
