CREATE TABLE [MySchema].[MyTable_01224] (
    ...
    CONSTRAINT [PK_MyTable_01224] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01224_MyTable01224] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01224] ([ColKey]),
    CONSTRAINT [BK_MyTable_01224_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
