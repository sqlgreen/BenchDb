CREATE TABLE [MySchema].[MyTable_01360] (
    ...
    CONSTRAINT [PK_MyTable_01360] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01360_MyTable01360] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01360] ([ColKey]),
    CONSTRAINT [BK_MyTable_01360_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
