CREATE TABLE [MySchema].[MyTable_01332] (
    ...
    CONSTRAINT [PK_MyTable_01332] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01332_MyTable01332] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01332] ([ColKey]),
    CONSTRAINT [BK_MyTable_01332_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
