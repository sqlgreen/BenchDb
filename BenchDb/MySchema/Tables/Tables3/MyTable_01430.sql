CREATE TABLE [MySchema].[MyTable_01430] (
    ...
    CONSTRAINT [PK_MyTable_01430] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01430_MyTable01430] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01430] ([ColKey]),
    CONSTRAINT [BK_MyTable_01430_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
