CREATE TABLE [MySchema].[MyTable_01287] (
    ...
    CONSTRAINT [PK_MyTable_01287] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01287_MyTable01287] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01287] ([ColKey]),
    CONSTRAINT [BK_MyTable_01287_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
