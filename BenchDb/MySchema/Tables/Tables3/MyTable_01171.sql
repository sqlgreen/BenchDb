CREATE TABLE [MySchema].[MyTable_01171] (
    ...
    CONSTRAINT [PK_MyTable_01171] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01171_MyTable01171] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01171] ([ColKey]),
    CONSTRAINT [BK_MyTable_01171_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
