CREATE TABLE [MySchema].[MyTable_01078] (
    ...
    CONSTRAINT [PK_MyTable_01078] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01078_MyTable01078] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01078] ([ColKey]),
    CONSTRAINT [BK_MyTable_01078_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
