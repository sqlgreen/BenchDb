CREATE TABLE [MySchema].[MyTable_01384] (
    ...
    CONSTRAINT [PK_MyTable_01384] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01384_MyTable01384] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01384] ([ColKey]),
    CONSTRAINT [BK_MyTable_01384_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
