CREATE TABLE [MySchema].[MyTable_01319] (
    ...
    CONSTRAINT [PK_MyTable_01319] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01319_MyTable01319] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01319] ([ColKey]),
    CONSTRAINT [BK_MyTable_01319_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
