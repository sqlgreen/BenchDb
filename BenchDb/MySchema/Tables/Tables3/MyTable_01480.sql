CREATE TABLE [MySchema].[MyTable_01480] (
    ...
    CONSTRAINT [PK_MyTable_01480] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01480_MyTable01480] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01480] ([ColKey]),
    CONSTRAINT [BK_MyTable_01480_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
