CREATE TABLE [MySchema].[MyTable_01406] (
    ...
    CONSTRAINT [PK_MyTable_01406] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01406_MyTable01406] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01406] ([ColKey]),
    CONSTRAINT [BK_MyTable_01406_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
