CREATE TABLE [MySchema].[MyTable_01222] (
    ...
    CONSTRAINT [PK_MyTable_01222] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01222_MyTable01222] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01222] ([ColKey]),
    CONSTRAINT [BK_MyTable_01222_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
