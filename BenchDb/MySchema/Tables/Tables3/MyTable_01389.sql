CREATE TABLE [MySchema].[MyTable_01389] (
    ...
    CONSTRAINT [PK_MyTable_01389] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01389_MyTable01389] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01389] ([ColKey]),
    CONSTRAINT [BK_MyTable_01389_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
