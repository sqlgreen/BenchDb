CREATE TABLE [MySchema].[MyTable_01297] (
    ...
    CONSTRAINT [PK_MyTable_01297] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01297_MyTable01297] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01297] ([ColKey]),
    CONSTRAINT [BK_MyTable_01297_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
