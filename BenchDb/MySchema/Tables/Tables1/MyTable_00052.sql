CREATE TABLE [MySchema].[MyTable_00052] (
    ...
    CONSTRAINT [PK_MyTable_00052] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00052_MyTable00052] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00052] ([ColKey]),
    CONSTRAINT [BK_MyTable_00052_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
