CREATE TABLE [MySchema].[MyTable_00355] (
    ...
    CONSTRAINT [PK_MyTable_00355] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00355_MyTable00355] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00355] ([ColKey]),
    CONSTRAINT [BK_MyTable_00355_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
