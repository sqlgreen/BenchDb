CREATE TABLE [MySchema].[MyTable_00458] (
    ...
    CONSTRAINT [PK_MyTable_00458] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00458_MyTable00458] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00458] ([ColKey]),
    CONSTRAINT [BK_MyTable_00458_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
