CREATE TABLE [MySchema].[MyTable_00090] (
    ...
    CONSTRAINT [PK_MyTable_00090] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00090_MyTable00090] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00090] ([ColKey]),
    CONSTRAINT [BK_MyTable_00090_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
