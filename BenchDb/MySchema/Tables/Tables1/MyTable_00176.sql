CREATE TABLE [MySchema].[MyTable_00176] (
    ...
    CONSTRAINT [PK_MyTable_00176] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00176_MyTable00176] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00176] ([ColKey]),
    CONSTRAINT [BK_MyTable_00176_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
