CREATE TABLE [MySchema].[MyTable_00133] (
    ...
    CONSTRAINT [PK_MyTable_00133] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00133_MyTable00133] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00133] ([ColKey]),
    CONSTRAINT [BK_MyTable_00133_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
