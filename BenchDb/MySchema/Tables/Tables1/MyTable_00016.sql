CREATE TABLE [MySchema].[MyTable_00016] (
    ...
    CONSTRAINT [PK_MyTable_00016] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00016_MyTable00016] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00016] ([ColKey]),
    CONSTRAINT [BK_MyTable_00016_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
