CREATE TABLE [MySchema].[MyTable_00240] (
    ...
    CONSTRAINT [PK_MyTable_00240] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00240_MyTable00240] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00240] ([ColKey]),
    CONSTRAINT [BK_MyTable_00240_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
