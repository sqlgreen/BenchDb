CREATE TABLE [MySchema].[MyTable_00202] (
    ...
    CONSTRAINT [PK_MyTable_00202] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00202_MyTable00202] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00202] ([ColKey]),
    CONSTRAINT [BK_MyTable_00202_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
