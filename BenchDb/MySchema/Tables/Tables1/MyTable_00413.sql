CREATE TABLE [MySchema].[MyTable_00413] (
    ...
    CONSTRAINT [PK_MyTable_00413] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00413_MyTable00413] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00413] ([ColKey]),
    CONSTRAINT [BK_MyTable_00413_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
