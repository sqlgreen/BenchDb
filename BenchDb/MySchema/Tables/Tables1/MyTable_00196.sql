CREATE TABLE [MySchema].[MyTable_00196] (
    ...
    CONSTRAINT [PK_MyTable_00196] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00196_MyTable00196] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00196] ([ColKey]),
    CONSTRAINT [BK_MyTable_00196_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
