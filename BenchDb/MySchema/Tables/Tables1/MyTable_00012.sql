CREATE TABLE [MySchema].[MyTable_00012] (
    ...
    CONSTRAINT [PK_MyTable_00012] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00012_MyTable00012] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00012] ([ColKey]),
    CONSTRAINT [BK_MyTable_00012_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
