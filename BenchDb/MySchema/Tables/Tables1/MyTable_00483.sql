CREATE TABLE [MySchema].[MyTable_00483] (
    ...
    CONSTRAINT [PK_MyTable_00483] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00483_MyTable00483] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00483] ([ColKey]),
    CONSTRAINT [BK_MyTable_00483_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
