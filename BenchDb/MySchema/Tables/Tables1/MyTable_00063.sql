CREATE TABLE [MySchema].[MyTable_00063] (
    ...
    CONSTRAINT [PK_MyTable_00063] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00063_MyTable00063] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00063] ([ColKey]),
    CONSTRAINT [BK_MyTable_00063_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
