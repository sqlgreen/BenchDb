CREATE TABLE [MySchema].[MyTable_00023] (
    ...
    CONSTRAINT [PK_MyTable_00023] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00023_MyTable00023] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00023] ([ColKey]),
    CONSTRAINT [BK_MyTable_00023_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
