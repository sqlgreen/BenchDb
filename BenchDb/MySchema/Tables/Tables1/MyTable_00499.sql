CREATE TABLE [MySchema].[MyTable_00499] (
    ...
    CONSTRAINT [PK_MyTable_00499] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00499_MyTable00499] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00499] ([ColKey]),
    CONSTRAINT [BK_MyTable_00499_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
