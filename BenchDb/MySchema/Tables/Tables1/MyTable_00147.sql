CREATE TABLE [MySchema].[MyTable_00147] (
    ...
    CONSTRAINT [PK_MyTable_00147] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00147_MyTable00147] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00147] ([ColKey]),
    CONSTRAINT [BK_MyTable_00147_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
