CREATE TABLE [MySchema].[MyTable_00010] (
    ...
    CONSTRAINT [PK_MyTable_00010] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00010_MyTable00010] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00010] ([ColKey]),
    CONSTRAINT [BK_MyTable_00010_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
