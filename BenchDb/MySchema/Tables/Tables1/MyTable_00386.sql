CREATE TABLE [MySchema].[MyTable_00386] (
    ...
    CONSTRAINT [PK_MyTable_00386] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00386_MyTable00386] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00386] ([ColKey]),
    CONSTRAINT [BK_MyTable_00386_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
