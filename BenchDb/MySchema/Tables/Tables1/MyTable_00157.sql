CREATE TABLE [MySchema].[MyTable_00157] (
    ...
    CONSTRAINT [PK_MyTable_00157] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00157_MyTable00157] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00157] ([ColKey]),
    CONSTRAINT [BK_MyTable_00157_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
