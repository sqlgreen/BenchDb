CREATE TABLE [MySchema].[MyTable_00028] (
    ...
    CONSTRAINT [PK_MyTable_00028] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00028_MyTable00028] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00028] ([ColKey]),
    CONSTRAINT [BK_MyTable_00028_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
