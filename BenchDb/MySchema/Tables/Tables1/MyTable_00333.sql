CREATE TABLE [MySchema].[MyTable_00333] (
    ...
    CONSTRAINT [PK_MyTable_00333] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00333_MyTable00333] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00333] ([ColKey]),
    CONSTRAINT [BK_MyTable_00333_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
