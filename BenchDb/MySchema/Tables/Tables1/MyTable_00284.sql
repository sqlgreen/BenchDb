CREATE TABLE [MySchema].[MyTable_00284] (
    ...
    CONSTRAINT [PK_MyTable_00284] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00284_MyTable00284] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00284] ([ColKey]),
    CONSTRAINT [BK_MyTable_00284_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
