CREATE TABLE [MySchema].[MyTable_00181] (
    ...
    CONSTRAINT [PK_MyTable_00181] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00181_MyTable00181] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00181] ([ColKey]),
    CONSTRAINT [BK_MyTable_00181_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
