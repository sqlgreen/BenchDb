CREATE TABLE [MySchema].[MyTable_00497] (
    ...
    CONSTRAINT [PK_MyTable_00497] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00497_MyTable00497] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00497] ([ColKey]),
    CONSTRAINT [BK_MyTable_00497_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
