CREATE TABLE [MySchema].[MyTable_00248] (
    ...
    CONSTRAINT [PK_MyTable_00248] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00248_MyTable00248] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00248] ([ColKey]),
    CONSTRAINT [BK_MyTable_00248_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
