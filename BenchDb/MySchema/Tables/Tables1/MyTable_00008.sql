CREATE TABLE [MySchema].[MyTable_00008] (
    ...
    CONSTRAINT [PK_MyTable_00008] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00008_MyTable00008] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00008] ([ColKey]),
    CONSTRAINT [BK_MyTable_00008_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
