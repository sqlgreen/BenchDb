CREATE TABLE [MySchema].[MyTable_00421] (
    ...
    CONSTRAINT [PK_MyTable_00421] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00421_MyTable00421] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00421] ([ColKey]),
    CONSTRAINT [BK_MyTable_00421_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
