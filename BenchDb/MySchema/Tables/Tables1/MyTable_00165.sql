CREATE TABLE [MySchema].[MyTable_00165] (
    ...
    CONSTRAINT [PK_MyTable_00165] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00165_MyTable00165] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00165] ([ColKey]),
    CONSTRAINT [BK_MyTable_00165_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
