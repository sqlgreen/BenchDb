CREATE TABLE [MySchema].[MyTable_00396] (
    ...
    CONSTRAINT [PK_MyTable_00396] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00396_MyTable00396] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00396] ([ColKey]),
    CONSTRAINT [BK_MyTable_00396_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
