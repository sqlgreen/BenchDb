CREATE TABLE [MySchema].[MyTable_00067] (
    ...
    CONSTRAINT [PK_MyTable_00067] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00067_MyTable00067] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00067] ([ColKey]),
    CONSTRAINT [BK_MyTable_00067_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
