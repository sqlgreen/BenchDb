CREATE TABLE [MySchema].[MyTable_00046] (
    ...
    CONSTRAINT [PK_MyTable_00046] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00046_MyTable00046] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00046] ([ColKey]),
    CONSTRAINT [BK_MyTable_00046_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
