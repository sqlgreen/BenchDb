CREATE TABLE [MySchema].[MyTable_00317] (
    ...
    CONSTRAINT [PK_MyTable_00317] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00317_MyTable00317] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00317] ([ColKey]),
    CONSTRAINT [BK_MyTable_00317_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
