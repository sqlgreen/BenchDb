CREATE TABLE [MySchema].[MyTable_00377] (
    ...
    CONSTRAINT [PK_MyTable_00377] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00377_MyTable00377] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00377] ([ColKey]),
    CONSTRAINT [BK_MyTable_00377_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
