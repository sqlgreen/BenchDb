CREATE TABLE [MySchema].[MyTable_00371] (
    ...
    CONSTRAINT [PK_MyTable_00371] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00371_MyTable00371] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00371] ([ColKey]),
    CONSTRAINT [BK_MyTable_00371_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
