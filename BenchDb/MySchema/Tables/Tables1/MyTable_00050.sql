CREATE TABLE [MySchema].[MyTable_00050] (
    ...
    CONSTRAINT [PK_MyTable_00050] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00050_MyTable00050] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00050] ([ColKey]),
    CONSTRAINT [BK_MyTable_00050_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
