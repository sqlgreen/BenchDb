CREATE TABLE [MySchema].[MyTable_00364] (
    ...
    CONSTRAINT [PK_MyTable_00364] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00364_MyTable00364] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00364] ([ColKey]),
    CONSTRAINT [BK_MyTable_00364_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
