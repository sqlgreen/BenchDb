CREATE TABLE [MySchema].[MyTable_00039] (
    ...
    CONSTRAINT [PK_MyTable_00039] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00039_MyTable00039] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00039] ([ColKey]),
    CONSTRAINT [BK_MyTable_00039_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
