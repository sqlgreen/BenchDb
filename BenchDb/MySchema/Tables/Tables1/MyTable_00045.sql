CREATE TABLE [MySchema].[MyTable_00045] (
    ...
    CONSTRAINT [PK_MyTable_00045] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00045_MyTable00045] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00045] ([ColKey]),
    CONSTRAINT [BK_MyTable_00045_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
