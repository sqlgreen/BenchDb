CREATE TABLE [MySchema].[MyTable_00007] (
    ...
    CONSTRAINT [PK_MyTable_00007] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00007_MyTable00007] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00007] ([ColKey]),
    CONSTRAINT [BK_MyTable_00007_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
