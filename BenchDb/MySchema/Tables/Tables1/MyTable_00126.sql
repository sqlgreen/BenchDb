CREATE TABLE [MySchema].[MyTable_00126] (
    ...
    CONSTRAINT [PK_MyTable_00126] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00126_MyTable00126] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00126] ([ColKey]),
    CONSTRAINT [BK_MyTable_00126_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
