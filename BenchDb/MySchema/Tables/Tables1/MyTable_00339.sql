CREATE TABLE [MySchema].[MyTable_00339] (
    ...
    CONSTRAINT [PK_MyTable_00339] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00339_MyTable00339] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00339] ([ColKey]),
    CONSTRAINT [BK_MyTable_00339_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
