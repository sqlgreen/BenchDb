CREATE TABLE [MySchema].[MyTable_00019] (
    ...
    CONSTRAINT [PK_MyTable_00019] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00019_MyTable00019] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00019] ([ColKey]),
    CONSTRAINT [BK_MyTable_00019_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
