CREATE TABLE [MySchema].[MyTable_00144] (
    ...
    CONSTRAINT [PK_MyTable_00144] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00144_MyTable00144] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00144] ([ColKey]),
    CONSTRAINT [BK_MyTable_00144_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
