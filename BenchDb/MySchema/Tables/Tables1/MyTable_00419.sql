CREATE TABLE [MySchema].[MyTable_00419] (
    ...
    CONSTRAINT [PK_MyTable_00419] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00419_MyTable00419] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00419] ([ColKey]),
    CONSTRAINT [BK_MyTable_00419_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
