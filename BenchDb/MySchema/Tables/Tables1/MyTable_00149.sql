CREATE TABLE [MySchema].[MyTable_00149] (
    ...
    CONSTRAINT [PK_MyTable_00149] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00149_MyTable00149] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00149] ([ColKey]),
    CONSTRAINT [BK_MyTable_00149_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
