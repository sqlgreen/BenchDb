CREATE TABLE [MySchema].[MyTable_00412] (
    ...
    CONSTRAINT [PK_MyTable_00412] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00412_MyTable00412] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00412] ([ColKey]),
    CONSTRAINT [BK_MyTable_00412_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
