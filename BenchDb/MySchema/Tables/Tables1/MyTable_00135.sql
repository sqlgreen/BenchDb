CREATE TABLE [MySchema].[MyTable_00135] (
    ...
    CONSTRAINT [PK_MyTable_00135] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00135_MyTable00135] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00135] ([ColKey]),
    CONSTRAINT [BK_MyTable_00135_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
