CREATE TABLE [MySchema].[MyTable_00382] (
    ...
    CONSTRAINT [PK_MyTable_00382] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00382_MyTable00382] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00382] ([ColKey]),
    CONSTRAINT [BK_MyTable_00382_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
