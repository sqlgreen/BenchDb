CREATE TABLE [MySchema].[MyTable_00388] (
    ...
    CONSTRAINT [PK_MyTable_00388] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00388_MyTable00388] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00388] ([ColKey]),
    CONSTRAINT [BK_MyTable_00388_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
