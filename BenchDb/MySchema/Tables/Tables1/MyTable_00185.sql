CREATE TABLE [MySchema].[MyTable_00185] (
    ...
    CONSTRAINT [PK_MyTable_00185] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00185_MyTable00185] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00185] ([ColKey]),
    CONSTRAINT [BK_MyTable_00185_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
