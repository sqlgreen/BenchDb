CREATE TABLE [MySchema].[MyTable_00245] (
    ...
    CONSTRAINT [PK_MyTable_00245] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00245_MyTable00245] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00245] ([ColKey]),
    CONSTRAINT [BK_MyTable_00245_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
