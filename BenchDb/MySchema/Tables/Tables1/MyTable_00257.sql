CREATE TABLE [MySchema].[MyTable_00257] (
    ...
    CONSTRAINT [PK_MyTable_00257] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00257_MyTable00257] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00257] ([ColKey]),
    CONSTRAINT [BK_MyTable_00257_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
