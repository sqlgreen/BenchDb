CREATE TABLE [MySchema].[MyTable_00462] (
    ...
    CONSTRAINT [PK_MyTable_00462] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00462_MyTable00462] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00462] ([ColKey]),
    CONSTRAINT [BK_MyTable_00462_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
