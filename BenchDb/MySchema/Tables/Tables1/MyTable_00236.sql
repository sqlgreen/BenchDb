CREATE TABLE [MySchema].[MyTable_00236] (
    ...
    CONSTRAINT [PK_MyTable_00236] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00236_MyTable00236] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00236] ([ColKey]),
    CONSTRAINT [BK_MyTable_00236_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
