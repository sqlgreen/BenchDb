CREATE TABLE [MySchema].[MyTable_00351] (
    ...
    CONSTRAINT [PK_MyTable_00351] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00351_MyTable00351] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00351] ([ColKey]),
    CONSTRAINT [BK_MyTable_00351_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
