CREATE TABLE [MySchema].[MyTable_00309] (
    ...
    CONSTRAINT [PK_MyTable_00309] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00309_MyTable00309] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00309] ([ColKey]),
    CONSTRAINT [BK_MyTable_00309_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
