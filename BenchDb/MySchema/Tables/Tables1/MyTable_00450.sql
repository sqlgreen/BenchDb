CREATE TABLE [MySchema].[MyTable_00450] (
    ...
    CONSTRAINT [PK_MyTable_00450] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00450_MyTable00450] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00450] ([ColKey]),
    CONSTRAINT [BK_MyTable_00450_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
