CREATE TABLE [MySchema].[MyTable_00352] (
    ...
    CONSTRAINT [PK_MyTable_00352] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00352_MyTable00352] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00352] ([ColKey]),
    CONSTRAINT [BK_MyTable_00352_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
