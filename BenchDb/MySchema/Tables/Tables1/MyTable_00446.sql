CREATE TABLE [MySchema].[MyTable_00446] (
    ...
    CONSTRAINT [PK_MyTable_00446] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00446_MyTable00446] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00446] ([ColKey]),
    CONSTRAINT [BK_MyTable_00446_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
