CREATE TABLE [MySchema].[MyTable_00389] (
    ...
    CONSTRAINT [PK_MyTable_00389] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00389_MyTable00389] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00389] ([ColKey]),
    CONSTRAINT [BK_MyTable_00389_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
