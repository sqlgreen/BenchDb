CREATE TABLE [MySchema].[MyTable_00272] (
    ...
    CONSTRAINT [PK_MyTable_00272] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00272_MyTable00272] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00272] ([ColKey]),
    CONSTRAINT [BK_MyTable_00272_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
