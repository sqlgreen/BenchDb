CREATE TABLE [MySchema].[MyTable_00384] (
    ...
    CONSTRAINT [PK_MyTable_00384] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00384_MyTable00384] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00384] ([ColKey]),
    CONSTRAINT [BK_MyTable_00384_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
