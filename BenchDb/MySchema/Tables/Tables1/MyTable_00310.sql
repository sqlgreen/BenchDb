CREATE TABLE [MySchema].[MyTable_00310] (
    ...
    CONSTRAINT [PK_MyTable_00310] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00310_MyTable00310] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00310] ([ColKey]),
    CONSTRAINT [BK_MyTable_00310_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
