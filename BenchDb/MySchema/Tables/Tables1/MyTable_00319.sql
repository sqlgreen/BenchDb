CREATE TABLE [MySchema].[MyTable_00319] (
    ...
    CONSTRAINT [PK_MyTable_00319] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00319_MyTable00319] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00319] ([ColKey]),
    CONSTRAINT [BK_MyTable_00319_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
