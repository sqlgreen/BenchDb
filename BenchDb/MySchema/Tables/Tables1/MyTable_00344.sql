CREATE TABLE [MySchema].[MyTable_00344] (
    ...
    CONSTRAINT [PK_MyTable_00344] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00344_MyTable00344] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00344] ([ColKey]),
    CONSTRAINT [BK_MyTable_00344_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
