CREATE TABLE [MySchema].[MyTable_00068] (
    ...
    CONSTRAINT [PK_MyTable_00068] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00068_MyTable00068] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00068] ([ColKey]),
    CONSTRAINT [BK_MyTable_00068_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
