CREATE TABLE [MySchema].[MyTable_00381] (
    ...
    CONSTRAINT [PK_MyTable_00381] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00381_MyTable00381] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00381] ([ColKey]),
    CONSTRAINT [BK_MyTable_00381_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
