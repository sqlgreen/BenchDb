CREATE TABLE [MySchema].[MyTable_00108] (
    ...
    CONSTRAINT [PK_MyTable_00108] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00108_MyTable00108] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00108] ([ColKey]),
    CONSTRAINT [BK_MyTable_00108_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
