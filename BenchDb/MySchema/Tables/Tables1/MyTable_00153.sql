CREATE TABLE [MySchema].[MyTable_00153] (
    ...
    CONSTRAINT [PK_MyTable_00153] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00153_MyTable00153] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00153] ([ColKey]),
    CONSTRAINT [BK_MyTable_00153_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
