CREATE TABLE [MySchema].[MyTable_00056] (
    ...
    CONSTRAINT [PK_MyTable_00056] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00056_MyTable00056] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00056] ([ColKey]),
    CONSTRAINT [BK_MyTable_00056_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
