CREATE TABLE [MySchema].[MyTable_00408] (
    ...
    CONSTRAINT [PK_MyTable_00408] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00408_MyTable00408] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00408] ([ColKey]),
    CONSTRAINT [BK_MyTable_00408_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
