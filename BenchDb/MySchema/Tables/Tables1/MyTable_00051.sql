CREATE TABLE [MySchema].[MyTable_00051] (
    ...
    CONSTRAINT [PK_MyTable_00051] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00051_MyTable00051] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00051] ([ColKey]),
    CONSTRAINT [BK_MyTable_00051_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
