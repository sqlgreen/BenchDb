CREATE TABLE [MySchema].[MyTable_00445] (
    ...
    CONSTRAINT [PK_MyTable_00445] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00445_MyTable00445] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00445] ([ColKey]),
    CONSTRAINT [BK_MyTable_00445_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
