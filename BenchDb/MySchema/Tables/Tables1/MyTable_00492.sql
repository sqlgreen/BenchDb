CREATE TABLE [MySchema].[MyTable_00492] (
    ...
    CONSTRAINT [PK_MyTable_00492] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00492_MyTable00492] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00492] ([ColKey]),
    CONSTRAINT [BK_MyTable_00492_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
