CREATE TABLE [MySchema].[MyTable_00283] (
    ...
    CONSTRAINT [PK_MyTable_00283] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00283_MyTable00283] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00283] ([ColKey]),
    CONSTRAINT [BK_MyTable_00283_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
