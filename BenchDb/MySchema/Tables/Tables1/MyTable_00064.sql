CREATE TABLE [MySchema].[MyTable_00064] (
    ...
    CONSTRAINT [PK_MyTable_00064] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00064_MyTable00064] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00064] ([ColKey]),
    CONSTRAINT [BK_MyTable_00064_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
