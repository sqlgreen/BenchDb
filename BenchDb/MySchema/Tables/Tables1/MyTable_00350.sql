CREATE TABLE [MySchema].[MyTable_00350] (
    ...
    CONSTRAINT [PK_MyTable_00350] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00350_MyTable00350] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00350] ([ColKey]),
    CONSTRAINT [BK_MyTable_00350_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
