CREATE TABLE [MySchema].[MyTable_00280] (
    ...
    CONSTRAINT [PK_MyTable_00280] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00280_MyTable00280] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00280] ([ColKey]),
    CONSTRAINT [BK_MyTable_00280_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
