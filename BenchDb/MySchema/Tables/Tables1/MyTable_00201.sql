CREATE TABLE [MySchema].[MyTable_00201] (
    ...
    CONSTRAINT [PK_MyTable_00201] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00201_MyTable00201] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00201] ([ColKey]),
    CONSTRAINT [BK_MyTable_00201_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
