CREATE TABLE [MySchema].[MyTable_00367] (
    ...
    CONSTRAINT [PK_MyTable_00367] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00367_MyTable00367] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00367] ([ColKey]),
    CONSTRAINT [BK_MyTable_00367_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
