CREATE TABLE [MySchema].[MyTable_00459] (
    ...
    CONSTRAINT [PK_MyTable_00459] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00459_MyTable00459] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00459] ([ColKey]),
    CONSTRAINT [BK_MyTable_00459_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
