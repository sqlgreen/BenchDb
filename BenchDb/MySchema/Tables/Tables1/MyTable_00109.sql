CREATE TABLE [MySchema].[MyTable_00109] (
    ...
    CONSTRAINT [PK_MyTable_00109] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00109_MyTable00109] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00109] ([ColKey]),
    CONSTRAINT [BK_MyTable_00109_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
