CREATE TABLE [MySchema].[MyTable_00353] (
    ...
    CONSTRAINT [PK_MyTable_00353] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00353_MyTable00353] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00353] ([ColKey]),
    CONSTRAINT [BK_MyTable_00353_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
