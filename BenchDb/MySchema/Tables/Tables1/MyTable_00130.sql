CREATE TABLE [MySchema].[MyTable_00130] (
    ...
    CONSTRAINT [PK_MyTable_00130] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00130_MyTable00130] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00130] ([ColKey]),
    CONSTRAINT [BK_MyTable_00130_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
