CREATE TABLE [MySchema].[MyTable_00237] (
    ...
    CONSTRAINT [PK_MyTable_00237] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00237_MyTable00237] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00237] ([ColKey]),
    CONSTRAINT [BK_MyTable_00237_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
