CREATE TABLE [MySchema].[MyTable_00084] (
    ...
    CONSTRAINT [PK_MyTable_00084] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00084_MyTable00084] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00084] ([ColKey]),
    CONSTRAINT [BK_MyTable_00084_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
