CREATE TABLE [MySchema].[MyTable_00208] (
    ...
    CONSTRAINT [PK_MyTable_00208] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00208_MyTable00208] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00208] ([ColKey]),
    CONSTRAINT [BK_MyTable_00208_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
