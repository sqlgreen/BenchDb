CREATE TABLE [MySchema].[MyTable_00473] (
    ...
    CONSTRAINT [PK_MyTable_00473] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00473_MyTable00473] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00473] ([ColKey]),
    CONSTRAINT [BK_MyTable_00473_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
