CREATE TABLE [MySchema].[MyTable_00131] (
    ...
    CONSTRAINT [PK_MyTable_00131] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00131_MyTable00131] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00131] ([ColKey]),
    CONSTRAINT [BK_MyTable_00131_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
