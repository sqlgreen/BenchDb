CREATE TABLE [MySchema].[MyTable_00107] (
    ...
    CONSTRAINT [PK_MyTable_00107] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00107_MyTable00107] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00107] ([ColKey]),
    CONSTRAINT [BK_MyTable_00107_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
