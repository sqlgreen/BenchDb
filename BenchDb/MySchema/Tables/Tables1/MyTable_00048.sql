CREATE TABLE [MySchema].[MyTable_00048] (
    ...
    CONSTRAINT [PK_MyTable_00048] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00048_MyTable00048] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00048] ([ColKey]),
    CONSTRAINT [BK_MyTable_00048_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
