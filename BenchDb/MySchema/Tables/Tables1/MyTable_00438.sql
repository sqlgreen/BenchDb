CREATE TABLE [MySchema].[MyTable_00438] (
    ...
    CONSTRAINT [PK_MyTable_00438] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00438_MyTable00438] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00438] ([ColKey]),
    CONSTRAINT [BK_MyTable_00438_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
