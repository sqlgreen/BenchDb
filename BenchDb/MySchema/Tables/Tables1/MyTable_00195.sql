CREATE TABLE [MySchema].[MyTable_00195] (
    ...
    CONSTRAINT [PK_MyTable_00195] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00195_MyTable00195] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00195] ([ColKey]),
    CONSTRAINT [BK_MyTable_00195_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
