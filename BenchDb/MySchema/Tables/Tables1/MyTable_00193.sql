CREATE TABLE [MySchema].[MyTable_00193] (
    ...
    CONSTRAINT [PK_MyTable_00193] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00193_MyTable00193] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00193] ([ColKey]),
    CONSTRAINT [BK_MyTable_00193_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
