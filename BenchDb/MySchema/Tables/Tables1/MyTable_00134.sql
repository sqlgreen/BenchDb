CREATE TABLE [MySchema].[MyTable_00134] (
    ...
    CONSTRAINT [PK_MyTable_00134] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00134_MyTable00134] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00134] ([ColKey]),
    CONSTRAINT [BK_MyTable_00134_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
