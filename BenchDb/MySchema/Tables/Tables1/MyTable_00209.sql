CREATE TABLE [MySchema].[MyTable_00209] (
    ...
    CONSTRAINT [PK_MyTable_00209] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00209_MyTable00209] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00209] ([ColKey]),
    CONSTRAINT [BK_MyTable_00209_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
