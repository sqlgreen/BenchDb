CREATE TABLE [MySchema].[MyTable_00061] (
    ...
    CONSTRAINT [PK_MyTable_00061] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00061_MyTable00061] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00061] ([ColKey]),
    CONSTRAINT [BK_MyTable_00061_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
