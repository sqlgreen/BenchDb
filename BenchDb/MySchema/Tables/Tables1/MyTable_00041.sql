CREATE TABLE [MySchema].[MyTable_00041] (
    ...
    CONSTRAINT [PK_MyTable_00041] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00041_MyTable00041] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00041] ([ColKey]),
    CONSTRAINT [BK_MyTable_00041_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
