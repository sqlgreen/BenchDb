CREATE TABLE [MySchema].[MyTable_00030] (
    ...
    CONSTRAINT [PK_MyTable_00030] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00030_MyTable00030] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00030] ([ColKey]),
    CONSTRAINT [BK_MyTable_00030_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
