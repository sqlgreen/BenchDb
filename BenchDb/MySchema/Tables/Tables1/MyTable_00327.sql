CREATE TABLE [MySchema].[MyTable_00327] (
    ...
    CONSTRAINT [PK_MyTable_00327] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00327_MyTable00327] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00327] ([ColKey]),
    CONSTRAINT [BK_MyTable_00327_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
