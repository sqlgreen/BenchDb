CREATE TABLE [MySchema].[MyTable_00424] (
    ...
    CONSTRAINT [PK_MyTable_00424] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00424_MyTable00424] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00424] ([ColKey]),
    CONSTRAINT [BK_MyTable_00424_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
