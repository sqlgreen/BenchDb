CREATE TABLE [MySchema].[MyTable_00011] (
    ...
    CONSTRAINT [PK_MyTable_00011] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00011_MyTable00011] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00011] ([ColKey]),
    CONSTRAINT [BK_MyTable_00011_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
