CREATE TABLE [MySchema].[MyTable_00301] (
    ...
    CONSTRAINT [PK_MyTable_00301] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00301_MyTable00301] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00301] ([ColKey]),
    CONSTRAINT [BK_MyTable_00301_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
