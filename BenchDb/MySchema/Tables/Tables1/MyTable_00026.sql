CREATE TABLE [MySchema].[MyTable_00026] (
    ...
    CONSTRAINT [PK_MyTable_00026] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00026_MyTable00026] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00026] ([ColKey]),
    CONSTRAINT [BK_MyTable_00026_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
