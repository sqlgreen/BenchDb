CREATE TABLE [MySchema].[MyTable_00451] (
    ...
    CONSTRAINT [PK_MyTable_00451] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00451_MyTable00451] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00451] ([ColKey]),
    CONSTRAINT [BK_MyTable_00451_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
