CREATE TABLE [MySchema].[MyTable_00002] (
    ...
    CONSTRAINT [PK_MyTable_00002] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00002_MyTable00002] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00002] ([ColKey]),
    CONSTRAINT [BK_MyTable_00002_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
