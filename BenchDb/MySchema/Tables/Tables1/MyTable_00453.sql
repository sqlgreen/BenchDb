CREATE TABLE [MySchema].[MyTable_00453] (
    ...
    CONSTRAINT [PK_MyTable_00453] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00453_MyTable00453] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00453] ([ColKey]),
    CONSTRAINT [BK_MyTable_00453_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
