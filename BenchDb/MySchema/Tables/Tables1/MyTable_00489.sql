CREATE TABLE [MySchema].[MyTable_00489] (
    ...
    CONSTRAINT [PK_MyTable_00489] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00489_MyTable00489] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00489] ([ColKey]),
    CONSTRAINT [BK_MyTable_00489_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
