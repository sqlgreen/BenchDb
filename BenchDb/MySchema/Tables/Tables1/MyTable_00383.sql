CREATE TABLE [MySchema].[MyTable_00383] (
    ...
    CONSTRAINT [PK_MyTable_00383] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00383_MyTable00383] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00383] ([ColKey]),
    CONSTRAINT [BK_MyTable_00383_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
