CREATE TABLE [MySchema].[MyTable_00363] (
    ...
    CONSTRAINT [PK_MyTable_00363] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00363_MyTable00363] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00363] ([ColKey]),
    CONSTRAINT [BK_MyTable_00363_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
