CREATE TABLE [MySchema].[MyTable_00000] (
    ...
    CONSTRAINT [PK_MyTable_00000] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00000_MyTable00000] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00000] ([ColKey]),
    CONSTRAINT [BK_MyTable_00000_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
