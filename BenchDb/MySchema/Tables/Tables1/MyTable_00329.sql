CREATE TABLE [MySchema].[MyTable_00329] (
    ...
    CONSTRAINT [PK_MyTable_00329] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00329_MyTable00329] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00329] ([ColKey]),
    CONSTRAINT [BK_MyTable_00329_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
