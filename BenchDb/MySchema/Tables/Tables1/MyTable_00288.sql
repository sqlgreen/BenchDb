CREATE TABLE [MySchema].[MyTable_00288] (
    ...
    CONSTRAINT [PK_MyTable_00288] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00288_MyTable00288] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00288] ([ColKey]),
    CONSTRAINT [BK_MyTable_00288_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
