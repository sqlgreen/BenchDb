CREATE TABLE [MySchema].[MyTable_00251] (
    ...
    CONSTRAINT [PK_MyTable_00251] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00251_MyTable00251] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00251] ([ColKey]),
    CONSTRAINT [BK_MyTable_00251_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
