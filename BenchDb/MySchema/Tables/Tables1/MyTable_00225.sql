CREATE TABLE [MySchema].[MyTable_00225] (
    ...
    CONSTRAINT [PK_MyTable_00225] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00225_MyTable00225] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00225] ([ColKey]),
    CONSTRAINT [BK_MyTable_00225_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
