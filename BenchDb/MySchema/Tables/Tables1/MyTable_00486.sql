CREATE TABLE [MySchema].[MyTable_00486] (
    ...
    CONSTRAINT [PK_MyTable_00486] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00486_MyTable00486] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00486] ([ColKey]),
    CONSTRAINT [BK_MyTable_00486_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
