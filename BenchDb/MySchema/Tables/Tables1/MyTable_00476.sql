CREATE TABLE [MySchema].[MyTable_00476] (
    ...
    CONSTRAINT [PK_MyTable_00476] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00476_MyTable00476] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00476] ([ColKey]),
    CONSTRAINT [BK_MyTable_00476_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
