CREATE TABLE [MySchema].[MyTable_00098] (
    ...
    CONSTRAINT [PK_MyTable_00098] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00098_MyTable00098] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00098] ([ColKey]),
    CONSTRAINT [BK_MyTable_00098_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
