CREATE TABLE [MySchema].[MyTable_00161] (
    ...
    CONSTRAINT [PK_MyTable_00161] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00161_MyTable00161] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00161] ([ColKey]),
    CONSTRAINT [BK_MyTable_00161_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
