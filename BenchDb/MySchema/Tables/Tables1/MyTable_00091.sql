CREATE TABLE [MySchema].[MyTable_00091] (
    ...
    CONSTRAINT [PK_MyTable_00091] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00091_MyTable00091] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00091] ([ColKey]),
    CONSTRAINT [BK_MyTable_00091_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
