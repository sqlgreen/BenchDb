CREATE TABLE [MySchema].[MyTable_00123] (
    ...
    CONSTRAINT [PK_MyTable_00123] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00123_MyTable00123] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00123] ([ColKey]),
    CONSTRAINT [BK_MyTable_00123_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
