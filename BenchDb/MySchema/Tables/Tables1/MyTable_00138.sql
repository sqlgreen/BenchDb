CREATE TABLE [MySchema].[MyTable_00138] (
    ...
    CONSTRAINT [PK_MyTable_00138] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00138_MyTable00138] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00138] ([ColKey]),
    CONSTRAINT [BK_MyTable_00138_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
