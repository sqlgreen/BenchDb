CREATE TABLE [MySchema].[MyTable_00058] (
    ...
    CONSTRAINT [PK_MyTable_00058] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00058_MyTable00058] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00058] ([ColKey]),
    CONSTRAINT [BK_MyTable_00058_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
