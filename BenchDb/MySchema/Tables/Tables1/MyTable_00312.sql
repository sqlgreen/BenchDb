CREATE TABLE [MySchema].[MyTable_00312] (
    ...
    CONSTRAINT [PK_MyTable_00312] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00312_MyTable00312] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00312] ([ColKey]),
    CONSTRAINT [BK_MyTable_00312_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
