CREATE TABLE [MySchema].[MyTable_00336] (
    ...
    CONSTRAINT [PK_MyTable_00336] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00336_MyTable00336] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00336] ([ColKey]),
    CONSTRAINT [BK_MyTable_00336_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
