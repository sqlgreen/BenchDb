CREATE TABLE [MySchema].[MyTable_00244] (
    ...
    CONSTRAINT [PK_MyTable_00244] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00244_MyTable00244] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00244] ([ColKey]),
    CONSTRAINT [BK_MyTable_00244_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
