CREATE TABLE [MySchema].[MyTable_00232] (
    ...
    CONSTRAINT [PK_MyTable_00232] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00232_MyTable00232] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00232] ([ColKey]),
    CONSTRAINT [BK_MyTable_00232_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
