CREATE TABLE [MySchema].[MyTable_00072] (
    ...
    CONSTRAINT [PK_MyTable_00072] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00072_MyTable00072] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00072] ([ColKey]),
    CONSTRAINT [BK_MyTable_00072_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
