CREATE TABLE [MySchema].[MyTable_00410] (
    ...
    CONSTRAINT [PK_MyTable_00410] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00410_MyTable00410] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00410] ([ColKey]),
    CONSTRAINT [BK_MyTable_00410_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
