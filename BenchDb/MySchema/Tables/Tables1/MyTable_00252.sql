CREATE TABLE [MySchema].[MyTable_00252] (
    ...
    CONSTRAINT [PK_MyTable_00252] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00252_MyTable00252] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00252] ([ColKey]),
    CONSTRAINT [BK_MyTable_00252_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
