CREATE TABLE [MySchema].[MyTable_00402] (
    ...
    CONSTRAINT [PK_MyTable_00402] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00402_MyTable00402] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00402] ([ColKey]),
    CONSTRAINT [BK_MyTable_00402_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
