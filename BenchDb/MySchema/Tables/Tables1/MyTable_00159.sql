CREATE TABLE [MySchema].[MyTable_00159] (
    ...
    CONSTRAINT [PK_MyTable_00159] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00159_MyTable00159] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00159] ([ColKey]),
    CONSTRAINT [BK_MyTable_00159_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
