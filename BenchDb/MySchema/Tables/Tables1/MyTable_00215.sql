CREATE TABLE [MySchema].[MyTable_00215] (
    ...
    CONSTRAINT [PK_MyTable_00215] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00215_MyTable00215] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00215] ([ColKey]),
    CONSTRAINT [BK_MyTable_00215_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
