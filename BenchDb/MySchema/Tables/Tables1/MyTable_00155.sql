CREATE TABLE [MySchema].[MyTable_00155] (
    ...
    CONSTRAINT [PK_MyTable_00155] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00155_MyTable00155] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00155] ([ColKey]),
    CONSTRAINT [BK_MyTable_00155_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
