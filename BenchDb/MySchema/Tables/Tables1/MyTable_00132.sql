CREATE TABLE [MySchema].[MyTable_00132] (
    ...
    CONSTRAINT [PK_MyTable_00132] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00132_MyTable00132] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00132] ([ColKey]),
    CONSTRAINT [BK_MyTable_00132_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
