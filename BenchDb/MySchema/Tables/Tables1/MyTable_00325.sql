CREATE TABLE [MySchema].[MyTable_00325] (
    ...
    CONSTRAINT [PK_MyTable_00325] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00325_MyTable00325] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00325] ([ColKey]),
    CONSTRAINT [BK_MyTable_00325_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
