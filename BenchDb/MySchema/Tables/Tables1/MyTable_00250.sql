CREATE TABLE [MySchema].[MyTable_00250] (
    ...
    CONSTRAINT [PK_MyTable_00250] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00250_MyTable00250] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00250] ([ColKey]),
    CONSTRAINT [BK_MyTable_00250_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
