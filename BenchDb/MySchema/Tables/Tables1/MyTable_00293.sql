CREATE TABLE [MySchema].[MyTable_00293] (
    ...
    CONSTRAINT [PK_MyTable_00293] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00293_MyTable00293] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00293] ([ColKey]),
    CONSTRAINT [BK_MyTable_00293_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
