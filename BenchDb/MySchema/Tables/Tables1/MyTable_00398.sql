CREATE TABLE [MySchema].[MyTable_00398] (
    ...
    CONSTRAINT [PK_MyTable_00398] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00398_MyTable00398] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00398] ([ColKey]),
    CONSTRAINT [BK_MyTable_00398_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
