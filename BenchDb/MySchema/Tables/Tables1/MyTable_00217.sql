CREATE TABLE [MySchema].[MyTable_00217] (
    ...
    CONSTRAINT [PK_MyTable_00217] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00217_MyTable00217] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00217] ([ColKey]),
    CONSTRAINT [BK_MyTable_00217_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
