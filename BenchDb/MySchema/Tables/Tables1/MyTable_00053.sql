CREATE TABLE [MySchema].[MyTable_00053] (
    ...
    CONSTRAINT [PK_MyTable_00053] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00053_MyTable00053] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00053] ([ColKey]),
    CONSTRAINT [BK_MyTable_00053_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
