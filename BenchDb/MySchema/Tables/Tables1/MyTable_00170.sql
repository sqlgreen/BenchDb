CREATE TABLE [MySchema].[MyTable_00170] (
    ...
    CONSTRAINT [PK_MyTable_00170] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00170_MyTable00170] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00170] ([ColKey]),
    CONSTRAINT [BK_MyTable_00170_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
