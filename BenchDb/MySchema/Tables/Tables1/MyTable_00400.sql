CREATE TABLE [MySchema].[MyTable_00400] (
    ...
    CONSTRAINT [PK_MyTable_00400] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00400_MyTable00400] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00400] ([ColKey]),
    CONSTRAINT [BK_MyTable_00400_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
