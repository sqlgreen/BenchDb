CREATE TABLE [MySchema].[MyTable_00171] (
    ...
    CONSTRAINT [PK_MyTable_00171] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00171_MyTable00171] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00171] ([ColKey]),
    CONSTRAINT [BK_MyTable_00171_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
