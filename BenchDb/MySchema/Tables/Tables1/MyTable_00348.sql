CREATE TABLE [MySchema].[MyTable_00348] (
    ...
    CONSTRAINT [PK_MyTable_00348] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00348_MyTable00348] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00348] ([ColKey]),
    CONSTRAINT [BK_MyTable_00348_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
