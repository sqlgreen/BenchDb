CREATE TABLE [MySchema].[MyTable_00242] (
    ...
    CONSTRAINT [PK_MyTable_00242] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00242_MyTable00242] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00242] ([ColKey]),
    CONSTRAINT [BK_MyTable_00242_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
