CREATE TABLE [MySchema].[MyTable_00006] (
    ...
    CONSTRAINT [PK_MyTable_00006] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00006_MyTable00006] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00006] ([ColKey]),
    CONSTRAINT [BK_MyTable_00006_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
