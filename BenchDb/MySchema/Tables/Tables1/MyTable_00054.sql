CREATE TABLE [MySchema].[MyTable_00054] (
    ...
    CONSTRAINT [PK_MyTable_00054] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00054_MyTable00054] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00054] ([ColKey]),
    CONSTRAINT [BK_MyTable_00054_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
