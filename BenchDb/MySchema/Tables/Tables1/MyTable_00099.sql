CREATE TABLE [MySchema].[MyTable_00099] (
    ...
    CONSTRAINT [PK_MyTable_00099] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00099_MyTable00099] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00099] ([ColKey]),
    CONSTRAINT [BK_MyTable_00099_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
