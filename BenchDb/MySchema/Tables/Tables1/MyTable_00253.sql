CREATE TABLE [MySchema].[MyTable_00253] (
    ...
    CONSTRAINT [PK_MyTable_00253] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00253_MyTable00253] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00253] ([ColKey]),
    CONSTRAINT [BK_MyTable_00253_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
