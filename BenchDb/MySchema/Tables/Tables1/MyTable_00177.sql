CREATE TABLE [MySchema].[MyTable_00177] (
    ...
    CONSTRAINT [PK_MyTable_00177] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00177_MyTable00177] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00177] ([ColKey]),
    CONSTRAINT [BK_MyTable_00177_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
