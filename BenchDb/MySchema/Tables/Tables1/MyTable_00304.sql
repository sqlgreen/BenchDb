CREATE TABLE [MySchema].[MyTable_00304] (
    ...
    CONSTRAINT [PK_MyTable_00304] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00304_MyTable00304] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00304] ([ColKey]),
    CONSTRAINT [BK_MyTable_00304_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
