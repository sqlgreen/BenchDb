CREATE TABLE [MySchema].[MyTable_00167] (
    ...
    CONSTRAINT [PK_MyTable_00167] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00167_MyTable00167] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00167] ([ColKey]),
    CONSTRAINT [BK_MyTable_00167_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
