CREATE TABLE [MySchema].[MyTable_00320] (
    ...
    CONSTRAINT [PK_MyTable_00320] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00320_MyTable00320] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00320] ([ColKey]),
    CONSTRAINT [BK_MyTable_00320_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
