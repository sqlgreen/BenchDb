CREATE TABLE [MySchema].[MyTable_00103] (
    ...
    CONSTRAINT [PK_MyTable_00103] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00103_MyTable00103] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00103] ([ColKey]),
    CONSTRAINT [BK_MyTable_00103_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
