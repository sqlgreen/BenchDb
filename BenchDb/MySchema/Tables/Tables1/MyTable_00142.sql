CREATE TABLE [MySchema].[MyTable_00142] (
    ...
    CONSTRAINT [PK_MyTable_00142] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00142_MyTable00142] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00142] ([ColKey]),
    CONSTRAINT [BK_MyTable_00142_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
