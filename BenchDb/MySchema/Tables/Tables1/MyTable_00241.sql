CREATE TABLE [MySchema].[MyTable_00241] (
    ...
    CONSTRAINT [PK_MyTable_00241] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00241_MyTable00241] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00241] ([ColKey]),
    CONSTRAINT [BK_MyTable_00241_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
