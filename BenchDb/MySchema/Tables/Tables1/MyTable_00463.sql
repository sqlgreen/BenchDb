CREATE TABLE [MySchema].[MyTable_00463] (
    ...
    CONSTRAINT [PK_MyTable_00463] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00463_MyTable00463] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00463] ([ColKey]),
    CONSTRAINT [BK_MyTable_00463_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
