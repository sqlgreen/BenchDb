CREATE TABLE [MySchema].[MyTable_00427] (
    ...
    CONSTRAINT [PK_MyTable_00427] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00427_MyTable00427] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00427] ([ColKey]),
    CONSTRAINT [BK_MyTable_00427_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
