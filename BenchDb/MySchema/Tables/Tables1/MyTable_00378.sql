CREATE TABLE [MySchema].[MyTable_00378] (
    ...
    CONSTRAINT [PK_MyTable_00378] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00378_MyTable00378] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00378] ([ColKey]),
    CONSTRAINT [BK_MyTable_00378_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
