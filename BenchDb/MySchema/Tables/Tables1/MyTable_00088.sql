CREATE TABLE [MySchema].[MyTable_00088] (
    ...
    CONSTRAINT [PK_MyTable_00088] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00088_MyTable00088] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00088] ([ColKey]),
    CONSTRAINT [BK_MyTable_00088_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
