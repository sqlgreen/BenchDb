CREATE TABLE [MySchema].[MyTable_00332] (
    ...
    CONSTRAINT [PK_MyTable_00332] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00332_MyTable00332] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00332] ([ColKey]),
    CONSTRAINT [BK_MyTable_00332_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
