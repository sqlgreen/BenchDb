CREATE TABLE [MySchema].[MyTable_00128] (
    ...
    CONSTRAINT [PK_MyTable_00128] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00128_MyTable00128] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00128] ([ColKey]),
    CONSTRAINT [BK_MyTable_00128_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
