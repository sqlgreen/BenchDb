CREATE TABLE [MySchema].[MyTable_00294] (
    ...
    CONSTRAINT [PK_MyTable_00294] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00294_MyTable00294] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00294] ([ColKey]),
    CONSTRAINT [BK_MyTable_00294_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
