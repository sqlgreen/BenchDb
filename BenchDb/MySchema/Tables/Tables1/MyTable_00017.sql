CREATE TABLE [MySchema].[MyTable_00017] (
    ...
    CONSTRAINT [PK_MyTable_00017] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00017_MyTable00017] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00017] ([ColKey]),
    CONSTRAINT [BK_MyTable_00017_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
