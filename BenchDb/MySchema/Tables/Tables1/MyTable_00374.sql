CREATE TABLE [MySchema].[MyTable_00374] (
    ...
    CONSTRAINT [PK_MyTable_00374] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00374_MyTable00374] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00374] ([ColKey]),
    CONSTRAINT [BK_MyTable_00374_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
