CREATE TABLE [MySchema].[MyTable_00204] (
    ...
    CONSTRAINT [PK_MyTable_00204] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00204_MyTable00204] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00204] ([ColKey]),
    CONSTRAINT [BK_MyTable_00204_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
