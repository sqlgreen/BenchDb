CREATE TABLE [MySchema].[MyTable_00096] (
    ...
    CONSTRAINT [PK_MyTable_00096] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00096_MyTable00096] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00096] ([ColKey]),
    CONSTRAINT [BK_MyTable_00096_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
