CREATE TABLE [MySchema].[MyTable_00076] (
    ...
    CONSTRAINT [PK_MyTable_00076] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00076_MyTable00076] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00076] ([ColKey]),
    CONSTRAINT [BK_MyTable_00076_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
