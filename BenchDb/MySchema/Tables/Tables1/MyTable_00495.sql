CREATE TABLE [MySchema].[MyTable_00495] (
    ...
    CONSTRAINT [PK_MyTable_00495] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00495_MyTable00495] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00495] ([ColKey]),
    CONSTRAINT [BK_MyTable_00495_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
