CREATE TABLE [MySchema].[MyTable_00345] (
    ...
    CONSTRAINT [PK_MyTable_00345] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00345_MyTable00345] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00345] ([ColKey]),
    CONSTRAINT [BK_MyTable_00345_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
