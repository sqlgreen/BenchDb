CREATE TABLE [MySchema].[MyTable_00143] (
    ...
    CONSTRAINT [PK_MyTable_00143] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00143_MyTable00143] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00143] ([ColKey]),
    CONSTRAINT [BK_MyTable_00143_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
