CREATE TABLE [MySchema].[MyTable_00085] (
    ...
    CONSTRAINT [PK_MyTable_00085] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00085_MyTable00085] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00085] ([ColKey]),
    CONSTRAINT [BK_MyTable_00085_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
