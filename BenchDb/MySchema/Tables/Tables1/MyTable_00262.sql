CREATE TABLE [MySchema].[MyTable_00262] (
    ...
    CONSTRAINT [PK_MyTable_00262] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00262_MyTable00262] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00262] ([ColKey]),
    CONSTRAINT [BK_MyTable_00262_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
