CREATE TABLE [MySchema].[MyTable_00033] (
    ...
    CONSTRAINT [PK_MyTable_00033] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00033_MyTable00033] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00033] ([ColKey]),
    CONSTRAINT [BK_MyTable_00033_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
