CREATE TABLE [MySchema].[MyTable_00479] (
    ...
    CONSTRAINT [PK_MyTable_00479] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00479_MyTable00479] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00479] ([ColKey]),
    CONSTRAINT [BK_MyTable_00479_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
