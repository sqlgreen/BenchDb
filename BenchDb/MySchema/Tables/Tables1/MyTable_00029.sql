CREATE TABLE [MySchema].[MyTable_00029] (
    ...
    CONSTRAINT [PK_MyTable_00029] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00029_MyTable00029] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00029] ([ColKey]),
    CONSTRAINT [BK_MyTable_00029_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
