CREATE TABLE [MySchema].[MyTable_00036] (
    ...
    CONSTRAINT [PK_MyTable_00036] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00036_MyTable00036] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00036] ([ColKey]),
    CONSTRAINT [BK_MyTable_00036_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
