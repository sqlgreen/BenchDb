CREATE TABLE [MySchema].[MyTable_00079] (
    ...
    CONSTRAINT [PK_MyTable_00079] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00079_MyTable00079] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00079] ([ColKey]),
    CONSTRAINT [BK_MyTable_00079_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
