CREATE TABLE [MySchema].[MyTable_00290] (
    ...
    CONSTRAINT [PK_MyTable_00290] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00290_MyTable00290] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00290] ([ColKey]),
    CONSTRAINT [BK_MyTable_00290_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
