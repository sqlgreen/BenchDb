CREATE TABLE [MySchema].[MyTable_00403] (
    ...
    CONSTRAINT [PK_MyTable_00403] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00403_MyTable00403] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00403] ([ColKey]),
    CONSTRAINT [BK_MyTable_00403_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
