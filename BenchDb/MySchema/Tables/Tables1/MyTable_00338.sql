CREATE TABLE [MySchema].[MyTable_00338] (
    ...
    CONSTRAINT [PK_MyTable_00338] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00338_MyTable00338] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00338] ([ColKey]),
    CONSTRAINT [BK_MyTable_00338_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
