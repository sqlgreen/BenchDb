CREATE TABLE [MySchema].[MyTable_00311] (
    ...
    CONSTRAINT [PK_MyTable_00311] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00311_MyTable00311] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00311] ([ColKey]),
    CONSTRAINT [BK_MyTable_00311_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
