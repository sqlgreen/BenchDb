CREATE TABLE [MySchema].[MyTable_00059] (
    ...
    CONSTRAINT [PK_MyTable_00059] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00059_MyTable00059] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00059] ([ColKey]),
    CONSTRAINT [BK_MyTable_00059_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
