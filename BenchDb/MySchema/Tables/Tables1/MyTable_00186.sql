CREATE TABLE [MySchema].[MyTable_00186] (
    ...
    CONSTRAINT [PK_MyTable_00186] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00186_MyTable00186] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00186] ([ColKey]),
    CONSTRAINT [BK_MyTable_00186_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
