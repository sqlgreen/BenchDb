CREATE TABLE [MySchema].[MyTable_00478] (
    ...
    CONSTRAINT [PK_MyTable_00478] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00478_MyTable00478] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00478] ([ColKey]),
    CONSTRAINT [BK_MyTable_00478_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
