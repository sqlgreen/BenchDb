CREATE TABLE [MySchema].[MyTable_00397] (
    ...
    CONSTRAINT [PK_MyTable_00397] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00397_MyTable00397] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00397] ([ColKey]),
    CONSTRAINT [BK_MyTable_00397_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
