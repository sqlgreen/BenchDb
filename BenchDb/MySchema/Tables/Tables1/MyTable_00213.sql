CREATE TABLE [MySchema].[MyTable_00213] (
    ...
    CONSTRAINT [PK_MyTable_00213] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00213_MyTable00213] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00213] ([ColKey]),
    CONSTRAINT [BK_MyTable_00213_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
