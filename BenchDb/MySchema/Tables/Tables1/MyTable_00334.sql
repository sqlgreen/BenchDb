CREATE TABLE [MySchema].[MyTable_00334] (
    ...
    CONSTRAINT [PK_MyTable_00334] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00334_MyTable00334] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00334] ([ColKey]),
    CONSTRAINT [BK_MyTable_00334_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
