CREATE TABLE [MySchema].[MyTable_00235] (
    ...
    CONSTRAINT [PK_MyTable_00235] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00235_MyTable00235] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00235] ([ColKey]),
    CONSTRAINT [BK_MyTable_00235_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
