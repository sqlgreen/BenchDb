CREATE TABLE [MySchema].[MyTable_00110] (
    ...
    CONSTRAINT [PK_MyTable_00110] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00110_MyTable00110] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00110] ([ColKey]),
    CONSTRAINT [BK_MyTable_00110_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
