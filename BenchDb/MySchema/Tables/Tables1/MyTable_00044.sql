CREATE TABLE [MySchema].[MyTable_00044] (
    ...
    CONSTRAINT [PK_MyTable_00044] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00044_MyTable00044] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00044] ([ColKey]),
    CONSTRAINT [BK_MyTable_00044_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
