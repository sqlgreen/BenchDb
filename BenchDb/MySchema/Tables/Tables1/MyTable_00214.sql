CREATE TABLE [MySchema].[MyTable_00214] (
    ...
    CONSTRAINT [PK_MyTable_00214] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00214_MyTable00214] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00214] ([ColKey]),
    CONSTRAINT [BK_MyTable_00214_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
