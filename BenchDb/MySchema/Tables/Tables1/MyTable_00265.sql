CREATE TABLE [MySchema].[MyTable_00265] (
    ...
    CONSTRAINT [PK_MyTable_00265] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00265_MyTable00265] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00265] ([ColKey]),
    CONSTRAINT [BK_MyTable_00265_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
