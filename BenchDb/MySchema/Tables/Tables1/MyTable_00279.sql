CREATE TABLE [MySchema].[MyTable_00279] (
    ...
    CONSTRAINT [PK_MyTable_00279] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00279_MyTable00279] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00279] ([ColKey]),
    CONSTRAINT [BK_MyTable_00279_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
