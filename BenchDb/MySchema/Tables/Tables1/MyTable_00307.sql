CREATE TABLE [MySchema].[MyTable_00307] (
    ...
    CONSTRAINT [PK_MyTable_00307] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00307_MyTable00307] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00307] ([ColKey]),
    CONSTRAINT [BK_MyTable_00307_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
