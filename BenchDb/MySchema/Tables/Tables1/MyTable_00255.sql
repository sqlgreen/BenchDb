CREATE TABLE [MySchema].[MyTable_00255] (
    ...
    CONSTRAINT [PK_MyTable_00255] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00255_MyTable00255] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00255] ([ColKey]),
    CONSTRAINT [BK_MyTable_00255_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
