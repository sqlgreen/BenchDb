CREATE TABLE [MySchema].[MyTable_00111] (
    ...
    CONSTRAINT [PK_MyTable_00111] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00111_MyTable00111] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00111] ([ColKey]),
    CONSTRAINT [BK_MyTable_00111_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
