CREATE TABLE [MySchema].[MyTable_00089] (
    ...
    CONSTRAINT [PK_MyTable_00089] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00089_MyTable00089] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00089] ([ColKey]),
    CONSTRAINT [BK_MyTable_00089_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
