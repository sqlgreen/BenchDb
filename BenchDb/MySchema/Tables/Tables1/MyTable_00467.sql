CREATE TABLE [MySchema].[MyTable_00467] (
    ...
    CONSTRAINT [PK_MyTable_00467] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00467_MyTable00467] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00467] ([ColKey]),
    CONSTRAINT [BK_MyTable_00467_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
