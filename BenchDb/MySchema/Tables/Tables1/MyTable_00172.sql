CREATE TABLE [MySchema].[MyTable_00172] (
    ...
    CONSTRAINT [PK_MyTable_00172] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00172_MyTable00172] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00172] ([ColKey]),
    CONSTRAINT [BK_MyTable_00172_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
