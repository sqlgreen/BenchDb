CREATE TABLE [MySchema].[MyTable_00219] (
    ...
    CONSTRAINT [PK_MyTable_00219] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00219_MyTable00219] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00219] ([ColKey]),
    CONSTRAINT [BK_MyTable_00219_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
