CREATE TABLE [MySchema].[MyTable_00491] (
    ...
    CONSTRAINT [PK_MyTable_00491] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00491_MyTable00491] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00491] ([ColKey]),
    CONSTRAINT [BK_MyTable_00491_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
