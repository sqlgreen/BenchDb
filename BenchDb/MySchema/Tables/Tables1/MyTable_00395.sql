CREATE TABLE [MySchema].[MyTable_00395] (
    ...
    CONSTRAINT [PK_MyTable_00395] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00395_MyTable00395] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00395] ([ColKey]),
    CONSTRAINT [BK_MyTable_00395_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
