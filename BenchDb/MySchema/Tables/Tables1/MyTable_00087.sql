CREATE TABLE [MySchema].[MyTable_00087] (
    ...
    CONSTRAINT [PK_MyTable_00087] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00087_MyTable00087] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00087] ([ColKey]),
    CONSTRAINT [BK_MyTable_00087_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
