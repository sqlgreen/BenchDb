CREATE TABLE [MySchema].[MyTable_00150] (
    ...
    CONSTRAINT [PK_MyTable_00150] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00150_MyTable00150] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00150] ([ColKey]),
    CONSTRAINT [BK_MyTable_00150_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
