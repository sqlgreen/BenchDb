CREATE TABLE [MySchema].[MyTable_00375] (
    ...
    CONSTRAINT [PK_MyTable_00375] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00375_MyTable00375] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00375] ([ColKey]),
    CONSTRAINT [BK_MyTable_00375_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
