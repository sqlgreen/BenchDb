CREATE TABLE [MySchema].[MyTable_00434] (
    ...
    CONSTRAINT [PK_MyTable_00434] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00434_MyTable00434] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00434] ([ColKey]),
    CONSTRAINT [BK_MyTable_00434_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
