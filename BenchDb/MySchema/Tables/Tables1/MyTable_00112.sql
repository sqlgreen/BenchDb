CREATE TABLE [MySchema].[MyTable_00112] (
    ...
    CONSTRAINT [PK_MyTable_00112] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00112_MyTable00112] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00112] ([ColKey]),
    CONSTRAINT [BK_MyTable_00112_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
