CREATE TABLE [MySchema].[MyTable_00071] (
    ...
    CONSTRAINT [PK_MyTable_00071] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00071_MyTable00071] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00071] ([ColKey]),
    CONSTRAINT [BK_MyTable_00071_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
