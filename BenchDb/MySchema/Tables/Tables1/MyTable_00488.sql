CREATE TABLE [MySchema].[MyTable_00488] (
    ...
    CONSTRAINT [PK_MyTable_00488] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00488_MyTable00488] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00488] ([ColKey]),
    CONSTRAINT [BK_MyTable_00488_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
