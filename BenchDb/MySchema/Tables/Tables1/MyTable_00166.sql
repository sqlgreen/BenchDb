CREATE TABLE [MySchema].[MyTable_00166] (
    ...
    CONSTRAINT [PK_MyTable_00166] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00166_MyTable00166] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00166] ([ColKey]),
    CONSTRAINT [BK_MyTable_00166_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
