CREATE TABLE [MySchema].[MyTable_00405] (
    ...
    CONSTRAINT [PK_MyTable_00405] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00405_MyTable00405] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00405] ([ColKey]),
    CONSTRAINT [BK_MyTable_00405_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
