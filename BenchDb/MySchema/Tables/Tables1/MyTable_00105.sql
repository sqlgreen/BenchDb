CREATE TABLE [MySchema].[MyTable_00105] (
    ...
    CONSTRAINT [PK_MyTable_00105] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00105_MyTable00105] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00105] ([ColKey]),
    CONSTRAINT [BK_MyTable_00105_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
