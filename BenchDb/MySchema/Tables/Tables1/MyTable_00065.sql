CREATE TABLE [MySchema].[MyTable_00065] (
    ...
    CONSTRAINT [PK_MyTable_00065] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00065_MyTable00065] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00065] ([ColKey]),
    CONSTRAINT [BK_MyTable_00065_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
