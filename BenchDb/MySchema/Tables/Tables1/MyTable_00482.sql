CREATE TABLE [MySchema].[MyTable_00482] (
    ...
    CONSTRAINT [PK_MyTable_00482] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00482_MyTable00482] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00482] ([ColKey]),
    CONSTRAINT [BK_MyTable_00482_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
