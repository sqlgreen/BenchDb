CREATE TABLE [MySchema].[MyTable_00106] (
    ...
    CONSTRAINT [PK_MyTable_00106] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00106_MyTable00106] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00106] ([ColKey]),
    CONSTRAINT [BK_MyTable_00106_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
