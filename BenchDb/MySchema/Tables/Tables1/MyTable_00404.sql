CREATE TABLE [MySchema].[MyTable_00404] (
    ...
    CONSTRAINT [PK_MyTable_00404] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00404_MyTable00404] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00404] ([ColKey]),
    CONSTRAINT [BK_MyTable_00404_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
