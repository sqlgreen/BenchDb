CREATE TABLE [MySchema].[MyTable_00136] (
    ...
    CONSTRAINT [PK_MyTable_00136] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00136_MyTable00136] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00136] ([ColKey]),
    CONSTRAINT [BK_MyTable_00136_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
