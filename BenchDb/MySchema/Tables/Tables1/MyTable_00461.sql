CREATE TABLE [MySchema].[MyTable_00461] (
    ...
    CONSTRAINT [PK_MyTable_00461] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00461_MyTable00461] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00461] ([ColKey]),
    CONSTRAINT [BK_MyTable_00461_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
