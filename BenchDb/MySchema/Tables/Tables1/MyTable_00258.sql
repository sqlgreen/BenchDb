CREATE TABLE [MySchema].[MyTable_00258] (
    ...
    CONSTRAINT [PK_MyTable_00258] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00258_MyTable00258] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00258] ([ColKey]),
    CONSTRAINT [BK_MyTable_00258_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
