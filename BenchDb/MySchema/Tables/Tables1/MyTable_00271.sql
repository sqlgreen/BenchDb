CREATE TABLE [MySchema].[MyTable_00271] (
    ...
    CONSTRAINT [PK_MyTable_00271] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00271_MyTable00271] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00271] ([ColKey]),
    CONSTRAINT [BK_MyTable_00271_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
