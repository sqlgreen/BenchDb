CREATE TABLE [MySchema].[MyTable_00498] (
    ...
    CONSTRAINT [PK_MyTable_00498] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00498_MyTable00498] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00498] ([ColKey]),
    CONSTRAINT [BK_MyTable_00498_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
