CREATE TABLE [MySchema].[MyTable_00415] (
    ...
    CONSTRAINT [PK_MyTable_00415] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00415_MyTable00415] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00415] ([ColKey]),
    CONSTRAINT [BK_MyTable_00415_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
