CREATE TABLE [MySchema].[MyTable_00038] (
    ...
    CONSTRAINT [PK_MyTable_00038] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00038_MyTable00038] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00038] ([ColKey]),
    CONSTRAINT [BK_MyTable_00038_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
