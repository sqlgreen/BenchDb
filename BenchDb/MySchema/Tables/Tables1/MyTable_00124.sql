CREATE TABLE [MySchema].[MyTable_00124] (
    ...
    CONSTRAINT [PK_MyTable_00124] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00124_MyTable00124] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00124] ([ColKey]),
    CONSTRAINT [BK_MyTable_00124_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
