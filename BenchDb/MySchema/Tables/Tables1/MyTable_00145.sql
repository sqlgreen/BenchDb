CREATE TABLE [MySchema].[MyTable_00145] (
    ...
    CONSTRAINT [PK_MyTable_00145] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00145_MyTable00145] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00145] ([ColKey]),
    CONSTRAINT [BK_MyTable_00145_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
