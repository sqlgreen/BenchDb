CREATE TABLE [MySchema].[MyTable_00392] (
    ...
    CONSTRAINT [PK_MyTable_00392] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00392_MyTable00392] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00392] ([ColKey]),
    CONSTRAINT [BK_MyTable_00392_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
