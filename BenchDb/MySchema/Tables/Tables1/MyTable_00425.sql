CREATE TABLE [MySchema].[MyTable_00425] (
    ...
    CONSTRAINT [PK_MyTable_00425] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00425_MyTable00425] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00425] ([ColKey]),
    CONSTRAINT [BK_MyTable_00425_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
