CREATE TABLE [MySchema].[MyTable_00484] (
    ...
    CONSTRAINT [PK_MyTable_00484] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00484_MyTable00484] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00484] ([ColKey]),
    CONSTRAINT [BK_MyTable_00484_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
