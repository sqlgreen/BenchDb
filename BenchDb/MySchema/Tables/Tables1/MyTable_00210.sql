CREATE TABLE [MySchema].[MyTable_00210] (
    ...
    CONSTRAINT [PK_MyTable_00210] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00210_MyTable00210] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00210] ([ColKey]),
    CONSTRAINT [BK_MyTable_00210_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
