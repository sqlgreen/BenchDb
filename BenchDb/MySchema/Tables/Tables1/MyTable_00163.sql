CREATE TABLE [MySchema].[MyTable_00163] (
    ...
    CONSTRAINT [PK_MyTable_00163] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00163_MyTable00163] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00163] ([ColKey]),
    CONSTRAINT [BK_MyTable_00163_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
