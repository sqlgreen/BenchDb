CREATE TABLE [MySchema].[MyTable_00022] (
    ...
    CONSTRAINT [PK_MyTable_00022] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00022_MyTable00022] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00022] ([ColKey]),
    CONSTRAINT [BK_MyTable_00022_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
