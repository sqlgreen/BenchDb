CREATE TABLE [MySchema].[MyTable_00269] (
    ...
    CONSTRAINT [PK_MyTable_00269] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00269_MyTable00269] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00269] ([ColKey]),
    CONSTRAINT [BK_MyTable_00269_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
