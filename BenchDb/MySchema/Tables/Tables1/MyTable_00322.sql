CREATE TABLE [MySchema].[MyTable_00322] (
    ...
    CONSTRAINT [PK_MyTable_00322] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00322_MyTable00322] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00322] ([ColKey]),
    CONSTRAINT [BK_MyTable_00322_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
