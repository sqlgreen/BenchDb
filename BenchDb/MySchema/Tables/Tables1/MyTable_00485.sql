CREATE TABLE [MySchema].[MyTable_00485] (
    ...
    CONSTRAINT [PK_MyTable_00485] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00485_MyTable00485] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00485] ([ColKey]),
    CONSTRAINT [BK_MyTable_00485_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
