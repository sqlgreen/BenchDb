CREATE TABLE [MySchema].[MyTable_00456] (
    ...
    CONSTRAINT [PK_MyTable_00456] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00456_MyTable00456] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00456] ([ColKey]),
    CONSTRAINT [BK_MyTable_00456_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
