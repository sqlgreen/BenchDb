CREATE TABLE [MySchema].[MyTable_00343] (
    ...
    CONSTRAINT [PK_MyTable_00343] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00343_MyTable00343] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00343] ([ColKey]),
    CONSTRAINT [BK_MyTable_00343_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
