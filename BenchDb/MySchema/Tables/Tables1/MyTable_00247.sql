CREATE TABLE [MySchema].[MyTable_00247] (
    ...
    CONSTRAINT [PK_MyTable_00247] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00247_MyTable00247] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00247] ([ColKey]),
    CONSTRAINT [BK_MyTable_00247_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
