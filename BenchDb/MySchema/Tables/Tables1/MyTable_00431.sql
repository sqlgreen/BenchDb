CREATE TABLE [MySchema].[MyTable_00431] (
    ...
    CONSTRAINT [PK_MyTable_00431] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00431_MyTable00431] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00431] ([ColKey]),
    CONSTRAINT [BK_MyTable_00431_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
