CREATE TABLE [MySchema].[MyTable_00341] (
    ...
    CONSTRAINT [PK_MyTable_00341] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00341_MyTable00341] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00341] ([ColKey]),
    CONSTRAINT [BK_MyTable_00341_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
