CREATE TABLE [MySchema].[MyTable_00203] (
    ...
    CONSTRAINT [PK_MyTable_00203] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00203_MyTable00203] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00203] ([ColKey]),
    CONSTRAINT [BK_MyTable_00203_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
