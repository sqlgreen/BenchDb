CREATE TABLE [MySchema].[MyTable_00192] (
    ...
    CONSTRAINT [PK_MyTable_00192] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00192_MyTable00192] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00192] ([ColKey]),
    CONSTRAINT [BK_MyTable_00192_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
