CREATE TABLE [MySchema].[MyTable_00083] (
    ...
    CONSTRAINT [PK_MyTable_00083] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00083_MyTable00083] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00083] ([ColKey]),
    CONSTRAINT [BK_MyTable_00083_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
