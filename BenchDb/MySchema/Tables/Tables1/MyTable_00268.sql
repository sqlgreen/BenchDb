CREATE TABLE [MySchema].[MyTable_00268] (
    ...
    CONSTRAINT [PK_MyTable_00268] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00268_MyTable00268] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00268] ([ColKey]),
    CONSTRAINT [BK_MyTable_00268_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
