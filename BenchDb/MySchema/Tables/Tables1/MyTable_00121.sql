CREATE TABLE [MySchema].[MyTable_00121] (
    ...
    CONSTRAINT [PK_MyTable_00121] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00121_MyTable00121] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00121] ([ColKey]),
    CONSTRAINT [BK_MyTable_00121_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
