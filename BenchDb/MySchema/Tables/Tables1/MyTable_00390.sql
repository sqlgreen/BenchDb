CREATE TABLE [MySchema].[MyTable_00390] (
    ...
    CONSTRAINT [PK_MyTable_00390] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00390_MyTable00390] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00390] ([ColKey]),
    CONSTRAINT [BK_MyTable_00390_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
