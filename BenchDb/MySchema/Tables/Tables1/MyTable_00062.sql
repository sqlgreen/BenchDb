CREATE TABLE [MySchema].[MyTable_00062] (
    ...
    CONSTRAINT [PK_MyTable_00062] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00062_MyTable00062] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00062] ([ColKey]),
    CONSTRAINT [BK_MyTable_00062_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
