CREATE TABLE [MySchema].[MyTable_00034] (
    ...
    CONSTRAINT [PK_MyTable_00034] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00034_MyTable00034] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00034] ([ColKey]),
    CONSTRAINT [BK_MyTable_00034_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
