CREATE TABLE [MySchema].[MyTable_00211] (
    ...
    CONSTRAINT [PK_MyTable_00211] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00211_MyTable00211] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00211] ([ColKey]),
    CONSTRAINT [BK_MyTable_00211_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
