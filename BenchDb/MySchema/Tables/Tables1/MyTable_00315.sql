CREATE TABLE [MySchema].[MyTable_00315] (
    ...
    CONSTRAINT [PK_MyTable_00315] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00315_MyTable00315] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00315] ([ColKey]),
    CONSTRAINT [BK_MyTable_00315_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
