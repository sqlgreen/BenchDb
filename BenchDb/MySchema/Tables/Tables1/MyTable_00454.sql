CREATE TABLE [MySchema].[MyTable_00454] (
    ...
    CONSTRAINT [PK_MyTable_00454] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00454_MyTable00454] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00454] ([ColKey]),
    CONSTRAINT [BK_MyTable_00454_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
