CREATE TABLE [MySchema].[MyTable_00316] (
    ...
    CONSTRAINT [PK_MyTable_00316] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00316_MyTable00316] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00316] ([ColKey]),
    CONSTRAINT [BK_MyTable_00316_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
