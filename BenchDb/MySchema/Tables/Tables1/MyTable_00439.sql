CREATE TABLE [MySchema].[MyTable_00439] (
    ...
    CONSTRAINT [PK_MyTable_00439] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00439_MyTable00439] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00439] ([ColKey]),
    CONSTRAINT [BK_MyTable_00439_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
