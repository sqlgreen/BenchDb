CREATE TABLE [MySchema].[MyTable_00324] (
    ...
    CONSTRAINT [PK_MyTable_00324] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00324_MyTable00324] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00324] ([ColKey]),
    CONSTRAINT [BK_MyTable_00324_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
