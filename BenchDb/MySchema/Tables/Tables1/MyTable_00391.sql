CREATE TABLE [MySchema].[MyTable_00391] (
    ...
    CONSTRAINT [PK_MyTable_00391] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00391_MyTable00391] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00391] ([ColKey]),
    CONSTRAINT [BK_MyTable_00391_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
