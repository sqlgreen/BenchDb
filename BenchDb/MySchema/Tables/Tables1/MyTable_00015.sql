CREATE TABLE [MySchema].[MyTable_00015] (
    ...
    CONSTRAINT [PK_MyTable_00015] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00015_MyTable00015] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00015] ([ColKey]),
    CONSTRAINT [BK_MyTable_00015_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
