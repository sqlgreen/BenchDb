CREATE TABLE [MySchema].[MyTable_00032] (
    ...
    CONSTRAINT [PK_MyTable_00032] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00032_MyTable00032] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00032] ([ColKey]),
    CONSTRAINT [BK_MyTable_00032_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
