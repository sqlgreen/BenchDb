CREATE TABLE [MySchema].[MyTable_00198] (
    ...
    CONSTRAINT [PK_MyTable_00198] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00198_MyTable00198] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00198] ([ColKey]),
    CONSTRAINT [BK_MyTable_00198_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
