CREATE TABLE [MySchema].[MyTable_00287] (
    ...
    CONSTRAINT [PK_MyTable_00287] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00287_MyTable00287] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00287] ([ColKey]),
    CONSTRAINT [BK_MyTable_00287_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
