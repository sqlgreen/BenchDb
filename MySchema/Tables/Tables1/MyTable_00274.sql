CREATE TABLE [MySchema].[MyTable_00274] (
    ...
    CONSTRAINT [PK_MyTable_00274] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00274_MyTable00274] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00274] ([ColKey]),
    CONSTRAINT [BK_MyTable_00274_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
