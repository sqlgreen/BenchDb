CREATE TABLE [MySchema].[MyTable_00097] (
    ...
    CONSTRAINT [PK_MyTable_00097] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00097_MyTable00097] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00097] ([ColKey]),
    CONSTRAINT [BK_MyTable_00097_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
