CREATE TABLE [MySchema].[MyTable_00082] (
    ...
    CONSTRAINT [PK_MyTable_00082] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00082_MyTable00082] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00082] ([ColKey]),
    CONSTRAINT [BK_MyTable_00082_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
