CREATE TABLE [MySchema].[MyTable_00207] (
    ...
    CONSTRAINT [PK_MyTable_00207] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00207_MyTable00207] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00207] ([ColKey]),
    CONSTRAINT [BK_MyTable_00207_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
