CREATE TABLE [MySchema].[MyTable_00194] (
    ...
    CONSTRAINT [PK_MyTable_00194] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00194_MyTable00194] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00194] ([ColKey]),
    CONSTRAINT [BK_MyTable_00194_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
