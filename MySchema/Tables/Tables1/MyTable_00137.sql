CREATE TABLE [MySchema].[MyTable_00137] (
    ...
    CONSTRAINT [PK_MyTable_00137] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00137_MyTable00137] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00137] ([ColKey]),
    CONSTRAINT [BK_MyTable_00137_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
