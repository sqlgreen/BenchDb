CREATE TABLE [MySchema].[MyTable_00291] (
    ...
    CONSTRAINT [PK_MyTable_00291] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00291_MyTable00291] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00291] ([ColKey]),
    CONSTRAINT [BK_MyTable_00291_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
