CREATE TABLE [MySchema].[MyTable_00101] (
    ...
    CONSTRAINT [PK_MyTable_00101] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00101_MyTable00101] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00101] ([ColKey]),
    CONSTRAINT [BK_MyTable_00101_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
