CREATE TABLE [MySchema].[MyTable_00183] (
    ...
    CONSTRAINT [PK_MyTable_00183] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00183_MyTable00183] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00183] ([ColKey]),
    CONSTRAINT [BK_MyTable_00183_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
