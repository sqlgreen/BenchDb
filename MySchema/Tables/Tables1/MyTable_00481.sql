CREATE TABLE [MySchema].[MyTable_00481] (
    ...
    CONSTRAINT [PK_MyTable_00481] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00481_MyTable00481] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00481] ([ColKey]),
    CONSTRAINT [BK_MyTable_00481_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
