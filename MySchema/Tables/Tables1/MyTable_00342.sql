CREATE TABLE [MySchema].[MyTable_00342] (
    ...
    CONSTRAINT [PK_MyTable_00342] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00342_MyTable00342] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00342] ([ColKey]),
    CONSTRAINT [BK_MyTable_00342_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
