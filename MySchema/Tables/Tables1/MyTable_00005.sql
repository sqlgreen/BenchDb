CREATE TABLE [MySchema].[MyTable_00005] (
    ...
    CONSTRAINT [PK_MyTable_00005] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00005_MyTable00005] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00005] ([ColKey]),
    CONSTRAINT [BK_MyTable_00005_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
