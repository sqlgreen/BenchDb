CREATE TABLE [MySchema].[MyTable_00387] (
    ...
    CONSTRAINT [PK_MyTable_00387] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00387_MyTable00387] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00387] ([ColKey]),
    CONSTRAINT [BK_MyTable_00387_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
