CREATE TABLE [MySchema].[MyTable_00414] (
    ...
    CONSTRAINT [PK_MyTable_00414] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00414_MyTable00414] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00414] ([ColKey]),
    CONSTRAINT [BK_MyTable_00414_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
