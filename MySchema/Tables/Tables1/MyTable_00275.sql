CREATE TABLE [MySchema].[MyTable_00275] (
    ...
    CONSTRAINT [PK_MyTable_00275] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00275_MyTable00275] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00275] ([ColKey]),
    CONSTRAINT [BK_MyTable_00275_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
