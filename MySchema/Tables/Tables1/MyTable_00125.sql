CREATE TABLE [MySchema].[MyTable_00125] (
    ...
    CONSTRAINT [PK_MyTable_00125] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00125_MyTable00125] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00125] ([ColKey]),
    CONSTRAINT [BK_MyTable_00125_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
