CREATE TABLE [MySchema].[MyTable_00102] (
    ...
    CONSTRAINT [PK_MyTable_00102] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00102_MyTable00102] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00102] ([ColKey]),
    CONSTRAINT [BK_MyTable_00102_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
