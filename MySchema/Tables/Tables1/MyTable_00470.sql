CREATE TABLE [MySchema].[MyTable_00470] (
    ...
    CONSTRAINT [PK_MyTable_00470] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00470_MyTable00470] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00470] ([ColKey]),
    CONSTRAINT [BK_MyTable_00470_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
