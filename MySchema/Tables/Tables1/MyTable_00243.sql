CREATE TABLE [MySchema].[MyTable_00243] (
    ...
    CONSTRAINT [PK_MyTable_00243] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00243_MyTable00243] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00243] ([ColKey]),
    CONSTRAINT [BK_MyTable_00243_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
