CREATE TABLE [MySchema].[MyTable_00212] (
    ...
    CONSTRAINT [PK_MyTable_00212] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00212_MyTable00212] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00212] ([ColKey]),
    CONSTRAINT [BK_MyTable_00212_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
