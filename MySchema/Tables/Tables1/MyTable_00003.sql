CREATE TABLE [MySchema].[MyTable_00003] (
    ...
    CONSTRAINT [PK_MyTable_00003] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00003_MyTable00003] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00003] ([ColKey]),
    CONSTRAINT [BK_MyTable_00003_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
