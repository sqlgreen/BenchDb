CREATE TABLE [MySchema].[MyTable_00178] (
    ...
    CONSTRAINT [PK_MyTable_00178] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00178_MyTable00178] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00178] ([ColKey]),
    CONSTRAINT [BK_MyTable_00178_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
