CREATE TABLE [MySchema].[MyTable_00189] (
    ...
    CONSTRAINT [PK_MyTable_00189] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00189_MyTable00189] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00189] ([ColKey]),
    CONSTRAINT [BK_MyTable_00189_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
