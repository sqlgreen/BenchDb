CREATE TABLE [MySchema].[MyTable_00184] (
    ...
    CONSTRAINT [PK_MyTable_00184] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00184_MyTable00184] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00184] ([ColKey]),
    CONSTRAINT [BK_MyTable_00184_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
