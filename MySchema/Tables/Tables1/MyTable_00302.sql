CREATE TABLE [MySchema].[MyTable_00302] (
    ...
    CONSTRAINT [PK_MyTable_00302] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00302_MyTable00302] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00302] ([ColKey]),
    CONSTRAINT [BK_MyTable_00302_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
