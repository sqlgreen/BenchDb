CREATE TABLE [MySchema].[MyTable_00286] (
    ...
    CONSTRAINT [PK_MyTable_00286] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00286_MyTable00286] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00286] ([ColKey]),
    CONSTRAINT [BK_MyTable_00286_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
