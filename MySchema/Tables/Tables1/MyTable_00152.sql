CREATE TABLE [MySchema].[MyTable_00152] (
    ...
    CONSTRAINT [PK_MyTable_00152] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00152_MyTable00152] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00152] ([ColKey]),
    CONSTRAINT [BK_MyTable_00152_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
