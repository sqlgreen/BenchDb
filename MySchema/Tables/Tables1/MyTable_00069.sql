CREATE TABLE [MySchema].[MyTable_00069] (
    ...
    CONSTRAINT [PK_MyTable_00069] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00069_MyTable00069] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00069] ([ColKey]),
    CONSTRAINT [BK_MyTable_00069_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
