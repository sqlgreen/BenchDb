CREATE TABLE [MySchema].[MyTable_00372] (
    ...
    CONSTRAINT [PK_MyTable_00372] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00372_MyTable00372] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00372] ([ColKey]),
    CONSTRAINT [BK_MyTable_00372_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
