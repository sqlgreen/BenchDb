CREATE TABLE [MySchema].[MyTable_00313] (
    ...
    CONSTRAINT [PK_MyTable_00313] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00313_MyTable00313] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00313] ([ColKey]),
    CONSTRAINT [BK_MyTable_00313_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
