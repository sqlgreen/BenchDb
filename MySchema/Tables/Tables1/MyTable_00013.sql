CREATE TABLE [MySchema].[MyTable_00013] (
    ...
    CONSTRAINT [PK_MyTable_00013] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00013_MyTable00013] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00013] ([ColKey]),
    CONSTRAINT [BK_MyTable_00013_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
