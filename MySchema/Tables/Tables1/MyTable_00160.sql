CREATE TABLE [MySchema].[MyTable_00160] (
    ...
    CONSTRAINT [PK_MyTable_00160] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00160_MyTable00160] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00160] ([ColKey]),
    CONSTRAINT [BK_MyTable_00160_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
