CREATE TABLE [MySchema].[MyTable_00306] (
    ...
    CONSTRAINT [PK_MyTable_00306] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00306_MyTable00306] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00306] ([ColKey]),
    CONSTRAINT [BK_MyTable_00306_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
