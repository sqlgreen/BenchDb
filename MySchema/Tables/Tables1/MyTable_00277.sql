CREATE TABLE [MySchema].[MyTable_00277] (
    ...
    CONSTRAINT [PK_MyTable_00277] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00277_MyTable00277] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00277] ([ColKey]),
    CONSTRAINT [BK_MyTable_00277_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
