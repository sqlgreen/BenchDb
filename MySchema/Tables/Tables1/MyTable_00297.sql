CREATE TABLE [MySchema].[MyTable_00297] (
    ...
    CONSTRAINT [PK_MyTable_00297] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00297_MyTable00297] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00297] ([ColKey]),
    CONSTRAINT [BK_MyTable_00297_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
