CREATE TABLE [MySchema].[MyTable_00156] (
    ...
    CONSTRAINT [PK_MyTable_00156] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00156_MyTable00156] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00156] ([ColKey]),
    CONSTRAINT [BK_MyTable_00156_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
