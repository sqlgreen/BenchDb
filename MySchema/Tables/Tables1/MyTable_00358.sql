CREATE TABLE [MySchema].[MyTable_00358] (
    ...
    CONSTRAINT [PK_MyTable_00358] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00358_MyTable00358] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00358] ([ColKey]),
    CONSTRAINT [BK_MyTable_00358_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
