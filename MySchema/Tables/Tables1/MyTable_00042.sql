CREATE TABLE [MySchema].[MyTable_00042] (
    ...
    CONSTRAINT [PK_MyTable_00042] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00042_MyTable00042] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00042] ([ColKey]),
    CONSTRAINT [BK_MyTable_00042_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
