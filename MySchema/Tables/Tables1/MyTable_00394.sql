CREATE TABLE [MySchema].[MyTable_00394] (
    ...
    CONSTRAINT [PK_MyTable_00394] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00394_MyTable00394] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00394] ([ColKey]),
    CONSTRAINT [BK_MyTable_00394_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
