CREATE TABLE [MySchema].[MyTable_00278] (
    ...
    CONSTRAINT [PK_MyTable_00278] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00278_MyTable00278] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00278] ([ColKey]),
    CONSTRAINT [BK_MyTable_00278_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
