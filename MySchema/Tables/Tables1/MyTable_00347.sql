CREATE TABLE [MySchema].[MyTable_00347] (
    ...
    CONSTRAINT [PK_MyTable_00347] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00347_MyTable00347] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00347] ([ColKey]),
    CONSTRAINT [BK_MyTable_00347_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
