CREATE TABLE [MySchema].[MyTable_00330] (
    ...
    CONSTRAINT [PK_MyTable_00330] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00330_MyTable00330] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00330] ([ColKey]),
    CONSTRAINT [BK_MyTable_00330_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
