CREATE TABLE [MySchema].[MyTable_00221] (
    ...
    CONSTRAINT [PK_MyTable_00221] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00221_MyTable00221] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00221] ([ColKey]),
    CONSTRAINT [BK_MyTable_00221_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
