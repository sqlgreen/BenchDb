CREATE TABLE [MySchema].[MyTable_00429] (
    ...
    CONSTRAINT [PK_MyTable_00429] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00429_MyTable00429] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00429] ([ColKey]),
    CONSTRAINT [BK_MyTable_00429_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
