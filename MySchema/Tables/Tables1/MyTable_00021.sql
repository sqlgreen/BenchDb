CREATE TABLE [MySchema].[MyTable_00021] (
    ...
    CONSTRAINT [PK_MyTable_00021] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00021_MyTable00021] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00021] ([ColKey]),
    CONSTRAINT [BK_MyTable_00021_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
