CREATE TABLE [MySchema].[MyTable_00321] (
    ...
    CONSTRAINT [PK_MyTable_00321] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00321_MyTable00321] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00321] ([ColKey]),
    CONSTRAINT [BK_MyTable_00321_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
