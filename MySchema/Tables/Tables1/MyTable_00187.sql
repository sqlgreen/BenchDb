CREATE TABLE [MySchema].[MyTable_00187] (
    ...
    CONSTRAINT [PK_MyTable_00187] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00187_MyTable00187] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00187] ([ColKey]),
    CONSTRAINT [BK_MyTable_00187_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
