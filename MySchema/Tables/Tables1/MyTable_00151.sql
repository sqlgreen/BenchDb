CREATE TABLE [MySchema].[MyTable_00151] (
    ...
    CONSTRAINT [PK_MyTable_00151] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00151_MyTable00151] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00151] ([ColKey]),
    CONSTRAINT [BK_MyTable_00151_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
