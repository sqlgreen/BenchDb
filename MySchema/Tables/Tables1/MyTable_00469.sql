CREATE TABLE [MySchema].[MyTable_00469] (
    ...
    CONSTRAINT [PK_MyTable_00469] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00469_MyTable00469] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00469] ([ColKey]),
    CONSTRAINT [BK_MyTable_00469_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
