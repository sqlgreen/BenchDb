CREATE TABLE [MySchema].[MyTable_00118] (
    ...
    CONSTRAINT [PK_MyTable_00118] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00118_MyTable00118] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00118] ([ColKey]),
    CONSTRAINT [BK_MyTable_00118_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
