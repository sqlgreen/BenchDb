CREATE TABLE [MySchema].[MyTable_00086] (
    ...
    CONSTRAINT [PK_MyTable_00086] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00086_MyTable00086] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00086] ([ColKey]),
    CONSTRAINT [BK_MyTable_00086_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
