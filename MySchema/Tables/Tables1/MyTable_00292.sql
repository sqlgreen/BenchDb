CREATE TABLE [MySchema].[MyTable_00292] (
    ...
    CONSTRAINT [PK_MyTable_00292] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00292_MyTable00292] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00292] ([ColKey]),
    CONSTRAINT [BK_MyTable_00292_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
