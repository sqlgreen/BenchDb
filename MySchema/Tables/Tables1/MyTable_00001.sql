CREATE TABLE [MySchema].[MyTable_00001] (
    ...
    CONSTRAINT [PK_MyTable_00001] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00001_MyTable00001] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00001] ([ColKey]),
    CONSTRAINT [BK_MyTable_00001_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
