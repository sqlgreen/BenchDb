CREATE TABLE [MySchema].[MyTable_00409] (
    ...
    CONSTRAINT [PK_MyTable_00409] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00409_MyTable00409] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00409] ([ColKey]),
    CONSTRAINT [BK_MyTable_00409_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
