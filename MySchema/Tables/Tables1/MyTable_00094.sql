CREATE TABLE [MySchema].[MyTable_00094] (
    ...
    CONSTRAINT [PK_MyTable_00094] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00094_MyTable00094] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00094] ([ColKey]),
    CONSTRAINT [BK_MyTable_00094_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
