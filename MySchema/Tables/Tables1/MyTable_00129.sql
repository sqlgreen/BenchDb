CREATE TABLE [MySchema].[MyTable_00129] (
    ...
    CONSTRAINT [PK_MyTable_00129] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00129_MyTable00129] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00129] ([ColKey]),
    CONSTRAINT [BK_MyTable_00129_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
