CREATE TABLE [MySchema].[MyTable_00337] (
    ...
    CONSTRAINT [PK_MyTable_00337] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00337_MyTable00337] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00337] ([ColKey]),
    CONSTRAINT [BK_MyTable_00337_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
