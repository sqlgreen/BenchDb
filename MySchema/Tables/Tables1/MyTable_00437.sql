CREATE TABLE [MySchema].[MyTable_00437] (
    ...
    CONSTRAINT [PK_MyTable_00437] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00437_MyTable00437] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00437] ([ColKey]),
    CONSTRAINT [BK_MyTable_00437_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
