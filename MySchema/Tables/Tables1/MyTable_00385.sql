CREATE TABLE [MySchema].[MyTable_00385] (
    ...
    CONSTRAINT [PK_MyTable_00385] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00385_MyTable00385] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00385] ([ColKey]),
    CONSTRAINT [BK_MyTable_00385_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
