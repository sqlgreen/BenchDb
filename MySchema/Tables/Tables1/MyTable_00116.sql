CREATE TABLE [MySchema].[MyTable_00116] (
    ...
    CONSTRAINT [PK_MyTable_00116] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00116_MyTable00116] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00116] ([ColKey]),
    CONSTRAINT [BK_MyTable_00116_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
