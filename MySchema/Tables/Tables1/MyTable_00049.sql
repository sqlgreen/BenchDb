CREATE TABLE [MySchema].[MyTable_00049] (
    ...
    CONSTRAINT [PK_MyTable_00049] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00049_MyTable00049] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00049] ([ColKey]),
    CONSTRAINT [BK_MyTable_00049_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
