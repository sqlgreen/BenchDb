CREATE TABLE [MySchema].[MyTable_00073] (
    ...
    CONSTRAINT [PK_MyTable_00073] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00073_MyTable00073] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00073] ([ColKey]),
    CONSTRAINT [BK_MyTable_00073_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
