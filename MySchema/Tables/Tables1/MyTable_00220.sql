CREATE TABLE [MySchema].[MyTable_00220] (
    ...
    CONSTRAINT [PK_MyTable_00220] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00220_MyTable00220] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00220] ([ColKey]),
    CONSTRAINT [BK_MyTable_00220_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
