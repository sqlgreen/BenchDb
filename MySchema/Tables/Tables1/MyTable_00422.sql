CREATE TABLE [MySchema].[MyTable_00422] (
    ...
    CONSTRAINT [PK_MyTable_00422] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00422_MyTable00422] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00422] ([ColKey]),
    CONSTRAINT [BK_MyTable_00422_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
