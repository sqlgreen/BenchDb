CREATE TABLE [MySchema].[MyTable_00224] (
    ...
    CONSTRAINT [PK_MyTable_00224] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00224_MyTable00224] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00224] ([ColKey]),
    CONSTRAINT [BK_MyTable_00224_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
