CREATE TABLE [MySchema].[MyTable_00362] (
    ...
    CONSTRAINT [PK_MyTable_00362] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00362_MyTable00362] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00362] ([ColKey]),
    CONSTRAINT [BK_MyTable_00362_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
