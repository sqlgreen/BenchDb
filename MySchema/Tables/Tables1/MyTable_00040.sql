CREATE TABLE [MySchema].[MyTable_00040] (
    ...
    CONSTRAINT [PK_MyTable_00040] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00040_MyTable00040] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00040] ([ColKey]),
    CONSTRAINT [BK_MyTable_00040_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
