CREATE TABLE [MySchema].[MyTable_00077] (
    ...
    CONSTRAINT [PK_MyTable_00077] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00077_MyTable00077] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00077] ([ColKey]),
    CONSTRAINT [BK_MyTable_00077_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
