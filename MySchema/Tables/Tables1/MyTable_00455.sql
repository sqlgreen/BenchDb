CREATE TABLE [MySchema].[MyTable_00455] (
    ...
    CONSTRAINT [PK_MyTable_00455] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00455_MyTable00455] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00455] ([ColKey]),
    CONSTRAINT [BK_MyTable_00455_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
