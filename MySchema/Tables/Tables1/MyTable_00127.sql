CREATE TABLE [MySchema].[MyTable_00127] (
    ...
    CONSTRAINT [PK_MyTable_00127] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00127_MyTable00127] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00127] ([ColKey]),
    CONSTRAINT [BK_MyTable_00127_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
