CREATE TABLE [MySchema].[MyTable_00200] (
    ...
    CONSTRAINT [PK_MyTable_00200] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00200_MyTable00200] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00200] ([ColKey]),
    CONSTRAINT [BK_MyTable_00200_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
