CREATE TABLE [MySchema].[MyTable_00460] (
    ...
    CONSTRAINT [PK_MyTable_00460] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00460_MyTable00460] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00460] ([ColKey]),
    CONSTRAINT [BK_MyTable_00460_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
