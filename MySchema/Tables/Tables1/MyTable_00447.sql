CREATE TABLE [MySchema].[MyTable_00447] (
    ...
    CONSTRAINT [PK_MyTable_00447] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00447_MyTable00447] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00447] ([ColKey]),
    CONSTRAINT [BK_MyTable_00447_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
