CREATE TABLE [MySchema].[MyTable_00335] (
    ...
    CONSTRAINT [PK_MyTable_00335] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00335_MyTable00335] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00335] ([ColKey]),
    CONSTRAINT [BK_MyTable_00335_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
