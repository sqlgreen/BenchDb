CREATE TABLE [MySchema].[MyTable_00146] (
    ...
    CONSTRAINT [PK_MyTable_00146] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00146_MyTable00146] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00146] ([ColKey]),
    CONSTRAINT [BK_MyTable_00146_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
