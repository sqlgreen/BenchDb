CREATE TABLE [MySchema].[MyTable_00432] (
    ...
    CONSTRAINT [PK_MyTable_00432] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00432_MyTable00432] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00432] ([ColKey]),
    CONSTRAINT [BK_MyTable_00432_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
