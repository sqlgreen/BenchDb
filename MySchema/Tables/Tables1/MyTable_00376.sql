CREATE TABLE [MySchema].[MyTable_00376] (
    ...
    CONSTRAINT [PK_MyTable_00376] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00376_MyTable00376] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00376] ([ColKey]),
    CONSTRAINT [BK_MyTable_00376_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
