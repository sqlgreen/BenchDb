CREATE TABLE [MySchema].[MyTable_00216] (
    ...
    CONSTRAINT [PK_MyTable_00216] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00216_MyTable00216] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00216] ([ColKey]),
    CONSTRAINT [BK_MyTable_00216_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
