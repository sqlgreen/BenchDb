CREATE TABLE [MySchema].[MyTable_00180] (
    ...
    CONSTRAINT [PK_MyTable_00180] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00180_MyTable00180] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00180] ([ColKey]),
    CONSTRAINT [BK_MyTable_00180_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
