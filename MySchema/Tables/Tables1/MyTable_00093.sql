CREATE TABLE [MySchema].[MyTable_00093] (
    ...
    CONSTRAINT [PK_MyTable_00093] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00093_MyTable00093] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00093] ([ColKey]),
    CONSTRAINT [BK_MyTable_00093_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
