CREATE TABLE [MySchema].[MyTable_00276] (
    ...
    CONSTRAINT [PK_MyTable_00276] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00276_MyTable00276] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00276] ([ColKey]),
    CONSTRAINT [BK_MyTable_00276_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
