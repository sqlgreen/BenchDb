CREATE TABLE [MySchema].[MyTable_00014] (
    ...
    CONSTRAINT [PK_MyTable_00014] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00014_MyTable00014] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00014] ([ColKey]),
    CONSTRAINT [BK_MyTable_00014_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
