CREATE TABLE [MySchema].[MyTable_00080] (
    ...
    CONSTRAINT [PK_MyTable_00080] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00080_MyTable00080] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00080] ([ColKey]),
    CONSTRAINT [BK_MyTable_00080_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
