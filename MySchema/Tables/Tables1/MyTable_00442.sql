CREATE TABLE [MySchema].[MyTable_00442] (
    ...
    CONSTRAINT [PK_MyTable_00442] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00442_MyTable00442] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00442] ([ColKey]),
    CONSTRAINT [BK_MyTable_00442_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
