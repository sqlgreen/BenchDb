CREATE TABLE [MySchema].[MyTable_00295] (
    ...
    CONSTRAINT [PK_MyTable_00295] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00295_MyTable00295] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00295] ([ColKey]),
    CONSTRAINT [BK_MyTable_00295_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
