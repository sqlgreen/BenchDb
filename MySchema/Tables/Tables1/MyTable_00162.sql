CREATE TABLE [MySchema].[MyTable_00162] (
    ...
    CONSTRAINT [PK_MyTable_00162] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00162_MyTable00162] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00162] ([ColKey]),
    CONSTRAINT [BK_MyTable_00162_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
