CREATE TABLE [MySchema].[MyTable_00314] (
    ...
    CONSTRAINT [PK_MyTable_00314] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00314_MyTable00314] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00314] ([ColKey]),
    CONSTRAINT [BK_MyTable_00314_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
