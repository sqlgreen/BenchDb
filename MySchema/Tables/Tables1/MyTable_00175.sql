CREATE TABLE [MySchema].[MyTable_00175] (
    ...
    CONSTRAINT [PK_MyTable_00175] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00175_MyTable00175] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00175] ([ColKey]),
    CONSTRAINT [BK_MyTable_00175_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
