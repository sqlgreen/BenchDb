CREATE TABLE [MySchema].[MyTable_00354] (
    ...
    CONSTRAINT [PK_MyTable_00354] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00354_MyTable00354] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00354] ([ColKey]),
    CONSTRAINT [BK_MyTable_00354_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
