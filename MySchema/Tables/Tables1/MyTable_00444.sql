CREATE TABLE [MySchema].[MyTable_00444] (
    ...
    CONSTRAINT [PK_MyTable_00444] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00444_MyTable00444] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00444] ([ColKey]),
    CONSTRAINT [BK_MyTable_00444_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
