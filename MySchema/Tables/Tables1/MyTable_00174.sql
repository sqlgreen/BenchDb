CREATE TABLE [MySchema].[MyTable_00174] (
    ...
    CONSTRAINT [PK_MyTable_00174] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00174_MyTable00174] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00174] ([ColKey]),
    CONSTRAINT [BK_MyTable_00174_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
