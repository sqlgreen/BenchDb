CREATE TABLE [MySchema].[MyTable_00075] (
    ...
    CONSTRAINT [PK_MyTable_00075] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00075_MyTable00075] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00075] ([ColKey]),
    CONSTRAINT [BK_MyTable_00075_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
