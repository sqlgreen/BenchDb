CREATE TABLE [MySchema].[MyTable_00418] (
    ...
    CONSTRAINT [PK_MyTable_00418] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00418_MyTable00418] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00418] ([ColKey]),
    CONSTRAINT [BK_MyTable_00418_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
