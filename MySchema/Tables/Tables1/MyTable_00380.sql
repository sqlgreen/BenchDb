CREATE TABLE [MySchema].[MyTable_00380] (
    ...
    CONSTRAINT [PK_MyTable_00380] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00380_MyTable00380] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00380] ([ColKey]),
    CONSTRAINT [BK_MyTable_00380_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
