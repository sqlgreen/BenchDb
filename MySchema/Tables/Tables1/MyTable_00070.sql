CREATE TABLE [MySchema].[MyTable_00070] (
    ...
    CONSTRAINT [PK_MyTable_00070] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00070_MyTable00070] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00070] ([ColKey]),
    CONSTRAINT [BK_MyTable_00070_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
