CREATE TABLE [MySchema].[MyTable_00205] (
    ...
    CONSTRAINT [PK_MyTable_00205] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00205_MyTable00205] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00205] ([ColKey]),
    CONSTRAINT [BK_MyTable_00205_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
