CREATE TABLE [MySchema].[MyTable_00173] (
    ...
    CONSTRAINT [PK_MyTable_00173] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00173_MyTable00173] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00173] ([ColKey]),
    CONSTRAINT [BK_MyTable_00173_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
