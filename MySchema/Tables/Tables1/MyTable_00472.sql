CREATE TABLE [MySchema].[MyTable_00472] (
    ...
    CONSTRAINT [PK_MyTable_00472] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00472_MyTable00472] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00472] ([ColKey]),
    CONSTRAINT [BK_MyTable_00472_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
