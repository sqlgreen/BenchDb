CREATE TABLE [MySchema].[MyTable_00468] (
    ...
    CONSTRAINT [PK_MyTable_00468] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00468_MyTable00468] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00468] ([ColKey]),
    CONSTRAINT [BK_MyTable_00468_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
