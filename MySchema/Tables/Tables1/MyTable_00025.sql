CREATE TABLE [MySchema].[MyTable_00025] (
    ...
    CONSTRAINT [PK_MyTable_00025] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00025_MyTable00025] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00025] ([ColKey]),
    CONSTRAINT [BK_MyTable_00025_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
