CREATE TABLE [MySchema].[MyTable_00416] (
    ...
    CONSTRAINT [PK_MyTable_00416] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00416_MyTable00416] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00416] ([ColKey]),
    CONSTRAINT [BK_MyTable_00416_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
