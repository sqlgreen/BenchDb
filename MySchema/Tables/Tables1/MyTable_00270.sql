CREATE TABLE [MySchema].[MyTable_00270] (
    ...
    CONSTRAINT [PK_MyTable_00270] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00270_MyTable00270] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00270] ([ColKey]),
    CONSTRAINT [BK_MyTable_00270_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
