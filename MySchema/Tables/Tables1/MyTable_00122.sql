CREATE TABLE [MySchema].[MyTable_00122] (
    ...
    CONSTRAINT [PK_MyTable_00122] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00122_MyTable00122] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00122] ([ColKey]),
    CONSTRAINT [BK_MyTable_00122_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
