CREATE TABLE [MySchema].[MyTable_00466] (
    ...
    CONSTRAINT [PK_MyTable_00466] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00466_MyTable00466] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00466] ([ColKey]),
    CONSTRAINT [BK_MyTable_00466_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
