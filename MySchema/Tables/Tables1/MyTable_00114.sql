CREATE TABLE [MySchema].[MyTable_00114] (
    ...
    CONSTRAINT [PK_MyTable_00114] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00114_MyTable00114] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00114] ([ColKey]),
    CONSTRAINT [BK_MyTable_00114_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
