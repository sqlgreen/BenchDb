CREATE TABLE [MySchema].[MyTable_00154] (
    ...
    CONSTRAINT [PK_MyTable_00154] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00154_MyTable00154] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00154] ([ColKey]),
    CONSTRAINT [BK_MyTable_00154_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
