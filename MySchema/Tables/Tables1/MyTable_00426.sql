CREATE TABLE [MySchema].[MyTable_00426] (
    ...
    CONSTRAINT [PK_MyTable_00426] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00426_MyTable00426] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00426] ([ColKey]),
    CONSTRAINT [BK_MyTable_00426_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
