CREATE TABLE [MySchema].[MyTable_00393] (
    ...
    CONSTRAINT [PK_MyTable_00393] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00393_MyTable00393] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00393] ([ColKey]),
    CONSTRAINT [BK_MyTable_00393_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
