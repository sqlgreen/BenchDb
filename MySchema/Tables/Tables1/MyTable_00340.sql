CREATE TABLE [MySchema].[MyTable_00340] (
    ...
    CONSTRAINT [PK_MyTable_00340] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00340_MyTable00340] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00340] ([ColKey]),
    CONSTRAINT [BK_MyTable_00340_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
