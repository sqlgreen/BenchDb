CREATE TABLE [MySchema].[MyTable_00226] (
    ...
    CONSTRAINT [PK_MyTable_00226] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00226_MyTable00226] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00226] ([ColKey]),
    CONSTRAINT [BK_MyTable_00226_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
