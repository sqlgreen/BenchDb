CREATE TABLE [MySchema].[MyTable_00074] (
    ...
    CONSTRAINT [PK_MyTable_00074] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00074_MyTable00074] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00074] ([ColKey]),
    CONSTRAINT [BK_MyTable_00074_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
