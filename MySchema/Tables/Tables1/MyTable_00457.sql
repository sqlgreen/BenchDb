CREATE TABLE [MySchema].[MyTable_00457] (
    ...
    CONSTRAINT [PK_MyTable_00457] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00457_MyTable00457] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00457] ([ColKey]),
    CONSTRAINT [BK_MyTable_00457_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
