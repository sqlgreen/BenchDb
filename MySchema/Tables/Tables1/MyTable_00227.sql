CREATE TABLE [MySchema].[MyTable_00227] (
    ...
    CONSTRAINT [PK_MyTable_00227] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00227_MyTable00227] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00227] ([ColKey]),
    CONSTRAINT [BK_MyTable_00227_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
