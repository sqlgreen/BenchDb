CREATE TABLE [MySchema].[MyTable_00369] (
    ...
    CONSTRAINT [PK_MyTable_00369] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00369_MyTable00369] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00369] ([ColKey]),
    CONSTRAINT [BK_MyTable_00369_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
