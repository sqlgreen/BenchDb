CREATE TABLE [MySchema].[MyTable_00148] (
    ...
    CONSTRAINT [PK_MyTable_00148] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00148_MyTable00148] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00148] ([ColKey]),
    CONSTRAINT [BK_MyTable_00148_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
