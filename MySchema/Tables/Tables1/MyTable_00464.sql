CREATE TABLE [MySchema].[MyTable_00464] (
    ...
    CONSTRAINT [PK_MyTable_00464] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00464_MyTable00464] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00464] ([ColKey]),
    CONSTRAINT [BK_MyTable_00464_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
