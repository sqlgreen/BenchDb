CREATE TABLE [MySchema].[MyTable_00078] (
    ...
    CONSTRAINT [PK_MyTable_00078] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00078_MyTable00078] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00078] ([ColKey]),
    CONSTRAINT [BK_MyTable_00078_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
