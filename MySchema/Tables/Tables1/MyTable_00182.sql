CREATE TABLE [MySchema].[MyTable_00182] (
    ...
    CONSTRAINT [PK_MyTable_00182] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00182_MyTable00182] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00182] ([ColKey]),
    CONSTRAINT [BK_MyTable_00182_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
