CREATE TABLE [MySchema].[MyTable_00490] (
    ...
    CONSTRAINT [PK_MyTable_00490] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00490_MyTable00490] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00490] ([ColKey]),
    CONSTRAINT [BK_MyTable_00490_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
