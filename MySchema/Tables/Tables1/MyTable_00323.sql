CREATE TABLE [MySchema].[MyTable_00323] (
    ...
    CONSTRAINT [PK_MyTable_00323] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00323_MyTable00323] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00323] ([ColKey]),
    CONSTRAINT [BK_MyTable_00323_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
