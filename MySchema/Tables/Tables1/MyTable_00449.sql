CREATE TABLE [MySchema].[MyTable_00449] (
    ...
    CONSTRAINT [PK_MyTable_00449] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00449_MyTable00449] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00449] ([ColKey]),
    CONSTRAINT [BK_MyTable_00449_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
