CREATE TABLE [MySchema].[MyTable_01707] (
    ...
    CONSTRAINT [PK_MyTable_01707] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01707_MyTable01707] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01707] ([ColKey]),
    CONSTRAINT [BK_MyTable_01707_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
