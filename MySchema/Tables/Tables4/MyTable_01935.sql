CREATE TABLE [MySchema].[MyTable_01935] (
    ...
    CONSTRAINT [PK_MyTable_01935] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01935_MyTable01935] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01935] ([ColKey]),
    CONSTRAINT [BK_MyTable_01935_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
