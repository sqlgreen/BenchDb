CREATE TABLE [MySchema].[MyTable_01925] (
    ...
    CONSTRAINT [PK_MyTable_01925] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01925_MyTable01925] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01925] ([ColKey]),
    CONSTRAINT [BK_MyTable_01925_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
