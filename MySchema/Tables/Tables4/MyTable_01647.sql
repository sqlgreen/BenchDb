CREATE TABLE [MySchema].[MyTable_01647] (
    ...
    CONSTRAINT [PK_MyTable_01647] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01647_MyTable01647] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01647] ([ColKey]),
    CONSTRAINT [BK_MyTable_01647_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
