CREATE TABLE [MySchema].[MyTable_01887] (
    ...
    CONSTRAINT [PK_MyTable_01887] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01887_MyTable01887] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01887] ([ColKey]),
    CONSTRAINT [BK_MyTable_01887_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
