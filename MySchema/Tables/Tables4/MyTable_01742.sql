CREATE TABLE [MySchema].[MyTable_01742] (
    ...
    CONSTRAINT [PK_MyTable_01742] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01742_MyTable01742] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01742] ([ColKey]),
    CONSTRAINT [BK_MyTable_01742_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
