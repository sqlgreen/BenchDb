CREATE TABLE [MySchema].[MyTable_01971] (
    ...
    CONSTRAINT [PK_MyTable_01971] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01971_MyTable01971] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01971] ([ColKey]),
    CONSTRAINT [BK_MyTable_01971_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
