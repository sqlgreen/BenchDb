CREATE TABLE [MySchema].[MyTable_01612] (
    ...
    CONSTRAINT [PK_MyTable_01612] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01612_MyTable01612] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01612] ([ColKey]),
    CONSTRAINT [BK_MyTable_01612_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
