CREATE TABLE [MySchema].[MyTable_01858] (
    ...
    CONSTRAINT [PK_MyTable_01858] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01858_MyTable01858] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01858] ([ColKey]),
    CONSTRAINT [BK_MyTable_01858_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
