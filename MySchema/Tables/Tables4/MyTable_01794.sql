CREATE TABLE [MySchema].[MyTable_01794] (
    ...
    CONSTRAINT [PK_MyTable_01794] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01794_MyTable01794] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01794] ([ColKey]),
    CONSTRAINT [BK_MyTable_01794_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
