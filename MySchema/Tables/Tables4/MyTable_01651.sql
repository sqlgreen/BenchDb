CREATE TABLE [MySchema].[MyTable_01651] (
    ...
    CONSTRAINT [PK_MyTable_01651] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01651_MyTable01651] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01651] ([ColKey]),
    CONSTRAINT [BK_MyTable_01651_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
