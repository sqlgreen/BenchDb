CREATE TABLE [MySchema].[MyTable_01739] (
    ...
    CONSTRAINT [PK_MyTable_01739] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01739_MyTable01739] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01739] ([ColKey]),
    CONSTRAINT [BK_MyTable_01739_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
