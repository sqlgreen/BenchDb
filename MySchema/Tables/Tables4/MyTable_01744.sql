CREATE TABLE [MySchema].[MyTable_01744] (
    ...
    CONSTRAINT [PK_MyTable_01744] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01744_MyTable01744] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01744] ([ColKey]),
    CONSTRAINT [BK_MyTable_01744_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
