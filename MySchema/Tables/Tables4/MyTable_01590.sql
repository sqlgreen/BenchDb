CREATE TABLE [MySchema].[MyTable_01590] (
    ...
    CONSTRAINT [PK_MyTable_01590] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01590_MyTable01590] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01590] ([ColKey]),
    CONSTRAINT [BK_MyTable_01590_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
