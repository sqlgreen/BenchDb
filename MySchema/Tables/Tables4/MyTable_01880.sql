CREATE TABLE [MySchema].[MyTable_01880] (
    ...
    CONSTRAINT [PK_MyTable_01880] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01880_MyTable01880] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01880] ([ColKey]),
    CONSTRAINT [BK_MyTable_01880_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
