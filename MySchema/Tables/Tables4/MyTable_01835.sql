CREATE TABLE [MySchema].[MyTable_01835] (
    ...
    CONSTRAINT [PK_MyTable_01835] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01835_MyTable01835] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01835] ([ColKey]),
    CONSTRAINT [BK_MyTable_01835_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
