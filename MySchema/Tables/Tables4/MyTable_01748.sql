CREATE TABLE [MySchema].[MyTable_01748] (
    ...
    CONSTRAINT [PK_MyTable_01748] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01748_MyTable01748] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01748] ([ColKey]),
    CONSTRAINT [BK_MyTable_01748_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
