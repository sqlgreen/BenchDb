CREATE TABLE [MySchema].[MyTable_01667] (
    ...
    CONSTRAINT [PK_MyTable_01667] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01667_MyTable01667] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01667] ([ColKey]),
    CONSTRAINT [BK_MyTable_01667_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
