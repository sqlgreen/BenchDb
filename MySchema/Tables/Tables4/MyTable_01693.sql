CREATE TABLE [MySchema].[MyTable_01693] (
    ...
    CONSTRAINT [PK_MyTable_01693] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01693_MyTable01693] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01693] ([ColKey]),
    CONSTRAINT [BK_MyTable_01693_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
