CREATE TABLE [MySchema].[MyTable_01738] (
    ...
    CONSTRAINT [PK_MyTable_01738] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01738_MyTable01738] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01738] ([ColKey]),
    CONSTRAINT [BK_MyTable_01738_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
