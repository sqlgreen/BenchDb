CREATE TABLE [MySchema].[MyTable_01816] (
    ...
    CONSTRAINT [PK_MyTable_01816] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01816_MyTable01816] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01816] ([ColKey]),
    CONSTRAINT [BK_MyTable_01816_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
