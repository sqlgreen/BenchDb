CREATE TABLE [MySchema].[MyTable_01508] (
    ...
    CONSTRAINT [PK_MyTable_01508] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01508_MyTable01508] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01508] ([ColKey]),
    CONSTRAINT [BK_MyTable_01508_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
