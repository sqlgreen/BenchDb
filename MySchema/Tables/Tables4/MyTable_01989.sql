CREATE TABLE [MySchema].[MyTable_01989] (
    ...
    CONSTRAINT [PK_MyTable_01989] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01989_MyTable01989] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01989] ([ColKey]),
    CONSTRAINT [BK_MyTable_01989_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
