CREATE TABLE [MySchema].[MyTable_01520] (
    ...
    CONSTRAINT [PK_MyTable_01520] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01520_MyTable01520] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01520] ([ColKey]),
    CONSTRAINT [BK_MyTable_01520_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
