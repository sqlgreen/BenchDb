CREATE TABLE [MySchema].[MyTable_01874] (
    ...
    CONSTRAINT [PK_MyTable_01874] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01874_MyTable01874] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01874] ([ColKey]),
    CONSTRAINT [BK_MyTable_01874_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
