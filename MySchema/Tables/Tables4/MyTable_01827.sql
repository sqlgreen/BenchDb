CREATE TABLE [MySchema].[MyTable_01827] (
    ...
    CONSTRAINT [PK_MyTable_01827] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01827_MyTable01827] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01827] ([ColKey]),
    CONSTRAINT [BK_MyTable_01827_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
