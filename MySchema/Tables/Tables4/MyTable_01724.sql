CREATE TABLE [MySchema].[MyTable_01724] (
    ...
    CONSTRAINT [PK_MyTable_01724] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01724_MyTable01724] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01724] ([ColKey]),
    CONSTRAINT [BK_MyTable_01724_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
