CREATE TABLE [MySchema].[MyTable_01991] (
    ...
    CONSTRAINT [PK_MyTable_01991] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01991_MyTable01991] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01991] ([ColKey]),
    CONSTRAINT [BK_MyTable_01991_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
