CREATE TABLE [MySchema].[MyTable_01869] (
    ...
    CONSTRAINT [PK_MyTable_01869] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01869_MyTable01869] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01869] ([ColKey]),
    CONSTRAINT [BK_MyTable_01869_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
