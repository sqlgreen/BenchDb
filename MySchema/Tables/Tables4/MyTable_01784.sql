CREATE TABLE [MySchema].[MyTable_01784] (
    ...
    CONSTRAINT [PK_MyTable_01784] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01784_MyTable01784] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01784] ([ColKey]),
    CONSTRAINT [BK_MyTable_01784_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
