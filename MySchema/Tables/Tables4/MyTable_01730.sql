CREATE TABLE [MySchema].[MyTable_01730] (
    ...
    CONSTRAINT [PK_MyTable_01730] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01730_MyTable01730] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01730] ([ColKey]),
    CONSTRAINT [BK_MyTable_01730_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
