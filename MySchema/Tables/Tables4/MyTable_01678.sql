CREATE TABLE [MySchema].[MyTable_01678] (
    ...
    CONSTRAINT [PK_MyTable_01678] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01678_MyTable01678] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01678] ([ColKey]),
    CONSTRAINT [BK_MyTable_01678_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
