CREATE TABLE [MySchema].[MyTable_01820] (
    ...
    CONSTRAINT [PK_MyTable_01820] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01820_MyTable01820] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01820] ([ColKey]),
    CONSTRAINT [BK_MyTable_01820_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
