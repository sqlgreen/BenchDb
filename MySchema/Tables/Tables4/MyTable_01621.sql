CREATE TABLE [MySchema].[MyTable_01621] (
    ...
    CONSTRAINT [PK_MyTable_01621] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01621_MyTable01621] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01621] ([ColKey]),
    CONSTRAINT [BK_MyTable_01621_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
