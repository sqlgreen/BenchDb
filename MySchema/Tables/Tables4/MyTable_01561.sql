CREATE TABLE [MySchema].[MyTable_01561] (
    ...
    CONSTRAINT [PK_MyTable_01561] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01561_MyTable01561] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01561] ([ColKey]),
    CONSTRAINT [BK_MyTable_01561_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
