CREATE TABLE [MySchema].[MyTable_01762] (
    ...
    CONSTRAINT [PK_MyTable_01762] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01762_MyTable01762] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01762] ([ColKey]),
    CONSTRAINT [BK_MyTable_01762_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
