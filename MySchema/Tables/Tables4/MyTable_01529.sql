CREATE TABLE [MySchema].[MyTable_01529] (
    ...
    CONSTRAINT [PK_MyTable_01529] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01529_MyTable01529] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01529] ([ColKey]),
    CONSTRAINT [BK_MyTable_01529_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
