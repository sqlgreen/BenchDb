CREATE TABLE [MySchema].[MyTable_01547] (
    ...
    CONSTRAINT [PK_MyTable_01547] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01547_MyTable01547] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01547] ([ColKey]),
    CONSTRAINT [BK_MyTable_01547_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
