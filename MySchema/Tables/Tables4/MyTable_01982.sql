CREATE TABLE [MySchema].[MyTable_01982] (
    ...
    CONSTRAINT [PK_MyTable_01982] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01982_MyTable01982] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01982] ([ColKey]),
    CONSTRAINT [BK_MyTable_01982_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
