CREATE TABLE [MySchema].[MyTable_01947] (
    ...
    CONSTRAINT [PK_MyTable_01947] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01947_MyTable01947] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01947] ([ColKey]),
    CONSTRAINT [BK_MyTable_01947_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
