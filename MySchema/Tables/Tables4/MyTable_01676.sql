CREATE TABLE [MySchema].[MyTable_01676] (
    ...
    CONSTRAINT [PK_MyTable_01676] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01676_MyTable01676] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01676] ([ColKey]),
    CONSTRAINT [BK_MyTable_01676_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
