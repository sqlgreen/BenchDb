CREATE TABLE [MySchema].[MyTable_01656] (
    ...
    CONSTRAINT [PK_MyTable_01656] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01656_MyTable01656] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01656] ([ColKey]),
    CONSTRAINT [BK_MyTable_01656_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
