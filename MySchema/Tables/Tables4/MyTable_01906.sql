CREATE TABLE [MySchema].[MyTable_01906] (
    ...
    CONSTRAINT [PK_MyTable_01906] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01906_MyTable01906] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01906] ([ColKey]),
    CONSTRAINT [BK_MyTable_01906_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
