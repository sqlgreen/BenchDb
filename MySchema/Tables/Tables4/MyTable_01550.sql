CREATE TABLE [MySchema].[MyTable_01550] (
    ...
    CONSTRAINT [PK_MyTable_01550] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01550_MyTable01550] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01550] ([ColKey]),
    CONSTRAINT [BK_MyTable_01550_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
