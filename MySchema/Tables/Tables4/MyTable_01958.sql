CREATE TABLE [MySchema].[MyTable_01958] (
    ...
    CONSTRAINT [PK_MyTable_01958] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01958_MyTable01958] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01958] ([ColKey]),
    CONSTRAINT [BK_MyTable_01958_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
