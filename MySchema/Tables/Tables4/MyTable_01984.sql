CREATE TABLE [MySchema].[MyTable_01984] (
    ...
    CONSTRAINT [PK_MyTable_01984] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01984_MyTable01984] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01984] ([ColKey]),
    CONSTRAINT [BK_MyTable_01984_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
