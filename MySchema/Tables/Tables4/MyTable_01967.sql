CREATE TABLE [MySchema].[MyTable_01967] (
    ...
    CONSTRAINT [PK_MyTable_01967] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01967_MyTable01967] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01967] ([ColKey]),
    CONSTRAINT [BK_MyTable_01967_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
