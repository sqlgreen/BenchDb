CREATE TABLE [MySchema].[MyTable_01910] (
    ...
    CONSTRAINT [PK_MyTable_01910] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01910_MyTable01910] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01910] ([ColKey]),
    CONSTRAINT [BK_MyTable_01910_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
