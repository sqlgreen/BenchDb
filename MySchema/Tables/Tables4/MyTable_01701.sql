CREATE TABLE [MySchema].[MyTable_01701] (
    ...
    CONSTRAINT [PK_MyTable_01701] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01701_MyTable01701] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01701] ([ColKey]),
    CONSTRAINT [BK_MyTable_01701_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
