CREATE TABLE [MySchema].[MyTable_01553] (
    ...
    CONSTRAINT [PK_MyTable_01553] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01553_MyTable01553] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01553] ([ColKey]),
    CONSTRAINT [BK_MyTable_01553_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
