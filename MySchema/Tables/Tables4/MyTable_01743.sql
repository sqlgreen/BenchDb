CREATE TABLE [MySchema].[MyTable_01743] (
    ...
    CONSTRAINT [PK_MyTable_01743] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01743_MyTable01743] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01743] ([ColKey]),
    CONSTRAINT [BK_MyTable_01743_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
