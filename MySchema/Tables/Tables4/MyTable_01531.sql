CREATE TABLE [MySchema].[MyTable_01531] (
    ...
    CONSTRAINT [PK_MyTable_01531] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01531_MyTable01531] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01531] ([ColKey]),
    CONSTRAINT [BK_MyTable_01531_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
