CREATE TABLE [MySchema].[MyTable_01751] (
    ...
    CONSTRAINT [PK_MyTable_01751] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01751_MyTable01751] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01751] ([ColKey]),
    CONSTRAINT [BK_MyTable_01751_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
