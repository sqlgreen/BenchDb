CREATE TABLE [MySchema].[MyTable_01620] (
    ...
    CONSTRAINT [PK_MyTable_01620] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01620_MyTable01620] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01620] ([ColKey]),
    CONSTRAINT [BK_MyTable_01620_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
