CREATE TABLE [MySchema].[MyTable_01919] (
    ...
    CONSTRAINT [PK_MyTable_01919] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01919_MyTable01919] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01919] ([ColKey]),
    CONSTRAINT [BK_MyTable_01919_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
