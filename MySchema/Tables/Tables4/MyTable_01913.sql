CREATE TABLE [MySchema].[MyTable_01913] (
    ...
    CONSTRAINT [PK_MyTable_01913] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01913_MyTable01913] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01913] ([ColKey]),
    CONSTRAINT [BK_MyTable_01913_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
