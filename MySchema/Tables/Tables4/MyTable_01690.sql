CREATE TABLE [MySchema].[MyTable_01690] (
    ...
    CONSTRAINT [PK_MyTable_01690] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01690_MyTable01690] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01690] ([ColKey]),
    CONSTRAINT [BK_MyTable_01690_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
