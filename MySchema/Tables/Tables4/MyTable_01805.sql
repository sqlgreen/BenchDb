CREATE TABLE [MySchema].[MyTable_01805] (
    ...
    CONSTRAINT [PK_MyTable_01805] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01805_MyTable01805] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01805] ([ColKey]),
    CONSTRAINT [BK_MyTable_01805_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
