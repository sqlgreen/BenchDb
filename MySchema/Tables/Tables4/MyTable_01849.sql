CREATE TABLE [MySchema].[MyTable_01849] (
    ...
    CONSTRAINT [PK_MyTable_01849] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01849_MyTable01849] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01849] ([ColKey]),
    CONSTRAINT [BK_MyTable_01849_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
