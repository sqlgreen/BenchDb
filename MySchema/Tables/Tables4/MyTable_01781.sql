CREATE TABLE [MySchema].[MyTable_01781] (
    ...
    CONSTRAINT [PK_MyTable_01781] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01781_MyTable01781] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01781] ([ColKey]),
    CONSTRAINT [BK_MyTable_01781_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
