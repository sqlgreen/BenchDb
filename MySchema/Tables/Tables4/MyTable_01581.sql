CREATE TABLE [MySchema].[MyTable_01581] (
    ...
    CONSTRAINT [PK_MyTable_01581] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01581_MyTable01581] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01581] ([ColKey]),
    CONSTRAINT [BK_MyTable_01581_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
