CREATE TABLE [MySchema].[MyTable_01665] (
    ...
    CONSTRAINT [PK_MyTable_01665] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01665_MyTable01665] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01665] ([ColKey]),
    CONSTRAINT [BK_MyTable_01665_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
