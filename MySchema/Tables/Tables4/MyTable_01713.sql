CREATE TABLE [MySchema].[MyTable_01713] (
    ...
    CONSTRAINT [PK_MyTable_01713] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01713_MyTable01713] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01713] ([ColKey]),
    CONSTRAINT [BK_MyTable_01713_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
