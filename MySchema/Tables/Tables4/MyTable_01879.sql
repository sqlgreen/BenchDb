CREATE TABLE [MySchema].[MyTable_01879] (
    ...
    CONSTRAINT [PK_MyTable_01879] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01879_MyTable01879] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01879] ([ColKey]),
    CONSTRAINT [BK_MyTable_01879_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
