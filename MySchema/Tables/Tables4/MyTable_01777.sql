CREATE TABLE [MySchema].[MyTable_01777] (
    ...
    CONSTRAINT [PK_MyTable_01777] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01777_MyTable01777] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01777] ([ColKey]),
    CONSTRAINT [BK_MyTable_01777_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
