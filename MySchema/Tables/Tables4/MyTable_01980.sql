CREATE TABLE [MySchema].[MyTable_01980] (
    ...
    CONSTRAINT [PK_MyTable_01980] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01980_MyTable01980] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01980] ([ColKey]),
    CONSTRAINT [BK_MyTable_01980_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
