CREATE TABLE [MySchema].[MyTable_01702] (
    ...
    CONSTRAINT [PK_MyTable_01702] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01702_MyTable01702] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01702] ([ColKey]),
    CONSTRAINT [BK_MyTable_01702_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
