CREATE TABLE [MySchema].[MyTable_01677] (
    ...
    CONSTRAINT [PK_MyTable_01677] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01677_MyTable01677] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01677] ([ColKey]),
    CONSTRAINT [BK_MyTable_01677_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
