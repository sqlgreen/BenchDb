CREATE TABLE [MySchema].[MyTable_01518] (
    ...
    CONSTRAINT [PK_MyTable_01518] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01518_MyTable01518] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01518] ([ColKey]),
    CONSTRAINT [BK_MyTable_01518_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
