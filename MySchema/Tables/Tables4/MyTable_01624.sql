CREATE TABLE [MySchema].[MyTable_01624] (
    ...
    CONSTRAINT [PK_MyTable_01624] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01624_MyTable01624] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01624] ([ColKey]),
    CONSTRAINT [BK_MyTable_01624_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
