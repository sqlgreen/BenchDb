CREATE TABLE [MySchema].[MyTable_01734] (
    ...
    CONSTRAINT [PK_MyTable_01734] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01734_MyTable01734] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01734] ([ColKey]),
    CONSTRAINT [BK_MyTable_01734_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
