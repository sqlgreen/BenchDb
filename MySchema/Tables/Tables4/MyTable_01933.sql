CREATE TABLE [MySchema].[MyTable_01933] (
    ...
    CONSTRAINT [PK_MyTable_01933] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01933_MyTable01933] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01933] ([ColKey]),
    CONSTRAINT [BK_MyTable_01933_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
