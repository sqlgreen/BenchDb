CREATE TABLE [MySchema].[MyTable_01507] (
    ...
    CONSTRAINT [PK_MyTable_01507] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01507_MyTable01507] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01507] ([ColKey]),
    CONSTRAINT [BK_MyTable_01507_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
