CREATE TABLE [MySchema].[MyTable_01750] (
    ...
    CONSTRAINT [PK_MyTable_01750] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01750_MyTable01750] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01750] ([ColKey]),
    CONSTRAINT [BK_MyTable_01750_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
