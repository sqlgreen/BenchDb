CREATE TABLE [MySchema].[MyTable_01719] (
    ...
    CONSTRAINT [PK_MyTable_01719] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01719_MyTable01719] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01719] ([ColKey]),
    CONSTRAINT [BK_MyTable_01719_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
