CREATE TABLE [MySchema].[MyTable_01600] (
    ...
    CONSTRAINT [PK_MyTable_01600] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01600_MyTable01600] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01600] ([ColKey]),
    CONSTRAINT [BK_MyTable_01600_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
