CREATE TABLE [MySchema].[MyTable_01500] (
    ...
    CONSTRAINT [PK_MyTable_01500] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01500_MyTable01500] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01500] ([ColKey]),
    CONSTRAINT [BK_MyTable_01500_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
