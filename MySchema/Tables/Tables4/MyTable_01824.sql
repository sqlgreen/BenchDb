CREATE TABLE [MySchema].[MyTable_01824] (
    ...
    CONSTRAINT [PK_MyTable_01824] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01824_MyTable01824] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01824] ([ColKey]),
    CONSTRAINT [BK_MyTable_01824_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
