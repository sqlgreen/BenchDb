CREATE TABLE [MySchema].[MyTable_01963] (
    ...
    CONSTRAINT [PK_MyTable_01963] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01963_MyTable01963] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01963] ([ColKey]),
    CONSTRAINT [BK_MyTable_01963_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
