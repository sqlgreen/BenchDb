CREATE TABLE [MySchema].[MyTable_01795] (
    ...
    CONSTRAINT [PK_MyTable_01795] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01795_MyTable01795] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01795] ([ColKey]),
    CONSTRAINT [BK_MyTable_01795_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
