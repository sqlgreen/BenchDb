CREATE TABLE [MySchema].[MyTable_01708] (
    ...
    CONSTRAINT [PK_MyTable_01708] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01708_MyTable01708] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01708] ([ColKey]),
    CONSTRAINT [BK_MyTable_01708_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
