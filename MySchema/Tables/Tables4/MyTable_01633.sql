CREATE TABLE [MySchema].[MyTable_01633] (
    ...
    CONSTRAINT [PK_MyTable_01633] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01633_MyTable01633] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01633] ([ColKey]),
    CONSTRAINT [BK_MyTable_01633_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
