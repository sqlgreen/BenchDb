CREATE TABLE [MySchema].[MyTable_01622] (
    ...
    CONSTRAINT [PK_MyTable_01622] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01622_MyTable01622] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01622] ([ColKey]),
    CONSTRAINT [BK_MyTable_01622_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
