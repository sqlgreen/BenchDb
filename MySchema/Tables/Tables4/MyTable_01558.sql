CREATE TABLE [MySchema].[MyTable_01558] (
    ...
    CONSTRAINT [PK_MyTable_01558] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01558_MyTable01558] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01558] ([ColKey]),
    CONSTRAINT [BK_MyTable_01558_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
