CREATE TABLE [MySchema].[MyTable_01703] (
    ...
    CONSTRAINT [PK_MyTable_01703] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01703_MyTable01703] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01703] ([ColKey]),
    CONSTRAINT [BK_MyTable_01703_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
