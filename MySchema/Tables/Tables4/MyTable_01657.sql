CREATE TABLE [MySchema].[MyTable_01657] (
    ...
    CONSTRAINT [PK_MyTable_01657] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01657_MyTable01657] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01657] ([ColKey]),
    CONSTRAINT [BK_MyTable_01657_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
