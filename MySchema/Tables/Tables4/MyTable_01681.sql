CREATE TABLE [MySchema].[MyTable_01681] (
    ...
    CONSTRAINT [PK_MyTable_01681] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01681_MyTable01681] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01681] ([ColKey]),
    CONSTRAINT [BK_MyTable_01681_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
