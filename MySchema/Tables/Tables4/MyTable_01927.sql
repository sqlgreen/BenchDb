CREATE TABLE [MySchema].[MyTable_01927] (
    ...
    CONSTRAINT [PK_MyTable_01927] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01927_MyTable01927] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01927] ([ColKey]),
    CONSTRAINT [BK_MyTable_01927_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
