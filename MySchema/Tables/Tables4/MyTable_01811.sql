CREATE TABLE [MySchema].[MyTable_01811] (
    ...
    CONSTRAINT [PK_MyTable_01811] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01811_MyTable01811] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01811] ([ColKey]),
    CONSTRAINT [BK_MyTable_01811_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
