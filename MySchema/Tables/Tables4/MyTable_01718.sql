CREATE TABLE [MySchema].[MyTable_01718] (
    ...
    CONSTRAINT [PK_MyTable_01718] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01718_MyTable01718] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01718] ([ColKey]),
    CONSTRAINT [BK_MyTable_01718_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
