CREATE TABLE [MySchema].[MyTable_01566] (
    ...
    CONSTRAINT [PK_MyTable_01566] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01566_MyTable01566] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01566] ([ColKey]),
    CONSTRAINT [BK_MyTable_01566_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
