CREATE TABLE [MySchema].[MyTable_01896] (
    ...
    CONSTRAINT [PK_MyTable_01896] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01896_MyTable01896] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01896] ([ColKey]),
    CONSTRAINT [BK_MyTable_01896_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
