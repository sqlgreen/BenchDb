CREATE TABLE [MySchema].[MyTable_01630] (
    ...
    CONSTRAINT [PK_MyTable_01630] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01630_MyTable01630] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01630] ([ColKey]),
    CONSTRAINT [BK_MyTable_01630_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
