CREATE TABLE [MySchema].[MyTable_01552] (
    ...
    CONSTRAINT [PK_MyTable_01552] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01552_MyTable01552] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01552] ([ColKey]),
    CONSTRAINT [BK_MyTable_01552_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
