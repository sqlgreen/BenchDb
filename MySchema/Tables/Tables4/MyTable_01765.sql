CREATE TABLE [MySchema].[MyTable_01765] (
    ...
    CONSTRAINT [PK_MyTable_01765] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01765_MyTable01765] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01765] ([ColKey]),
    CONSTRAINT [BK_MyTable_01765_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
