CREATE TABLE [MySchema].[MyTable_01575] (
    ...
    CONSTRAINT [PK_MyTable_01575] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01575_MyTable01575] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01575] ([ColKey]),
    CONSTRAINT [BK_MyTable_01575_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
