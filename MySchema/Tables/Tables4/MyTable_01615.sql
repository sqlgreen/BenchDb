CREATE TABLE [MySchema].[MyTable_01615] (
    ...
    CONSTRAINT [PK_MyTable_01615] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01615_MyTable01615] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01615] ([ColKey]),
    CONSTRAINT [BK_MyTable_01615_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
