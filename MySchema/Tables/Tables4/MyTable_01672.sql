CREATE TABLE [MySchema].[MyTable_01672] (
    ...
    CONSTRAINT [PK_MyTable_01672] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01672_MyTable01672] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01672] ([ColKey]),
    CONSTRAINT [BK_MyTable_01672_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
