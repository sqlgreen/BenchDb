CREATE TABLE [MySchema].[MyTable_01606] (
    ...
    CONSTRAINT [PK_MyTable_01606] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01606_MyTable01606] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01606] ([ColKey]),
    CONSTRAINT [BK_MyTable_01606_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
