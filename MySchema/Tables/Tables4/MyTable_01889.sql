CREATE TABLE [MySchema].[MyTable_01889] (
    ...
    CONSTRAINT [PK_MyTable_01889] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01889_MyTable01889] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01889] ([ColKey]),
    CONSTRAINT [BK_MyTable_01889_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
