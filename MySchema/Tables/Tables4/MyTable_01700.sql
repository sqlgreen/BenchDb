CREATE TABLE [MySchema].[MyTable_01700] (
    ...
    CONSTRAINT [PK_MyTable_01700] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01700_MyTable01700] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01700] ([ColKey]),
    CONSTRAINT [BK_MyTable_01700_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
