CREATE TABLE [MySchema].[MyTable_01712] (
    ...
    CONSTRAINT [PK_MyTable_01712] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01712_MyTable01712] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01712] ([ColKey]),
    CONSTRAINT [BK_MyTable_01712_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
