CREATE TABLE [MySchema].[MyTable_01523] (
    ...
    CONSTRAINT [PK_MyTable_01523] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01523_MyTable01523] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01523] ([ColKey]),
    CONSTRAINT [BK_MyTable_01523_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
