CREATE TABLE [MySchema].[MyTable_01648] (
    ...
    CONSTRAINT [PK_MyTable_01648] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01648_MyTable01648] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01648] ([ColKey]),
    CONSTRAINT [BK_MyTable_01648_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
