CREATE TABLE [MySchema].[MyTable_01918] (
    ...
    CONSTRAINT [PK_MyTable_01918] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01918_MyTable01918] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01918] ([ColKey]),
    CONSTRAINT [BK_MyTable_01918_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
