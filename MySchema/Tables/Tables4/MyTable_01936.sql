CREATE TABLE [MySchema].[MyTable_01936] (
    ...
    CONSTRAINT [PK_MyTable_01936] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01936_MyTable01936] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01936] ([ColKey]),
    CONSTRAINT [BK_MyTable_01936_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
