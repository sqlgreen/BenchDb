CREATE TABLE [MySchema].[MyTable_01848] (
    ...
    CONSTRAINT [PK_MyTable_01848] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01848_MyTable01848] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01848] ([ColKey]),
    CONSTRAINT [BK_MyTable_01848_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
