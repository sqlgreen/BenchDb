CREATE TABLE [MySchema].[MyTable_01819] (
    ...
    CONSTRAINT [PK_MyTable_01819] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01819_MyTable01819] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01819] ([ColKey]),
    CONSTRAINT [BK_MyTable_01819_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
