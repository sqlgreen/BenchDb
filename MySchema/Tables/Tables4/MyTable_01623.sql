CREATE TABLE [MySchema].[MyTable_01623] (
    ...
    CONSTRAINT [PK_MyTable_01623] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01623_MyTable01623] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01623] ([ColKey]),
    CONSTRAINT [BK_MyTable_01623_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
