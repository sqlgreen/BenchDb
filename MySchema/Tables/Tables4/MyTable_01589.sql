CREATE TABLE [MySchema].[MyTable_01589] (
    ...
    CONSTRAINT [PK_MyTable_01589] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01589_MyTable01589] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01589] ([ColKey]),
    CONSTRAINT [BK_MyTable_01589_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
