CREATE TABLE [MySchema].[MyTable_01992] (
    ...
    CONSTRAINT [PK_MyTable_01992] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01992_MyTable01992] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01992] ([ColKey]),
    CONSTRAINT [BK_MyTable_01992_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
