CREATE TABLE [MySchema].[MyTable_01990] (
    ...
    CONSTRAINT [PK_MyTable_01990] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01990_MyTable01990] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01990] ([ColKey]),
    CONSTRAINT [BK_MyTable_01990_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
