CREATE TABLE [MySchema].[MyTable_01973] (
    ...
    CONSTRAINT [PK_MyTable_01973] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01973_MyTable01973] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01973] ([ColKey]),
    CONSTRAINT [BK_MyTable_01973_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
