CREATE TABLE [MySchema].[MyTable_01775] (
    ...
    CONSTRAINT [PK_MyTable_01775] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01775_MyTable01775] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01775] ([ColKey]),
    CONSTRAINT [BK_MyTable_01775_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
