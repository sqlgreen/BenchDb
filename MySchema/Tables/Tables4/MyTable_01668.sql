CREATE TABLE [MySchema].[MyTable_01668] (
    ...
    CONSTRAINT [PK_MyTable_01668] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01668_MyTable01668] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01668] ([ColKey]),
    CONSTRAINT [BK_MyTable_01668_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
