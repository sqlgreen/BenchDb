CREATE TABLE [MySchema].[MyTable_01594] (
    ...
    CONSTRAINT [PK_MyTable_01594] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01594_MyTable01594] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01594] ([ColKey]),
    CONSTRAINT [BK_MyTable_01594_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
