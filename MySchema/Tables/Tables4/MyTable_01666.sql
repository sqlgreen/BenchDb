CREATE TABLE [MySchema].[MyTable_01666] (
    ...
    CONSTRAINT [PK_MyTable_01666] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01666_MyTable01666] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01666] ([ColKey]),
    CONSTRAINT [BK_MyTable_01666_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
