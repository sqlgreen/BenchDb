CREATE TABLE [MySchema].[MyTable_01616] (
    ...
    CONSTRAINT [PK_MyTable_01616] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01616_MyTable01616] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01616] ([ColKey]),
    CONSTRAINT [BK_MyTable_01616_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
