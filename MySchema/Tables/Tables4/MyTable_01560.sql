CREATE TABLE [MySchema].[MyTable_01560] (
    ...
    CONSTRAINT [PK_MyTable_01560] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01560_MyTable01560] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01560] ([ColKey]),
    CONSTRAINT [BK_MyTable_01560_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
