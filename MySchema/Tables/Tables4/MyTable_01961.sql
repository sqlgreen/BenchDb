CREATE TABLE [MySchema].[MyTable_01961] (
    ...
    CONSTRAINT [PK_MyTable_01961] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01961_MyTable01961] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01961] ([ColKey]),
    CONSTRAINT [BK_MyTable_01961_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
