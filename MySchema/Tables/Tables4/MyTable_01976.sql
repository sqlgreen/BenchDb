CREATE TABLE [MySchema].[MyTable_01976] (
    ...
    CONSTRAINT [PK_MyTable_01976] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01976_MyTable01976] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01976] ([ColKey]),
    CONSTRAINT [BK_MyTable_01976_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
