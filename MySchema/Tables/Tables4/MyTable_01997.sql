CREATE TABLE [MySchema].[MyTable_01997] (
    ...
    CONSTRAINT [PK_MyTable_01997] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01997_MyTable01997] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01997] ([ColKey]),
    CONSTRAINT [BK_MyTable_01997_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
