CREATE TABLE [MySchema].[MyTable_01783] (
    ...
    CONSTRAINT [PK_MyTable_01783] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01783_MyTable01783] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01783] ([ColKey]),
    CONSTRAINT [BK_MyTable_01783_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
