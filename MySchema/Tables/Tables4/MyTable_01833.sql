CREATE TABLE [MySchema].[MyTable_01833] (
    ...
    CONSTRAINT [PK_MyTable_01833] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01833_MyTable01833] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01833] ([ColKey]),
    CONSTRAINT [BK_MyTable_01833_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
