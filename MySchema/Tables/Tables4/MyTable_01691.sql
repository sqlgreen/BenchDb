CREATE TABLE [MySchema].[MyTable_01691] (
    ...
    CONSTRAINT [PK_MyTable_01691] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01691_MyTable01691] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01691] ([ColKey]),
    CONSTRAINT [BK_MyTable_01691_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
