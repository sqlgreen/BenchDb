CREATE TABLE [MySchema].[MyTable_01791] (
    ...
    CONSTRAINT [PK_MyTable_01791] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01791_MyTable01791] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01791] ([ColKey]),
    CONSTRAINT [BK_MyTable_01791_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
