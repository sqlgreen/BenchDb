CREATE TABLE [MySchema].[MyTable_01897] (
    ...
    CONSTRAINT [PK_MyTable_01897] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01897_MyTable01897] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01897] ([ColKey]),
    CONSTRAINT [BK_MyTable_01897_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
