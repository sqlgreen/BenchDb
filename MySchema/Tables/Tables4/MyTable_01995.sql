CREATE TABLE [MySchema].[MyTable_01995] (
    ...
    CONSTRAINT [PK_MyTable_01995] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01995_MyTable01995] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01995] ([ColKey]),
    CONSTRAINT [BK_MyTable_01995_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
