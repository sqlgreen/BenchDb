CREATE TABLE [MySchema].[MyTable_01823] (
    ...
    CONSTRAINT [PK_MyTable_01823] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01823_MyTable01823] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01823] ([ColKey]),
    CONSTRAINT [BK_MyTable_01823_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
