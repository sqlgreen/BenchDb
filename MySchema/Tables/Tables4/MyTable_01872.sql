CREATE TABLE [MySchema].[MyTable_01872] (
    ...
    CONSTRAINT [PK_MyTable_01872] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01872_MyTable01872] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01872] ([ColKey]),
    CONSTRAINT [BK_MyTable_01872_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
