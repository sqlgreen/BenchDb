CREATE TABLE [MySchema].[MyTable_01602] (
    ...
    CONSTRAINT [PK_MyTable_01602] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01602_MyTable01602] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01602] ([ColKey]),
    CONSTRAINT [BK_MyTable_01602_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
