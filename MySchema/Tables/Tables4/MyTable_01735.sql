CREATE TABLE [MySchema].[MyTable_01735] (
    ...
    CONSTRAINT [PK_MyTable_01735] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01735_MyTable01735] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01735] ([ColKey]),
    CONSTRAINT [BK_MyTable_01735_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
