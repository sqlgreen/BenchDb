CREATE TABLE [MySchema].[MyTable_00820] (
    ...
    CONSTRAINT [PK_MyTable_00820] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00820_MyTable00820] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00820] ([ColKey]),
    CONSTRAINT [BK_MyTable_00820_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
