CREATE TABLE [MySchema].[MyTable_00772] (
    ...
    CONSTRAINT [PK_MyTable_00772] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00772_MyTable00772] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00772] ([ColKey]),
    CONSTRAINT [BK_MyTable_00772_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
