CREATE TABLE [MySchema].[MyTable_00813] (
    ...
    CONSTRAINT [PK_MyTable_00813] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00813_MyTable00813] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00813] ([ColKey]),
    CONSTRAINT [BK_MyTable_00813_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
