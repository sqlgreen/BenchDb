CREATE TABLE [MySchema].[MyTable_00938] (
    ...
    CONSTRAINT [PK_MyTable_00938] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00938_MyTable00938] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00938] ([ColKey]),
    CONSTRAINT [BK_MyTable_00938_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
