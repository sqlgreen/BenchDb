CREATE TABLE [MySchema].[MyTable_00766] (
    ...
    CONSTRAINT [PK_MyTable_00766] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00766_MyTable00766] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00766] ([ColKey]),
    CONSTRAINT [BK_MyTable_00766_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
