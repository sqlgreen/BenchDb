CREATE TABLE [MySchema].[MyTable_00605] (
    ...
    CONSTRAINT [PK_MyTable_00605] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00605_MyTable00605] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00605] ([ColKey]),
    CONSTRAINT [BK_MyTable_00605_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
