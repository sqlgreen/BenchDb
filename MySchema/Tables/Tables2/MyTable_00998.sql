CREATE TABLE [MySchema].[MyTable_00998] (
    ...
    CONSTRAINT [PK_MyTable_00998] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00998_MyTable00998] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00998] ([ColKey]),
    CONSTRAINT [BK_MyTable_00998_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
