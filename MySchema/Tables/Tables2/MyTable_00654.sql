CREATE TABLE [MySchema].[MyTable_00654] (
    ...
    CONSTRAINT [PK_MyTable_00654] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00654_MyTable00654] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00654] ([ColKey]),
    CONSTRAINT [BK_MyTable_00654_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
