CREATE TABLE [MySchema].[MyTable_00827] (
    ...
    CONSTRAINT [PK_MyTable_00827] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00827_MyTable00827] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00827] ([ColKey]),
    CONSTRAINT [BK_MyTable_00827_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
