CREATE TABLE [MySchema].[MyTable_00992] (
    ...
    CONSTRAINT [PK_MyTable_00992] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00992_MyTable00992] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00992] ([ColKey]),
    CONSTRAINT [BK_MyTable_00992_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
