CREATE TABLE [MySchema].[MyTable_00531] (
    ...
    CONSTRAINT [PK_MyTable_00531] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00531_MyTable00531] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00531] ([ColKey]),
    CONSTRAINT [BK_MyTable_00531_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
