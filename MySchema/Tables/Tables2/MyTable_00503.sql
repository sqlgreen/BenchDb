CREATE TABLE [MySchema].[MyTable_00503] (
    ...
    CONSTRAINT [PK_MyTable_00503] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00503_MyTable00503] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00503] ([ColKey]),
    CONSTRAINT [BK_MyTable_00503_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
