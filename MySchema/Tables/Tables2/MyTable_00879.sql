CREATE TABLE [MySchema].[MyTable_00879] (
    ...
    CONSTRAINT [PK_MyTable_00879] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00879_MyTable00879] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00879] ([ColKey]),
    CONSTRAINT [BK_MyTable_00879_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
