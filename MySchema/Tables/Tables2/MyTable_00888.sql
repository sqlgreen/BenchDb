CREATE TABLE [MySchema].[MyTable_00888] (
    ...
    CONSTRAINT [PK_MyTable_00888] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00888_MyTable00888] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00888] ([ColKey]),
    CONSTRAINT [BK_MyTable_00888_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
