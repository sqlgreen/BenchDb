CREATE TABLE [MySchema].[MyTable_00729] (
    ...
    CONSTRAINT [PK_MyTable_00729] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00729_MyTable00729] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00729] ([ColKey]),
    CONSTRAINT [BK_MyTable_00729_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
