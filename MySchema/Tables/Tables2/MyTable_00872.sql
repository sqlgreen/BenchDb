CREATE TABLE [MySchema].[MyTable_00872] (
    ...
    CONSTRAINT [PK_MyTable_00872] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00872_MyTable00872] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00872] ([ColKey]),
    CONSTRAINT [BK_MyTable_00872_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
