CREATE TABLE [MySchema].[MyTable_00854] (
    ...
    CONSTRAINT [PK_MyTable_00854] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00854_MyTable00854] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00854] ([ColKey]),
    CONSTRAINT [BK_MyTable_00854_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
