CREATE TABLE [MySchema].[MyTable_00575] (
    ...
    CONSTRAINT [PK_MyTable_00575] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00575_MyTable00575] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00575] ([ColKey]),
    CONSTRAINT [BK_MyTable_00575_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
