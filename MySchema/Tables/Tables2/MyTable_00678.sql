CREATE TABLE [MySchema].[MyTable_00678] (
    ...
    CONSTRAINT [PK_MyTable_00678] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00678_MyTable00678] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00678] ([ColKey]),
    CONSTRAINT [BK_MyTable_00678_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
