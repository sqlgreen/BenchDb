CREATE TABLE [MySchema].[MyTable_00763] (
    ...
    CONSTRAINT [PK_MyTable_00763] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00763_MyTable00763] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00763] ([ColKey]),
    CONSTRAINT [BK_MyTable_00763_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
