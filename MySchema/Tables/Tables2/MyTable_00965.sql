CREATE TABLE [MySchema].[MyTable_00965] (
    ...
    CONSTRAINT [PK_MyTable_00965] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00965_MyTable00965] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00965] ([ColKey]),
    CONSTRAINT [BK_MyTable_00965_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
