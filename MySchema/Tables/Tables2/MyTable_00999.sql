CREATE TABLE [MySchema].[MyTable_00999] (
    ...
    CONSTRAINT [PK_MyTable_00999] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00999_MyTable00999] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00999] ([ColKey]),
    CONSTRAINT [BK_MyTable_00999_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
