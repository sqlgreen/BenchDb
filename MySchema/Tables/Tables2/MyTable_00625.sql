CREATE TABLE [MySchema].[MyTable_00625] (
    ...
    CONSTRAINT [PK_MyTable_00625] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00625_MyTable00625] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00625] ([ColKey]),
    CONSTRAINT [BK_MyTable_00625_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
