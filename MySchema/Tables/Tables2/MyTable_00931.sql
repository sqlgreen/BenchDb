CREATE TABLE [MySchema].[MyTable_00931] (
    ...
    CONSTRAINT [PK_MyTable_00931] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00931_MyTable00931] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00931] ([ColKey]),
    CONSTRAINT [BK_MyTable_00931_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
