CREATE TABLE [MySchema].[MyTable_00936] (
    ...
    CONSTRAINT [PK_MyTable_00936] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00936_MyTable00936] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00936] ([ColKey]),
    CONSTRAINT [BK_MyTable_00936_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
