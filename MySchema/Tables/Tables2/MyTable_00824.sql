CREATE TABLE [MySchema].[MyTable_00824] (
    ...
    CONSTRAINT [PK_MyTable_00824] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00824_MyTable00824] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00824] ([ColKey]),
    CONSTRAINT [BK_MyTable_00824_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
