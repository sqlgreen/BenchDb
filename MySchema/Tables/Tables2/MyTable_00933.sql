CREATE TABLE [MySchema].[MyTable_00933] (
    ...
    CONSTRAINT [PK_MyTable_00933] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00933_MyTable00933] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00933] ([ColKey]),
    CONSTRAINT [BK_MyTable_00933_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
