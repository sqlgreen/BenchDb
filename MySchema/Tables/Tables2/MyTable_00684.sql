CREATE TABLE [MySchema].[MyTable_00684] (
    ...
    CONSTRAINT [PK_MyTable_00684] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00684_MyTable00684] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00684] ([ColKey]),
    CONSTRAINT [BK_MyTable_00684_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
