CREATE TABLE [MySchema].[MyTable_00946] (
    ...
    CONSTRAINT [PK_MyTable_00946] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00946_MyTable00946] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00946] ([ColKey]),
    CONSTRAINT [BK_MyTable_00946_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
