CREATE TABLE [MySchema].[MyTable_00912] (
    ...
    CONSTRAINT [PK_MyTable_00912] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00912_MyTable00912] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00912] ([ColKey]),
    CONSTRAINT [BK_MyTable_00912_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
