CREATE TABLE [MySchema].[MyTable_00924] (
    ...
    CONSTRAINT [PK_MyTable_00924] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00924_MyTable00924] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00924] ([ColKey]),
    CONSTRAINT [BK_MyTable_00924_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
