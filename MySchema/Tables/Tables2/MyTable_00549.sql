CREATE TABLE [MySchema].[MyTable_00549] (
    ...
    CONSTRAINT [PK_MyTable_00549] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00549_MyTable00549] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00549] ([ColKey]),
    CONSTRAINT [BK_MyTable_00549_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
