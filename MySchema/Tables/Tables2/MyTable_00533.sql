CREATE TABLE [MySchema].[MyTable_00533] (
    ...
    CONSTRAINT [PK_MyTable_00533] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00533_MyTable00533] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00533] ([ColKey]),
    CONSTRAINT [BK_MyTable_00533_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
