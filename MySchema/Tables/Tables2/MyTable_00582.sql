CREATE TABLE [MySchema].[MyTable_00582] (
    ...
    CONSTRAINT [PK_MyTable_00582] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00582_MyTable00582] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00582] ([ColKey]),
    CONSTRAINT [BK_MyTable_00582_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
