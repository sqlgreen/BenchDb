CREATE TABLE [MySchema].[MyTable_00686] (
    ...
    CONSTRAINT [PK_MyTable_00686] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00686_MyTable00686] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00686] ([ColKey]),
    CONSTRAINT [BK_MyTable_00686_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
