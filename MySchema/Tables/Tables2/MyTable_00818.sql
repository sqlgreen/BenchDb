CREATE TABLE [MySchema].[MyTable_00818] (
    ...
    CONSTRAINT [PK_MyTable_00818] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00818_MyTable00818] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00818] ([ColKey]),
    CONSTRAINT [BK_MyTable_00818_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
