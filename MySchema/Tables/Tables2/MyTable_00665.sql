CREATE TABLE [MySchema].[MyTable_00665] (
    ...
    CONSTRAINT [PK_MyTable_00665] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00665_MyTable00665] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00665] ([ColKey]),
    CONSTRAINT [BK_MyTable_00665_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
