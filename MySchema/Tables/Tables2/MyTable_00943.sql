CREATE TABLE [MySchema].[MyTable_00943] (
    ...
    CONSTRAINT [PK_MyTable_00943] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00943_MyTable00943] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00943] ([ColKey]),
    CONSTRAINT [BK_MyTable_00943_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
