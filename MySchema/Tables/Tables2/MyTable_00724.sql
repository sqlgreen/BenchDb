CREATE TABLE [MySchema].[MyTable_00724] (
    ...
    CONSTRAINT [PK_MyTable_00724] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00724_MyTable00724] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00724] ([ColKey]),
    CONSTRAINT [BK_MyTable_00724_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
