CREATE TABLE [MySchema].[MyTable_00742] (
    ...
    CONSTRAINT [PK_MyTable_00742] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00742_MyTable00742] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00742] ([ColKey]),
    CONSTRAINT [BK_MyTable_00742_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
