CREATE TABLE [MySchema].[MyTable_00876] (
    ...
    CONSTRAINT [PK_MyTable_00876] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00876_MyTable00876] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00876] ([ColKey]),
    CONSTRAINT [BK_MyTable_00876_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
