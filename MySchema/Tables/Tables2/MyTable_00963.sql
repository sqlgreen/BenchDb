CREATE TABLE [MySchema].[MyTable_00963] (
    ...
    CONSTRAINT [PK_MyTable_00963] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00963_MyTable00963] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00963] ([ColKey]),
    CONSTRAINT [BK_MyTable_00963_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
