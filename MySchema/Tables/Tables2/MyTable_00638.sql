CREATE TABLE [MySchema].[MyTable_00638] (
    ...
    CONSTRAINT [PK_MyTable_00638] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00638_MyTable00638] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00638] ([ColKey]),
    CONSTRAINT [BK_MyTable_00638_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
