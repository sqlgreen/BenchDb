CREATE TABLE [MySchema].[MyTable_00602] (
    ...
    CONSTRAINT [PK_MyTable_00602] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00602_MyTable00602] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00602] ([ColKey]),
    CONSTRAINT [BK_MyTable_00602_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
