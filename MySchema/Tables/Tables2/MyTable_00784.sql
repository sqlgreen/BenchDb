CREATE TABLE [MySchema].[MyTable_00784] (
    ...
    CONSTRAINT [PK_MyTable_00784] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00784_MyTable00784] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00784] ([ColKey]),
    CONSTRAINT [BK_MyTable_00784_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
