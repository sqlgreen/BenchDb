CREATE TABLE [MySchema].[MyTable_00666] (
    ...
    CONSTRAINT [PK_MyTable_00666] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00666_MyTable00666] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00666] ([ColKey]),
    CONSTRAINT [BK_MyTable_00666_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
