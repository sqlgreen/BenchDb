CREATE TABLE [MySchema].[MyTable_00801] (
    ...
    CONSTRAINT [PK_MyTable_00801] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00801_MyTable00801] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00801] ([ColKey]),
    CONSTRAINT [BK_MyTable_00801_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
