CREATE TABLE [MySchema].[MyTable_00994] (
    ...
    CONSTRAINT [PK_MyTable_00994] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00994_MyTable00994] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00994] ([ColKey]),
    CONSTRAINT [BK_MyTable_00994_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
