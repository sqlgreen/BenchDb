CREATE TABLE [MySchema].[MyTable_00831] (
    ...
    CONSTRAINT [PK_MyTable_00831] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00831_MyTable00831] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00831] ([ColKey]),
    CONSTRAINT [BK_MyTable_00831_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
