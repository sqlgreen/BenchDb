CREATE TABLE [MySchema].[MyTable_00566] (
    ...
    CONSTRAINT [PK_MyTable_00566] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00566_MyTable00566] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00566] ([ColKey]),
    CONSTRAINT [BK_MyTable_00566_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
