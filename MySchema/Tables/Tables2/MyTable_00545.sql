CREATE TABLE [MySchema].[MyTable_00545] (
    ...
    CONSTRAINT [PK_MyTable_00545] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00545_MyTable00545] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00545] ([ColKey]),
    CONSTRAINT [BK_MyTable_00545_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
