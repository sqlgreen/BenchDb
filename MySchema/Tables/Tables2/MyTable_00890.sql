CREATE TABLE [MySchema].[MyTable_00890] (
    ...
    CONSTRAINT [PK_MyTable_00890] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00890_MyTable00890] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00890] ([ColKey]),
    CONSTRAINT [BK_MyTable_00890_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
