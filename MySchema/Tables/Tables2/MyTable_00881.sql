CREATE TABLE [MySchema].[MyTable_00881] (
    ...
    CONSTRAINT [PK_MyTable_00881] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00881_MyTable00881] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00881] ([ColKey]),
    CONSTRAINT [BK_MyTable_00881_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
