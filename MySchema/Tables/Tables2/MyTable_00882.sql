CREATE TABLE [MySchema].[MyTable_00882] (
    ...
    CONSTRAINT [PK_MyTable_00882] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00882_MyTable00882] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00882] ([ColKey]),
    CONSTRAINT [BK_MyTable_00882_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
