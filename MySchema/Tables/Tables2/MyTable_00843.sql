CREATE TABLE [MySchema].[MyTable_00843] (
    ...
    CONSTRAINT [PK_MyTable_00843] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00843_MyTable00843] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00843] ([ColKey]),
    CONSTRAINT [BK_MyTable_00843_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
