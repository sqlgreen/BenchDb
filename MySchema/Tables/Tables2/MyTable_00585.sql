CREATE TABLE [MySchema].[MyTable_00585] (
    ...
    CONSTRAINT [PK_MyTable_00585] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00585_MyTable00585] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00585] ([ColKey]),
    CONSTRAINT [BK_MyTable_00585_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
