CREATE TABLE [MySchema].[MyTable_00794] (
    ...
    CONSTRAINT [PK_MyTable_00794] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00794_MyTable00794] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00794] ([ColKey]),
    CONSTRAINT [BK_MyTable_00794_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
