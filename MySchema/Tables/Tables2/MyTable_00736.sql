CREATE TABLE [MySchema].[MyTable_00736] (
    ...
    CONSTRAINT [PK_MyTable_00736] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00736_MyTable00736] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00736] ([ColKey]),
    CONSTRAINT [BK_MyTable_00736_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
