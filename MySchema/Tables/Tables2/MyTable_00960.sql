CREATE TABLE [MySchema].[MyTable_00960] (
    ...
    CONSTRAINT [PK_MyTable_00960] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00960_MyTable00960] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00960] ([ColKey]),
    CONSTRAINT [BK_MyTable_00960_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
