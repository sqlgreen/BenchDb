CREATE TABLE [MySchema].[MyTable_00656] (
    ...
    CONSTRAINT [PK_MyTable_00656] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00656_MyTable00656] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00656] ([ColKey]),
    CONSTRAINT [BK_MyTable_00656_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
