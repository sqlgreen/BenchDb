CREATE TABLE [MySchema].[MyTable_00956] (
    ...
    CONSTRAINT [PK_MyTable_00956] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00956_MyTable00956] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00956] ([ColKey]),
    CONSTRAINT [BK_MyTable_00956_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
