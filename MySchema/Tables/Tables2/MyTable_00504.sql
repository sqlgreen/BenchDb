CREATE TABLE [MySchema].[MyTable_00504] (
    ...
    CONSTRAINT [PK_MyTable_00504] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00504_MyTable00504] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00504] ([ColKey]),
    CONSTRAINT [BK_MyTable_00504_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
