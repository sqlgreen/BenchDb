CREATE TABLE [MySchema].[MyTable_00799] (
    ...
    CONSTRAINT [PK_MyTable_00799] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00799_MyTable00799] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00799] ([ColKey]),
    CONSTRAINT [BK_MyTable_00799_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
