CREATE TABLE [MySchema].[MyTable_00588] (
    ...
    CONSTRAINT [PK_MyTable_00588] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00588_MyTable00588] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00588] ([ColKey]),
    CONSTRAINT [BK_MyTable_00588_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
