CREATE TABLE [MySchema].[MyTable_00885] (
    ...
    CONSTRAINT [PK_MyTable_00885] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00885_MyTable00885] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00885] ([ColKey]),
    CONSTRAINT [BK_MyTable_00885_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
