CREATE TABLE [MySchema].[MyTable_00704] (
    ...
    CONSTRAINT [PK_MyTable_00704] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00704_MyTable00704] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00704] ([ColKey]),
    CONSTRAINT [BK_MyTable_00704_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
