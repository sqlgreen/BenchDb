CREATE TABLE [MySchema].[MyTable_00897] (
    ...
    CONSTRAINT [PK_MyTable_00897] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00897_MyTable00897] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00897] ([ColKey]),
    CONSTRAINT [BK_MyTable_00897_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
