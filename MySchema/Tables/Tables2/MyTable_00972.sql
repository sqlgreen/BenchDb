CREATE TABLE [MySchema].[MyTable_00972] (
    ...
    CONSTRAINT [PK_MyTable_00972] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00972_MyTable00972] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00972] ([ColKey]),
    CONSTRAINT [BK_MyTable_00972_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
