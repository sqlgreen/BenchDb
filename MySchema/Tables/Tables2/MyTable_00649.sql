CREATE TABLE [MySchema].[MyTable_00649] (
    ...
    CONSTRAINT [PK_MyTable_00649] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00649_MyTable00649] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00649] ([ColKey]),
    CONSTRAINT [BK_MyTable_00649_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
