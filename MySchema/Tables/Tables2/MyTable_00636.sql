CREATE TABLE [MySchema].[MyTable_00636] (
    ...
    CONSTRAINT [PK_MyTable_00636] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00636_MyTable00636] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00636] ([ColKey]),
    CONSTRAINT [BK_MyTable_00636_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
