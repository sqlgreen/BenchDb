CREATE TABLE [MySchema].[MyTable_00726] (
    ...
    CONSTRAINT [PK_MyTable_00726] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00726_MyTable00726] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00726] ([ColKey]),
    CONSTRAINT [BK_MyTable_00726_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
