CREATE TABLE [MySchema].[MyTable_00822] (
    ...
    CONSTRAINT [PK_MyTable_00822] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00822_MyTable00822] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00822] ([ColKey]),
    CONSTRAINT [BK_MyTable_00822_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
