CREATE TABLE [MySchema].[MyTable_00932] (
    ...
    CONSTRAINT [PK_MyTable_00932] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00932_MyTable00932] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00932] ([ColKey]),
    CONSTRAINT [BK_MyTable_00932_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
