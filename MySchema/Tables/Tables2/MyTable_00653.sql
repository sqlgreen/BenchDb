CREATE TABLE [MySchema].[MyTable_00653] (
    ...
    CONSTRAINT [PK_MyTable_00653] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00653_MyTable00653] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00653] ([ColKey]),
    CONSTRAINT [BK_MyTable_00653_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
