CREATE TABLE [MySchema].[MyTable_00627] (
    ...
    CONSTRAINT [PK_MyTable_00627] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00627_MyTable00627] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00627] ([ColKey]),
    CONSTRAINT [BK_MyTable_00627_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
