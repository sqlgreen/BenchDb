CREATE TABLE [MySchema].[MyTable_00853] (
    ...
    CONSTRAINT [PK_MyTable_00853] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00853_MyTable00853] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00853] ([ColKey]),
    CONSTRAINT [BK_MyTable_00853_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
