CREATE TABLE [MySchema].[MyTable_00750] (
    ...
    CONSTRAINT [PK_MyTable_00750] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00750_MyTable00750] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00750] ([ColKey]),
    CONSTRAINT [BK_MyTable_00750_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
