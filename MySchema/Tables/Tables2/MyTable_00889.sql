CREATE TABLE [MySchema].[MyTable_00889] (
    ...
    CONSTRAINT [PK_MyTable_00889] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00889_MyTable00889] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00889] ([ColKey]),
    CONSTRAINT [BK_MyTable_00889_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
