CREATE TABLE [MySchema].[MyTable_00913] (
    ...
    CONSTRAINT [PK_MyTable_00913] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00913_MyTable00913] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00913] ([ColKey]),
    CONSTRAINT [BK_MyTable_00913_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
