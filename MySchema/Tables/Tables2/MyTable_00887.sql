CREATE TABLE [MySchema].[MyTable_00887] (
    ...
    CONSTRAINT [PK_MyTable_00887] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00887_MyTable00887] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00887] ([ColKey]),
    CONSTRAINT [BK_MyTable_00887_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
