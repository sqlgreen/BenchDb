CREATE TABLE [MySchema].[MyTable_00596] (
    ...
    CONSTRAINT [PK_MyTable_00596] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00596_MyTable00596] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00596] ([ColKey]),
    CONSTRAINT [BK_MyTable_00596_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
