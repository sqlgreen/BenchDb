CREATE TABLE [MySchema].[MyTable_00561] (
    ...
    CONSTRAINT [PK_MyTable_00561] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00561_MyTable00561] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00561] ([ColKey]),
    CONSTRAINT [BK_MyTable_00561_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
