CREATE TABLE [MySchema].[MyTable_00524] (
    ...
    CONSTRAINT [PK_MyTable_00524] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00524_MyTable00524] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00524] ([ColKey]),
    CONSTRAINT [BK_MyTable_00524_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
