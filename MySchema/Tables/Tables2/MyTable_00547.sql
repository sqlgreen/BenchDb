CREATE TABLE [MySchema].[MyTable_00547] (
    ...
    CONSTRAINT [PK_MyTable_00547] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00547_MyTable00547] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00547] ([ColKey]),
    CONSTRAINT [BK_MyTable_00547_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
