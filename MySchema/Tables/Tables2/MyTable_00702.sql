CREATE TABLE [MySchema].[MyTable_00702] (
    ...
    CONSTRAINT [PK_MyTable_00702] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00702_MyTable00702] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00702] ([ColKey]),
    CONSTRAINT [BK_MyTable_00702_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
