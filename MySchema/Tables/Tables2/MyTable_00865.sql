CREATE TABLE [MySchema].[MyTable_00865] (
    ...
    CONSTRAINT [PK_MyTable_00865] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00865_MyTable00865] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00865] ([ColKey]),
    CONSTRAINT [BK_MyTable_00865_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
