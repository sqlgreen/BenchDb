CREATE TABLE [MySchema].[MyTable_00633] (
    ...
    CONSTRAINT [PK_MyTable_00633] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00633_MyTable00633] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00633] ([ColKey]),
    CONSTRAINT [BK_MyTable_00633_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
