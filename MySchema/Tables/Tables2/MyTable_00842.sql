CREATE TABLE [MySchema].[MyTable_00842] (
    ...
    CONSTRAINT [PK_MyTable_00842] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00842_MyTable00842] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00842] ([ColKey]),
    CONSTRAINT [BK_MyTable_00842_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
