CREATE TABLE [MySchema].[MyTable_00785] (
    ...
    CONSTRAINT [PK_MyTable_00785] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00785_MyTable00785] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00785] ([ColKey]),
    CONSTRAINT [BK_MyTable_00785_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
