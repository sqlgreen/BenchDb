CREATE TABLE [MySchema].[MyTable_00911] (
    ...
    CONSTRAINT [PK_MyTable_00911] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00911_MyTable00911] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00911] ([ColKey]),
    CONSTRAINT [BK_MyTable_00911_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
