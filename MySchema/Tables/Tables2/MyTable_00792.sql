CREATE TABLE [MySchema].[MyTable_00792] (
    ...
    CONSTRAINT [PK_MyTable_00792] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00792_MyTable00792] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00792] ([ColKey]),
    CONSTRAINT [BK_MyTable_00792_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
