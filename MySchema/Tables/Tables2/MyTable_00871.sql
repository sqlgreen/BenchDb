CREATE TABLE [MySchema].[MyTable_00871] (
    ...
    CONSTRAINT [PK_MyTable_00871] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00871_MyTable00871] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00871] ([ColKey]),
    CONSTRAINT [BK_MyTable_00871_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
