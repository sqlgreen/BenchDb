CREATE TABLE [MySchema].[MyTable_00940] (
    ...
    CONSTRAINT [PK_MyTable_00940] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00940_MyTable00940] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00940] ([ColKey]),
    CONSTRAINT [BK_MyTable_00940_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
