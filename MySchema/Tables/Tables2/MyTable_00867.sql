CREATE TABLE [MySchema].[MyTable_00867] (
    ...
    CONSTRAINT [PK_MyTable_00867] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00867_MyTable00867] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00867] ([ColKey]),
    CONSTRAINT [BK_MyTable_00867_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
