CREATE TABLE [MySchema].[MyTable_00786] (
    ...
    CONSTRAINT [PK_MyTable_00786] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00786_MyTable00786] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00786] ([ColKey]),
    CONSTRAINT [BK_MyTable_00786_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
