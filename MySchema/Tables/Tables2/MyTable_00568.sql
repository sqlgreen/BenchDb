CREATE TABLE [MySchema].[MyTable_00568] (
    ...
    CONSTRAINT [PK_MyTable_00568] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00568_MyTable00568] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00568] ([ColKey]),
    CONSTRAINT [BK_MyTable_00568_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
