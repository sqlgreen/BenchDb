CREATE TABLE [MySchema].[MyTable_00916] (
    ...
    CONSTRAINT [PK_MyTable_00916] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00916_MyTable00916] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00916] ([ColKey]),
    CONSTRAINT [BK_MyTable_00916_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
