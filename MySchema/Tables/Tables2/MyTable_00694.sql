CREATE TABLE [MySchema].[MyTable_00694] (
    ...
    CONSTRAINT [PK_MyTable_00694] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00694_MyTable00694] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00694] ([ColKey]),
    CONSTRAINT [BK_MyTable_00694_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
