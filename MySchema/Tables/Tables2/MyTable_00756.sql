CREATE TABLE [MySchema].[MyTable_00756] (
    ...
    CONSTRAINT [PK_MyTable_00756] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00756_MyTable00756] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00756] ([ColKey]),
    CONSTRAINT [BK_MyTable_00756_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
