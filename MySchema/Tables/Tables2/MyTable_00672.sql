CREATE TABLE [MySchema].[MyTable_00672] (
    ...
    CONSTRAINT [PK_MyTable_00672] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00672_MyTable00672] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00672] ([ColKey]),
    CONSTRAINT [BK_MyTable_00672_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
