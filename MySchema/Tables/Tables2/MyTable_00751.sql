CREATE TABLE [MySchema].[MyTable_00751] (
    ...
    CONSTRAINT [PK_MyTable_00751] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00751_MyTable00751] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00751] ([ColKey]),
    CONSTRAINT [BK_MyTable_00751_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
