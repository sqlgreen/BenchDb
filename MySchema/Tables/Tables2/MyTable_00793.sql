CREATE TABLE [MySchema].[MyTable_00793] (
    ...
    CONSTRAINT [PK_MyTable_00793] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00793_MyTable00793] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00793] ([ColKey]),
    CONSTRAINT [BK_MyTable_00793_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
