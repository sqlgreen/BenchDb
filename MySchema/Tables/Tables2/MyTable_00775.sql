CREATE TABLE [MySchema].[MyTable_00775] (
    ...
    CONSTRAINT [PK_MyTable_00775] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00775_MyTable00775] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00775] ([ColKey]),
    CONSTRAINT [BK_MyTable_00775_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
