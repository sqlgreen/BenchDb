CREATE TABLE [MySchema].[MyTable_00506] (
    ...
    CONSTRAINT [PK_MyTable_00506] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00506_MyTable00506] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00506] ([ColKey]),
    CONSTRAINT [BK_MyTable_00506_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
