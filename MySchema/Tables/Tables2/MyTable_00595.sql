CREATE TABLE [MySchema].[MyTable_00595] (
    ...
    CONSTRAINT [PK_MyTable_00595] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00595_MyTable00595] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00595] ([ColKey]),
    CONSTRAINT [BK_MyTable_00595_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
