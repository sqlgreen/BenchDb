CREATE TABLE [MySchema].[MyTable_00634] (
    ...
    CONSTRAINT [PK_MyTable_00634] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00634_MyTable00634] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00634] ([ColKey]),
    CONSTRAINT [BK_MyTable_00634_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
