CREATE TABLE [MySchema].[MyTable_00668] (
    ...
    CONSTRAINT [PK_MyTable_00668] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00668_MyTable00668] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00668] ([ColKey]),
    CONSTRAINT [BK_MyTable_00668_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
