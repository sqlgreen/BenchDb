CREATE TABLE [MySchema].[MyTable_00774] (
    ...
    CONSTRAINT [PK_MyTable_00774] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00774_MyTable00774] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00774] ([ColKey]),
    CONSTRAINT [BK_MyTable_00774_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
