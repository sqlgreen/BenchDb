CREATE TABLE [MySchema].[MyTable_00915] (
    ...
    CONSTRAINT [PK_MyTable_00915] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00915_MyTable00915] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00915] ([ColKey]),
    CONSTRAINT [BK_MyTable_00915_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
