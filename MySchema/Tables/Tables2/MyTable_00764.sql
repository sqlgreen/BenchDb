CREATE TABLE [MySchema].[MyTable_00764] (
    ...
    CONSTRAINT [PK_MyTable_00764] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00764_MyTable00764] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00764] ([ColKey]),
    CONSTRAINT [BK_MyTable_00764_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
