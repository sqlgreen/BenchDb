CREATE TABLE [MySchema].[MyTable_00791] (
    ...
    CONSTRAINT [PK_MyTable_00791] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00791_MyTable00791] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00791] ([ColKey]),
    CONSTRAINT [BK_MyTable_00791_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
