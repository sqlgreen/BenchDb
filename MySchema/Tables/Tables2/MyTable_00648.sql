CREATE TABLE [MySchema].[MyTable_00648] (
    ...
    CONSTRAINT [PK_MyTable_00648] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00648_MyTable00648] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00648] ([ColKey]),
    CONSTRAINT [BK_MyTable_00648_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
