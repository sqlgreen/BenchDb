CREATE TABLE [MySchema].[MyTable_00707] (
    ...
    CONSTRAINT [PK_MyTable_00707] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00707_MyTable00707] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00707] ([ColKey]),
    CONSTRAINT [BK_MyTable_00707_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
