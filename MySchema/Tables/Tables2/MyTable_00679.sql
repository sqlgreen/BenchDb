CREATE TABLE [MySchema].[MyTable_00679] (
    ...
    CONSTRAINT [PK_MyTable_00679] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00679_MyTable00679] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00679] ([ColKey]),
    CONSTRAINT [BK_MyTable_00679_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
