CREATE TABLE [MySchema].[MyTable_00711] (
    ...
    CONSTRAINT [PK_MyTable_00711] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00711_MyTable00711] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00711] ([ColKey]),
    CONSTRAINT [BK_MyTable_00711_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
