CREATE TABLE [MySchema].[MyTable_00593] (
    ...
    CONSTRAINT [PK_MyTable_00593] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00593_MyTable00593] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00593] ([ColKey]),
    CONSTRAINT [BK_MyTable_00593_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
