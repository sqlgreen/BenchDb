CREATE TABLE [MySchema].[MyTable_00941] (
    ...
    CONSTRAINT [PK_MyTable_00941] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00941_MyTable00941] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00941] ([ColKey]),
    CONSTRAINT [BK_MyTable_00941_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
