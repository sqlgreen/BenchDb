CREATE TABLE [MySchema].[MyTable_00830] (
    ...
    CONSTRAINT [PK_MyTable_00830] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00830_MyTable00830] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00830] ([ColKey]),
    CONSTRAINT [BK_MyTable_00830_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
