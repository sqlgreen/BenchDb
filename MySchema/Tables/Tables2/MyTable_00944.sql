CREATE TABLE [MySchema].[MyTable_00944] (
    ...
    CONSTRAINT [PK_MyTable_00944] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00944_MyTable00944] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00944] ([ColKey]),
    CONSTRAINT [BK_MyTable_00944_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
