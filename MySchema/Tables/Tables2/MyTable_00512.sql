CREATE TABLE [MySchema].[MyTable_00512] (
    ...
    CONSTRAINT [PK_MyTable_00512] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00512_MyTable00512] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00512] ([ColKey]),
    CONSTRAINT [BK_MyTable_00512_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
