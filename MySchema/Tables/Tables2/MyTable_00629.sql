CREATE TABLE [MySchema].[MyTable_00629] (
    ...
    CONSTRAINT [PK_MyTable_00629] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00629_MyTable00629] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00629] ([ColKey]),
    CONSTRAINT [BK_MyTable_00629_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
