CREATE TABLE [MySchema].[MyTable_00655] (
    ...
    CONSTRAINT [PK_MyTable_00655] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00655_MyTable00655] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00655] ([ColKey]),
    CONSTRAINT [BK_MyTable_00655_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
