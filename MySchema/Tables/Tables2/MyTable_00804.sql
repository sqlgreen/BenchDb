CREATE TABLE [MySchema].[MyTable_00804] (
    ...
    CONSTRAINT [PK_MyTable_00804] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00804_MyTable00804] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00804] ([ColKey]),
    CONSTRAINT [BK_MyTable_00804_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
