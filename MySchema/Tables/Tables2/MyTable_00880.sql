CREATE TABLE [MySchema].[MyTable_00880] (
    ...
    CONSTRAINT [PK_MyTable_00880] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00880_MyTable00880] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00880] ([ColKey]),
    CONSTRAINT [BK_MyTable_00880_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
