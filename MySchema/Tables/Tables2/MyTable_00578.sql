CREATE TABLE [MySchema].[MyTable_00578] (
    ...
    CONSTRAINT [PK_MyTable_00578] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00578_MyTable00578] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00578] ([ColKey]),
    CONSTRAINT [BK_MyTable_00578_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
