CREATE TABLE [MySchema].[MyTable_00620] (
    ...
    CONSTRAINT [PK_MyTable_00620] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00620_MyTable00620] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00620] ([ColKey]),
    CONSTRAINT [BK_MyTable_00620_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
