CREATE TABLE [MySchema].[MyTable_00893] (
    ...
    CONSTRAINT [PK_MyTable_00893] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_00893_MyTable00893] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_00893] ([ColKey]),
    CONSTRAINT [BK_MyTable_00893_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
