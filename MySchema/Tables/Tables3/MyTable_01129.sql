CREATE TABLE [MySchema].[MyTable_01129] (
    ...
    CONSTRAINT [PK_MyTable_01129] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01129_MyTable01129] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01129] ([ColKey]),
    CONSTRAINT [BK_MyTable_01129_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
