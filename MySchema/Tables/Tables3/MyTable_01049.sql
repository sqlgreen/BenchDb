CREATE TABLE [MySchema].[MyTable_01049] (
    ...
    CONSTRAINT [PK_MyTable_01049] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01049_MyTable01049] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01049] ([ColKey]),
    CONSTRAINT [BK_MyTable_01049_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
