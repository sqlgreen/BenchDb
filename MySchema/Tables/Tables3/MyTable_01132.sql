CREATE TABLE [MySchema].[MyTable_01132] (
    ...
    CONSTRAINT [PK_MyTable_01132] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01132_MyTable01132] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01132] ([ColKey]),
    CONSTRAINT [BK_MyTable_01132_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
