CREATE TABLE [MySchema].[MyTable_01488] (
    ...
    CONSTRAINT [PK_MyTable_01488] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01488_MyTable01488] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01488] ([ColKey]),
    CONSTRAINT [BK_MyTable_01488_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
