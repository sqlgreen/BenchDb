CREATE TABLE [MySchema].[MyTable_01404] (
    ...
    CONSTRAINT [PK_MyTable_01404] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01404_MyTable01404] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01404] ([ColKey]),
    CONSTRAINT [BK_MyTable_01404_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
