CREATE TABLE [MySchema].[MyTable_01030] (
    ...
    CONSTRAINT [PK_MyTable_01030] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01030_MyTable01030] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01030] ([ColKey]),
    CONSTRAINT [BK_MyTable_01030_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
