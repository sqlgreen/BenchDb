CREATE TABLE [MySchema].[MyTable_01408] (
    ...
    CONSTRAINT [PK_MyTable_01408] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01408_MyTable01408] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01408] ([ColKey]),
    CONSTRAINT [BK_MyTable_01408_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
