CREATE TABLE [MySchema].[MyTable_01464] (
    ...
    CONSTRAINT [PK_MyTable_01464] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01464_MyTable01464] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01464] ([ColKey]),
    CONSTRAINT [BK_MyTable_01464_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
