CREATE TABLE [MySchema].[MyTable_01465] (
    ...
    CONSTRAINT [PK_MyTable_01465] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01465_MyTable01465] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01465] ([ColKey]),
    CONSTRAINT [BK_MyTable_01465_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
