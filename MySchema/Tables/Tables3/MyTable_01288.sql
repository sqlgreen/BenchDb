CREATE TABLE [MySchema].[MyTable_01288] (
    ...
    CONSTRAINT [PK_MyTable_01288] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01288_MyTable01288] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01288] ([ColKey]),
    CONSTRAINT [BK_MyTable_01288_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
