CREATE TABLE [MySchema].[MyTable_01250] (
    ...
    CONSTRAINT [PK_MyTable_01250] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01250_MyTable01250] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01250] ([ColKey]),
    CONSTRAINT [BK_MyTable_01250_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
