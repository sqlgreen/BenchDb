CREATE TABLE [MySchema].[MyTable_01100] (
    ...
    CONSTRAINT [PK_MyTable_01100] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01100_MyTable01100] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01100] ([ColKey]),
    CONSTRAINT [BK_MyTable_01100_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
