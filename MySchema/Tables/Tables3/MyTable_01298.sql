CREATE TABLE [MySchema].[MyTable_01298] (
    ...
    CONSTRAINT [PK_MyTable_01298] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01298_MyTable01298] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01298] ([ColKey]),
    CONSTRAINT [BK_MyTable_01298_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
