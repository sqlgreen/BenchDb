CREATE TABLE [MySchema].[MyTable_01337] (
    ...
    CONSTRAINT [PK_MyTable_01337] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01337_MyTable01337] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01337] ([ColKey]),
    CONSTRAINT [BK_MyTable_01337_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
