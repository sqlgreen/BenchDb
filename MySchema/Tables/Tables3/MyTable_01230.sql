CREATE TABLE [MySchema].[MyTable_01230] (
    ...
    CONSTRAINT [PK_MyTable_01230] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01230_MyTable01230] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01230] ([ColKey]),
    CONSTRAINT [BK_MyTable_01230_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
