CREATE TABLE [MySchema].[MyTable_01281] (
    ...
    CONSTRAINT [PK_MyTable_01281] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01281_MyTable01281] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01281] ([ColKey]),
    CONSTRAINT [BK_MyTable_01281_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
