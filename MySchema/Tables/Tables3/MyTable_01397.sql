CREATE TABLE [MySchema].[MyTable_01397] (
    ...
    CONSTRAINT [PK_MyTable_01397] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01397_MyTable01397] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01397] ([ColKey]),
    CONSTRAINT [BK_MyTable_01397_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
