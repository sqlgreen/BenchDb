CREATE TABLE [MySchema].[MyTable_01091] (
    ...
    CONSTRAINT [PK_MyTable_01091] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01091_MyTable01091] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01091] ([ColKey]),
    CONSTRAINT [BK_MyTable_01091_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
