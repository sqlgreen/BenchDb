CREATE TABLE [MySchema].[MyTable_01221] (
    ...
    CONSTRAINT [PK_MyTable_01221] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01221_MyTable01221] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01221] ([ColKey]),
    CONSTRAINT [BK_MyTable_01221_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
