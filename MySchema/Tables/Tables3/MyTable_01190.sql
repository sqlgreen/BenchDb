CREATE TABLE [MySchema].[MyTable_01190] (
    ...
    CONSTRAINT [PK_MyTable_01190] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01190_MyTable01190] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01190] ([ColKey]),
    CONSTRAINT [BK_MyTable_01190_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
