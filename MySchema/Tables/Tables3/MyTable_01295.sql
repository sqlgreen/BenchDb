CREATE TABLE [MySchema].[MyTable_01295] (
    ...
    CONSTRAINT [PK_MyTable_01295] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01295_MyTable01295] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01295] ([ColKey]),
    CONSTRAINT [BK_MyTable_01295_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
