CREATE TABLE [MySchema].[MyTable_01246] (
    ...
    CONSTRAINT [PK_MyTable_01246] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01246_MyTable01246] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01246] ([ColKey]),
    CONSTRAINT [BK_MyTable_01246_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
