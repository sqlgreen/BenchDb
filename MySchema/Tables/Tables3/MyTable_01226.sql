CREATE TABLE [MySchema].[MyTable_01226] (
    ...
    CONSTRAINT [PK_MyTable_01226] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01226_MyTable01226] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01226] ([ColKey]),
    CONSTRAINT [BK_MyTable_01226_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
