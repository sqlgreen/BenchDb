CREATE TABLE [MySchema].[MyTable_01349] (
    ...
    CONSTRAINT [PK_MyTable_01349] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01349_MyTable01349] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01349] ([ColKey]),
    CONSTRAINT [BK_MyTable_01349_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
