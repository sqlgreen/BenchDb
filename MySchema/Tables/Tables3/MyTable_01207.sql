CREATE TABLE [MySchema].[MyTable_01207] (
    ...
    CONSTRAINT [PK_MyTable_01207] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01207_MyTable01207] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01207] ([ColKey]),
    CONSTRAINT [BK_MyTable_01207_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
