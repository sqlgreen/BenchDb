CREATE TABLE [MySchema].[MyTable_01325] (
    ...
    CONSTRAINT [PK_MyTable_01325] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01325_MyTable01325] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01325] ([ColKey]),
    CONSTRAINT [BK_MyTable_01325_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
