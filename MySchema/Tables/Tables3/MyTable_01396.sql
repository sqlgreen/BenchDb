CREATE TABLE [MySchema].[MyTable_01396] (
    ...
    CONSTRAINT [PK_MyTable_01396] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01396_MyTable01396] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01396] ([ColKey]),
    CONSTRAINT [BK_MyTable_01396_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
