CREATE TABLE [MySchema].[MyTable_01000] (
    ...
    CONSTRAINT [PK_MyTable_01000] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01000_MyTable01000] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01000] ([ColKey]),
    CONSTRAINT [BK_MyTable_01000_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
