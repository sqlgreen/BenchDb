CREATE TABLE [MySchema].[MyTable_01196] (
    ...
    CONSTRAINT [PK_MyTable_01196] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01196_MyTable01196] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01196] ([ColKey]),
    CONSTRAINT [BK_MyTable_01196_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
