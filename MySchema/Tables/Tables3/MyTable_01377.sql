CREATE TABLE [MySchema].[MyTable_01377] (
    ...
    CONSTRAINT [PK_MyTable_01377] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01377_MyTable01377] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01377] ([ColKey]),
    CONSTRAINT [BK_MyTable_01377_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
