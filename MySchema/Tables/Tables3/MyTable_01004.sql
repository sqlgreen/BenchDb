CREATE TABLE [MySchema].[MyTable_01004] (
    ...
    CONSTRAINT [PK_MyTable_01004] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01004_MyTable01004] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01004] ([ColKey]),
    CONSTRAINT [BK_MyTable_01004_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
