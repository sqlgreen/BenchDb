CREATE TABLE [MySchema].[MyTable_01438] (
    ...
    CONSTRAINT [PK_MyTable_01438] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01438_MyTable01438] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01438] ([ColKey]),
    CONSTRAINT [BK_MyTable_01438_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
