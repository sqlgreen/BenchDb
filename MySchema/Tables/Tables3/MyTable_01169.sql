CREATE TABLE [MySchema].[MyTable_01169] (
    ...
    CONSTRAINT [PK_MyTable_01169] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01169_MyTable01169] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01169] ([ColKey]),
    CONSTRAINT [BK_MyTable_01169_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
