CREATE TABLE [MySchema].[MyTable_01243] (
    ...
    CONSTRAINT [PK_MyTable_01243] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01243_MyTable01243] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01243] ([ColKey]),
    CONSTRAINT [BK_MyTable_01243_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
