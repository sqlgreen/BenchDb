CREATE TABLE [MySchema].[MyTable_01082] (
    ...
    CONSTRAINT [PK_MyTable_01082] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01082_MyTable01082] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01082] ([ColKey]),
    CONSTRAINT [BK_MyTable_01082_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
