CREATE TABLE [MySchema].[MyTable_01120] (
    ...
    CONSTRAINT [PK_MyTable_01120] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01120_MyTable01120] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01120] ([ColKey]),
    CONSTRAINT [BK_MyTable_01120_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
