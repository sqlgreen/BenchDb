CREATE TABLE [MySchema].[MyTable_01193] (
    ...
    CONSTRAINT [PK_MyTable_01193] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01193_MyTable01193] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01193] ([ColKey]),
    CONSTRAINT [BK_MyTable_01193_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
