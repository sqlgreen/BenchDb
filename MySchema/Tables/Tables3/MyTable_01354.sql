CREATE TABLE [MySchema].[MyTable_01354] (
    ...
    CONSTRAINT [PK_MyTable_01354] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01354_MyTable01354] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01354] ([ColKey]),
    CONSTRAINT [BK_MyTable_01354_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
