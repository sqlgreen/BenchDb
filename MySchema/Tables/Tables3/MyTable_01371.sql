CREATE TABLE [MySchema].[MyTable_01371] (
    ...
    CONSTRAINT [PK_MyTable_01371] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01371_MyTable01371] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01371] ([ColKey]),
    CONSTRAINT [BK_MyTable_01371_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
