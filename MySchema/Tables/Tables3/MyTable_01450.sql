CREATE TABLE [MySchema].[MyTable_01450] (
    ...
    CONSTRAINT [PK_MyTable_01450] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01450_MyTable01450] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01450] ([ColKey]),
    CONSTRAINT [BK_MyTable_01450_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
