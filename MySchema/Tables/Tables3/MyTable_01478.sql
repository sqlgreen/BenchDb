CREATE TABLE [MySchema].[MyTable_01478] (
    ...
    CONSTRAINT [PK_MyTable_01478] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01478_MyTable01478] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01478] ([ColKey]),
    CONSTRAINT [BK_MyTable_01478_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
