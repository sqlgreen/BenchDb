CREATE TABLE [MySchema].[MyTable_01227] (
    ...
    CONSTRAINT [PK_MyTable_01227] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01227_MyTable01227] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01227] ([ColKey]),
    CONSTRAINT [BK_MyTable_01227_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
