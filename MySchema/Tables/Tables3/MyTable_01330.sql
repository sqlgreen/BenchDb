CREATE TABLE [MySchema].[MyTable_01330] (
    ...
    CONSTRAINT [PK_MyTable_01330] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01330_MyTable01330] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01330] ([ColKey]),
    CONSTRAINT [BK_MyTable_01330_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
