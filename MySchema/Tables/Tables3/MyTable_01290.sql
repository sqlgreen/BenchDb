CREATE TABLE [MySchema].[MyTable_01290] (
    ...
    CONSTRAINT [PK_MyTable_01290] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01290_MyTable01290] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01290] ([ColKey]),
    CONSTRAINT [BK_MyTable_01290_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
