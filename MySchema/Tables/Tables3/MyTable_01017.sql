CREATE TABLE [MySchema].[MyTable_01017] (
    ...
    CONSTRAINT [PK_MyTable_01017] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01017_MyTable01017] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01017] ([ColKey]),
    CONSTRAINT [BK_MyTable_01017_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
