CREATE TABLE [MySchema].[MyTable_01149] (
    ...
    CONSTRAINT [PK_MyTable_01149] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01149_MyTable01149] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01149] ([ColKey]),
    CONSTRAINT [BK_MyTable_01149_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
