CREATE TABLE [MySchema].[MyTable_01135] (
    ...
    CONSTRAINT [PK_MyTable_01135] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01135_MyTable01135] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01135] ([ColKey]),
    CONSTRAINT [BK_MyTable_01135_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
