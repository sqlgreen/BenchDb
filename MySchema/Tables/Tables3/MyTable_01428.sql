CREATE TABLE [MySchema].[MyTable_01428] (
    ...
    CONSTRAINT [PK_MyTable_01428] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01428_MyTable01428] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01428] ([ColKey]),
    CONSTRAINT [BK_MyTable_01428_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
