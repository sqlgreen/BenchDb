CREATE TABLE [MySchema].[MyTable_01025] (
    ...
    CONSTRAINT [PK_MyTable_01025] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01025_MyTable01025] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01025] ([ColKey]),
    CONSTRAINT [BK_MyTable_01025_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
