CREATE TABLE [MySchema].[MyTable_01200] (
    ...
    CONSTRAINT [PK_MyTable_01200] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01200_MyTable01200] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01200] ([ColKey]),
    CONSTRAINT [BK_MyTable_01200_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
