CREATE TABLE [MySchema].[MyTable_01420] (
    ...
    CONSTRAINT [PK_MyTable_01420] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01420_MyTable01420] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01420] ([ColKey]),
    CONSTRAINT [BK_MyTable_01420_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
