CREATE TABLE [MySchema].[MyTable_01118] (
    ...
    CONSTRAINT [PK_MyTable_01118] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01118_MyTable01118] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01118] ([ColKey]),
    CONSTRAINT [BK_MyTable_01118_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
