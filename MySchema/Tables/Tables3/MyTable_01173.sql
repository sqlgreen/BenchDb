CREATE TABLE [MySchema].[MyTable_01173] (
    ...
    CONSTRAINT [PK_MyTable_01173] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01173_MyTable01173] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01173] ([ColKey]),
    CONSTRAINT [BK_MyTable_01173_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
