CREATE TABLE [MySchema].[MyTable_01257] (
    ...
    CONSTRAINT [PK_MyTable_01257] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01257_MyTable01257] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01257] ([ColKey]),
    CONSTRAINT [BK_MyTable_01257_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
