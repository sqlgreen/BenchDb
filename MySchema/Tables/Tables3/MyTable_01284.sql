CREATE TABLE [MySchema].[MyTable_01284] (
    ...
    CONSTRAINT [PK_MyTable_01284] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01284_MyTable01284] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01284] ([ColKey]),
    CONSTRAINT [BK_MyTable_01284_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
