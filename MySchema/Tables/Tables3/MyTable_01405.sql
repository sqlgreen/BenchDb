CREATE TABLE [MySchema].[MyTable_01405] (
    ...
    CONSTRAINT [PK_MyTable_01405] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01405_MyTable01405] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01405] ([ColKey]),
    CONSTRAINT [BK_MyTable_01405_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
