CREATE TABLE [MySchema].[MyTable_01047] (
    ...
    CONSTRAINT [PK_MyTable_01047] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01047_MyTable01047] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01047] ([ColKey]),
    CONSTRAINT [BK_MyTable_01047_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
