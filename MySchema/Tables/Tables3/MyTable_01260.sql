CREATE TABLE [MySchema].[MyTable_01260] (
    ...
    CONSTRAINT [PK_MyTable_01260] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01260_MyTable01260] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01260] ([ColKey]),
    CONSTRAINT [BK_MyTable_01260_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
