CREATE TABLE [MySchema].[MyTable_01034] (
    ...
    CONSTRAINT [PK_MyTable_01034] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01034_MyTable01034] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01034] ([ColKey]),
    CONSTRAINT [BK_MyTable_01034_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
