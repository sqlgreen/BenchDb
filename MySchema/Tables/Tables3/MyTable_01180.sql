CREATE TABLE [MySchema].[MyTable_01180] (
    ...
    CONSTRAINT [PK_MyTable_01180] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01180_MyTable01180] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01180] ([ColKey]),
    CONSTRAINT [BK_MyTable_01180_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
