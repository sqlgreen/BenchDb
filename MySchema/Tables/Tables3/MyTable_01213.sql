CREATE TABLE [MySchema].[MyTable_01213] (
    ...
    CONSTRAINT [PK_MyTable_01213] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01213_MyTable01213] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01213] ([ColKey]),
    CONSTRAINT [BK_MyTable_01213_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
