CREATE TABLE [MySchema].[MyTable_01248] (
    ...
    CONSTRAINT [PK_MyTable_01248] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01248_MyTable01248] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01248] ([ColKey]),
    CONSTRAINT [BK_MyTable_01248_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
