CREATE TABLE [MySchema].[MyTable_01001] (
    ...
    CONSTRAINT [PK_MyTable_01001] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01001_MyTable01001] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01001] ([ColKey]),
    CONSTRAINT [BK_MyTable_01001_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
