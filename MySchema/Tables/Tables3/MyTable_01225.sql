CREATE TABLE [MySchema].[MyTable_01225] (
    ...
    CONSTRAINT [PK_MyTable_01225] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01225_MyTable01225] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01225] ([ColKey]),
    CONSTRAINT [BK_MyTable_01225_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
