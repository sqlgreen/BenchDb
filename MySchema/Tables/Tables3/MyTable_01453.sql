CREATE TABLE [MySchema].[MyTable_01453] (
    ...
    CONSTRAINT [PK_MyTable_01453] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01453_MyTable01453] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01453] ([ColKey]),
    CONSTRAINT [BK_MyTable_01453_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
