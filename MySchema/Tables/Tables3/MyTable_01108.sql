CREATE TABLE [MySchema].[MyTable_01108] (
    ...
    CONSTRAINT [PK_MyTable_01108] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01108_MyTable01108] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01108] ([ColKey]),
    CONSTRAINT [BK_MyTable_01108_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
