CREATE TABLE [MySchema].[MyTable_01358] (
    ...
    CONSTRAINT [PK_MyTable_01358] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01358_MyTable01358] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01358] ([ColKey]),
    CONSTRAINT [BK_MyTable_01358_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
