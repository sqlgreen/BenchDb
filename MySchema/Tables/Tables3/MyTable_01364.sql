CREATE TABLE [MySchema].[MyTable_01364] (
    ...
    CONSTRAINT [PK_MyTable_01364] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01364_MyTable01364] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01364] ([ColKey]),
    CONSTRAINT [BK_MyTable_01364_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
