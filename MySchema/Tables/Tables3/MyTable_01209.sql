CREATE TABLE [MySchema].[MyTable_01209] (
    ...
    CONSTRAINT [PK_MyTable_01209] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01209_MyTable01209] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01209] ([ColKey]),
    CONSTRAINT [BK_MyTable_01209_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
