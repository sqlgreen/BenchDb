CREATE TABLE [MySchema].[MyTable_01467] (
    ...
    CONSTRAINT [PK_MyTable_01467] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01467_MyTable01467] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01467] ([ColKey]),
    CONSTRAINT [BK_MyTable_01467_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
