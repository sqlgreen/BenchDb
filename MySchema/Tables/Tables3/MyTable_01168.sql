CREATE TABLE [MySchema].[MyTable_01168] (
    ...
    CONSTRAINT [PK_MyTable_01168] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01168_MyTable01168] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01168] ([ColKey]),
    CONSTRAINT [BK_MyTable_01168_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
