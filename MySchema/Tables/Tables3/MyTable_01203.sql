CREATE TABLE [MySchema].[MyTable_01203] (
    ...
    CONSTRAINT [PK_MyTable_01203] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01203_MyTable01203] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01203] ([ColKey]),
    CONSTRAINT [BK_MyTable_01203_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
