CREATE TABLE [MySchema].[MyTable_01296] (
    ...
    CONSTRAINT [PK_MyTable_01296] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01296_MyTable01296] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01296] ([ColKey]),
    CONSTRAINT [BK_MyTable_01296_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
