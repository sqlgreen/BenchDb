CREATE TABLE [MySchema].[MyTable_01454] (
    ...
    CONSTRAINT [PK_MyTable_01454] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01454_MyTable01454] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01454] ([ColKey]),
    CONSTRAINT [BK_MyTable_01454_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
