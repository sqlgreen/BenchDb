CREATE TABLE [MySchema].[MyTable_01486] (
    ...
    CONSTRAINT [PK_MyTable_01486] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01486_MyTable01486] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01486] ([ColKey]),
    CONSTRAINT [BK_MyTable_01486_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
