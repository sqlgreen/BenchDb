CREATE TABLE [MySchema].[MyTable_01101] (
    ...
    CONSTRAINT [PK_MyTable_01101] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01101_MyTable01101] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01101] ([ColKey]),
    CONSTRAINT [BK_MyTable_01101_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
