CREATE TABLE [MySchema].[MyTable_01439] (
    ...
    CONSTRAINT [PK_MyTable_01439] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01439_MyTable01439] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01439] ([ColKey]),
    CONSTRAINT [BK_MyTable_01439_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
