CREATE TABLE [MySchema].[MyTable_01300] (
    ...
    CONSTRAINT [PK_MyTable_01300] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01300_MyTable01300] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01300] ([ColKey]),
    CONSTRAINT [BK_MyTable_01300_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
