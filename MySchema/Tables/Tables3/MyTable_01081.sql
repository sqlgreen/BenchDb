CREATE TABLE [MySchema].[MyTable_01081] (
    ...
    CONSTRAINT [PK_MyTable_01081] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01081_MyTable01081] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01081] ([ColKey]),
    CONSTRAINT [BK_MyTable_01081_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
