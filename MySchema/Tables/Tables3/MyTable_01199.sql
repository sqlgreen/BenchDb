CREATE TABLE [MySchema].[MyTable_01199] (
    ...
    CONSTRAINT [PK_MyTable_01199] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01199_MyTable01199] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01199] ([ColKey]),
    CONSTRAINT [BK_MyTable_01199_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
