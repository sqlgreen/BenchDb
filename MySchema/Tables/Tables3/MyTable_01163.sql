CREATE TABLE [MySchema].[MyTable_01163] (
    ...
    CONSTRAINT [PK_MyTable_01163] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01163_MyTable01163] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01163] ([ColKey]),
    CONSTRAINT [BK_MyTable_01163_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
