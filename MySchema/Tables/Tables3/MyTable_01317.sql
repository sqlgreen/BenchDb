CREATE TABLE [MySchema].[MyTable_01317] (
    ...
    CONSTRAINT [PK_MyTable_01317] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01317_MyTable01317] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01317] ([ColKey]),
    CONSTRAINT [BK_MyTable_01317_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
