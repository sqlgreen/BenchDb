CREATE TABLE [MySchema].[MyTable_01133] (
    ...
    CONSTRAINT [PK_MyTable_01133] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01133_MyTable01133] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01133] ([ColKey]),
    CONSTRAINT [BK_MyTable_01133_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
