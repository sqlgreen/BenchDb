CREATE TABLE [MySchema].[MyTable_01425] (
    ...
    CONSTRAINT [PK_MyTable_01425] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01425_MyTable01425] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01425] ([ColKey]),
    CONSTRAINT [BK_MyTable_01425_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
