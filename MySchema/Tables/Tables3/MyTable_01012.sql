CREATE TABLE [MySchema].[MyTable_01012] (
    ...
    CONSTRAINT [PK_MyTable_01012] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01012_MyTable01012] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01012] ([ColKey]),
    CONSTRAINT [BK_MyTable_01012_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
