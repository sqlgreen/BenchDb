CREATE TABLE [MySchema].[MyTable_01310] (
    ...
    CONSTRAINT [PK_MyTable_01310] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01310_MyTable01310] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01310] ([ColKey]),
    CONSTRAINT [BK_MyTable_01310_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
