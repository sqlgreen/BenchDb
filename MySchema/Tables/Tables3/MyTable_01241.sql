CREATE TABLE [MySchema].[MyTable_01241] (
    ...
    CONSTRAINT [PK_MyTable_01241] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01241_MyTable01241] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01241] ([ColKey]),
    CONSTRAINT [BK_MyTable_01241_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
