CREATE TABLE [MySchema].[MyTable_01382] (
    ...
    CONSTRAINT [PK_MyTable_01382] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01382_MyTable01382] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01382] ([ColKey]),
    CONSTRAINT [BK_MyTable_01382_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
