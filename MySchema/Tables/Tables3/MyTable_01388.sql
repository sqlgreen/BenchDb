CREATE TABLE [MySchema].[MyTable_01388] (
    ...
    CONSTRAINT [PK_MyTable_01388] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01388_MyTable01388] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01388] ([ColKey]),
    CONSTRAINT [BK_MyTable_01388_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
