CREATE TABLE [MySchema].[MyTable_01054] (
    ...
    CONSTRAINT [PK_MyTable_01054] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01054_MyTable01054] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01054] ([ColKey]),
    CONSTRAINT [BK_MyTable_01054_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
