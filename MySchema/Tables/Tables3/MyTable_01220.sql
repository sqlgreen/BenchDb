CREATE TABLE [MySchema].[MyTable_01220] (
    ...
    CONSTRAINT [PK_MyTable_01220] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01220_MyTable01220] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01220] ([ColKey]),
    CONSTRAINT [BK_MyTable_01220_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
