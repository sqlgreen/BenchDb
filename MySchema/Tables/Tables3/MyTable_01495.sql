CREATE TABLE [MySchema].[MyTable_01495] (
    ...
    CONSTRAINT [PK_MyTable_01495] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01495_MyTable01495] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01495] ([ColKey]),
    CONSTRAINT [BK_MyTable_01495_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
