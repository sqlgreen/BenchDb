CREATE TABLE [MySchema].[MyTable_01016] (
    ...
    CONSTRAINT [PK_MyTable_01016] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01016_MyTable01016] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01016] ([ColKey]),
    CONSTRAINT [BK_MyTable_01016_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
