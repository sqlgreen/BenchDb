CREATE TABLE [MySchema].[MyTable_01174] (
    ...
    CONSTRAINT [PK_MyTable_01174] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01174_MyTable01174] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01174] ([ColKey]),
    CONSTRAINT [BK_MyTable_01174_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
