CREATE TABLE [MySchema].[MyTable_01157] (
    ...
    CONSTRAINT [PK_MyTable_01157] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01157_MyTable01157] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01157] ([ColKey]),
    CONSTRAINT [BK_MyTable_01157_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
