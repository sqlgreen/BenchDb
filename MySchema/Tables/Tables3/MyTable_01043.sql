CREATE TABLE [MySchema].[MyTable_01043] (
    ...
    CONSTRAINT [PK_MyTable_01043] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01043_MyTable01043] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01043] ([ColKey]),
    CONSTRAINT [BK_MyTable_01043_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
