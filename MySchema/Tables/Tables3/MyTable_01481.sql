CREATE TABLE [MySchema].[MyTable_01481] (
    ...
    CONSTRAINT [PK_MyTable_01481] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01481_MyTable01481] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01481] ([ColKey]),
    CONSTRAINT [BK_MyTable_01481_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
