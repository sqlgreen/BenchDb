CREATE TABLE [MySchema].[MyTable_01206] (
    ...
    CONSTRAINT [PK_MyTable_01206] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01206_MyTable01206] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01206] ([ColKey]),
    CONSTRAINT [BK_MyTable_01206_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
