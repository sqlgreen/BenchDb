CREATE TABLE [MySchema].[MyTable_01336] (
    ...
    CONSTRAINT [PK_MyTable_01336] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01336_MyTable01336] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01336] ([ColKey]),
    CONSTRAINT [BK_MyTable_01336_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
