CREATE TABLE [MySchema].[MyTable_01326] (
    ...
    CONSTRAINT [PK_MyTable_01326] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01326_MyTable01326] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01326] ([ColKey]),
    CONSTRAINT [BK_MyTable_01326_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
