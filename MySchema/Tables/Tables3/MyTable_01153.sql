CREATE TABLE [MySchema].[MyTable_01153] (
    ...
    CONSTRAINT [PK_MyTable_01153] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01153_MyTable01153] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01153] ([ColKey]),
    CONSTRAINT [BK_MyTable_01153_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
