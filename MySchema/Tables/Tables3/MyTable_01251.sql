CREATE TABLE [MySchema].[MyTable_01251] (
    ...
    CONSTRAINT [PK_MyTable_01251] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01251_MyTable01251] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01251] ([ColKey]),
    CONSTRAINT [BK_MyTable_01251_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
