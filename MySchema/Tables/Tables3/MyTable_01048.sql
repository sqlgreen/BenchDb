CREATE TABLE [MySchema].[MyTable_01048] (
    ...
    CONSTRAINT [PK_MyTable_01048] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01048_MyTable01048] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01048] ([ColKey]),
    CONSTRAINT [BK_MyTable_01048_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
