CREATE TABLE [MySchema].[MyTable_01414] (
    ...
    CONSTRAINT [PK_MyTable_01414] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01414_MyTable01414] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01414] ([ColKey]),
    CONSTRAINT [BK_MyTable_01414_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
