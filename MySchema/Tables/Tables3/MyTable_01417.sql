CREATE TABLE [MySchema].[MyTable_01417] (
    ...
    CONSTRAINT [PK_MyTable_01417] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01417_MyTable01417] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01417] ([ColKey]),
    CONSTRAINT [BK_MyTable_01417_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
