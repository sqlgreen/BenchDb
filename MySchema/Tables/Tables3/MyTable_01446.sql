CREATE TABLE [MySchema].[MyTable_01446] (
    ...
    CONSTRAINT [PK_MyTable_01446] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01446_MyTable01446] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01446] ([ColKey]),
    CONSTRAINT [BK_MyTable_01446_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
