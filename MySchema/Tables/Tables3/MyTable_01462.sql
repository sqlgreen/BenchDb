CREATE TABLE [MySchema].[MyTable_01462] (
    ...
    CONSTRAINT [PK_MyTable_01462] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01462_MyTable01462] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01462] ([ColKey]),
    CONSTRAINT [BK_MyTable_01462_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
