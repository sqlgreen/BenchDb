CREATE TABLE [MySchema].[MyTable_01181] (
    ...
    CONSTRAINT [PK_MyTable_01181] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01181_MyTable01181] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01181] ([ColKey]),
    CONSTRAINT [BK_MyTable_01181_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
