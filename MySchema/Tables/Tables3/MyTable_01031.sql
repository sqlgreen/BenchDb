CREATE TABLE [MySchema].[MyTable_01031] (
    ...
    CONSTRAINT [PK_MyTable_01031] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01031_MyTable01031] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01031] ([ColKey]),
    CONSTRAINT [BK_MyTable_01031_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
