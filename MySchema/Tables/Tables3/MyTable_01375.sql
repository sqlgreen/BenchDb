CREATE TABLE [MySchema].[MyTable_01375] (
    ...
    CONSTRAINT [PK_MyTable_01375] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01375_MyTable01375] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01375] ([ColKey]),
    CONSTRAINT [BK_MyTable_01375_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
