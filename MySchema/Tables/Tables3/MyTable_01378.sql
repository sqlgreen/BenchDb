CREATE TABLE [MySchema].[MyTable_01378] (
    ...
    CONSTRAINT [PK_MyTable_01378] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01378_MyTable01378] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01378] ([ColKey]),
    CONSTRAINT [BK_MyTable_01378_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
