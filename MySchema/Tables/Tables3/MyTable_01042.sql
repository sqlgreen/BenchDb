CREATE TABLE [MySchema].[MyTable_01042] (
    ...
    CONSTRAINT [PK_MyTable_01042] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01042_MyTable01042] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01042] ([ColKey]),
    CONSTRAINT [BK_MyTable_01042_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
