CREATE TABLE [MySchema].[MyTable_01459] (
    ...
    CONSTRAINT [PK_MyTable_01459] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01459_MyTable01459] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01459] ([ColKey]),
    CONSTRAINT [BK_MyTable_01459_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
