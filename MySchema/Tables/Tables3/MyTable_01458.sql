CREATE TABLE [MySchema].[MyTable_01458] (
    ...
    CONSTRAINT [PK_MyTable_01458] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01458_MyTable01458] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01458] ([ColKey]),
    CONSTRAINT [BK_MyTable_01458_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
