CREATE TABLE [MySchema].[MyTable_01476] (
    ...
    CONSTRAINT [PK_MyTable_01476] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01476_MyTable01476] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01476] ([ColKey]),
    CONSTRAINT [BK_MyTable_01476_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
