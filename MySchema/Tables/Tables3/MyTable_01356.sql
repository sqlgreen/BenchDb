CREATE TABLE [MySchema].[MyTable_01356] (
    ...
    CONSTRAINT [PK_MyTable_01356] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01356_MyTable01356] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01356] ([ColKey]),
    CONSTRAINT [BK_MyTable_01356_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
