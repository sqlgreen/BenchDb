CREATE TABLE [MySchema].[MyTable_01314] (
    ...
    CONSTRAINT [PK_MyTable_01314] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01314_MyTable01314] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01314] ([ColKey]),
    CONSTRAINT [BK_MyTable_01314_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
