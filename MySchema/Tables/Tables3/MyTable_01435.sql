CREATE TABLE [MySchema].[MyTable_01435] (
    ...
    CONSTRAINT [PK_MyTable_01435] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01435_MyTable01435] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01435] ([ColKey]),
    CONSTRAINT [BK_MyTable_01435_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
