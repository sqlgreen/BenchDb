CREATE TABLE [MySchema].[MyTable_01350] (
    ...
    CONSTRAINT [PK_MyTable_01350] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01350_MyTable01350] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01350] ([ColKey]),
    CONSTRAINT [BK_MyTable_01350_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
