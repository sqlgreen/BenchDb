CREATE TABLE [MySchema].[MyTable_01455] (
    ...
    CONSTRAINT [PK_MyTable_01455] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01455_MyTable01455] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01455] ([ColKey]),
    CONSTRAINT [BK_MyTable_01455_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
