CREATE TABLE [MySchema].[MyTable_01497] (
    ...
    CONSTRAINT [PK_MyTable_01497] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01497_MyTable01497] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01497] ([ColKey]),
    CONSTRAINT [BK_MyTable_01497_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
