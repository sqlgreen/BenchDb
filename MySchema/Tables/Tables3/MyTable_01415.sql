CREATE TABLE [MySchema].[MyTable_01415] (
    ...
    CONSTRAINT [PK_MyTable_01415] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01415_MyTable01415] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01415] ([ColKey]),
    CONSTRAINT [BK_MyTable_01415_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
