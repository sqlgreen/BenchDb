CREATE TABLE [MySchema].[MyTable_01130] (
    ...
    CONSTRAINT [PK_MyTable_01130] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01130_MyTable01130] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01130] ([ColKey]),
    CONSTRAINT [BK_MyTable_01130_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
