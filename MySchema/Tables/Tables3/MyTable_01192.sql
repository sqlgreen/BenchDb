CREATE TABLE [MySchema].[MyTable_01192] (
    ...
    CONSTRAINT [PK_MyTable_01192] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01192_MyTable01192] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01192] ([ColKey]),
    CONSTRAINT [BK_MyTable_01192_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
