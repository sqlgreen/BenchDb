CREATE TABLE [MySchema].[MyTable_01305] (
    ...
    CONSTRAINT [PK_MyTable_01305] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01305_MyTable01305] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01305] ([ColKey]),
    CONSTRAINT [BK_MyTable_01305_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
