CREATE TABLE [MySchema].[MyTable_01293] (
    ...
    CONSTRAINT [PK_MyTable_01293] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01293_MyTable01293] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01293] ([ColKey]),
    CONSTRAINT [BK_MyTable_01293_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
