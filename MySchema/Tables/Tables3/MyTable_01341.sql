CREATE TABLE [MySchema].[MyTable_01341] (
    ...
    CONSTRAINT [PK_MyTable_01341] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01341_MyTable01341] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01341] ([ColKey]),
    CONSTRAINT [BK_MyTable_01341_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
