CREATE TABLE [MySchema].[MyTable_01423] (
    ...
    CONSTRAINT [PK_MyTable_01423] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01423_MyTable01423] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01423] ([ColKey]),
    CONSTRAINT [BK_MyTable_01423_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
