CREATE TABLE [MySchema].[MyTable_01027] (
    ...
    CONSTRAINT [PK_MyTable_01027] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01027_MyTable01027] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01027] ([ColKey]),
    CONSTRAINT [BK_MyTable_01027_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
