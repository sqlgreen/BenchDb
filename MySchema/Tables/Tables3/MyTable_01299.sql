CREATE TABLE [MySchema].[MyTable_01299] (
    ...
    CONSTRAINT [PK_MyTable_01299] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01299_MyTable01299] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01299] ([ColKey]),
    CONSTRAINT [BK_MyTable_01299_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
