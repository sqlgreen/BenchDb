CREATE TABLE [MySchema].[MyTable_01424] (
    ...
    CONSTRAINT [PK_MyTable_01424] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01424_MyTable01424] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01424] ([ColKey]),
    CONSTRAINT [BK_MyTable_01424_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
