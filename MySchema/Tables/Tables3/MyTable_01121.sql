CREATE TABLE [MySchema].[MyTable_01121] (
    ...
    CONSTRAINT [PK_MyTable_01121] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01121_MyTable01121] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01121] ([ColKey]),
    CONSTRAINT [BK_MyTable_01121_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
