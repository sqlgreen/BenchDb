CREATE TABLE [MySchema].[MyTable_01077] (
    ...
    CONSTRAINT [PK_MyTable_01077] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01077_MyTable01077] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01077] ([ColKey]),
    CONSTRAINT [BK_MyTable_01077_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
