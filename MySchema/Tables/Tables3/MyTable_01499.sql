CREATE TABLE [MySchema].[MyTable_01499] (
    ...
    CONSTRAINT [PK_MyTable_01499] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01499_MyTable01499] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01499] ([ColKey]),
    CONSTRAINT [BK_MyTable_01499_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
