CREATE TABLE [MySchema].[MyTable_01445] (
    ...
    CONSTRAINT [PK_MyTable_01445] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01445_MyTable01445] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01445] ([ColKey]),
    CONSTRAINT [BK_MyTable_01445_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
