CREATE TABLE [MySchema].[MyTable_01401] (
    ...
    CONSTRAINT [PK_MyTable_01401] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01401_MyTable01401] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01401] ([ColKey]),
    CONSTRAINT [BK_MyTable_01401_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
