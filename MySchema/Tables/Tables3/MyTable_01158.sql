CREATE TABLE [MySchema].[MyTable_01158] (
    ...
    CONSTRAINT [PK_MyTable_01158] PRIMARY KEY CLUSTERED ([ColKey] ASC, [CZ] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [FK_MyTable_Key_01158_MyTable01158] FOREIGN KEY ([ColKey]) REFERENCES [MySchema].[MyTable_Key_01158] ([ColKey]),
    CONSTRAINT [BK_MyTable_01158_CZ] UNIQUE NONCLUSTERED ([CZ] ASC) WITH (DATA_COMPRESSION = PAGE)
);
